...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("flow_cache_1_way_1_alu") stateful_alu() flow_cache_1_way_1_alu_0;
    @name("flow_cache_1_way_1_learn_alu") stateful_alu() flow_cache_1_way_1_learn_alu_0;
    @name("flow_cache_1_way_2_alu") stateful_alu() flow_cache_1_way_2_alu_0;
    @name("flow_cache_2_way_1_alu") stateful_alu() flow_cache_2_way_1_alu_0;
    @name("flow_cache_2_way_1_learn_alu") stateful_alu() flow_cache_2_way_1_learn_alu_0;
    @name("flow_cache_2_way_2_alu") stateful_alu() flow_cache_2_way_2_alu_0;
    @name(".do_flow_table_cache_1_1") action do_flow_table_cache_1() {
        flow_cache_1_way_1_alu_0.execute_stateful_alu();
    }
    @name(".do_flow_table_cache_1_2") action do_flow_table_cache_1_0() {
        flow_cache_1_way_2_alu_0.execute_stateful_alu();
    }
    @name(".do_flow_table_learn_1_1") action do_flow_table_learn_1() {
        flow_cache_1_way_1_learn_alu_0.execute_stateful_alu();
    }
    @name(".do_flow_table_cache_2_1") action do_flow_table_cache_2() {
        flow_cache_2_way_1_alu_0.execute_stateful_alu();
    }
    @name(".do_flow_table_cache_2_2") action do_flow_table_cache_2_0() {
        flow_cache_2_way_2_alu_0.execute_stateful_alu();
    }
    @name(".do_flow_table_learn_2_1") action do_flow_table_learn_2() {
        flow_cache_2_way_1_learn_alu_0.execute_stateful_alu();
    }
