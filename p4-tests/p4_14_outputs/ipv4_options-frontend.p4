...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".parse_ether") state parse_ether {
        packet.extract<ether_t>(hdr.ether);
    ...
    @name(".parse_mpls") state parse_mpls {
        tmp_5 = packet.lookahead<bit<24>>();
        transition select(tmp_5[0:0]) {
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".show_parser_error") action show_parser_error_0() {
        hdr.ether.mac_da = (bit<48>)hdr.ig_intr_md_from_parser_aux.ingress_parser_err;
        hdr.ig_intr_md_for_tm.ucast_egress_port = 9w0;
    }
    @name(".show_parser_error") table show_parser_error_1 {
        actions = {
            show_parser_error_0();
        }
        size = 1;
        default_action = show_parser_error_0();
    }
    apply {
        show_parser_error_1.apply();
    }
}

control DeparserImpl(packet_out packet, in headers hdr) {
    apply {
        packet.emit<ether_t>(hdr.ether);
...
control verifyChecksum(inout headers hdr, inout metadata meta) {
    apply {
        verify_checksum<tuple<bit<4>, bit<4>, bit<8>, bit<16>, bit<16>, bit<3>, bit<13>, bit<8>, bit<8>, bit<32>, bit<32>, bit<32>, bit<64>, bit<96>, bit<128>, bit<160>, bit<192>, bit<224>, bit<256>, bit<320>>, bit<16>>(true, { hdr.ipv4.version, hdr.ipv4.ihl, hdr.ipv4.diffserv, hdr.ipv4.totalLen, hdr.ipv4.identification, hdr.ipv4.flags, hdr.ipv4.fragOffset, hdr.ipv4.ttl, hdr.ipv4.protocol, hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, hdr.ipv4_options_4b.options, hdr.ipv4_options_8b.options, hdr.ipv4_options_12b.options, hdr.ipv4_options_16b.options, hdr.ipv4_options_20b.options, hdr.ipv4_options_24b.options, hdr.ipv4_options_28b.options, hdr.ipv4_options_32b.options, hdr.ipv4_options_40b.options }, hdr.ipv4.hdrChecksum, HashAlgorithm.csum16);
    }
}

control computeChecksum(inout headers hdr, inout metadata meta) {
    apply {
        update_checksum<tuple<bit<4>, bit<4>, bit<8>, bit<16>, bit<16>, bit<3>, bit<13>, bit<8>, bit<8>, bit<32>, bit<32>, bit<32>, bit<64>, bit<96>, bit<128>, bit<160>, bit<192>, bit<224>, bit<256>, bit<320>>, bit<16>>(true, { hdr.ipv4.version, hdr.ipv4.ihl, hdr.ipv4.diffserv, hdr.ipv4.totalLen, hdr.ipv4.identification, hdr.ipv4.flags, hdr.ipv4.fragOffset, hdr.ipv4.ttl, hdr.ipv4.protocol, hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, hdr.ipv4_options_4b.options, hdr.ipv4_options_8b.options, hdr.ipv4_options_12b.options, hdr.ipv4_options_16b.options, hdr.ipv4_options_20b.options, hdr.ipv4_options_24b.options, hdr.ipv4_options_28b.options, hdr.ipv4_options_32b.options, hdr.ipv4_options_40b.options }, hdr.ipv4.hdrChecksum, HashAlgorithm.csum16);
    }
}
