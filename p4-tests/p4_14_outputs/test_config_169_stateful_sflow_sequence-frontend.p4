...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name("sflow_state_exp_seq_num") register<bit<32>>(32w4294967295) sflow_state_exp_seq_num_0;
    ...
    @name("sflow_seq_num") table sflow_seq_num_0 {
        ...
        key = {
            ...
            meta.meta.sflow_sample_seq_no: exact @name("meta.meta.sflow_sample_seq_no") ;
        }
        size = 1024;
