...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".action_160") action action_160(bit<32> param_1_32, bit<32> param_2_32, bit<32> param_3_32, bit<8> param_4_32, bit<16> param_5_16, bit<8> param_6_8) {
        hdr.my_test_config_1.a_32 = (bit<32>)param_1_32;
        hdr.my_test_config_1.e_32 = (bit<32>)param_2_32;
        hdr.my_test_config_1.f_32 = (bit<32>)param_3_32;
        hdr.my_test_config_1.m_16 = (bit<16>)param_5_16;
        hdr.my_test_config_1.c_8 = (bit<8>)param_6_8;
    }
    @name(".action_8") action action_8(bit<8> param_1_8) {
        hdr.my_test_config_1.b_8 = (bit<8>)param_1_8;
    }
