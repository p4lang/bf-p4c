...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".action_0") action action_0(bit<1> param0, bit<1> param1, bit<4> param2, bit<4> param3, bit<1> param4, bit<1> param5, bit<16> param6) {
        ...
        hdr.pkt.field_d_32 = (bit<32>)32w55;
        hdr.pkt.field_g_16 = (bit<16>)param6;
    }
