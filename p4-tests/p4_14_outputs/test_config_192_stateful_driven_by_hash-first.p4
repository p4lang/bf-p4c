...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    stateful_alu() b_em_direct;
    stateful_alu() b_em_indirect;
    stateful_alu() b_hash_act;
    stateful_alu() b_no_key;
    stateful_alu() b_t_direct;
    stateful_alu() b_t_indirect;
    @name(".a_em_direct") action a_em_direct() {
        b_em_direct.execute_stateful_alu_from_hash<tuple<bit<32>, bit<32>>>({ hdr.pkt.field_a_32, hdr.pkt.field_b_32 });
    }
    @name(".a_em_indirect") action a_em_indirect() {
        b_em_indirect.execute_stateful_alu_from_hash<tuple<bit<32>, bit<32>>>({ hdr.pkt.field_a_32, hdr.pkt.field_b_32 });
    }
    @name(".do_nothing") action do_nothing() {
    }
    @name(".a_hash_act") action a_hash_act() {
        b_hash_act.execute_stateful_alu_from_hash<tuple<bit<32>, bit<32>>>({ hdr.pkt.field_a_32, hdr.pkt.field_b_32 });
    }
    @name(".a_no_key") action a_no_key() {
        b_no_key.execute_stateful_alu_from_hash<tuple<bit<32>, bit<32>>>({ hdr.pkt.field_a_32, hdr.pkt.field_b_32 });
    }
    @name(".a_t_direct") action a_t_direct() {
        b_t_direct.execute_stateful_alu_from_hash<tuple<bit<32>, bit<32>>>({ hdr.pkt.field_a_32, hdr.pkt.field_b_32 });
    }
    @name(".a_t_indirect") action a_t_indirect() {
        b_t_indirect.execute_stateful_alu_from_hash<tuple<bit<32>, bit<32>>>({ hdr.pkt.field_a_32, hdr.pkt.field_b_32 });
    }
