...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".set_m2") action set_m2() {
        meta.m2.p = (bit<3>)hdr.vlan2.priority;
        meta.m2.c = (bit<1>)hdr.vlan2.cfi;
        meta.m2.v = (bit<12>)hdr.vlan2.vid;
        meta.m2.t = (bit<16>)hdr.vlan2.vtype;
    }
    @name(".set_m_again") action set_m_again() {
        meta.m.p = (bit<3>)meta.m2.p;
        meta.m.c = (bit<1>)meta.m2.c;
        meta.m.v = (bit<12>)meta.m2.v;
        meta.m.t = (bit<16>)meta.m2.t;
    }
    @name("t1") table t1 {
        actions = {
            do_nothing;
