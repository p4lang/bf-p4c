...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".calc_dpi_lan_inner_mac_mag_hash") action calc_dpi_lan_inner_mac_mag_hash() {
        hash(meta.ebmeta.port_hash, HashAlgorithm.crc16, (bit<16>)0, { hdr.inner_ethernet.srcAddr, hdr.inner_ethernet.dstAddr }, (bit<32>)65536);
    }
    @name(".calc_dpi_lan_ipv4_mag_hash") action calc_dpi_lan_ipv4_mag_hash() {
        hash(meta.ebmeta.port_hash, HashAlgorithm.crc16, (bit<16>)0, { hdr.outer_ipv4.srcAddr, hdr.outer_ipv4.dstAddr }, (bit<32>)65536);
    }
    @name(".calc_dpi_lan_ipv6_mag_hash") action calc_dpi_lan_ipv6_mag_hash() {
        hash(meta.ebmeta.port_hash, HashAlgorithm.crc16, (bit<16>)0, { hdr.outer_ipv6.srcAddr, hdr.outer_ipv6.dstAddr }, (bit<32>)65536);
    }
    @name(".calc_dpi_lan_outer_mac_mag_hash") action calc_dpi_lan_outer_mac_mag_hash() {
        hash(meta.ebmeta.port_hash, HashAlgorithm.crc16, (bit<16>)0, { hdr.outer_ethernet.srcAddr, hdr.outer_ethernet.dstAddr }, (bit<32>)65536);
    }
    @name(".calc_dpi_wan_inner_mac_mag_hash") action calc_dpi_wan_inner_mac_mag_hash() {
        hash(meta.ebmeta.port_hash, HashAlgorithm.crc16, (bit<16>)0, { hdr.inner_ethernet.dstAddr, hdr.inner_ethernet.srcAddr }, (bit<32>)65536);
    }
    @name(".calc_dpi_wan_ipv4_mag_hash") action calc_dpi_wan_ipv4_mag_hash() {
        ...
        hash(meta.ebmeta.port_hash, HashAlgorithm.crc16, (bit<16>)0, { hdr.outer_ipv4.dstAddr, hdr.outer_ipv4.srcAddr }, (bit<32>)65536);
    }
    @name(".calc_dpi_wan_ipv6_mag_hash") action calc_dpi_wan_ipv6_mag_hash() {
        hash(meta.ebmeta.port_hash, HashAlgorithm.crc16, (bit<16>)0, { hdr.outer_ipv6.dstAddr, hdr.outer_ipv6.srcAddr }, (bit<32>)65536);
    }
    @name(".calc_dpi_wan_outer_mac_mag_hash") action calc_dpi_wan_outer_mac_mag_hash() {
        hash(meta.ebmeta.port_hash, HashAlgorithm.crc16, (bit<16>)0, { hdr.outer_ethernet.dstAddr, hdr.outer_ethernet.srcAddr }, (bit<32>)65536);
    }
