...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("._nop") action _nop_17() {
    }
    @name("._nop") action _nop_18() {
    }
    @name("._nop") action _nop_19() {
    }
    @name("._nop") action _nop_20() {
    }
    @name("._nop") action _nop_21() {
    }
    @name("._nop") action _nop_22() {
    }
    @name("._nop") action _nop_23() {
    }
    @name("._nop") action _nop_24() {
    }
    @name("._nop") action _nop_25() {
    }
    @name("._nop") action _nop_26() {
    }
    @name("._nop") action _nop_27() {
    }
    @name("._nop") action _nop_28() {
    }
    @name("._nop") action _nop_29() {
    }
    @name("._nop") action _nop_30() {
    }
