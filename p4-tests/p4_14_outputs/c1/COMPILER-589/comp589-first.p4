...
control Alamota(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Aynor") table Aynor {
        ...
        size = 256;
        default_action = Magoun(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Aynor.apply();
    }
...
control Armstrong(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".DeLancey") table DeLancey {
        ...
        size = 256;
        default_action = Waterflow(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        DeLancey.apply();
    }
...
control Arnold(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Jamesport") table Jamesport {
        ...
        size = 256;
        default_action = Bryan(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Jamesport.apply();
    }
...
control Barclay(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @ways(4) @name(".WestBay") table WestBay {
        ...
        key = {
            meta.Burrel.Shobonier  : exact @name("Burrel.Shobonier") ;
            meta.Vandling.Glenpool : exact @name("Vandling.Glenpool") ;
            meta.Vandling.Hotchkiss: exact @name("Vandling.Hotchkiss") ;
            meta.Vandling.Bellmore : exact @name("Vandling.Bellmore") ;
            meta.Vandling.Lubec    : exact @name("Vandling.Lubec") ;
            meta.Vandling.Ashwood  : exact @name("Vandling.Ashwood") ;
            meta.Vandling.BigBar   : exact @name("Vandling.BigBar") ;
            meta.Vandling.Catlin   : exact @name("Vandling.Catlin") ;
            meta.Vandling.Veneta   : exact @name("Vandling.Veneta") ;
            meta.Vandling.Armijo   : exact @name("Vandling.Armijo") ;
        }
        size = 4096;
        default_action = NoAction();
    }
...
control Killen(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Bosler") table Bosler {
        ...
        size = 256;
        default_action = Lamison(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Bosler.apply();
    }
...
control Norcatur(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Fragaria") table Fragaria {
        ...
        size = 256;
        default_action = Umkumiut(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Fragaria.apply();
    }
...
control Oakridge(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @ways(4) @name(".Rushton") table Rushton {
        ...
        key = {
            meta.Burrel.Shobonier: exact @name("Burrel.Shobonier") ;
            meta.Burrel.Glenpool : exact @name("Burrel.Glenpool") ;
            meta.Burrel.Hotchkiss: exact @name("Burrel.Hotchkiss") ;
            meta.Burrel.Bellmore : exact @name("Burrel.Bellmore") ;
            meta.Burrel.Lubec    : exact @name("Burrel.Lubec") ;
            meta.Burrel.Ashwood  : exact @name("Burrel.Ashwood") ;
            meta.Burrel.BigBar   : exact @name("Burrel.BigBar") ;
            meta.Burrel.Catlin   : exact @name("Burrel.Catlin") ;
            meta.Burrel.Veneta   : exact @name("Burrel.Veneta") ;
            meta.Burrel.Armijo   : exact @name("Burrel.Armijo") ;
        }
        size = 4096;
        default_action = NoAction();
    }
...
control Oregon(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Keener") table Keener {
        ...
        size = 256;
        default_action = Bayard(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Keener.apply();
    }
...
control Wenatchee(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Diomede") table Diomede {
        ...
        size = 256;
        default_action = Buckfield(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Diomede.apply();
    }
...
control WhiteOwl(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Savery") table Savery {
        ...
        size = 256;
        default_action = Phelps(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Savery.apply();
    }
