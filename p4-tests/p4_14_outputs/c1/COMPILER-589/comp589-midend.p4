...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Sarasota") action _Sarasota() {
        hash<bit<19>, bit<19>, tuple_0, bit<20>>(_Calabasas_temp_1, HashAlgorithm.identity, 19w0, { hdr.ig_intr_md.ingress_port, hdr.McCaulley[0].Batchelor }, 20w524288);
        _Calabasas_tmp_1 = _Calabasas_Olene_0.execute((bit<32>)_Calabasas_temp_1);
    ...
    @name(".Rawson") action _Rawson() {
        hash<bit<19>, bit<19>, tuple_0, bit<20>>(_Calabasas_temp_2, HashAlgorithm.identity, 19w0, { hdr.ig_intr_md.ingress_port, hdr.McCaulley[0].Batchelor }, 20w524288);
        _Calabasas_tmp_2 = _Calabasas_Portal_0.execute((bit<32>)_Calabasas_temp_2);
    ...
    @name(".ViewPark") action _ViewPark() {
        hash<bit<32>, bit<32>, tuple_1, bit<64>>(meta.Sherando.Poland, HashAlgorithm.crc32, 32w0, { hdr.Dixboro.Hueytown, hdr.Dixboro.Scottdale, hdr.Dixboro.Larose, hdr.Dixboro.Topmost, hdr.Dixboro.Montegut }, 64w4294967296);
    }
    ...
    @name(".Magasco") action _Magasco() {
        hash<bit<32>, bit<32>, tuple_2, bit<64>>(meta.Sherando.Roachdale, HashAlgorithm.crc32, 32w0, { hdr.Crossnore.Cloverly, hdr.Crossnore.Despard, hdr.Crossnore.Palco, hdr.Crossnore.Gunter }, 64w4294967296);
    }
    @name(".Dutton") action _Dutton() {
        hash<bit<32>, bit<32>, tuple_3, bit<64>>(meta.Sherando.Roachdale, HashAlgorithm.crc32, 32w0, { hdr.CapRock.Kremlin, hdr.CapRock.Nerstrand, hdr.CapRock.Cimarron }, 64w4294967296);
    }
    ...
    @name(".Atoka") action _Atoka() {
        hash<bit<32>, bit<32>, tuple_4, bit<64>>(meta.Sherando.Havana, HashAlgorithm.crc32, 32w0, { hdr.CapRock.Nerstrand, hdr.CapRock.Cimarron, hdr.Wauregan.Hendley, hdr.Wauregan.Chicago }, 64w4294967296);
    }
    ...
    @name(".Pathfork") action _Pathfork(bit<32> Pettry) {
        _Brazos_tmp_0 = (meta.Sargent.Tulsa >= Pettry ? meta.Sargent.Tulsa : _Brazos_tmp_0);
        _Brazos_tmp_0 = (!(meta.Sargent.Tulsa >= Pettry) ? Pettry : _Brazos_tmp_0);
    ...
    @name(".Pathfork") action _Pathfork_0(bit<32> Pettry) {
        _Heron_tmp_0 = (meta.Sargent.Tulsa >= Pettry ? meta.Sargent.Tulsa : _Heron_tmp_0);
        _Heron_tmp_0 = (!(meta.Sargent.Tulsa >= Pettry) ? Pettry : _Heron_tmp_0);
    ...
    @name(".Pathfork") action _Pathfork_1(bit<32> Pettry) {
        _Homeland_tmp_0 = (meta.Sargent.Tulsa >= Pettry ? meta.Sargent.Tulsa : _Homeland_tmp_0);
        _Homeland_tmp_0 = (!(meta.Sargent.Tulsa >= Pettry) ? Pettry : _Homeland_tmp_0);
    ...
    @name(".Pathfork") action _Pathfork_2(bit<32> Pettry) {
        _Woodridge_tmp_0 = (meta.Sargent.Tulsa >= Pettry ? meta.Sargent.Tulsa : _Woodridge_tmp_0);
        _Woodridge_tmp_0 = (!(meta.Sargent.Tulsa >= Pettry) ? Pettry : _Woodridge_tmp_0);
    ...
    @name(".Madison") action _Madison(bit<32> Suamico) {
        _TonkaBay_tmp_0 = (meta.Timbo.Tulsa >= Suamico ? meta.Timbo.Tulsa : _TonkaBay_tmp_0);
        _TonkaBay_tmp_0 = (!(meta.Timbo.Tulsa >= Suamico) ? Suamico : _TonkaBay_tmp_0);
    ...
    @name(".Pathfork") action _Pathfork_3(bit<32> Pettry) {
        _Accord_tmp_0 = (meta.Sargent.Tulsa >= Pettry ? meta.Sargent.Tulsa : _Accord_tmp_0);
        _Accord_tmp_0 = (!(meta.Sargent.Tulsa >= Pettry) ? Pettry : _Accord_tmp_0);
    ...
    @name(".Clovis") action _Clovis() {
        _Sylvan_tmp_0 = (meta.Timbo.Tulsa >= meta.Sargent.Tulsa ? meta.Timbo.Tulsa : _Sylvan_tmp_0);
        _Sylvan_tmp_0 = (!(meta.Timbo.Tulsa >= meta.Sargent.Tulsa) ? meta.Sargent.Tulsa : _Sylvan_tmp_0);
    ...
    @name(".Ewing") action _Ewing_40() {
        _Fallis_0.count();
    }
    @name(".Darien") table _Darien_0 {
        actions = {
            _Ewing_40();
            @defaultonly _Ewing_39();
        }
        key = {
...
control verifyChecksum(in headers hdr, inout metadata meta) {
    bit<16> tmp_15;
    bit<16> tmp_23;
    @name("Parthenon") Checksum16() Parthenon;
    @name("Kinards") Checksum16() Kinards;
    apply {
        tmp_15 = Parthenon.get<tuple_5>({ hdr.CapRock.Supai, hdr.CapRock.DeSart, hdr.CapRock.Naches, hdr.CapRock.Claypool, hdr.CapRock.Millett, hdr.CapRock.LaUnion, hdr.CapRock.Emmalane, hdr.CapRock.Farlin, hdr.CapRock.Weimar, hdr.CapRock.Kremlin, hdr.CapRock.Nerstrand, hdr.CapRock.Cimarron });
        if (hdr.CapRock.Waubun == tmp_15) 
            mark_to_drop();
        tmp_23 = Kinards.get<tuple_5>({ hdr.Lepanto.Supai, hdr.Lepanto.DeSart, hdr.Lepanto.Naches, hdr.Lepanto.Claypool, hdr.Lepanto.Millett, hdr.Lepanto.LaUnion, hdr.Lepanto.Emmalane, hdr.Lepanto.Farlin, hdr.Lepanto.Weimar, hdr.Lepanto.Kremlin, hdr.Lepanto.Nerstrand, hdr.Lepanto.Cimarron });
        if (hdr.Lepanto.Waubun == tmp_23) 
            mark_to_drop();
    }
}
...
control computeChecksum(inout headers hdr, inout metadata meta) {
    bit<16> tmp_25;
    bit<16> tmp_26;
    @name("Parthenon") Checksum16() Parthenon_2;
    @name("Kinards") Checksum16() Kinards_2;
    apply {
        tmp_25 = Parthenon_2.get<tuple_5>({ hdr.CapRock.Supai, hdr.CapRock.DeSart, hdr.CapRock.Naches, hdr.CapRock.Claypool, hdr.CapRock.Millett, hdr.CapRock.LaUnion, hdr.CapRock.Emmalane, hdr.CapRock.Farlin, hdr.CapRock.Weimar, hdr.CapRock.Kremlin, hdr.CapRock.Nerstrand, hdr.CapRock.Cimarron });
        hdr.CapRock.Waubun = tmp_25;
        tmp_26 = Kinards_2.get<tuple_5>({ hdr.Lepanto.Supai, hdr.Lepanto.DeSart, hdr.Lepanto.Naches, hdr.Lepanto.Claypool, hdr.Lepanto.Millett, hdr.Lepanto.LaUnion, hdr.Lepanto.Emmalane, hdr.Lepanto.Farlin, hdr.Lepanto.Weimar, hdr.Lepanto.Kremlin, hdr.Lepanto.Nerstrand, hdr.Lepanto.Cimarron });
        hdr.Lepanto.Waubun = tmp_26;
    }
}
