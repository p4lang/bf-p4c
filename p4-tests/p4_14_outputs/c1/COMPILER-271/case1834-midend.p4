...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Lucien") action _Lucien() {
        hash<bit<18>, bit<18>, tuple_0, bit<19>>(_Satanta_temp_1, HashAlgorithm.identity, 18w0, { meta.Azusa.Mishicot, hdr.Talbert[0].Sandoval }, 19w262144);
    ...
    @name(".Palmdale") action _Palmdale() {
        hash<bit<18>, bit<18>, tuple_0, bit<19>>(_Satanta_temp_2, HashAlgorithm.identity, 18w0, { meta.Azusa.Mishicot, hdr.Talbert[0].Sandoval }, 19w262144);
    ...
    @name(".Bremond") action _Bremond() {
        hash<bit<32>, bit<32>, tuple_1, bit<64>>(meta.Halley.Conda, HashAlgorithm.crc32, 32w0, { hdr.WhiteOwl.Putnam, hdr.WhiteOwl.Stanwood, hdr.WhiteOwl.National, hdr.WhiteOwl.Rohwer, hdr.WhiteOwl.Weleetka }, 64w4294967296);
    }
    ...
    @name(".Pickering") action _Pickering() {
        hash<bit<32>, bit<32>, tuple_2, bit<64>>(meta.Halley.Corder, HashAlgorithm.crc32, 32w0, { hdr.Atlas.Kenova, hdr.Atlas.Verdemont, hdr.Atlas.Natalbany, hdr.Atlas.Bosco }, 64w4294967296);
    }
    @name(".Stoystown") action _Stoystown() {
        hash<bit<32>, bit<32>, tuple_3, bit<64>>(meta.Halley.Corder, HashAlgorithm.crc32, 32w0, { hdr.Sardinia.Stovall, hdr.Sardinia.Natalia, hdr.Sardinia.Everetts }, 64w4294967296);
    }
    ...
    @name(".Bethayres") action _Bethayres() {
        hash<bit<32>, bit<32>, tuple_4, bit<64>>(meta.Halley.Wickett, HashAlgorithm.crc32, 32w0, { hdr.Sardinia.Stovall, hdr.Sardinia.Natalia, hdr.Sardinia.Everetts, hdr.Nuangola.Cammal, hdr.Nuangola.Hutchings }, 64w4294967296);
    }
