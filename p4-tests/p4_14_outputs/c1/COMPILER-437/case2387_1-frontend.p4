...
control Victoria(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("Kekoskee") stateful_alu() Kekoskee_0;
    @name("Woodsboro") stateful_alu() Woodsboro_0;
    @name(".Pacifica") action Pacifica_0() {
        Woodsboro_0.execute_stateful_alu_from_hash<tuple<bit<6>, bit<12>>>({ meta.Tarlton.Atoka, hdr.Maryhill[0].Ladner });
    }
    ...
    @name(".Kerrville") action Kerrville_0() {
        Kekoskee_0.execute_stateful_alu_from_hash<tuple<bit<6>, bit<12>>>({ meta.Tarlton.Atoka, hdr.Maryhill[0].Ladner });
    }
