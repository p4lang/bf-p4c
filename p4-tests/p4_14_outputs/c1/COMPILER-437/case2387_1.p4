...
control Victoria(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Pacifica") action Pacifica() {
        Woodsboro.execute_stateful_alu_from_hash({ meta.Tarlton.Atoka, hdr.Maryhill[0].Ladner });
    }
    ...
    @name(".Kerrville") action Kerrville() {
        Kekoskee.execute_stateful_alu_from_hash({ meta.Tarlton.Atoka, hdr.Maryhill[0].Ladner });
    }
