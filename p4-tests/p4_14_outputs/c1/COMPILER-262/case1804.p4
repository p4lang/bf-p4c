...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Sopris") state Sopris {
        packet.extract(hdr.Milwaukie);
        meta.Phelps.Tabler = 2w1;
        transition Vallejo;
    }
    @name(".Townville") state Townville {
        packet.extract(hdr.Newsoms);
        transition accept;
    }
    @name(".Vallejo") state Vallejo {
        packet.extract(hdr.Helotes);
    ...
    @name(".ViewPark") state ViewPark {
        packet.extract(hdr.Ludell);
        transition accept;
    }
    @name(".WestCity") state WestCity {
        packet.extract(hdr.Maupin);
        transition accept;
    }
...
control Absarokee(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Goldsboro") action Goldsboro() {
        digest<Westwood>((bit<32>)0, { meta.Pinecrest.Wyatte, meta.Phelps.Nipton, hdr.Helotes.Greer, hdr.Helotes.DonaAna, hdr.Redvale.Bassett });
    }
...
control Belfalls(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @stage(2) @name(".Floyd") table Floyd {
        ...
        key = {
            meta.Glenshaw.Colson  : exact;
            meta.Glenshaw.Bellwood: exact;
            meta.Glenshaw.Needles : exact;
            hdr.Redvale.isValid() : ternary;
            hdr.Maupin.isValid()  : ternary;
        }
        size = 512;
    }
...
control Colonie(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Anguilla") table Anguilla {
        ...
        key = {
            meta.Glenshaw.Segundo: exact;
            meta.Brinkley.Tarlton: selector;
        }
        size = 1024;
...
control Haines(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Torrance") action Torrance() {
        hash(meta.Brinkley.Tarlton, HashAlgorithm.crc32, (bit<32>)0, { hdr.SaintAnn.Ladner, hdr.SaintAnn.Dubbs, hdr.SaintAnn.Greer, hdr.SaintAnn.DonaAna, hdr.SaintAnn.DelRosa }, (bit<64>)65536);
    }
    @pa_solitary("ingress", "Phelps.Nipton") @pa_solitary("ingress", "Phelps.Ahmeek") @pa_solitary("ingress", "Phelps.Galestown") @pa_solitary("egress", "Glenshaw.Mayview") @pa_solitary("ig_intr_md_for_tm.ucast_egress_port") @name(".Elsmere") action Elsmere() {
        ;
    }
    @name(".Othello") table Othello {
        ...
        key = {
            hdr.Hillister.isValid(): ternary;
            hdr.Dyess.isValid()    : ternary;
            hdr.Ludell.isValid()   : ternary;
            hdr.Clermont.isValid() : ternary;
            hdr.Helotes.isValid()  : ternary;
            hdr.Veradale.isValid() : ternary;
            hdr.Requa.isValid()    : ternary;
            hdr.Redvale.isValid()  : ternary;
            hdr.Maupin.isValid()   : ternary;
            hdr.SaintAnn.isValid() : ternary;
        }
        size = 256;
...
control KentPark(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Sherack") register_action<bit<1>, bit<1>>(Chaffey) Sherack = {
    ...
    @name(".Spiro") register_action<bit<1>, bit<1>>(Buenos) Spiro = {
        void apply(inout bit<1> value, out bit<1> rv) {
            bit<1> in_value;
            in_value = value;
            rv = 1w0;
    ...
    @name(".Hanapepe") action Hanapepe() {
        {
            bit<18> temp;
            hash(temp, HashAlgorithm.identity, 18w0, { meta.Kranzburg.Arnold, hdr.Florala.Lutsen }, 19w262144);
    ...
    @name(".Hadley") action Hadley() {
        {
            bit<18> temp_0;
            hash(temp_0, HashAlgorithm.identity, 18w0, { meta.Kranzburg.Arnold, hdr.Florala.Lutsen }, 19w262144);
...
control Overton(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Council") table Council {
        ...
        key = {
            hdr.SaintAnn.Ladner: exact;
            hdr.SaintAnn.Dubbs : exact;
        }
        size = 64;
    }
    apply {
...
control Kinde(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Dundee") table Dundee {
        ...
        key = {
            meta.Kranzburg.Renton: ternary;
            hdr.Florala.isValid(): exact;
            hdr.Florala.Lutsen   : ternary;
        }
        size = 4096;
    }
    @name(".Higbee") table Higbee {
        ...
        key = {
            hdr.SaintAnn.Ladner: exact;
            hdr.SaintAnn.Dubbs : exact;
            hdr.Redvale.Dauphin: exact;
            meta.Phelps.Tabler : exact;
        }
        size = 1024;
    ...
    @name(".Savery") table Savery {
        ...
        key = {
            meta.Kranzburg.Wheatland: exact;
        }
        size = 4096;
    }
...
control Laneburg(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Powderly") register_action<bit<1>, bit<1>>(Ingleside) Powderly = {
        void apply(inout bit<1> value, out bit<1> rv) {
            bit<1> in_value;
            in_value = value;
            rv = 1w0;
    ...
    @name(".Rapids") table Rapids {
        ...
        key = {
            meta.Phelps.Salus : exact;
            meta.Phelps.Corder: exact;
            meta.Phelps.Nipton: exact;
            meta.Phelps.Ahmeek: exact;
        }
        size = 65536;
    }
    apply {
...
control Magness(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @ways(1) @name(".Masontown") table Masontown {
        ...
        key = {
            meta.Glenshaw.Berlin : exact;
            meta.Glenshaw.Almeria: exact;
        }
        size = 1;
...
control Millican(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Anahola") action Anahola() {
        digest<ElPrado>((bit<32>)0, { meta.Pinecrest.Wyatte, meta.Phelps.Salus, meta.Phelps.Corder, meta.Phelps.Nipton, meta.Phelps.Ahmeek });
    }
...
control Russia(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Bomarton") table Bomarton {
        ...
        key = {
            meta.Phelps.Galestown: ternary;
            meta.Phelps.Taopi    : exact;
            meta.Phelps.Viroqua  : exact;
        }
        size = 512;
    }
    apply {
...
control WallLake(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @atcam_partition_index("Opelousas.Ronan") @atcam_number_partitions(1024) @name(".Dassel") table Dassel {
        ...
        key = {
            meta.Opelousas.Ronan         : exact;
            meta.Opelousas.Anniston[79:0]: lpm;
        }
        size = 16384;
        default_action = Elsmere();
    }
    @atcam_partition_index("Opelousas.Northlake") @atcam_number_partitions(8192) @name(".Eclectic") table Eclectic {
        ...
        key = {
            meta.Opelousas.Northlake       : exact;
            meta.Opelousas.Anniston[106:64]: lpm;
        }
        size = 65536;
    }
    @idletime_precision(1) @name(".Findlay") table Findlay {
        ...
        key = {
            meta.Nashoba.Coalwood: exact;
            meta.Stilwell.Valeene: lpm;
        }
        size = 1024;
        default_action = Elsmere();
    }
    @name(".Laketown") table Laketown {
        ...
        key = {
            meta.Nashoba.Coalwood          : exact;
            meta.Opelousas.Anniston[127:56]: lpm;
        }
        size = 8192;
    }
    @atcam_partition_index("Stilwell.Bushland") @atcam_number_partitions(8192) @name(".Lodoga") table Lodoga {
        ...
        key = {
            meta.Stilwell.Bushland     : exact;
            meta.Stilwell.Valeene[15:0]: lpm;
        }
        size = 131072;
        default_action = Elsmere();
    }
...
control DeparserImpl(packet_out packet, in headers hdr) {
    apply {
        packet.emit(hdr.SaintAnn);
        packet.emit(hdr.Florala);
        packet.emit(hdr.Newsoms);
        packet.emit(hdr.Maupin);
        packet.emit(hdr.Redvale);
        packet.emit(hdr.Requa);
        packet.emit(hdr.Milwaukie);
        packet.emit(hdr.Helotes);
        packet.emit(hdr.Clermont);
        packet.emit(hdr.Ludell);
    }
}
