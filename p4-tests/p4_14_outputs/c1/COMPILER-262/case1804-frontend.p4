...
control KentPark(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("Sherack") stateful_alu() Sherack_0;
    @name("Spiro") stateful_alu() Spiro_0;
    ...
    @name(".Hanapepe") action Hanapepe_0() {
        Sherack_0.execute_stateful_alu_from_hash<tuple<bit<6>, bit<12>>>({ meta.Kranzburg.Arnold, hdr.Florala.Lutsen });
    }
    ...
    @name(".Hadley") action Hadley_0() {
        Spiro_0.execute_stateful_alu_from_hash<tuple<bit<6>, bit<12>>>({ meta.Kranzburg.Arnold, hdr.Florala.Lutsen });
    }
...
control Laneburg(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("Powderly") stateful_alu() Powderly_0;
    @name(".Ingraham") action Ingraham_0(bit<8> Isabel) {
        Powderly_0.execute_stateful_alu();
    }
