...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Schaller") state Schaller {
        packet.extract<Langhorne_0>(hdr.Mather);
...
control Alakanuk(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    register_action<bit<1>, bit<1>>(Seagrove) Cricket = {
    ...
    register_action<bit<1>, bit<1>>(Lackey) Jerico = {
        void apply(inout bit<1> value, out bit<1> rv) {
            rv = 1w0;
            value = value;
            rv = value;
    ...
    @name(".Telephone") action Telephone() {
        {
            bit<18> temp;
            hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(temp, HashAlgorithm.identity, 18w0, { meta.Brodnax.Columbia, hdr.Jayton[0].Jigger }, 19w262144);
    ...
    @name(".Clementon") action Clementon() {
        {
            bit<18> temp_0;
            hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(temp_0, HashAlgorithm.identity, 18w0, { meta.Brodnax.Columbia, hdr.Jayton[0].Jigger }, 19w262144);
...
control Columbus(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Grasmere") action Grasmere() {
        hash<bit<32>, bit<32>, tuple<bit<24>, bit<24>, bit<24>, bit<24>, bit<16>>, bit<64>>(meta.Buckeye.Candle, HashAlgorithm.crc32, 32w0, { hdr.Twain.SanJuan, hdr.Twain.Weatherly, hdr.Twain.Gordon, hdr.Twain.Topton, hdr.Twain.Lilydale }, 64w65536);
    }
...
control Hanston(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Ozark") table Ozark {
        ...
        size = 8;
        default_action = Whitman(24w0, 24w1);
    }
...
control Mantee(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Metzger") table Metzger {
        ...
        size = 4096;
        default_action = Kamas(8w0, 1w1, 1w0, 1w1, 1w0);
    }
    apply {
...
control NewRoads(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    register_action<bit<1>, bit<1>>(Floyd) Fowlkes = {
        void apply(inout bit<1> value, out bit<1> rv) {
            rv = 1w0;
            value = 1w1;
        }
...
control Nuiqsut(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Missoula") table Missoula {
        ...
        size = 65536;
        default_action = Hoadly(24w0, 24w1, 16w2);
    }
    apply {
