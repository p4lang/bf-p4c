...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Bagwell.Goodwin") stateful_alu() _Bagwell_Goodwin_0;
    @name(".Bagwell.Hulbert") stateful_alu() _Bagwell_Hulbert_0;
    ...
    @name(".Woodland") action _Woodland() {
        _Bagwell_Goodwin_0.execute_stateful_alu_from_hash<tuple_0>({ meta.Harding.Honokahua, hdr.Casper[0].Mariemont });
    }
    @name(".Glazier") action _Glazier() {
        _Bagwell_Hulbert_0.execute_stateful_alu_from_hash<tuple_0>({ meta.Harding.Honokahua, hdr.Casper[0].Mariemont });
    }
