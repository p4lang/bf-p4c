...
control Bagwell(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("Goodwin") stateful_alu() Goodwin_0;
    @name("Hulbert") stateful_alu() Hulbert_0;
    ...
    @name(".Woodland") action Woodland_0() {
        Goodwin_0.execute_stateful_alu_from_hash<tuple<bit<6>, bit<12>>>({ meta.Harding.Honokahua, hdr.Casper[0].Mariemont });
    }
    @name(".Glazier") action Glazier_0() {
        Hulbert_0.execute_stateful_alu_from_hash<tuple<bit<6>, bit<12>>>({ meta.Harding.Honokahua, hdr.Casper[0].Mariemont });
    }
