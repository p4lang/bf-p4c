...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".WindLake") action _WindLake(bit<32> Kaluaaha) {
        if (meta.Sagamore.RichHill >= Kaluaaha) 
            _Paulette_tmp_0 = meta.Sagamore.RichHill;
        else 
            _Paulette_tmp_0 = Kaluaaha;
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    bit<1> _Lacona_tmp_1;
    bit<1> _Lacona_tmp_2;
    @name(".Masardis") register_action<bit<1>, bit<1>>(Parkline) _Masardis_0 = {
        void apply(inout bit<1> value, out bit<1> rv) {
            bit<1> _Lacona_in_value_1;
            _Lacona_in_value_1 = value;
            value = _Lacona_in_value_1;
            rv = value;
        }
    };
    @name(".Woodcrest") register_action<bit<1>, bit<1>>(Ontonagon) _Woodcrest_0 = {
        void apply(inout bit<1> value, out bit<1> rv) {
            bit<1> _Lacona_in_value_2;
            _Lacona_in_value_2 = value;
            value = _Lacona_in_value_2;
            rv = ~value;
        }
    };
    ...
    @name(".Tiverton") action _Tiverton() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_Lacona_temp_1, HashAlgorithm.identity, 18w0, { meta.CedarKey.Norborne, hdr.Carnero[0].Mission }, 19w262144);
    ...
    @name(".Reidland") action _Reidland() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_Lacona_temp_2, HashAlgorithm.identity, 18w0, { meta.CedarKey.Norborne, hdr.Carnero[0].Mission }, 19w262144);
    ...
    @name(".WindLake") action _WindLake_0(bit<32> Kaluaaha) {
        if (meta.Sagamore.RichHill >= Kaluaaha) 
            _Freeville_tmp_0 = meta.Sagamore.RichHill;
        else 
            _Freeville_tmp_0 = Kaluaaha;
    ...
    @name(".WindLake") action _WindLake_1(bit<32> Kaluaaha) {
        if (meta.Sagamore.RichHill >= Kaluaaha) 
            _Wyncote_tmp_0 = meta.Sagamore.RichHill;
        else 
            _Wyncote_tmp_0 = Kaluaaha;
    ...
    @name(".WindLake") action _WindLake_2(bit<32> Kaluaaha) {
        if (meta.Sagamore.RichHill >= Kaluaaha) 
            _Campo_tmp_0 = meta.Sagamore.RichHill;
        else 
            _Campo_tmp_0 = Kaluaaha;
    ...
    @name(".WindLake") action _WindLake_3(bit<32> Kaluaaha) {
        if (meta.Sagamore.RichHill >= Kaluaaha) 
            _Peosta_tmp_0 = meta.Sagamore.RichHill;
        else 
            _Peosta_tmp_0 = Kaluaaha;
    ...
    @name(".WindLake") action _WindLake_4(bit<32> Kaluaaha) {
        if (meta.Sagamore.RichHill >= Kaluaaha) 
            _Pelican_tmp_0 = meta.Sagamore.RichHill;
        else 
            _Pelican_tmp_0 = Kaluaaha;
