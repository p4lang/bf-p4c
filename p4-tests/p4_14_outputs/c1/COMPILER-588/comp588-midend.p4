...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @command_line("--no-dead-code-elimination") @name(".Silvertip") table _Silvertip_0 {
        actions = {
            _Ericsburg();
    ...
    @name(".Warsaw") action _Warsaw() {
        hash<bit<19>, bit<19>, tuple_0, bit<20>>(_Giltner_temp_1, HashAlgorithm.identity, 19w0, { hdr.ig_intr_md.ingress_port, hdr.Hartwick[0].Bunavista }, 20w524288);
        _Giltner_tmp_1 = _Giltner_Colonias_0.execute((bit<32>)_Giltner_temp_1);
    ...
    @name(".Bosler") action _Bosler() {
        hash<bit<19>, bit<19>, tuple_0, bit<20>>(_Giltner_temp_2, HashAlgorithm.identity, 19w0, { hdr.ig_intr_md.ingress_port, hdr.Hartwick[0].Bunavista }, 20w524288);
        _Giltner_tmp_2 = _Giltner_Bramwell_0.execute((bit<32>)_Giltner_temp_2);
    ...
    @name(".Cotter") action _Cotter() {
        hash<bit<32>, bit<32>, tuple_2, bit<64>>(meta.Paxico.Knierim, HashAlgorithm.crc32, 32w0, { hdr.Robbs.Patsville, hdr.Robbs.Sandoval, hdr.Robbs.Claiborne, hdr.Robbs.Purves }, 64w4294967296);
    }
    @name(".DeKalb") action _DeKalb() {
        hash<bit<32>, bit<32>, tuple_3, bit<64>>(meta.Paxico.Knierim, HashAlgorithm.crc32, 32w0, { hdr.Maybee.Lolita, hdr.Maybee.Camanche, hdr.Maybee.Remsen }, 64w4294967296);
    }
    ...
    @name(".Sieper") action _Sieper() {
        hash<bit<32>, bit<32>, tuple_4, bit<64>>(meta.Paxico.Milbank, HashAlgorithm.crc32, 32w0, { hdr.Maybee.Camanche, hdr.Maybee.Remsen, hdr.Sidon.Woodcrest, hdr.Sidon.Haslet }, 64w4294967296);
    }
    ...
    @name(".ViewPark") action _ViewPark_10() {
    }
    ...
    @name(".LaMoille") action _LaMoille(bit<32> Swenson) {
        _Odebolt_tmp_0 = (meta.Parmalee.Livonia >= Swenson ? meta.Parmalee.Livonia : _Odebolt_tmp_0);
        _Odebolt_tmp_0 = (!(meta.Parmalee.Livonia >= Swenson) ? Swenson : _Odebolt_tmp_0);
    ...
    @name(".LaMoille") action _LaMoille_0(bit<32> Swenson) {
        _Yulee_tmp_0 = (meta.Parmalee.Livonia >= Swenson ? meta.Parmalee.Livonia : _Yulee_tmp_0);
        _Yulee_tmp_0 = (!(meta.Parmalee.Livonia >= Swenson) ? Swenson : _Yulee_tmp_0);
    ...
    @name(".ViewPark") action _ViewPark_37() {
    }
    ...
    @name(".LaMoille") action _LaMoille_1(bit<32> Swenson) {
        _Chambers_tmp_0 = (meta.Parmalee.Livonia >= Swenson ? meta.Parmalee.Livonia : _Chambers_tmp_0);
        _Chambers_tmp_0 = (!(meta.Parmalee.Livonia >= Swenson) ? Swenson : _Chambers_tmp_0);
    ...
    @name(".LaMoille") action _LaMoille_2(bit<32> Swenson) {
        _RushCity_tmp_0 = (meta.Parmalee.Livonia >= Swenson ? meta.Parmalee.Livonia : _RushCity_tmp_0);
        _RushCity_tmp_0 = (!(meta.Parmalee.Livonia >= Swenson) ? Swenson : _RushCity_tmp_0);
    ...
    @name(".Ironside") action _Ironside(bit<32> RowanBay) {
        _CeeVee_tmp_0 = (meta.Newsome.Livonia >= RowanBay ? meta.Newsome.Livonia : _CeeVee_tmp_0);
        _CeeVee_tmp_0 = (!(meta.Newsome.Livonia >= RowanBay) ? RowanBay : _CeeVee_tmp_0);
    ...
    @name(".LaMoille") action _LaMoille_3(bit<32> Swenson) {
        _LaPlata_tmp_0 = (meta.Parmalee.Livonia >= Swenson ? meta.Parmalee.Livonia : _LaPlata_tmp_0);
        _LaPlata_tmp_0 = (!(meta.Parmalee.Livonia >= Swenson) ? Swenson : _LaPlata_tmp_0);
    ...
    @name(".ViewPark") action _ViewPark_38() {
    }
    ...
    @name(".Tunis") action _Tunis() {
        _Fajardo_tmp_0 = (meta.Newsome.Livonia >= meta.Parmalee.Livonia ? meta.Newsome.Livonia : _Fajardo_tmp_0);
        _Fajardo_tmp_0 = (!(meta.Newsome.Livonia >= meta.Parmalee.Livonia) ? meta.Parmalee.Livonia : _Fajardo_tmp_0);
    ...
    @name(".ViewPark") action _ViewPark_40() {
        _Newsoms_0.count();
    }
    @name(".Eggleston") table _Eggleston_0 {
        actions = {
            _ViewPark_40();
            @defaultonly _ViewPark_39();
        }
        key = {
