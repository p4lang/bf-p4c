...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Tocito") state Tocito {
        packet.extract<Mangham>(hdr.FulksRun);
...
control Bayshore(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @ways(4) @name(".Moorpark") table Moorpark {
        ...
        key = {
            meta.Waialee.LasLomas: exact @name("Waialee.LasLomas") ;
            meta.Kalskag.Sonora  : exact @name("Kalskag.Sonora") ;
            meta.Kalskag.Winger  : exact @name("Kalskag.Winger") ;
            meta.Kalskag.Tolley  : exact @name("Kalskag.Tolley") ;
            meta.Kalskag.Sawyer  : exact @name("Kalskag.Sawyer") ;
            meta.Kalskag.Academy : exact @name("Kalskag.Academy") ;
            meta.Kalskag.LeeCity : exact @name("Kalskag.LeeCity") ;
            meta.Kalskag.Fairlea : exact @name("Kalskag.Fairlea") ;
            meta.Kalskag.Emmalane: exact @name("Kalskag.Emmalane") ;
            meta.Kalskag.Shirley : exact @name("Kalskag.Shirley") ;
        }
        size = 4096;
        default_action = NoAction();
    }
...
control Corum(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Belmont") table Belmont {
        ...
        size = 256;
        default_action = Knippa(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Belmont.apply();
    }
...
control DeSmet(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Humeston") table Humeston {
        ...
        size = 256;
        default_action = Wyncote(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Humeston.apply();
    }
...
control DesPeres(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Ronneby") table Ronneby {
        ...
        size = 256;
        default_action = Genola(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Ronneby.apply();
    }
...
control Eastover(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Tecolote") action Tecolote(bit<32> Schaller) {
        SanJon.execute_meter<bit<2>>(Schaller, hdr.ig_intr_md_for_tm.packet_color);
    }
    @name(".Challis") action Challis() {
        Paxtonia.count((bit<32>)meta.Empire.Paoli);
    }
...
control Edgemont(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @ways(4) @name(".Marysvale") table Marysvale {
        ...
        key = {
            meta.Waialee.LasLomas: exact @name("Waialee.LasLomas") ;
            meta.Waialee.Sonora  : exact @name("Waialee.Sonora") ;
            meta.Waialee.Winger  : exact @name("Waialee.Winger") ;
            meta.Waialee.Tolley  : exact @name("Waialee.Tolley") ;
            meta.Waialee.Sawyer  : exact @name("Waialee.Sawyer") ;
            meta.Waialee.Academy : exact @name("Waialee.Academy") ;
            meta.Waialee.LeeCity : exact @name("Waialee.LeeCity") ;
            meta.Waialee.Fairlea : exact @name("Waialee.Fairlea") ;
            meta.Waialee.Emmalane: exact @name("Waialee.Emmalane") ;
            meta.Waialee.Shirley : exact @name("Waialee.Shirley") ;
        }
        size = 4096;
        default_action = NoAction();
    }
...
control Giltner(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    register_action<bit<1>, bit<1>>(OldMinto) Colonias = {
        void apply(inout bit<1> value, out bit<1> rv) {
            value = value;
            rv = value;
        }
    ...
    @name(".Warsaw") action Warsaw() {
        {
            bit<19> temp;
            hash<bit<19>, bit<19>, tuple<bit<9>, bit<12>>, bit<20>>(temp, HashAlgorithm.identity, 19w0, { hdr.ig_intr_md.ingress_port, hdr.Hartwick[0].Bunavista }, 20w524288);
    ...
    @name(".Bosler") action Bosler() {
        {
            bit<19> temp_0;
            hash<bit<19>, bit<19>, tuple<bit<9>, bit<12>>, bit<20>>(temp_0, HashAlgorithm.identity, 19w0, { hdr.ig_intr_md.ingress_port, hdr.Hartwick[0].Bunavista }, 20w524288);
...
control Govan(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Poneto") table Poneto {
        ...
        size = 256;
        default_action = Caroleen(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Poneto.apply();
    }
...
control Koloa(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".LaMarque") table LaMarque {
        ...
        size = 256;
        default_action = DelMar(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        LaMarque.apply();
    }
...
control LeeCreek(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Hartwell") table Hartwell {
        ...
        size = 256;
        default_action = Elwood(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Hartwell.apply();
    }
...
control Norborne(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Kress") table Kress {
        ...
        size = 256;
        default_action = Anaconda(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Kress.apply();
    }
...
control Olcott(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Stovall") table Stovall {
        ...
        size = 256;
        default_action = Shanghai(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Stovall.apply();
    }
...
control Pettigrew(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".LaHoma") table LaHoma {
        ...
        size = 256;
        default_action = AquaPark(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        LaHoma.apply();
    }
...
control Satanta(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Poplar") table Poplar {
        ...
        size = 256;
        default_action = Onley(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Poplar.apply();
    }
...
control Smithland(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Ossining") table Ossining {
        ...
        size = 256;
        default_action = Honaker(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Ossining.apply();
    }
...
control Tolleson(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Hopedale") table Hopedale {
        ...
        size = 256;
        default_action = Redmon(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Hopedale.apply();
    }
...
control Wakita(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Norma") table Norma {
        ...
        size = 1;
        default_action = Snowflake(1w0, 1w0);
    }
    apply {
        Norma.apply();
        Arkoe.apply();
...
control Willits(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Beaverton") table Beaverton {
        ...
        size = 256;
        default_action = Benkelman(16w0xffff, 16w0xffff, 16w0xffff, 16w0xffff, 8w0xff, 6w0x3f, 8w0xff, 8w0xff, 1w1);
    }
    apply {
        Beaverton.apply();
    }
...
control Wiota(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Silvertip") table Silvertip {
        actions = {
            Ericsburg();
            @defaultonly NoAction();
        }
...
control verifyChecksum(in headers hdr, inout metadata meta) {
    ...
    Checksum16() Nanakuli;
    apply {
        if (hdr.Maybee.Chatanika == (Rankin.get<tuple<bit<4>, bit<4>, bit<6>, bit<2>, bit<16>, bit<16>, bit<3>, bit<13>, bit<8>, bit<8>, bit<32>, bit<32>>>({ hdr.Maybee.Venice, hdr.Maybee.Heizer, hdr.Maybee.Frederika, hdr.Maybee.Angus, hdr.Maybee.Vieques, hdr.Maybee.Fackler, hdr.Maybee.Belmond, hdr.Maybee.Parker, hdr.Maybee.Weissert, hdr.Maybee.Lolita, hdr.Maybee.Camanche, hdr.Maybee.Remsen }))) 
            mark_to_drop();
        if (hdr.Moorcroft.Chatanika == (Nanakuli.get<tuple<bit<4>, bit<4>, bit<6>, bit<2>, bit<16>, bit<16>, bit<3>, bit<13>, bit<8>, bit<8>, bit<32>, bit<32>>>({ hdr.Moorcroft.Venice, hdr.Moorcroft.Heizer, hdr.Moorcroft.Frederika, hdr.Moorcroft.Angus, hdr.Moorcroft.Vieques, hdr.Moorcroft.Fackler, hdr.Moorcroft.Belmond, hdr.Moorcroft.Parker, hdr.Moorcroft.Weissert, hdr.Moorcroft.Lolita, hdr.Moorcroft.Camanche, hdr.Moorcroft.Remsen }))) 
            mark_to_drop();
    }
}
...
control computeChecksum(inout headers hdr, inout metadata meta) {
    ...
    Checksum16() Nanakuli;
    apply {
        hdr.Maybee.Chatanika = Rankin.get<tuple<bit<4>, bit<4>, bit<6>, bit<2>, bit<16>, bit<16>, bit<3>, bit<13>, bit<8>, bit<8>, bit<32>, bit<32>>>({ hdr.Maybee.Venice, hdr.Maybee.Heizer, hdr.Maybee.Frederika, hdr.Maybee.Angus, hdr.Maybee.Vieques, hdr.Maybee.Fackler, hdr.Maybee.Belmond, hdr.Maybee.Parker, hdr.Maybee.Weissert, hdr.Maybee.Lolita, hdr.Maybee.Camanche, hdr.Maybee.Remsen });
        hdr.Moorcroft.Chatanika = Nanakuli.get<tuple<bit<4>, bit<4>, bit<6>, bit<2>, bit<16>, bit<16>, bit<3>, bit<13>, bit<8>, bit<8>, bit<32>, bit<32>>>({ hdr.Moorcroft.Venice, hdr.Moorcroft.Heizer, hdr.Moorcroft.Frederika, hdr.Moorcroft.Angus, hdr.Moorcroft.Vieques, hdr.Moorcroft.Fackler, hdr.Moorcroft.Belmond, hdr.Moorcroft.Parker, hdr.Moorcroft.Weissert, hdr.Moorcroft.Lolita, hdr.Moorcroft.Camanche, hdr.Moorcroft.Remsen });
    }
}
