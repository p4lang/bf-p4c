...
control Chamois(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Sequim") action Sequim() {
        Millikin.execute_stateful_alu_from_hash({ meta.Shine.Sitka, hdr.Ahmeek[0].Pinta });
    }
    ...
    @name(".Cadott") action Cadott() {
        Pierpont.execute_stateful_alu_from_hash({ meta.Shine.Sitka, hdr.Ahmeek[0].Pinta });
    }
