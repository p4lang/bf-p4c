...
control Chamois(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("Millikin") stateful_alu() Millikin_0;
    @name("Pierpont") stateful_alu() Pierpont_0;
    @name(".Sequim") action Sequim_0() {
        Millikin_0.execute_stateful_alu_from_hash<tuple<bit<6>, bit<12>>>({ meta.Shine.Sitka, hdr.Ahmeek[0].Pinta });
    }
    ...
    @name(".Cadott") action Cadott_0() {
        Pierpont_0.execute_stateful_alu_from_hash<tuple<bit<6>, bit<12>>>({ meta.Shine.Sitka, hdr.Ahmeek[0].Pinta });
    }
