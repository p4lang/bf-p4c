...
@pa_solitary("ingress", "Nashoba.Allons") @pa_solitary("ingress", "Nashoba.Ekron") @pa_solitary("ingress", "Nashoba.Kekoskee") @pa_solitary("egress", "Barksdale.Range") @pa_solitary("ig_intr_md_for_tm.ucast_egress_port") @pa_atomic("ingress", "Penrose.Philbrook") @pa_solitary("ingress", "Penrose.Philbrook") @pa_atomic("ingress", "Penrose.Lathrop") @pa_solitary("ingress", "Penrose.Lathrop") struct BigBar {
    bit<16> Caputa;
    bit<16> Sasser;
    bit<8>  Hadley;
    bit<8>  McHenry;
...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Elbing") state Elbing {
        packet.extract<Sunflower>(hdr.Hamden);
...
control Arial(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @atcam_partition_index("Braxton.Ohiowa") @atcam_number_partitions(2048) @name(".Braymer") table Braymer {
        ...
        key = {
            meta.Braxton.Ohiowa         : exact @name("meta.Braxton.Ohiowa") ;
            meta.Braxton.Westpoint[63:0]: lpm @name("meta.Braxton.Westpoint[63:0]") ;
        }
        size = 16384;
    ...
    @ways(2) @atcam_partition_index("Moline.Hallville") @atcam_number_partitions(16384) @name(".Browndell") table Browndell {
        ...
        key = {
            meta.Moline.Hallville   : exact @name("meta.Moline.Hallville") ;
            meta.Moline.Aurora[19:0]: lpm @name("meta.Moline.Aurora[19:0]") ;
        }
        size = 131072;
        default_action = Tarnov();
    }
    @action_default_only("Tarnov") @name(".Edinburgh") table Edinburgh {
        ...
        key = {
            meta.Wagener.Coqui    : exact @name("meta.Wagener.Coqui") ;
            meta.Braxton.Westpoint: lpm @name("meta.Braxton.Westpoint") ;
        }
        size = 2048;
    ...
    @idletime_precision(1) @name(".Hiland") table Hiland {
        ...
        key = {
            meta.Wagener.Coqui    : exact @name("meta.Wagener.Coqui") ;
            meta.Braxton.Westpoint: exact @name("meta.Braxton.Westpoint") ;
        }
        size = 65536;
        default_action = Tarnov();
    }
    @atcam_partition_index("Braxton.Wanilla") @atcam_number_partitions(8192) @name(".Hurdtown") table Hurdtown {
        ...
        key = {
            meta.Braxton.Wanilla          : exact @name("meta.Braxton.Wanilla") ;
            meta.Braxton.Westpoint[106:64]: lpm @name("meta.Braxton.Westpoint[106:64]") ;
        }
        size = 65536;
        default_action = Tarnov();
    }
    @action_default_only("Tarnov") @name(".Madera") table Madera {
        ...
        key = {
            meta.Wagener.Coqui            : exact @name("meta.Wagener.Coqui") ;
            meta.Braxton.Westpoint[127:64]: lpm @name("meta.Braxton.Westpoint[127:64]") ;
        }
        size = 8192;
        default_action = NoAction();
    }
    @action_default_only("Tarnov") @idletime_precision(1) @name(".Metter") table Metter {
        ...
        key = {
            meta.Wagener.Coqui: exact @name("meta.Wagener.Coqui") ;
            meta.Moline.Aurora: lpm @name("meta.Moline.Aurora") ;
        }
        size = 1024;
        default_action = NoAction();
    }
    ...
    @idletime_precision(1) @name(".Woodridge") table Woodridge {
        ...
        key = {
            meta.Wagener.Coqui: exact @name("meta.Wagener.Coqui") ;
            meta.Moline.Aurora: exact @name("meta.Moline.Aurora") ;
        }
        size = 65536;
        default_action = Tarnov();
    }
...
control Averill(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Towaoc") table Towaoc {
        ...
        key = {
            ...
            meta.Barksdale.Rotan      : exact @name("meta.Barksdale.Rotan") ;
        }
        size = 4096;
...
control Chamois(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    stateful_alu() Millikin;
    stateful_alu() Pierpont;
    @name(".Sequim") action Sequim() {
        Millikin.execute_stateful_alu_from_hash<tuple<bit<6>, bit<12>>>({ meta.Shine.Sitka, hdr.Ahmeek[0].Pinta });
    }
    ...
    @name(".Cadott") action Cadott() {
        Pierpont.execute_stateful_alu_from_hash<tuple<bit<6>, bit<12>>>({ meta.Shine.Sitka, hdr.Ahmeek[0].Pinta });
    }
    ...
    @use_hash_action(0) @name(".EastDuke") table EastDuke {
        ...
        key = {
            meta.Shine.Sitka: exact @name("meta.Shine.Sitka") ;
        }
        size = 64;
        default_action = NoAction();
    }
...
control DelMar(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Hester") table Hester {
        ...
        key = {
            meta.Shine.Emsworth : exact @name("meta.Shine.Emsworth") ;
            meta.Shine.Layton   : ternary @name("meta.Shine.Layton") ;
            meta.Nashoba.Halfa  : ternary @name("meta.Nashoba.Halfa") ;
            meta.Nashoba.Vallejo: ternary @name("meta.Nashoba.Vallejo") ;
        }
        size = 80;
        default_action = NoAction();
    }
...
control Dockton(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Honaker") table Honaker {
        ...
        key = {
            meta.Roseau.Firesteel: exact @name("meta.Roseau.Firesteel") ;
        }
        size = 65536;
        default_action = NoAction();
    }
...
control Elvaston(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".LakePine") table LakePine {
        ...
        key = {
            meta.Barksdale.Honalo     : exact @name("meta.Barksdale.Honalo") ;
            hdr.eg_intr_md.egress_port: exact @name("hdr.eg_intr_md.egress_port") ;
        }
        size = 64;
...
control Ewing(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @immediate(0) @name(".Joshua") table Joshua {
        ...
        key = {
            hdr.Hookstown.isValid(): ternary @name("hdr.Hookstown.isValid()") ;
            hdr.Anoka.isValid()    : ternary @name("hdr.Anoka.isValid()") ;
            hdr.Santos.isValid()   : ternary @name("hdr.Santos.isValid()") ;
            hdr.Tahlequah.isValid(): ternary @name("hdr.Tahlequah.isValid()") ;
        }
        size = 6;
        default_action = NoAction();
    }
    @action_default_only("Tarnov") @immediate(0) @name(".PineCity") table PineCity {
        ...
        key = {
            hdr.Hookstown.isValid(): ternary @name("hdr.Hookstown.isValid()") ;
            hdr.Anoka.isValid()    : ternary @name("hdr.Anoka.isValid()") ;
            hdr.Dialville.isValid(): ternary @name("hdr.Dialville.isValid()") ;
            hdr.Sylvester.isValid(): ternary @name("hdr.Sylvester.isValid()") ;
            hdr.Maydelle.isValid() : ternary @name("hdr.Maydelle.isValid()") ;
            hdr.Santos.isValid()   : ternary @name("hdr.Santos.isValid()") ;
            hdr.Tahlequah.isValid(): ternary @name("hdr.Tahlequah.isValid()") ;
            hdr.Slick.isValid()    : ternary @name("hdr.Slick.isValid()") ;
            hdr.DuPont.isValid()   : ternary @name("hdr.DuPont.isValid()") ;
            hdr.Skillman.isValid() : ternary @name("hdr.Skillman.isValid()") ;
        }
        size = 256;
        default_action = NoAction();
    }
...
control Longwood(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Mekoryuk") table Mekoryuk {
        ...
        key = {
            meta.Barksdale.Aspetuck: exact @name("meta.Barksdale.Aspetuck") ;
            meta.Penrose.Philbrook : selector @name("meta.Penrose.Philbrook") ;
        }
        size = 1024;
...
control Manning(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Dillsburg") table Dillsburg {
        ...
        key = {
            meta.Nashoba.Kekoskee : ternary @name("meta.Nashoba.Kekoskee") ;
            meta.Nashoba.Yakima   : exact @name("meta.Nashoba.Yakima") ;
            meta.Nashoba.Roodhouse: exact @name("meta.Nashoba.Roodhouse") ;
        }
        size = 512;
        default_action = NoAction();
    }
    @name(".Durant") table Durant {
        ...
        key = {
            meta.Nashoba.Crumstown: exact @name("meta.Nashoba.Crumstown") ;
            meta.Nashoba.Hatchel  : exact @name("meta.Nashoba.Hatchel") ;
            meta.Nashoba.Allons   : exact @name("meta.Nashoba.Allons") ;
            meta.Nashoba.Ekron    : exact @name("meta.Nashoba.Ekron") ;
        }
        size = 65536;
        default_action = NoAction();
    }
    ...
    @action_default_only("Tarnov") @name(".Shamokin") table Shamokin {
        ...
        key = {
            meta.Shine.Sitka     : exact @name("meta.Shine.Sitka") ;
            meta.Comobabi.Oneonta: ternary @name("meta.Comobabi.Oneonta") ;
            meta.Comobabi.Mentone: ternary @name("meta.Comobabi.Mentone") ;
            meta.Nashoba.Ivanhoe : ternary @name("meta.Nashoba.Ivanhoe") ;
            meta.Nashoba.Chualar : ternary @name("meta.Nashoba.Chualar") ;
            meta.Nashoba.Iselin  : ternary @name("meta.Nashoba.Iselin") ;
        }
        size = 512;
...
control Meridean(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Petty") table Petty {
        ...
        key = {
            meta.Roseau.Plush   : exact @name("meta.Roseau.Plush") ;
            meta.Penrose.Lathrop: selector @name("meta.Penrose.Lathrop") ;
        }
        size = 2048;
...
control Pinole(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @action_default_only("Tarnov") @name(".Biggers") table Biggers {
        ...
        key = {
            meta.Shine.Walcott : exact @name("meta.Shine.Walcott") ;
            hdr.Ahmeek[0].Pinta: exact @name("hdr..Ahmeek[0].Pinta") ;
        }
        size = 1024;
        default_action = NoAction();
    }
    @name(".Bleecker") table Bleecker {
        ...
        key = {
            meta.Shine.Hanston: exact @name("meta.Shine.Hanston") ;
        }
        size = 4096;
        default_action = NoAction();
    }
    @name(".Crump") table Crump {
        ...
        key = {
            meta.Shine.Walcott     : ternary @name("meta.Shine.Walcott") ;
            hdr.Ahmeek[0].isValid(): exact @name("hdr..Ahmeek[0].isValid()") ;
            hdr.Ahmeek[0].Pinta    : ternary @name("hdr..Ahmeek[0].Pinta") ;
        }
        size = 4096;
        default_action = NoAction();
    }
    @name(".Kaeleku") table Kaeleku {
        ...
        key = {
            hdr.Slick.Corfu: exact @name("hdr.Slick.Corfu") ;
        }
        size = 4096;
    ...
    @name(".Myton") table Myton {
        ...
        key = {
            hdr.Holliday.Hargis: exact @name("hdr.Holliday.Hargis") ;
        }
        size = 4096;
        default_action = NoAction();
    }
    @name(".Wenona") table Wenona {
        ...
        key = {
            hdr.Skillman.Waldo : exact @name("hdr.Skillman.Waldo") ;
            hdr.Skillman.Halbur: exact @name("hdr.Skillman.Halbur") ;
            hdr.Slick.Ottertail: exact @name("hdr.Slick.Ottertail") ;
            meta.Nashoba.Berea : exact @name("meta.Nashoba.Berea") ;
        }
        size = 1024;
...
control Purley(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Hartwell") action Hartwell(bit<5> Redmon, bit<3> Rembrandt, bit<32> Cooter) {
        ...
        Cornell.count(Cooter);
    }
    @name(".Lisman") action Lisman(bit<32> Belpre) {
        Cornell.count(Belpre);
    }
    ...
    @name(".Amasa") table Amasa {
        ...
        key = {
            meta.Shine.Sitka     : exact @name("meta.Shine.Sitka") ;
            meta.Barksdale.Timken: exact @name("meta.Barksdale.Timken") ;
        }
        size = 2048;
        default_action = NoAction();
    }
    @name(".Philip") table Philip {
        ...
        key = {
            meta.Shine.Sitka     : exact @name("meta.Shine.Sitka") ;
            meta.Barksdale.Timken: exact @name("meta.Barksdale.Timken") ;
            meta.Cabot.Glenoma   : exact @name("meta.Cabot.Glenoma") ;
        }
        size = 4096;
        default_action = NoAction();
    }
...
control SneeOosh(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Magnolia") table Magnolia {
        ...
        key = {
            meta.Barksdale.Astatula: exact @name("meta.Barksdale.Astatula") ;
        }
        size = 8;
        default_action = NoAction();
    }
    @name(".Markville") table Markville {
        ...
        key = {
            meta.Barksdale.Auvergne: exact @name("meta.Barksdale.Auvergne") ;
            meta.Barksdale.Astatula: exact @name("meta.Barksdale.Astatula") ;
            meta.Barksdale.Hannibal: exact @name("meta.Barksdale.Hannibal") ;
            hdr.Slick.isValid()    : ternary @name("hdr.Slick.isValid()") ;
            hdr.DuPont.isValid()   : ternary @name("hdr.DuPont.isValid()") ;
        }
        size = 512;
...
control Sutton(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Inola") table Inola {
        ...
        key = {
            hdr.Skillman.Barclay : ternary @name("hdr.Skillman.Barclay") ;
            hdr.Skillman.Bootjack: ternary @name("hdr.Skillman.Bootjack") ;
        }
        size = 512;
        default_action = NoAction();
    }
    ...
    @name(".Wilmore") table Wilmore {
        ...
        key = {
            meta.Shine.Sitka   : exact @name("meta.Shine.Sitka") ;
            hdr.Skillman.Waldo : ternary @name("hdr.Skillman.Waldo") ;
            hdr.Skillman.Halbur: ternary @name("hdr.Skillman.Halbur") ;
        }
        size = 512;
...
control Wellford(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @ways(1) @name(".Century") table Century {
        ...
        key = {
            meta.Barksdale.Maywood  : exact @name("meta.Barksdale.Maywood") ;
            meta.Barksdale.Greenlawn: exact @name("meta.Barksdale.Greenlawn") ;
        }
        size = 1;
...
control Wimberley(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".FlatRock") table FlatRock {
        ...
        key = {
            meta.Nashoba.Noelke: exact @name("meta.Nashoba.Noelke") ;
        }
        size = 1;
        default_action = NoAction();
    }
    @name(".Volcano") table Volcano {
        ...
        key = {
            meta.Nashoba.MuleBarn: exact @name("meta.Nashoba.MuleBarn") ;
            meta.Nashoba.Portales: exact @name("meta.Nashoba.Portales") ;
        }
        size = 3;
        default_action = NoAction();
    }
