...
control Carrizozo(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Kniman") action Kniman() {
        Skene.execute_stateful_alu_from_hash({ meta.Flynn.Hawthorn, hdr.Allgood[0].Russia });
    }
    ...
    @name(".Shirley") action Shirley() {
        Silco.execute_stateful_alu_from_hash({ meta.Flynn.Hawthorn, hdr.Allgood[0].Russia });
    }
