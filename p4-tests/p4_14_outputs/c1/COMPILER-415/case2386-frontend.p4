...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Silco") RegisterAction<bit<1>, bit<32>, bit<1>>(Abraham) _Silco = {
        void apply(inout bit<1> value, out bit<1> rv) {
            bit<1> _Carrizozo_in_value;
            _Carrizozo_in_value = value;
            value = _Carrizozo_in_value;
            rv = value;
        }
    };
    ...
    @name(".Kniman") action _Kniman_0() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_Carrizozo_temp, HashAlgorithm.identity, 18w0, { meta.Flynn.Hawthorn, hdr.Allgood[0].Russia }, 19w262144);
    ...
    @name(".Shirley") action _Shirley_0() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_Carrizozo_temp_0, HashAlgorithm.identity, 18w0, { meta.Flynn.Hawthorn, hdr.Allgood[0].Russia }, 19w262144);
