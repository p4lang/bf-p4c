...
control Amber(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("Moxley") stateful_alu() Moxley_0;
    @name("Shorter") stateful_alu() Shorter_0;
    ...
    @name(".Pringle") action Pringle_0() {
        Moxley_0.execute_stateful_alu_from_hash<tuple<bit<6>, bit<12>>>({ meta.Naylor.Glenolden, hdr.Walcott[0].Wenden });
    }
    ...
    @name(".Rardin") action Rardin_0() {
        Shorter_0.execute_stateful_alu_from_hash<tuple<bit<6>, bit<12>>>({ meta.Naylor.Glenolden, hdr.Walcott[0].Wenden });
    }
