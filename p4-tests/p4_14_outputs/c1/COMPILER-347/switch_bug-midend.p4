...
struct headers {
    ...
    @name(".inner_icmp") 
    icmp_t                                         inner_icmp;
    @pa_fragment("ingress", "inner_ipv4.hdrChecksum") @pa_fragment("egress", "inner_ipv4.hdrChecksum") @pa_container_size("ingress", "inner_ipv4.version", 8) @name(".inner_ipv4") 
    ipv4_t                                         inner_ipv4;
    @name(".inner_ipv6") 
    ipv6_t                                         inner_ipv6;
    @name(".inner_sctp") 
...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".parse_inner_ipv4") state parse_inner_ipv4 {
        ...
        meta.l3_metadata.lkp_ip_ihl = hdr.inner_ipv4.ihl;
...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".egress_mirror_drop") action _egress_mirror_drop(bit<8> reason_code, bit<8> platform_id) {
        meta.i2e_metadata.mirror_session_id = 16w1015;
        clone3<tuple_1>(CloneType.E2E, 32w1015, { meta.i2e_metadata.ingress_tstamp, 16w1015 });
        mark_to_drop();
    }
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".ipv4_lkp") action _ipv4_lkp() {
        ...
        meta.l3_metadata.lkp_ip_ihl = hdr.ipv4.ihl;
    ...
    @name(".validate_packet") table _validate_packet_0 {
        ...
        key = {
            ...
            meta.l3_metadata.lkp_ip_ihl            : ternary @name("l3_metadata.lkp_ip_ihl") ;
