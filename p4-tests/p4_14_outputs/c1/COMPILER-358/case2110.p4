...
control Sitka(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Flaxton") action Flaxton() {
        Theba.execute_stateful_alu_from_hash({ meta.Mapleview.Lamont, hdr.Kinston[0].Holliday });
    }
    @name(".Cisne") action Cisne() {
        Klondike.execute_stateful_alu_from_hash({ meta.Mapleview.Lamont, hdr.Kinston[0].Holliday });
    }
