...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Doyline") state Doyline {
        packet.extract(hdr.McCallum);
        transition accept;
    }
    @name(".Oreland") state Oreland {
        packet.extract(hdr.Cantwell);
...
control Bonilla(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Barrow") table Barrow {
        ...
        key = {
            meta.CedarKey.Chouteau: exact;
            meta.CedarKey.LeSueur : exact;
            meta.CedarKey.Wheaton : exact;
            hdr.Aredale.isValid() : ternary;
            hdr.Ackerman.isValid(): ternary;
        }
        size = 512;
    }
...
control Cisco(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Franklin") action Franklin() {
        hash(meta.Woodfield.Neavitt, HashAlgorithm.crc32, (bit<32>)0, { hdr.Nuremberg.Panola, hdr.Nuremberg.Pierson, hdr.Nuremberg.Snowball, hdr.Nuremberg.Waipahu, hdr.Nuremberg.Knolls }, (bit<64>)4294967296);
    }
...
control Dresser(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @idletime_precision(1) @name(".Carmel") table Carmel {
        ...
        key = {
            meta.Ahuimanu.Halltown  : exact;
            meta.Dialville.Youngtown: exact;
        }
        size = 65536;
        default_action = Pawtucket();
    }
...
control Hollyhill(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Amite") action Amite() {
        digest<Shelby>((bit<32>)0, { meta.Yukon.Florala, meta.Seagrove.Jermyn, hdr.Gerty.Snowball, hdr.Gerty.Waipahu, hdr.Aredale.Norwood });
    }
...
control Iberia(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Holcomb") table Holcomb {
        ...
        key = {
            hdr.Nuremberg.Snowball: ternary;
            hdr.Nuremberg.Waipahu : ternary;
        }
        size = 512;
    }
    ...
    @name(".WestEnd") table WestEnd {
        ...
        key = {
            meta.Mapleview.Lamont: exact;
            hdr.Nuremberg.Panola : ternary;
...
control Kaltag(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Novinger") action Novinger() {
        hash(meta.Woodfield.Lauada, HashAlgorithm.crc32, (bit<32>)0, { hdr.Aredale.Norwood, hdr.Aredale.Lofgreen, hdr.Hitchland.Scarville, hdr.Hitchland.PoleOjea }, (bit<64>)4294967296);
    }
...
control Magma(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Dubach") action Dubach() {
        digest<Rhine>((bit<32>)0, { meta.Yukon.Florala, meta.Seagrove.Amanda, meta.Seagrove.Waucousta, meta.Seagrove.Jermyn, meta.Seagrove.Tascosa });
    }
...
control Northlake(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".LeeCreek") table LeeCreek {
        ...
        key = {
            meta.Seagrove.Sedan: exact;
            meta.Seagrove.Trout: exact;
        }
        size = 3;
    }
    apply {
...
control Osage(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @action_default_only("Pawtucket") @name(".Allyn") table Allyn {
        ...
        key = {
            meta.Mapleview.Lamont: exact;
            meta.Trammel.Choptank: ternary;
            meta.Trammel.Cement  : ternary;
            meta.Seagrove.Talent : ternary;
            meta.Seagrove.Horton : ternary;
    ...
    @name(".Hisle") table Hisle {
        ...
        key = {
            meta.Seagrove.Amanda   : exact;
            meta.Seagrove.Waucousta: exact;
            meta.Seagrove.Jermyn   : exact;
            meta.Seagrove.Tascosa  : exact;
        }
        size = 65536;
    }
    @name(".Mifflin") table Mifflin {
        ...
        key = {
            meta.Seagrove.Braselton: ternary;
            meta.Seagrove.Edinburgh: exact;
            meta.Seagrove.Elvaston : exact;
        }
        size = 512;
    }
    apply {
...
control Parmelee(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Duchesne") table Duchesne {
        ...
        key = {
            meta.Mapleview.Triplett: exact;
            meta.Mapleview.Mammoth : ternary;
            meta.Seagrove.Riner    : ternary;
            meta.Seagrove.Crowheart: ternary;
        }
        size = 80;
    }
    apply {
...
control Silva(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @ways(1) @name(".Thayne") table Thayne {
        ...
        key = {
            meta.CedarKey.Provencal: exact;
            meta.CedarKey.Hiland   : exact;
        }
        size = 1;
...
control Sitka(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Klondike") RegisterAction<bit<1>, bit<1>>(Buenos) Klondike = {
    ...
    @name(".Theba") RegisterAction<bit<1>, bit<1>>(Tryon) Theba = {
        void apply(inout bit<1> value, out bit<1> rv) {
            rv = 1w0;
            bit<1> in_value;
            in_value = value;
    ...
    @name(".Flaxton") action Flaxton() {
        {
            bit<18> temp;
            hash(temp, HashAlgorithm.identity, 18w0, { meta.Mapleview.Lamont, hdr.Kinston[0].Holliday }, 19w262144);
    ...
    @name(".Cisne") action Cisne() {
        {
            bit<18> temp_0;
            hash(temp_0, HashAlgorithm.identity, 18w0, { meta.Mapleview.Lamont, hdr.Kinston[0].Holliday }, 19w262144);
...
control Suarez(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".BullRun") table BullRun {
        ...
        key = {
            hdr.Nuremberg.Panola : exact;
            hdr.Nuremberg.Pierson: exact;
            hdr.Aredale.Lofgreen : exact;
            meta.Seagrove.Trion  : exact;
        }
        size = 1024;
    ...
    @name(".Felton") table Felton {
        ...
        key = {
            meta.Mapleview.Ottertail: exact;
        }
        size = 4096;
    }
    @name(".Lodoga") table Lodoga {
        ...
        key = {
            meta.Mapleview.Almedia  : ternary;
            hdr.Kinston[0].isValid(): exact;
            hdr.Kinston[0].Holliday : ternary;
        }
        size = 4096;
    }
...
control Troutman(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Charters") action Charters() {
        hash(meta.Woodfield.Petrolia, HashAlgorithm.crc32, (bit<32>)0, { hdr.Aredale.Crary, hdr.Aredale.Norwood, hdr.Aredale.Lofgreen }, (bit<64>)4294967296);
    }
    @name(".Carver") action Carver() {
        hash(meta.Woodfield.Petrolia, HashAlgorithm.crc32, (bit<32>)0, { hdr.Ackerman.LaPalma, hdr.Ackerman.Quarry, hdr.Ackerman.Herring, hdr.Ackerman.Graford }, (bit<64>)4294967296);
    }
...
control Walcott(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @immediate(0) @name(".Converse") table Converse {
        ...
        key = {
            hdr.Palmer.isValid()   : ternary;
            hdr.Quijotoa.isValid() : ternary;
            hdr.Cankton.isValid()  : ternary;
            hdr.Hitchland.isValid(): ternary;
        }
        size = 6;
    }
    @action_default_only("Pawtucket") @immediate(0) @name(".Taneytown") table Taneytown {
        ...
        key = {
            hdr.Palmer.isValid()   : ternary;
            hdr.Quijotoa.isValid() : ternary;
            hdr.Yardville.isValid(): ternary;
            hdr.Silesia.isValid()  : ternary;
            hdr.Gerty.isValid()    : ternary;
            hdr.Cankton.isValid()  : ternary;
            hdr.Hitchland.isValid(): ternary;
            hdr.Aredale.isValid()  : ternary;
            hdr.Ackerman.isValid() : ternary;
            hdr.Nuremberg.isValid(): ternary;
        }
        size = 256;
    }
    apply {
...
control DeparserImpl(packet_out packet, in headers hdr) {
    apply {
        packet.emit(hdr.Nuremberg);
        packet.emit(hdr.Kinston[0]);
        packet.emit(hdr.McCallum);
        packet.emit(hdr.Ackerman);
        packet.emit(hdr.Aredale);
        packet.emit(hdr.Hitchland);
        packet.emit(hdr.Cantwell);
        packet.emit(hdr.Gerty);
        packet.emit(hdr.Silesia);
