...
control Parnell(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("Gonzalez") register_action<bit<1>, bit<1>>(BigWells_0) Gonzalez_0 = {
    ...
    @name(".Ledger") action Ledger_0() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(temp_1, HashAlgorithm.identity, 18w0, { meta.Wolsey.Perryton, hdr.Moodys[0].Salome }, 19w262144);
        tmp_0 = Tillatoba_0.execute((bit<32>)temp_1);
        meta.Rixford.TonkaBay = tmp_0;
    }
    ...
    @name(".Quinault") action Quinault_0() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(temp_2, HashAlgorithm.identity, 18w0, { meta.Wolsey.Perryton, hdr.Moodys[0].Salome }, 19w262144);
        tmp_1 = Gonzalez_0.execute((bit<32>)temp_2);
        meta.Rixford.Houston = tmp_1;
    }
