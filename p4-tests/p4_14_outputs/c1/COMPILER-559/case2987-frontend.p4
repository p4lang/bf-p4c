...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Exira") action _Exira() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_Walcott_temp_1, HashAlgorithm.identity, 18w0, { meta.Mentone.Aiken, hdr.Rockfield[0].Friend }, 19w262144);
    ...
    @name(".DeerPark") action _DeerPark() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_Walcott_temp_2, HashAlgorithm.identity, 18w0, { meta.Mentone.Aiken, hdr.Rockfield[0].Friend }, 19w262144);
