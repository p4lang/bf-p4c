...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".start") state start {
        tmp_20 = packet.lookahead<bit<112>>();
        transition select(tmp_20[15:0]) {
            16w0xbf00: Flats;
            default: Wheeler;
        }
    }
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Ivyland") action _Ivyland() {
        hash<bit<19>, bit<19>, tuple_0, bit<20>>(_Bogota_temp_1, HashAlgorithm.identity, 19w0, { hdr.ig_intr_md.ingress_port, hdr.Hobucken[0].DelRey }, 20w524288);
        _Bogota_tmp_1 = _Bogota_Union_0.execute((bit<32>)_Bogota_temp_1);
    ...
    @name(".Verdery") action _Verdery() {
        hash<bit<19>, bit<19>, tuple_0, bit<20>>(_Bogota_temp_2, HashAlgorithm.identity, 19w0, { hdr.ig_intr_md.ingress_port, hdr.Hobucken[0].DelRey }, 20w524288);
        _Bogota_tmp_2 = _Bogota_Booth_0.execute((bit<32>)_Bogota_temp_2);
    ...
    @name(".Sweeny") table _Sweeny_0 {
        ...
        size = 4096;
        default_action = _Nanson_8();
    }
    @name(".Sallisaw") action _Sallisaw() {
        hash<bit<32>, bit<32>, tuple_1, bit<64>>(meta.Perma.Archer, HashAlgorithm.crc32, 32w0, { hdr.Newcomb.Ceiba, hdr.Newcomb.Rochert, hdr.Newcomb.Milbank }, 64w4294967296);
    }
    @name(".Jacobs") action _Jacobs() {
        hash<bit<32>, bit<32>, tuple_2, bit<64>>(meta.Perma.Archer, HashAlgorithm.crc32, 32w0, { hdr.Vacherie.Murchison, hdr.Vacherie.OakLevel, hdr.Vacherie.Wesson, hdr.Vacherie.Clementon }, 64w4294967296);
    }
    ...
    @name(".Farson") action _Farson() {
        hash<bit<32>, bit<32>, tuple_3, bit<64>>(meta.Perma.Odessa, HashAlgorithm.crc32, 32w0, { hdr.Newcomb.Rochert, hdr.Newcomb.Milbank, hdr.Saxis.Ivins, hdr.Saxis.Morgana }, 64w4294967296);
    }
    ...
    @name(".Elcho") action _Elcho(bit<32> Parkway) {
        _Aspetuck_tmp_0 = (meta.Brinkman.Notus >= Parkway ? meta.Brinkman.Notus : _Aspetuck_tmp_0);
        _Aspetuck_tmp_0 = (!(meta.Brinkman.Notus >= Parkway) ? Parkway : _Aspetuck_tmp_0);
    ...
    @name(".Elcho") action _Elcho_0(bit<32> Parkway) {
        _Wauna_tmp_0 = (meta.Brinkman.Notus >= Parkway ? meta.Brinkman.Notus : _Wauna_tmp_0);
        _Wauna_tmp_0 = (!(meta.Brinkman.Notus >= Parkway) ? Parkway : _Wauna_tmp_0);
    ...
    @name(".ShadeGap") action _ShadeGap() {
        hash<bit<32>, bit<32>, tuple_4, bit<64>>(meta.Perma.BigPark, HashAlgorithm.crc32, 32w0, { hdr.Frontenac.Wolcott, hdr.Frontenac.Glouster, hdr.Frontenac.Farner, hdr.Frontenac.Lapoint, hdr.Frontenac.WoodDale }, 64w4294967296);
    }
    ...
    @name(".Elcho") action _Elcho_1(bit<32> Parkway) {
        _Curlew_tmp_0 = (meta.Brinkman.Notus >= Parkway ? meta.Brinkman.Notus : _Curlew_tmp_0);
        _Curlew_tmp_0 = (!(meta.Brinkman.Notus >= Parkway) ? Parkway : _Curlew_tmp_0);
    ...
    @name(".Elcho") action _Elcho_2(bit<32> Parkway) {
        _Sammamish_tmp_0 = (meta.Brinkman.Notus >= Parkway ? meta.Brinkman.Notus : _Sammamish_tmp_0);
        _Sammamish_tmp_0 = (!(meta.Brinkman.Notus >= Parkway) ? Parkway : _Sammamish_tmp_0);
    ...
    @name(".Elcho") action _Elcho_3(bit<32> Parkway) {
        _Lawai_tmp_0 = (meta.Brinkman.Notus >= Parkway ? meta.Brinkman.Notus : _Lawai_tmp_0);
        _Lawai_tmp_0 = (!(meta.Brinkman.Notus >= Parkway) ? Parkway : _Lawai_tmp_0);
    ...
    @name(".Nanson") action _Nanson_42() {
        _Hiland_0.count();
    }
    @name(".Stratford") table _Stratford_0 {
        actions = {
            _Nanson_42();
            @defaultonly _Nanson_41();
        }
        key = {
...
control verifyChecksum(in headers hdr, inout metadata meta) {
    bit<16> tmp_21;
    bit<16> tmp_23;
    @name("Callimont") Checksum16() Callimont;
    @name("McAlister") Checksum16() McAlister;
    apply {
        tmp_21 = Callimont.get<tuple_5>({ hdr.Caspian.Eunice, hdr.Caspian.Yatesboro, hdr.Caspian.Philmont, hdr.Caspian.Vinita, hdr.Caspian.Hillside, hdr.Caspian.Wyarno, hdr.Caspian.Goosport, hdr.Caspian.Currie, hdr.Caspian.Stambaugh, hdr.Caspian.Ceiba, hdr.Caspian.Rochert, hdr.Caspian.Milbank });
        if (hdr.Caspian.Gunder == tmp_21) 
            mark_to_drop();
        tmp_23 = McAlister.get<tuple_5>({ hdr.Newcomb.Eunice, hdr.Newcomb.Yatesboro, hdr.Newcomb.Philmont, hdr.Newcomb.Vinita, hdr.Newcomb.Hillside, hdr.Newcomb.Wyarno, hdr.Newcomb.Goosport, hdr.Newcomb.Currie, hdr.Newcomb.Stambaugh, hdr.Newcomb.Ceiba, hdr.Newcomb.Rochert, hdr.Newcomb.Milbank });
        if (hdr.Newcomb.Gunder == tmp_23) 
            mark_to_drop();
    }
}
...
control computeChecksum(inout headers hdr, inout metadata meta) {
    bit<16> tmp_25;
    bit<16> tmp_26;
    @name("Callimont") Checksum16() Callimont_2;
    @name("McAlister") Checksum16() McAlister_2;
    apply {
        tmp_25 = Callimont_2.get<tuple_5>({ hdr.Caspian.Eunice, hdr.Caspian.Yatesboro, hdr.Caspian.Philmont, hdr.Caspian.Vinita, hdr.Caspian.Hillside, hdr.Caspian.Wyarno, hdr.Caspian.Goosport, hdr.Caspian.Currie, hdr.Caspian.Stambaugh, hdr.Caspian.Ceiba, hdr.Caspian.Rochert, hdr.Caspian.Milbank });
        hdr.Caspian.Gunder = tmp_25;
        tmp_26 = McAlister_2.get<tuple_5>({ hdr.Newcomb.Eunice, hdr.Newcomb.Yatesboro, hdr.Newcomb.Philmont, hdr.Newcomb.Vinita, hdr.Newcomb.Hillside, hdr.Newcomb.Wyarno, hdr.Newcomb.Goosport, hdr.Newcomb.Currie, hdr.Newcomb.Stambaugh, hdr.Newcomb.Ceiba, hdr.Newcomb.Rochert, hdr.Newcomb.Milbank });
        hdr.Newcomb.Gunder = tmp_26;
    }
}
