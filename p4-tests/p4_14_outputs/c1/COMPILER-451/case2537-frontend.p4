...
control Hiawassee(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("Kasilof") stateful_alu() Kasilof_0;
    @name("Noyack") stateful_alu() Noyack_0;
    ...
    @name(".Riverlea") action Riverlea_0() {
        Noyack_0.execute_stateful_alu_from_hash<tuple<bit<6>, bit<12>>>({ meta.Harding.Honokahua, hdr.Casper[0].Mariemont });
    }
    @name(".Cedonia") action Cedonia_0() {
        Kasilof_0.execute_stateful_alu_from_hash<tuple<bit<6>, bit<12>>>({ meta.Harding.Honokahua, hdr.Casper[0].Mariemont });
    }
