...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Hiawassee.Kasilof") stateful_alu() _Hiawassee_Kasilof_0;
    @name(".Hiawassee.Noyack") stateful_alu() _Hiawassee_Noyack_0;
    ...
    @name(".Riverlea") action _Riverlea() {
        _Hiawassee_Noyack_0.execute_stateful_alu_from_hash<tuple_0>({ meta.Harding.Honokahua, hdr.Casper[0].Mariemont });
    }
    @name(".Cedonia") action _Cedonia() {
        _Hiawassee_Kasilof_0.execute_stateful_alu_from_hash<tuple_0>({ meta.Harding.Honokahua, hdr.Casper[0].Mariemont });
    }
