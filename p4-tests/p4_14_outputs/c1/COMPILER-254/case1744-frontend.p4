...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".uVMcgg") register<bit<1>>(32w65536) uVMcgg_0;
    @name("abcAlu1") stateful_alu() abcAlu1_0;
    ...
    @name(".wgUyys") action wgUyys_0(bit<8> pIFssJ) {
        abcAlu1_0.execute_stateful_alu();
    }
    ...
    @name(".DLWTDd") table DLWTDd_0 {
        ...
        key = {
            meta.DiLHQO.pdXGWn: exact @name("meta.DiLHQO.pdXGWn") ;
            meta.rPaenA.AzzIVF: exact @name("meta.rPaenA.AzzIVF") ;
        }
        size = 65536;
        default_action = NoAction();
    }
    @name(".EnUeBj") table EnUeBj_0 {
        actions = {
            ZMxEHs_0();
            @defaultonly NoAction();
        }
        key = {
            meta.ISBegy.SByXeq: ternary @name("meta.ISBegy.SByXeq") ;
            meta.ISBegy.fBlaNb: exact @name("meta.ISBegy.fBlaNb") ;
            meta.ISBegy.iyhgyP: exact @name("meta.ISBegy.iyhgyP") ;
        }
        size = 512;
        default_action = NoAction();
    }
    @name(".FrriYI") table FrriYI_0 {
        actions = {
            GUkRTK_0();
            OaIjAZ_0();
            QySKDb_0();
        ...
        key = {
            meta.UEnfPN.aReYBT: exact @name("meta.UEnfPN.aReYBT") ;
            meta.UEnfPN.kecNpA: exact @name("meta.UEnfPN.kecNpA") ;
            meta.UEnfPN.jRFjiT: exact @name("meta.UEnfPN.jRFjiT") ;
        }
        size = 65536;
        default_action = NoAction();
    }
    @name(".JDNOvi") table JDNOvi_0 {
        actions = {
            qWIgTk_0();
            @defaultonly NoAction();
        }
        key = {
            hdr.wTmLsD.Xotmsw: exact @name("hdr.wTmLsD.Xotmsw") ;
        }
        size = 4096;
        default_action = NoAction();
    }
    @name(".OOisIO") table OOisIO_0 {
        actions = {
            HIrDUm_0();
            @defaultonly NoAction();
        }
        key = {
            meta.jwCLby.bwlvkO: exact @name("meta.jwCLby.bwlvkO") ;
        }
        size = 4096;
        default_action = NoAction();
    }
    @name(".PYggeW") table PYggeW_0 {
        actions = {
            xyNqmz_0();
            zDZfBi_0();
            @defaultonly NoAction();
        ...
        key = {
            hdr.BKUgda.kqQake : exact @name("hdr.BKUgda.kqQake") ;
            hdr.BKUgda.lafbST : exact @name("hdr.BKUgda.lafbST") ;
            hdr.YsFfOi.qsmkxH : exact @name("hdr.YsFfOi.qsmkxH") ;
            meta.ISBegy.Bogpst: exact @name("meta.ISBegy.Bogpst") ;
        }
        size = 1024;
        default_action = NoAction();
    }
    @name(".PlDVOx") table PlDVOx_0 {
        actions = {
            PkiRck_0();
            @defaultonly NoAction();
        }
    ...
    @name(".csvDSE") table csvDSE_0 {
        ...
        key = {
            meta.DiLHQO.pdXGWn: exact @name("meta.DiLHQO.pdXGWn") ;
            meta.BmGNnj.RzMwNx: exact @name("meta.BmGNnj.RzMwNx") ;
        }
        size = 65536;
        default_action = NoAction();
    }
    @name(".fQyPjm") table fQyPjm_0 {
        actions = {
            jmisxL_0();
            @defaultonly NoAction();
        }
    ...
    @name(".gjmQaN") table gjmQaN_0 {
        actions = {
            sNrOwP_0();
            @defaultonly NoAction();
        }
        key = {
            meta.jwCLby.ZmhYkw: exact @name("meta.jwCLby.ZmhYkw") ;
        }
        size = 512;
        default_action = NoAction();
    }
    @name(".iAUfJw") table iAUfJw_0 {
        actions = {
            wgUyys_0();
            oLXWui_0();
            @defaultonly NoAction();
        ...
        key = {
            meta.ISBegy.PypKpF: exact @name("meta.ISBegy.PypKpF") ;
            meta.ISBegy.gRXamj: exact @name("meta.ISBegy.gRXamj") ;
            meta.ISBegy.CykjqF: exact @name("meta.ISBegy.CykjqF") ;
            meta.ISBegy.OzuGhp: exact @name("meta.ISBegy.OzuGhp") ;
        }
        size = 65536;
        default_action = NoAction();
    }
    @name(".iBkgYU") table iBkgYU_0 {
        actions = {
            HPPlzH_0();
            ZlMvHS_0();
            @defaultonly NoAction();
        ...
        key = {
            hdr.YmdqVQ.GpgeBz: exact @name("hdr.YmdqVQ.GpgeBz") ;
        }
        size = 4096;
        default_action = NoAction();
    }
    @name(".isqhxf") table isqhxf_0 {
        actions = {
            OBWlGA_0();
            rGpmFL_0();
            @defaultonly NoAction();
    ...
    @name(".kiVysN") table kiVysN_0 {
        ...
        key = {
            meta.DiLHQO.pdXGWn: exact @name("meta.DiLHQO.pdXGWn") ;
            meta.rPaenA.AzzIVF: lpm @name("meta.rPaenA.AzzIVF") ;
        }
        size = 16384;
        default_action = NoAction();
    }
    @name(".kjsVFs") table kjsVFs_0 {
        actions = {
            ZREoXK_0();
            @defaultonly NoAction();
        }
    ...
    @name(".tVqytV") table tVqytV_0 {
        ...
        key = {
            hdr.YsFfOi.gnQHPE: exact @name("hdr.YsFfOi.gnQHPE") ;
        }
        size = 4096;
        default_action = NoAction();
    }
    @name(".watTno") table watTno_0 {
        actions = {
            wLhHGY_0();
            WtUopq_0();
            @defaultonly NoAction();
        ...
        key = {
            meta.jwCLby.IZubMG: exact @name("meta.jwCLby.IZubMG") ;
            hdr.wTmLsD.Xotmsw : exact @name("hdr.wTmLsD.Xotmsw") ;
        }
        size = 1024;
        default_action = NoAction();
    }
    @atcam_partition_index("rPaenA.KDRpzh") @atcam_number_partitions(16384) @name(".wjWaOf") table wjWaOf_0 {
        actions = {
            xekLAZ_0();
            @defaultonly NoAction();
        }
        key = {
            meta.rPaenA.KDRpzh: exact @name("meta.rPaenA.KDRpzh") ;
            meta.rPaenA.AzzIVF: lpm @name("meta.rPaenA.AzzIVF") ;
        }
        size = 147456;
        default_action = NoAction();
    }
    @name(".wvUKrF") table wvUKrF_0 {
        actions = {
            mzdRSP_0();
            afVWBb_0();
            xGsHXD_0();
        ...
        key = {
            meta.jwCLby.IZubMG  : ternary @name("meta.jwCLby.IZubMG") ;
            hdr.wTmLsD.isValid(): exact @name("hdr.wTmLsD.isValid()") ;
            hdr.wTmLsD.Xotmsw   : ternary @name("hdr.wTmLsD.Xotmsw") ;
        }
        size = 4096;
        default_action = NoAction();
    }
    apply {
        if (hdr.ig_intr_md.resubmit_flag == 1w0x0) 
            pSklAb_0.apply();
        UvqxDx_0.apply();
        switch (PYggeW_0.apply().action_run) {
            xyNqmz_0: {
                tVqytV_0.apply();
                iBkgYU_0.apply();
            }
            zDZfBi_0: {
                ...
                if (hdr.wTmLsD.isValid()) 
                    switch (watTno_0.apply().action_run) {
                        WtUopq_0: {
                            JDNOvi_0.apply();
                        }
                    }
        ...
        if (meta.aiEvpD.kbVmag == 1w0x0 && meta.aiEvpD.fLJxJk == 1w0x0 && meta.ISBegy.wLrIOy == 1w0x0 && meta.DiLHQO.bgBnjZ == 1w0x1) {
            if (meta.DiLHQO.fGWrQt == 1w0x1 && (meta.ISBegy.Bogpst == 2w0x0 && hdr.YsFfOi.isValid() || meta.ISBegy.Bogpst != 2w0x0 && hdr.vJDCOF.isValid())) 
                switch (DLWTDd_0.apply().action_run) {
                    WtUopq_0: {
                        kiVysN_0.apply();
        ...
        if (meta.ISBegy.wLrIOy == 1w0x0) 
            switch (FrriYI_0.apply().action_run) {
                QySKDb_0: {
                    switch (isqhxf_0.apply().action_run) {
                        rGpmFL_0: {
