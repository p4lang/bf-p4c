...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Fishers") state Fishers {
        packet.extract(hdr.Dandridge);
        transition accept;
    }
    @name(".Germano") state Germano {
        packet.extract(hdr.Wyatte);
    ...
    @name(".Hiwassee") state Hiwassee {
        packet.extract(hdr.Hobart);
        meta.Neshoba.Goodlett = 2w1;
        transition Germano;
    }
    @name(".Kremlin") state Kremlin {
        packet.extract(hdr.LaMarque[0]);
...
control Boyle(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Brashear") table Brashear {
        ...
        key = {
            meta.Calabasas.Everton: exact;
            meta.ElPrado.Amenia   : selector;
        }
        size = 1024;
...
control Cassa(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Tindall") action Tindall() {
        digest<Covington>((bit<32>)0, { meta.Candor.Ferrum, meta.Neshoba.Gunter, hdr.Wyatte.Aynor, hdr.Wyatte.Portales, hdr.Uhland.Rudolph });
    }
...
control Cypress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    register_action<bit<1>, bit<1>>(Ceiba) Clermont = {
    ...
    register_action<bit<1>, bit<1>>(Mentmore) Selah = {
        void apply(inout bit<1> value, out bit<1> rv) {
            rv = 1w0;
            value = value;
            rv = value;
    ...
    @name(".Essex") action Essex() {
        {
            bit<18> temp;
            hash(temp, HashAlgorithm.identity, 18w0, { meta.Fosston.Shasta, hdr.LaMarque[0].Ivins }, 19w262144);
    ...
    @name(".Hawthorn") action Hawthorn() {
        {
            bit<18> temp_0;
            hash(temp_0, HashAlgorithm.identity, 18w0, { meta.Fosston.Shasta, hdr.LaMarque[0].Ivins }, 19w262144);
...
control DelRosa(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Stirrat") table Stirrat {
        ...
        key = {
            meta.Neshoba.Fittstown: exact;
            meta.Neshoba.Windber  : exact;
        }
        size = 3;
    }
    apply {
...
control DimeBox(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @stage(2) @name(".Kurthwood") table Kurthwood {
        ...
        key = {
            meta.Calabasas.Elwyn   : exact;
            meta.Calabasas.Woodrow : exact;
            meta.Calabasas.Hookdale: exact;
            hdr.Uhland.isValid()   : ternary;
            hdr.Maloy.isValid()    : ternary;
        }
        size = 512;
    }
...
control Gannett(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Blanding") table Blanding {
        ...
        key = {
            meta.Fosston.Portville: exact;
            meta.Fosston.Puyallup : ternary;
            meta.Fosston.Blitchton: ternary;
        }
        size = 64;
    }
    @name(".Sutherlin") table Sutherlin {
        ...
        key = {
            meta.Fosston.Portville: exact;
            meta.Fosston.Libby    : ternary;
            meta.Neshoba.DuckHill : ternary;
            meta.Neshoba.Quinwood : ternary;
        }
        size = 80;
    }
    apply {
...
control Glenshaw(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @ways(1) @name(".Kentwood") table Kentwood {
        ...
        key = {
            meta.Calabasas.Storden: exact;
            meta.Calabasas.Osage  : exact;
        }
        size = 1;
...
control Hurst(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @immediate(0) @name(".Flasher") table Flasher {
        ...
        key = {
            ...
            hdr.VanHorn.isValid() : ternary;
            hdr.Spiro.isValid()   : ternary;
            hdr.Ralph.isValid()   : ternary;
            hdr.Wyatte.isValid()  : ternary;
            hdr.Aldrich.isValid() : ternary;
            hdr.Clauene.isValid() : ternary;
            hdr.Uhland.isValid()  : ternary;
            hdr.Maloy.isValid()   : ternary;
            hdr.Saranap.isValid() : ternary;
        }
        size = 256;
...
control Kenova(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Hanford") action Hanford() {
        hash(meta.Ravena.Patchogue, HashAlgorithm.crc32, (bit<32>)0, { hdr.Saranap.Homeland, hdr.Saranap.Gurdon, hdr.Saranap.Aynor, hdr.Saranap.Portales, hdr.Saranap.Hannibal }, (bit<64>)4294967296);
    }
...
control Kewanee(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Burwell") table Burwell {
        ...
        key = {
            meta.Sunset.Littleton       : exact;
            meta.Dabney.EastDuke[127:64]: lpm;
        }
        size = 8192;
        default_action = Shauck();
    }
    ...
    @atcam_partition_index("Duelm.Knoke") @atcam_number_partitions(16384) @name(".ElCentro") table ElCentro {
        ...
        key = {
            meta.Duelm.Knoke         : exact;
            meta.Duelm.Domestic[19:0]: lpm;
        }
        size = 131072;
        default_action = Shauck();
    }
    ...
    @atcam_partition_index("Dabney.Hughson") @atcam_number_partitions(8192) @name(".Westvaco") table Westvaco {
        ...
        key = {
            meta.Dabney.Hughson         : exact;
            meta.Dabney.EastDuke[106:64]: lpm;
        }
        size = 65536;
        default_action = Shauck();
    }
...
control Locke(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Felida") action Felida() {
        hash(meta.Ravena.Swansboro, HashAlgorithm.crc32, (bit<32>)0, { hdr.Uhland.Irondale, hdr.Uhland.Rudolph, hdr.Uhland.Bosler }, (bit<64>)4294967296);
    }
    @name(".Vanzant") action Vanzant() {
        hash(meta.Ravena.Swansboro, HashAlgorithm.crc32, (bit<32>)0, { hdr.Maloy.Hephzibah, hdr.Maloy.Redvale, hdr.Maloy.RushCity, hdr.Maloy.Gasport }, (bit<64>)4294967296);
    }
...
control McKenna(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Gallinas") table Gallinas {
        ...
        key = {
            meta.Fosston.PineHill    : ternary;
            hdr.LaMarque[0].isValid(): exact;
            hdr.LaMarque[0].Ivins    : ternary;
        }
        size = 4096;
    }
    ...
    @name(".Hookstown") table Hookstown {
        ...
        key = {
            meta.Fosston.PineHill: exact;
            hdr.LaMarque[0].Ivins: exact;
        }
        size = 1024;
        default_action = Shauck();
    }
    ...
    @name(".Weslaco") table Weslaco {
        ...
        key = {
            hdr.Saranap.Homeland : exact;
            hdr.Saranap.Gurdon   : exact;
            hdr.Uhland.Bosler    : exact;
            meta.Neshoba.Goodlett: exact;
        }
        size = 1024;
...
control Moark(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    register_action<bit<1>, bit<1>>(Brinson) Mabelle = {
        void apply(inout bit<1> value, out bit<1> rv) {
            rv = 1w0;
            value = 1w1;
        }
    ...
    @name(".Chenequa") table Chenequa {
        ...
        key = {
            meta.Neshoba.Kingsland: ternary;
            meta.Neshoba.Naalehu  : exact;
            meta.Neshoba.Adair    : exact;
        }
        size = 512;
    }
    ...
    @name(".DuPont") table DuPont {
        ...
        key = {
            meta.Fosston.Shasta   : exact;
            meta.Kerrville.Wanatah: ternary;
            meta.Kerrville.Ivanhoe: ternary;
            meta.Neshoba.Newland  : ternary;
            meta.Neshoba.Nahunta  : ternary;
            meta.Neshoba.Lumpkin  : ternary;
        }
        size = 512;
        default_action = Shauck();
        counters = Silvertip;
    ...
    @name(".Lowemont") table Lowemont {
        ...
        key = {
            meta.Neshoba.Waialee  : exact;
            meta.Neshoba.Lattimore: exact;
            meta.Neshoba.Gunter   : exact;
            meta.Neshoba.Champlain: exact;
        }
        size = 65536;
    }
    apply {
...
control Sherwin(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Pavillion") action Pavillion() {
        hash(meta.Ravena.Grantfork, HashAlgorithm.crc32, (bit<32>)0, { hdr.Uhland.Irondale, hdr.Uhland.Rudolph, hdr.Uhland.Bosler, hdr.Clauene.Hiland, hdr.Clauene.Lamar }, (bit<64>)4294967296);
    }
...
control Thayne(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Altadena") table Altadena {
        ...
        key = {
            hdr.Saranap.Homeland: ternary;
            hdr.Saranap.Gurdon  : ternary;
        }
        size = 512;
    ...
    @name(".Goodwin") table Goodwin {
        ...
        key = {
            hdr.Saranap.Aynor   : ternary;
            hdr.Saranap.Portales: ternary;
        }
        size = 512;
    }
    apply {
...
control Wapinitia(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Evelyn") action Evelyn() {
        digest<Coalgate>((bit<32>)0, { meta.Candor.Ferrum, meta.Neshoba.Waialee, meta.Neshoba.Lattimore, meta.Neshoba.Gunter, meta.Neshoba.Champlain });
    }
...
control DeparserImpl(packet_out packet, in headers hdr) {
    apply {
        packet.emit(hdr.Saranap);
        packet.emit(hdr.LaMarque[0]);
        packet.emit(hdr.Dandridge);
        packet.emit(hdr.Maloy);
        packet.emit(hdr.Uhland);
        packet.emit(hdr.Clauene);
        packet.emit(hdr.Hobart);
        packet.emit(hdr.Wyatte);
        packet.emit(hdr.Ralph);
        packet.emit(hdr.Spiro);
    }
}
