...
control Advance(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".ArchCape") table ArchCape {
        ...
        key = {
            ...
            meta.Wildell.Hilgard  : ternary;
            meta.Wildell.Nashoba  : ternary;
            meta.Wildell.Dushore  : ternary;
            meta.Wildell.Waretown : ternary;
            meta.Wildell.Pinebluff: ternary;
            meta.Wildell.Croghan  : ternary;
            meta.Wildell.Proctor  : ternary;
            meta.Wildell.Moorewood: ternary;
            meta.Wildell.Shabbona : ternary;
        }
        size = 512;
    }
    apply {
...
control Bondad(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @ways(4) @name(".Westbrook") table Westbrook {
        ...
        key = {
            meta.Wildell.Tofte    : exact;
            meta.Viroqua.Hilgard  : exact;
            meta.Viroqua.Nashoba  : exact;
            meta.Viroqua.Dushore  : exact;
            meta.Viroqua.Waretown : exact;
            meta.Viroqua.Pinebluff: exact;
            meta.Viroqua.Croghan  : exact;
            meta.Viroqua.Proctor  : exact;
            meta.Viroqua.Moorewood: exact;
            meta.Viroqua.Shabbona : exact;
        }
        size = 4096;
    }
    apply {
...
control Canfield(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @ways(4) @name(".Tecumseh") table Tecumseh {
        ...
        key = {
            meta.Wildell.Tofte    : exact;
            meta.Wildell.Hilgard  : exact;
            meta.Wildell.Nashoba  : exact;
            meta.Wildell.Dushore  : exact;
            meta.Wildell.Waretown : exact;
            meta.Wildell.Pinebluff: exact;
            meta.Wildell.Croghan  : exact;
            meta.Wildell.Proctor  : exact;
            meta.Wildell.Moorewood: exact;
            meta.Wildell.Shabbona : exact;
        }
        size = 4096;
    }
    apply {
