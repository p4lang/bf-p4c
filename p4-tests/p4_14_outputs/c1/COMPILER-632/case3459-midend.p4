...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Larwill") action _Larwill_0() {
        hash<bit<19>, bit<19>, tuple_0, bit<20>>(_Ludowici_temp, HashAlgorithm.identity, 19w0, { hdr.ig_intr_md.ingress_port, hdr.Mission[0].Ozona }, 20w524288);
        _Ludowici_tmp = _Matador.execute((bit<32>)_Ludowici_temp);
        meta.Humeston.Hector = _Ludowici_tmp;
    }
    @name(".Waiehu") action _Waiehu_0() {
        hash<bit<19>, bit<19>, tuple_0, bit<20>>(_Ludowici_temp_0, HashAlgorithm.identity, 19w0, { hdr.ig_intr_md.ingress_port, hdr.Mission[0].Ozona }, 20w524288);
    ...
    @name(".Chualar") action _Chualar_4(bit<32> Fonda) {
        _Blakeman_tmp = (meta.Weyauwega.Alcoma >= Fonda ? meta.Weyauwega.Alcoma : _Blakeman_tmp);
        _Blakeman_tmp = (!(meta.Weyauwega.Alcoma >= Fonda) ? Fonda : _Blakeman_tmp);
    ...
    @name(".Chualar") action _Chualar_5(bit<32> Fonda) {
        _Frontier_tmp = (meta.Weyauwega.Alcoma >= Fonda ? meta.Weyauwega.Alcoma : _Frontier_tmp);
        _Frontier_tmp = (!(meta.Weyauwega.Alcoma >= Fonda) ? Fonda : _Frontier_tmp);
    ...
    @name(".Chualar") action _Chualar_6(bit<32> Fonda) {
        _Pierpont_tmp = (meta.Weyauwega.Alcoma >= Fonda ? meta.Weyauwega.Alcoma : _Pierpont_tmp);
        _Pierpont_tmp = (!(meta.Weyauwega.Alcoma >= Fonda) ? Fonda : _Pierpont_tmp);
    ...
    @name(".Chualar") action _Chualar_7(bit<32> Fonda) {
        _Lenox_tmp = (meta.Weyauwega.Alcoma >= Fonda ? meta.Weyauwega.Alcoma : _Lenox_tmp);
        _Lenox_tmp = (!(meta.Weyauwega.Alcoma >= Fonda) ? Fonda : _Lenox_tmp);
    ...
    @name(".Chualar") action _Chualar_8(bit<32> Fonda) {
        _Craigmont_tmp = (meta.Weyauwega.Alcoma >= Fonda ? meta.Weyauwega.Alcoma : _Craigmont_tmp);
        _Craigmont_tmp = (!(meta.Weyauwega.Alcoma >= Fonda) ? Fonda : _Craigmont_tmp);
