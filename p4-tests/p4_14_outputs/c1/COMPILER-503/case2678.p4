...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Ekwok") state Ekwok {
        packet.extract(hdr.Combine);
        meta.Netcong.Mingus = 2w1;
        transition LaHabra;
    }
    @name(".Elkader") state Elkader {
        packet.extract(hdr.Flynn);
    ...
    @name(".Leesport") state Leesport {
        packet.extract(hdr.Foster);
        transition Osterdock;
    }
    @name(".McDaniels") state McDaniels {
        packet.extract(hdr.Scherr);
...
control Abernant(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Wyanet") action Wyanet() {
        hash(meta.Cropper.Vananda, HashAlgorithm.crc32, (bit<32>)0, { hdr.Scherr.Kalaloch, hdr.Scherr.Tilton, hdr.Wondervu.Clover, hdr.Wondervu.Holtville }, (bit<64>)4294967296);
    }
...
control Antelope(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Hayfield") action Hayfield() {
        digest<Henning>((bit<32>)0, { meta.Elkins.Pinecreek, meta.Netcong.Rawlins, meta.Netcong.Kittredge, meta.Netcong.Eucha, meta.Netcong.Mantee });
    }
...
control Astatula(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Satanta") action Satanta() {
        Amasa.execute_meter((bit<32>)(bit<32>)meta.Burrel.Empire, hdr.ig_intr_md_for_tm.packet_color);
    }
    @name(".Rampart") table Rampart {
        ...
        key = {
            meta.Burrel.Empire     : ternary;
            meta.Netcong.Mantee    : ternary;
            meta.Netcong.Captiva   : ternary;
            meta.Chloride.Wabbaseka: ternary;
            meta.Burrel.Steger     : ternary;
        }
        size = 1024;
    }
    apply {
...
control Daguao(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @ways(1) @name(".Breda") table Breda {
        ...
        key = {
            meta.Peebles.Fentress: exact;
            meta.Peebles.Bajandas: exact;
        }
        size = 1;
...
control Devore(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Leeville") action Leeville() {
        {
            bit<18> temp;
            hash(temp, HashAlgorithm.identity, 18w0, { meta.Lowemont.Rocky, hdr.Melrude[0].Chamois }, 19w262144);
    ...
    @name(".Kaweah") action Kaweah() {
        {
            bit<18> temp_0;
            hash(temp_0, HashAlgorithm.identity, 18w0, { meta.Lowemont.Rocky, hdr.Melrude[0].Chamois }, 19w262144);
...
control Dollar(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Ojibwa") table Ojibwa {
        ...
        key = {
            meta.Lowemont.Ramapo             : exact;
            meta.Burrel.Lawai                : exact;
            meta.Burrel.Greycliff            : exact;
...
control Garlin(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".LaMonte") table LaMonte {
        ...
        key = {
            meta.Peebles.Platina   : exact;
            meta.Peebles.Boonsboro : exact;
            meta.Peebles.Waucoma   : exact;
            hdr.Scherr.isValid()   : ternary;
            hdr.McCracken.isValid(): ternary;
            hdr.HornLake.isValid() : ternary;
            hdr.Tusayan.isValid()  : ternary;
        }
        size = 512;
    }
...
control GilaBend(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".McIntyre") action McIntyre() {
        digest<Grottoes>((bit<32>)0, { meta.Elkins.Pinecreek, meta.Netcong.Eucha, hdr.Brush.Tahuya, hdr.Brush.Kennedale, hdr.Scherr.Kalaloch });
    }
...
control Hallwood(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Garibaldi") table Garibaldi {
        ...
        key = {
            meta.Peebles.Subiaco: exact;
            meta.Funston.Ivydale: selector;
        }
        size = 1024;
...
control Harvest(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @action_default_only("Shoshone") @immediate(0) @name(".Gillespie") table Gillespie {
        ...
        key = {
            hdr.Joyce.isValid()    : ternary;
            hdr.Herod.isValid()    : ternary;
            hdr.HornLake.isValid() : ternary;
            hdr.Tusayan.isValid()  : ternary;
            hdr.Brush.isValid()    : ternary;
            hdr.Woodridge.isValid(): ternary;
            hdr.Plato.isValid()    : ternary;
            hdr.Scherr.isValid()   : ternary;
            hdr.McCracken.isValid(): ternary;
            hdr.Bavaria.isValid()  : ternary;
        }
        size = 256;
    }
...
control Jigger(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Glenolden") table Glenolden {
        ...
        key = {
            meta.Gheen.Rillton    : exact;
            meta.Funston.Macksburg: selector;
        }
        size = 2048;
...
control Kapalua(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Wegdahl") action Wegdahl() {
        hash(meta.Cropper.Cochise, HashAlgorithm.crc32, (bit<32>)0, { hdr.McCracken.Lefors, hdr.McCracken.Ouachita, hdr.McCracken.Keener, hdr.McCracken.Gorum }, (bit<64>)4294967296);
    }
    @name(".Exira") action Exira() {
        hash(meta.Cropper.Cochise, HashAlgorithm.crc32, (bit<32>)0, { hdr.Scherr.Columbia, hdr.Scherr.Kalaloch, hdr.Scherr.Tilton }, (bit<64>)4294967296);
    }
...
control Lenoir(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @ternary(1) @name(".Ewing") table Ewing {
        ...
        key = {
            meta.Peebles.Tappan              : exact;
            hdr.ig_intr_md_for_tm.copy_to_cpu: exact;
            meta.Chloride.Wabbaseka          : exact;
            meta.Lowemont.Grandy             : ternary;
            meta.Peebles.Sandoval            : ternary;
        }
        size = 512;
    }
    apply {
...
control Neuse(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Emida") table Emida {
        ...
        key = {
            meta.Lowemont.Highcliff : ternary;
            hdr.Melrude[0].isValid(): exact;
            hdr.Melrude[0].Chamois  : ternary;
        }
        size = 4096;
    }
    @action_default_only("Shoshone") @name(".Fowlkes") table Fowlkes {
        ...
        key = {
            meta.Lowemont.Highcliff: exact;
            hdr.Melrude[0].Chamois : exact;
        }
        size = 1024;
    }
    ...
    @name(".Ortley") table Ortley {
        ...
        key = {
            hdr.Bavaria.Hilltop: exact;
            hdr.Bavaria.Govan  : exact;
            hdr.Scherr.Tilton  : exact;
            meta.Netcong.Mingus: exact;
        }
        size = 1024;
...
control Roseville(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Marysvale") table Marysvale {
        ...
        key = {
            meta.Burrel.Waring  : exact;
            meta.Netcong.Abbott : ternary;
            meta.Netcong.Needles: ternary;
            meta.Netcong.Bradner: ternary;
        }
        size = 512;
        default_action = Odell();
    }
...
control Salitpa(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".McManus") table McManus {
        ...
        key = {
            meta.Lowemont.Ramapo  : ternary;
            meta.Lowemont.ElCentro: ternary;
            meta.Burrel.Sawyer    : ternary;
            meta.Burrel.Virgin    : ternary;
            meta.Burrel.Creekside : ternary;
        }
        size = 80;
    }
    apply {
...
control ShadeGap(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".LaFayette") table LaFayette {
        ...
        key = {
            hdr.Foster.Gastonia: exact;
            hdr.Foster.Floral  : exact;
            hdr.Foster.Woodward: exact;
            hdr.Foster.Wadley  : exact;
        }
        size = 256;
...
control Terral(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Bucktown") table Bucktown {
        ...
        key = {
            hdr.Bavaria.Tahuya   : ternary;
            hdr.Bavaria.Kennedale: ternary;
        }
        size = 512;
    }
    ...
    @name(".Bunker") table Bunker {
        ...
        key = {
            meta.Lowemont.Rocky: exact;
            hdr.Bavaria.Hilltop: ternary;
            hdr.Bavaria.Govan  : ternary;
        }
        size = 512;
...
control Urbanette(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Caulfield") table Caulfield {
        ...
        key = {
            meta.Netcong.Rawlins  : exact;
            meta.Netcong.Kittredge: exact;
            meta.Netcong.Eucha    : exact;
            meta.Netcong.Mantee   : exact;
        }
        size = 65536;
    ...
    @name(".Halley") table Halley {
        ...
        key = {
            meta.Netcong.Captiva: ternary;
            meta.Netcong.Abbott : exact;
            meta.Netcong.Needles: exact;
        }
        size = 512;
    }
    ...
    @name(".Johnsburg") table Johnsburg {
        ...
        key = {
            meta.Lowemont.Rocky   : exact;
            meta.Stout.Ashville   : ternary;
            meta.Stout.Verndale   : ternary;
            meta.Netcong.Stateline: ternary;
            meta.Netcong.Punaluu  : ternary;
            meta.Netcong.Montour  : ternary;
        }
        size = 512;
        default_action = Shoshone();
...
control Wardville(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Gordon") table Gordon {
        ...
        key = {
            meta.Netcong.Trenary: exact;
            meta.Netcong.Seattle: exact;
        }
        size = 3;
    }
...
control Willshire(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".PortWing") action PortWing() {
        hash(meta.Cropper.Wiota, HashAlgorithm.crc32, (bit<32>)0, { hdr.Bavaria.Hilltop, hdr.Bavaria.Govan, hdr.Bavaria.Tahuya, hdr.Bavaria.Kennedale, hdr.Bavaria.Rudolph }, (bit<64>)4294967296);
    }
...
control DeparserImpl(packet_out packet, in headers hdr) {
    apply {
        packet.emit(hdr.Hayfork);
        packet.emit(hdr.Foster);
        packet.emit(hdr.Bavaria);
        packet.emit(hdr.Melrude[0]);
        packet.emit(hdr.Flynn);
        packet.emit(hdr.McCracken);
        packet.emit(hdr.Scherr);
        packet.emit(hdr.Wondervu);
        packet.emit(hdr.Woodridge);
        packet.emit(hdr.Plato);
        packet.emit(hdr.Combine);
        packet.emit(hdr.Brush);
        packet.emit(hdr.Tusayan);
        packet.emit(hdr.HornLake);
    }
}
...
control verifyChecksum(in headers hdr, inout metadata meta) {
    ...
    Checksum16() Duncombe;
    apply {
        if (hdr.HornLake.Angeles == Anacortes.get({ hdr.HornLake.Woodbury, hdr.HornLake.Munich, hdr.HornLake.Lansdale, hdr.HornLake.Deport, hdr.HornLake.Eureka, hdr.HornLake.Litroe, hdr.HornLake.Neavitt, hdr.HornLake.Heavener, hdr.HornLake.Elderon, hdr.HornLake.Columbia, hdr.HornLake.Kalaloch, hdr.HornLake.Tilton })) 
            mark_to_drop();
        if (hdr.Scherr.Angeles == Duncombe.get({ hdr.Scherr.Woodbury, hdr.Scherr.Munich, hdr.Scherr.Lansdale, hdr.Scherr.Deport, hdr.Scherr.Eureka, hdr.Scherr.Litroe, hdr.Scherr.Neavitt, hdr.Scherr.Heavener, hdr.Scherr.Elderon, hdr.Scherr.Columbia, hdr.Scherr.Kalaloch, hdr.Scherr.Tilton })) 
            mark_to_drop();
    }
}
...
control computeChecksum(inout headers hdr, inout metadata meta) {
    ...
    Checksum16() Duncombe;
    apply {
        hdr.HornLake.Angeles = Anacortes.get({ hdr.HornLake.Woodbury, hdr.HornLake.Munich, hdr.HornLake.Lansdale, hdr.HornLake.Deport, hdr.HornLake.Eureka, hdr.HornLake.Litroe, hdr.HornLake.Neavitt, hdr.HornLake.Heavener, hdr.HornLake.Elderon, hdr.HornLake.Columbia, hdr.HornLake.Kalaloch, hdr.HornLake.Tilton });
        hdr.Scherr.Angeles = Duncombe.get({ hdr.Scherr.Woodbury, hdr.Scherr.Munich, hdr.Scherr.Lansdale, hdr.Scherr.Deport, hdr.Scherr.Eureka, hdr.Scherr.Litroe, hdr.Scherr.Neavitt, hdr.Scherr.Heavener, hdr.Scherr.Elderon, hdr.Scherr.Columbia, hdr.Scherr.Kalaloch, hdr.Scherr.Tilton });
    }
}
