...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Alnwick") action _Alnwick() {
        hash<bit<32>, bit<32>, tuple_1, bit<64>>(meta.Alden.Hobart, HashAlgorithm.crc32, 32w0, { hdr.Bellport.Ruthsburg, hdr.Bellport.Mulliken, hdr.Bellport.Gomez, hdr.Bellport.Starkey, hdr.Bellport.Annette }, 64w4294967296);
    }
    ...
    @name(".Minto") action _Minto() {
        hash<bit<32>, bit<32>, tuple_2, bit<64>>(meta.Alden.Monaca, HashAlgorithm.crc32, 32w0, { hdr.Abbyville.Waterman, hdr.Abbyville.Domingo, hdr.Abbyville.Woodfords, hdr.Abbyville.Hackney }, 64w4294967296);
    }
    @name(".Kenvil") action _Kenvil() {
        hash<bit<32>, bit<32>, tuple_3, bit<64>>(meta.Alden.Monaca, HashAlgorithm.crc32, 32w0, { hdr.Pensaukee.Angus, hdr.Pensaukee.Rankin, hdr.Pensaukee.Norwood }, 64w4294967296);
    }
    ...
    @name(".Moylan") action _Moylan() {
        hash<bit<32>, bit<32>, tuple_4, bit<64>>(meta.Alden.Graford, HashAlgorithm.crc32, 32w0, { hdr.Pensaukee.Angus, hdr.Pensaukee.Rankin, hdr.Pensaukee.Norwood, hdr.Yatesboro.Dasher, hdr.Yatesboro.Tomato }, 64w4294967296);
    }
