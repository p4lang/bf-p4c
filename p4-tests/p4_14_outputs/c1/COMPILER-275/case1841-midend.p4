...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Homeacre.Donegal") register_action<bit<1>, bit<1>>(Robinette) _Homeacre_Donegal_0 = {
        void apply(inout bit<1> value, out bit<1> rv) {
            rv = value;
        }
    };
    @name(".Homeacre.Sitka") register_action<bit<1>, bit<1>>(Steger) _Homeacre_Sitka_0 = {
        void apply(inout bit<1> value, out bit<1> rv) {
            rv = value;
        }
    };
    ...
    @name(".Rawlins") action _Rawlins() {
        hash<bit<18>, bit<18>, tuple_0, bit<19>>(_Homeacre_temp_1, HashAlgorithm.identity, 18w0, { meta.Harpster.Nettleton, hdr.Oklee[0].ElPortal }, 19w262144);
        _Homeacre_tmp_1 = _Homeacre_Donegal_0.execute((bit<32>)_Homeacre_temp_1);
        meta.Noelke.Taylors = _Homeacre_tmp_1;
    }
    @name(".Colona") action _Colona() {
        hash<bit<18>, bit<18>, tuple_0, bit<19>>(_Homeacre_temp_2, HashAlgorithm.identity, 18w0, { meta.Harpster.Nettleton, hdr.Oklee[0].ElPortal }, 19w262144);
        _Homeacre_tmp_2 = _Homeacre_Sitka_0.execute((bit<32>)_Homeacre_temp_2);
    ...
    @name(".Occoquan") action _Occoquan() {
        hash<bit<32>, bit<32>, tuple_1, bit<64>>(meta.Rosburg.Boquet, HashAlgorithm.crc32, 32w0, { hdr.ElmGrove.Ashville, hdr.ElmGrove.Arminto, hdr.ElmGrove.Hobart, hdr.ElmGrove.Ackley, hdr.ElmGrove.Carpenter }, 64w4294967296);
    }
    ...
    @name(".Puyallup.Chaumont") register_action<bit<1>, bit<1>>(Grants) _Puyallup_Chaumont_0 = {
        void apply(inout bit<1> value, out bit<1> rv) {
            rv = 1w0;
            value = 1w1;
        }
    ...
    @name(".Cache") action _Cache() {
        hash<bit<32>, bit<32>, tuple_2, bit<64>>(meta.Rosburg.Lyman, HashAlgorithm.crc32, 32w0, { hdr.Sargent.Philippi, hdr.Sargent.HornLake, hdr.Sargent.Rushmore, hdr.Sargent.Dalkeith }, 64w4294967296);
    }
    @name(".Raceland") action _Raceland() {
        hash<bit<32>, bit<32>, tuple_3, bit<64>>(meta.Rosburg.Lyman, HashAlgorithm.crc32, 32w0, { hdr.Arapahoe.Kenvil, hdr.Arapahoe.Wyanet, hdr.Arapahoe.Storden }, 64w4294967296);
    }
    ...
    @name(".Wiota") action _Wiota() {
        hash<bit<32>, bit<32>, tuple_4, bit<64>>(meta.Rosburg.LaMonte, HashAlgorithm.crc32, 32w0, { hdr.Arapahoe.Kenvil, hdr.Arapahoe.Wyanet, hdr.Arapahoe.Storden, hdr.Segundo.ElMirage, hdr.Segundo.Romney }, 64w4294967296);
    }
