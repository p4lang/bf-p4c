...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Alston") state Alston {
        packet.extract(hdr.Mausdale);
        transition accept;
    }
    @name(".Bolckow") state Bolckow {
        packet.extract(hdr.MuleBarn);
    ...
    @name(".Circle") state Circle {
        packet.extract(hdr.Kaluaaha);
        meta.Wayne.Tehachapi = 2w1;
        transition Domingo;
    }
    @name(".Delmar") state Delmar {
        packet.extract(hdr.Spanaway);
...
control Alzada(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Cache") action Cache() {
        hash(meta.Rosburg.Lyman, HashAlgorithm.crc32, (bit<32>)0, { hdr.Sargent.Philippi, hdr.Sargent.HornLake, hdr.Sargent.Rushmore, hdr.Sargent.Dalkeith }, (bit<64>)4294967296);
    }
    @name(".Raceland") action Raceland() {
        hash(meta.Rosburg.Lyman, HashAlgorithm.crc32, (bit<32>)0, { hdr.Arapahoe.Kenvil, hdr.Arapahoe.Wyanet, hdr.Arapahoe.Storden }, (bit<64>)4294967296);
    }
...
control Hephzibah(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Tolleson") table Tolleson {
        ...
        key = {
            meta.Brazil.Cuprum    : exact;
            meta.Brazil.Elsmere   : exact;
            meta.Brazil.Amesville : exact;
            hdr.Arapahoe.isValid(): ternary;
            hdr.Sargent.isValid() : ternary;
        }
        size = 512;
    }
    apply {
...
control Homeacre(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Rawlins") action Rawlins() {
        {
            bit<18> temp;
            hash(temp, HashAlgorithm.identity, 18w0, { meta.Harpster.Nettleton, hdr.Oklee[0].ElPortal }, 19w262144);
    ...
    @name(".Colona") action Colona() {
        {
            bit<18> temp_0;
            hash(temp_0, HashAlgorithm.identity, 18w0, { meta.Harpster.Nettleton, hdr.Oklee[0].ElPortal }, 19w262144);
...
control Husum(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Hisle") action Hisle() {
        digest<Aquilla>((bit<32>)0, { meta.Beaverdam.Truro, meta.Wayne.Leland, hdr.Perrin.Hobart, hdr.Perrin.Ackley, hdr.Arapahoe.Wyanet });
    }
...
control Kansas(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Wiota") action Wiota() {
        hash(meta.Rosburg.LaMonte, HashAlgorithm.crc32, (bit<32>)0, { hdr.Arapahoe.Kenvil, hdr.Arapahoe.Wyanet, hdr.Arapahoe.Storden, hdr.Segundo.ElMirage, hdr.Segundo.Romney }, (bit<64>)4294967296);
    }
...
control LaMoille(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @immediate(0) @name(".Kooskia") table Kooskia {
        ...
        key = {
            hdr.Weinert.isValid() : ternary;
            hdr.Jenera.isValid()  : ternary;
            hdr.Oshoto.isValid()  : ternary;
            hdr.MuleBarn.isValid(): ternary;
            hdr.Perrin.isValid()  : ternary;
            hdr.Coronado.isValid(): ternary;
            hdr.Segundo.isValid() : ternary;
            hdr.Arapahoe.isValid(): ternary;
            hdr.Sargent.isValid() : ternary;
            hdr.ElmGrove.isValid(): ternary;
        }
        size = 256;
...
control Layton(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Occoquan") action Occoquan() {
        hash(meta.Rosburg.Boquet, HashAlgorithm.crc32, (bit<32>)0, { hdr.ElmGrove.Ashville, hdr.ElmGrove.Arminto, hdr.ElmGrove.Hobart, hdr.ElmGrove.Ackley, hdr.ElmGrove.Carpenter }, (bit<64>)4294967296);
    }
...
control Needles(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Cherokee") table Cherokee {
        ...
        key = {
            meta.Brazil.Sonora  : exact;
            meta.Brazil.Willows : exact;
            meta.Brazil.Rockdale: exact;
        }
        size = 65536;
...
control Othello(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Elrosa") table Elrosa {
        ...
        key = {
            meta.Harpster.Champlain: ternary;
            hdr.Oklee[0].isValid() : exact;
            hdr.Oklee[0].ElPortal  : ternary;
        }
        size = 4096;
    }
    ...
    @name(".Sixteen") table Sixteen {
        ...
        key = {
            hdr.ElmGrove.Ashville: exact;
            hdr.ElmGrove.Arminto : exact;
            hdr.Arapahoe.Storden : exact;
            meta.Wayne.Tehachapi : exact;
        }
        size = 1024;
...
control Perez(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Sylvan") table Sylvan {
        ...
        key = {
            meta.Brazil.Slana : exact;
            meta.Orrum.WestEnd: selector;
        }
        size = 1024;
...
control Puyallup(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Boistfort") table Boistfort {
        ...
        key = {
            meta.Wayne.Paoli  : exact;
            meta.Wayne.Rodessa: exact;
            meta.Wayne.Leland : exact;
            meta.Wayne.Malabar: exact;
        }
        size = 65536;
    }
    @name(".Sopris") table Sopris {
        ...
        key = {
            meta.Wayne.Creekside: ternary;
            meta.Wayne.Marshall : exact;
            meta.Wayne.Raritan  : exact;
        }
        size = 512;
    }
    ...
    @name(".Yreka") table Yreka {
        ...
        key = {
            meta.Harpster.Nettleton: exact;
            meta.Noelke.Taylors    : ternary;
            meta.Noelke.Anvik      : ternary;
            meta.Wayne.Flats       : ternary;
            meta.Wayne.UnionGap    : ternary;
            meta.Wayne.Laplace     : ternary;
        }
        size = 512;
...
control Sunset(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @atcam_partition_index("Kahului.WestGate") @atcam_number_partitions(16384) @name(".Admire") table Admire {
        ...
        key = {
            meta.Kahului.WestGate     : exact;
            meta.Kahului.Colonie[19:0]: lpm;
        }
        size = 131072;
        default_action = Isleta();
    }
    @atcam_partition_index("Cadwell.Cotter") @atcam_number_partitions(8192) @name(".Ammon") table Ammon {
        ...
        key = {
            meta.Cadwell.Cotter         : exact;
            meta.Cadwell.Coulter[106:64]: lpm;
        }
        size = 65536;
        default_action = Isleta();
    }
    @idletime_precision(1) @name(".Daykin") table Daykin {
        ...
        key = {
            meta.Pimento.Roodhouse: exact;
            meta.Kahului.Colonie  : lpm;
        }
        size = 1024;
        default_action = Isleta();
    }
    @name(".Garibaldi") table Garibaldi {
        ...
        key = {
            meta.Pimento.Roodhouse      : exact;
            meta.Cadwell.Coulter[127:64]: lpm;
        }
        size = 8192;
        default_action = Isleta();
    }
    ...
    @atcam_partition_index("Cadwell.Redmon") @atcam_number_partitions(2048) @name(".Goldsmith") table Goldsmith {
        ...
        key = {
            meta.Cadwell.Redmon       : exact;
            meta.Cadwell.Coulter[63:0]: lpm;
        }
        size = 16384;
        default_action = Isleta();
    }
...
control WallLake(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".McHenry") action McHenry() {
        digest<Connell>((bit<32>)0, { meta.Beaverdam.Truro, meta.Wayne.Paoli, meta.Wayne.Rodessa, meta.Wayne.Leland, meta.Wayne.Malabar });
    }
...
control Westpoint(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Castle") table Castle {
        ...
        key = {
            hdr.ElmGrove.Hobart: ternary;
            hdr.ElmGrove.Ackley: ternary;
        }
        size = 512;
    }
    @name(".Provencal") table Provencal {
        ...
        key = {
            hdr.ElmGrove.Ashville: ternary;
            hdr.ElmGrove.Arminto : ternary;
        }
        size = 512;
...
control DeparserImpl(packet_out packet, in headers hdr) {
    apply {
        packet.emit(hdr.ElmGrove);
        packet.emit(hdr.Oklee[0]);
        packet.emit(hdr.Mausdale);
        packet.emit(hdr.Sargent);
        packet.emit(hdr.Arapahoe);
        packet.emit(hdr.Segundo);
        packet.emit(hdr.Kaluaaha);
        packet.emit(hdr.Perrin);
        packet.emit(hdr.MuleBarn);
        packet.emit(hdr.Oshoto);
    }
}
