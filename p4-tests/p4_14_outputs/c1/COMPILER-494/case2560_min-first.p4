...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Mahomet") state Mahomet {
        packet.extract<Harvest_0>(hdr.Orrum);
...
control Garrison(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @action_default_only("Fillmore") @idletime_precision(1) @name(".Boquet") table Boquet {
        ...
        key = {
            meta.Bieber.Coverdale: exact @name("meta.Bieber.Coverdale") ;
            meta.Cantwell.Colona : lpm @name("meta.Cantwell.Colona") ;
        }
        size = 1024;
    ...
    @atcam_partition_index("Hitterdal.Dixie") @atcam_number_partitions(8192) @name(".KeyWest") table KeyWest {
        ...
        key = {
            meta.Hitterdal.Dixie           : exact @name("meta.Hitterdal.Dixie") ;
            meta.Hitterdal.Danville[106:64]: lpm @name("meta.Hitterdal.Danville[106:64]") ;
        }
        size = 65536;
    ...
    @atcam_partition_index("Hitterdal.Lenoir") @atcam_number_partitions(2048) @name(".Minoa") table Minoa {
        ...
        key = {
            meta.Hitterdal.Lenoir        : exact @name("meta.Hitterdal.Lenoir") ;
            meta.Hitterdal.Danville[63:0]: lpm @name("meta.Hitterdal.Danville[63:0]") ;
        }
        size = 16384;
        default_action = Lueders();
    }
    @idletime_precision(1) @name(".Neches") table Neches {
        ...
        key = {
            meta.Bieber.Coverdale: exact @name("meta.Bieber.Coverdale") ;
            meta.Cantwell.Colona : exact @name("meta.Cantwell.Colona") ;
        }
        size = 65536;
        default_action = Lueders();
    }
    @command_line("--no-dead-code-elimination") @action_default_only("Fillmore") @name(".Nuyaka") table Nuyaka {
        ...
        key = {
            meta.Bieber.Coverdale          : exact @name("meta.Bieber.Coverdale") ;
            meta.Hitterdal.Danville[127:64]: lpm @name("meta.Hitterdal.Danville[127:64]") ;
        }
        size = 8192;
        default_action = NoAction();
    }
    @idletime_precision(1) @name(".Saragosa") table Saragosa {
        ...
        key = {
            meta.Bieber.Coverdale  : exact @name("meta.Bieber.Coverdale") ;
            meta.Hitterdal.Danville: exact @name("meta.Hitterdal.Danville") ;
        }
        size = 65536;
        default_action = Lueders();
    }
    @action_default_only("Lueders") @name(".Valeene") table Valeene {
        ...
        key = {
            meta.Bieber.Coverdale  : exact @name("meta.Bieber.Coverdale") ;
            meta.Hitterdal.Danville: lpm @name("meta.Hitterdal.Danville") ;
        }
        size = 2048;
        default_action = NoAction();
    }
    @ways(2) @atcam_partition_index("Cantwell.BarNunn") @atcam_number_partitions(16384) @name(".Waretown") table Waretown {
        ...
        key = {
            meta.Cantwell.BarNunn     : exact @name("meta.Cantwell.BarNunn") ;
            meta.Cantwell.Colona[19:0]: lpm @name("meta.Cantwell.Colona[19:0]") ;
        }
        size = 131072;
        default_action = Lueders();
    }
...
control Taopi(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Meyers") table Meyers {
        ...
        key = {
            meta.Brainard.JaneLew: exact @name("meta.Brainard.JaneLew") ;
        }
        size = 256;
        default_action = NoAction();
    }
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".Garrison") Garrison() Garrison_0;
    @name(".Taopi") Taopi() Taopi_0;
    apply {
        Garrison_0.apply(hdr, meta, standard_metadata);
        Taopi_0.apply(hdr, meta, standard_metadata);
    }
}
...
control verifyChecksum(in headers hdr, inout metadata meta) {
    ...
    Checksum16() Bardwell;
    apply {
        if (hdr.Kinsley.Leola == (Ojibwa.get<tuple<bit<4>, bit<4>, bit<6>, bit<2>, bit<16>, bit<16>, bit<3>, bit<13>, bit<8>, bit<8>, bit<32>, bit<32>>>({ hdr.Kinsley.Adair, hdr.Kinsley.Arcanum, hdr.Kinsley.Hewitt, hdr.Kinsley.Boysen, hdr.Kinsley.Pineridge, hdr.Kinsley.Dilia, hdr.Kinsley.Blunt, hdr.Kinsley.Clermont, hdr.Kinsley.DeepGap, hdr.Kinsley.Cuprum, hdr.Kinsley.Keachi, hdr.Kinsley.Finley }))) 
            mark_to_drop();
        if (hdr.Wauseon.Leola == (Bardwell.get<tuple<bit<4>, bit<4>, bit<6>, bit<2>, bit<16>, bit<16>, bit<3>, bit<13>, bit<8>, bit<8>, bit<32>, bit<32>>>({ hdr.Wauseon.Adair, hdr.Wauseon.Arcanum, hdr.Wauseon.Hewitt, hdr.Wauseon.Boysen, hdr.Wauseon.Pineridge, hdr.Wauseon.Dilia, hdr.Wauseon.Blunt, hdr.Wauseon.Clermont, hdr.Wauseon.DeepGap, hdr.Wauseon.Cuprum, hdr.Wauseon.Keachi, hdr.Wauseon.Finley }))) 
            mark_to_drop();
    }
}
...
control computeChecksum(inout headers hdr, inout metadata meta) {
    ...
    Checksum16() Bardwell;
    apply {
        hdr.Kinsley.Leola = Ojibwa.get<tuple<bit<4>, bit<4>, bit<6>, bit<2>, bit<16>, bit<16>, bit<3>, bit<13>, bit<8>, bit<8>, bit<32>, bit<32>>>({ hdr.Kinsley.Adair, hdr.Kinsley.Arcanum, hdr.Kinsley.Hewitt, hdr.Kinsley.Boysen, hdr.Kinsley.Pineridge, hdr.Kinsley.Dilia, hdr.Kinsley.Blunt, hdr.Kinsley.Clermont, hdr.Kinsley.DeepGap, hdr.Kinsley.Cuprum, hdr.Kinsley.Keachi, hdr.Kinsley.Finley });
        hdr.Wauseon.Leola = Bardwell.get<tuple<bit<4>, bit<4>, bit<6>, bit<2>, bit<16>, bit<16>, bit<3>, bit<13>, bit<8>, bit<8>, bit<32>, bit<32>>>({ hdr.Wauseon.Adair, hdr.Wauseon.Arcanum, hdr.Wauseon.Hewitt, hdr.Wauseon.Boysen, hdr.Wauseon.Pineridge, hdr.Wauseon.Dilia, hdr.Wauseon.Blunt, hdr.Wauseon.Clermont, hdr.Wauseon.DeepGap, hdr.Wauseon.Cuprum, hdr.Wauseon.Keachi, hdr.Wauseon.Finley });
    }
}
