...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".action_0") action action_2(bit<1> param0, bit<1> param1, bit<4> param2, bit<4> param3, bit<1> param4, bit<1> param5) {
        ...
        meta.meta.field_a3_1 = param1;
        meta.meta.field_b_4 = 4w9;
    ...
    @include_idletime(1) @idletime_two_way_notification(1) @idletime_per_flow_idletime(1) @name(".table_1") table table_1 {
        ...
        key = {
            ...
            meta.meta.field_a0_1: exact @name("meta.field_a0_1") ;
            meta.meta.field_a1_1: exact @name("meta.field_a1_1") ;
            meta.meta.field_a2_1: exact @name("meta.field_a2_1") ;
            meta.meta.field_a3_1: exact @name("meta.field_a3_1") ;
            meta.meta.field_b_4 : exact @name("meta.field_b_4") ;
            meta.meta.field_c_4 : exact @name("meta.field_c_4") ;
            meta.meta.field_d_4 : exact @name("meta.field_d_4") ;
            meta.meta.field_e_4 : exact @name("meta.field_e_4") ;
            meta.meta.field_f_4 : exact @name("meta.field_f_4") ;
            meta.meta.field_g_4 : exact @name("meta.field_g_4") ;
            meta.meta.field_h0_1: exact @name("meta.field_h0_1") ;
            meta.meta.field_h1_1: exact @name("meta.field_h1_1") ;
            meta.meta.field_h2_1: exact @name("meta.field_h2_1") ;
            meta.meta.field_h3_1: exact @name("meta.field_h3_1") ;
        }
        size = 65536;
