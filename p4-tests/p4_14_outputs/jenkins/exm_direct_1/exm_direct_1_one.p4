...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".custom_action_5") action custom_action_5(bit<16> dstPort, bit<16> srcPort) {
    ...
    @name(".custom_action_4") action custom_action_4(bit<9> egress_port, bit<16> dstPort, bit<16> srcPort) {
        hdr.tcp.dstPort = dstPort;
        hdr.tcp.srcPort = srcPort;
        hdr.ig_intr_md_for_tm.ucast_egress_port = egress_port;
    }
    ...
    @name(".mod_mac_addr") action mod_mac_addr(bit<9> egress_port, bit<48> dstmac) {
        hdr.ig_intr_md_for_tm.ucast_egress_port = egress_port;
        hdr.ethernet.dstAddr = dstmac;
    }
    ...
    @stage(0) @ways(3) @pack(1) @name(".exm_3ways_1Entries") table exm_3ways_1Entries {
        actions = {
            nop;
            next_hop_ipv4;
        }
    ...
    @stage(0) @pack(2) @name(".exm_6ways_2Entries") table exm_6ways_2Entries {
        actions = {
            nop;
            modify_tcp_dst_port;
        }
    ...
    apply {
        ...
        exm_6ways_2Entries.apply();
        exm_3ways_1Entries.apply();
        exm_4ways_1Entries.apply();
        exm_5ways_1Entries.apply();
        exm_6ways_7Entries.apply();
        exm_deep_32k.apply();
        exm_deep_64k.apply();
        exm_6ways_1Entries.apply();
        exm_5ways_2Entries.apply();
        exm_4ways_2Entries.apply();
        exm_3ways_2Entries.apply();
        exm_wide_key.apply();
        exm_6ways_8Entries.apply();
        exm_5ways_8Entries.apply();
    }
}
...
control computeChecksum(inout headers hdr, inout metadata meta) {
    ...
    apply {
        hdr.ipv4.hdrChecksum = ipv4_chksum_calc.get({ hdr.ipv4.version, hdr.ipv4.ihl, hdr.ipv4.diffserv, hdr.ipv4.totalLen, hdr.ipv4.identification, hdr.ipv4.flags, hdr.ipv4.fragOffset, hdr.ipv4.ttl, hdr.ipv4.protocol, hdr.ipv4.srcAddr, hdr.ipv4.dstAddr });
    }
}
