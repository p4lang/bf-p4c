...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @stage(7) @name(".dest_non_overlap_range_table") table dest_non_overlap_range_table_0 {
        actions = {
            nop_1();
            set_drange_mdata_0();
            @defaultonly NoAction();
    ...
    @command_line("--no-dead-code-elimination") @command_line("--placement", "pragma") @immediate(1) @stage(0) @name(".ig_udp") table ig_udp_0 {
        actions = {
            nop_1();
            udp_set_dest_0();
            @defaultonly NoAction();
    ...
    @name(".ig_udp_ternary_valid") table ig_udp_ternary_valid_0 {
        actions = {
            nop_1();
            udp_set_dest_0();
            tcp_set_src_dest_0();
        ...
        key = {
            hdr.ethernet.isValid(): exact @name("hdr.ethernet.isValid()") ;
            hdr.ipv4.isValid()    : exact @name("hdr.ipv4.isValid()") ;
            hdr.udp.isValid()     : ternary @name("hdr.udp.isValid()") ;
            meta.md.dport         : ternary @name("meta.md.dport") ;
        }
        default_action = NoAction();
    }
    ...
    @stage(11) @entries_with_ranges(1) @name(".match_range_table") table match_range_table_0 {
        actions = {
            nop_1();
            hop_ipv4_0();
            @defaultonly NoAction();
        ...
        key = {
            meta.range_mdata.src_range_index : ternary @name("meta.range_mdata.src_range_index") ;
            meta.range_mdata.dest_range_index: ternary @name("meta.range_mdata.dest_range_index") ;
            hdr.tcp.srcPort                  : range @name("hdr.tcp.srcPort") ;
            hdr.tcp.dstPort                  : range @name("hdr.tcp.dstPort") ;
    ...
    @stage(10) @name(".no_key_1") table no_key {
        actions = {
            set_mgid_0();
            @defaultonly NoAction();
        }
    ...
    @stage(11) @name(".no_key_2") table no_key_0 {
        actions = {
            clr_mgid_0();
            @defaultonly NoAction();
        }
    ...
    @stage(7) @name(".src_non_overlap_range_table") table src_non_overlap_range_table_0 {
        actions = {
            nop_1();
            set_srange_mdata_0();
            @defaultonly NoAction();
    ...
    @stage(6) @entries_with_ranges(1) @name(".tcam_range_2_fields") table tcam_range_2_fields_0 {
        actions = {
            nop_1();
            hop_ipv4_0();
            @defaultonly NoAction();
    ...
    @stage(5) @name(".tcam_range_ternary_valid") table tcam_range_ternary_valid_0 {
        actions = {
            nop_1();
            hop_ipv4_0();
            @defaultonly NoAction();
        ...
        key = {
            hdr.tcp.isValid(): ternary @name("hdr.tcp.isValid()") ;
            hdr.ipv4.dstAddr : ternary @name("hdr.ipv4.dstAddr") ;
            meta.md.dport    : range @name("meta.md.dport") ;
        }
        size = 1024;
        default_action = NoAction();
    }
    ...
    apply {
        ...
        tcam_range_0.apply();
        tcam_range_ternary_valid_0.apply();
        ipv4_routing_exm_ways_4_pack_4_stage.apply();
        tcam_range_2_fields_0.apply();
        ipv4_routing_exm_ways_5_pack_4_stage.apply();
        src_non_overlap_range_table_0.apply();
        dest_non_overlap_range_table_0.apply();
