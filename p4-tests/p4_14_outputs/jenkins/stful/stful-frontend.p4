...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".ifid_cntr") register<bit<16>>(32w25000) ifid_cntr_0;
    @name(".ob1") register<bit<1>>(32w1000) ob1_0;
    @name(".ob2") register<bit<1>>(32w1000) ob2_0;
    @name(".port_cntr") register<bit<64>>(32w16384) port_cntr_0;
    ...
    @stage(6) @name(".next_hop_ecmp") table next_hop_ecmp_0 {
        actions = {
            set_next_hop_0();
            @defaultonly NoAction();
        }
