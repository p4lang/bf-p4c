...
control computeChecksum(inout headers hdr, inout metadata meta) {
    ...
    apply {
        hdr.ipv4.hdrChecksum = ipv4_chksum_calc.get({ hdr.ipv4.version, hdr.ipv4.ihl, hdr.ipv4.diffserv, hdr.ipv4.totalLen, hdr.ipv4.identification, hdr.ipv4.flags_resv, hdr.ipv4.flags_df, hdr.ipv4.flags_mf, hdr.ipv4.fragOffset, hdr.ipv4.ttl, hdr.ipv4.protocol, hdr.ipv4.srcAddr, hdr.ipv4.dstAddr });
    }
}
