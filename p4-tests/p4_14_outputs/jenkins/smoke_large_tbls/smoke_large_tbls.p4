...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".idle_stats_tbl") table idle_stats_tbl {
        ...
        key = {
            ...
            hdr.vlan_tag.cfi       : ternary;
            hdr.vlan_tag.vlan_id   : ternary;
            hdr.vlan_tag.etherType : ternary;
            ...
            hdr.ipv4.hdrChecksum   : ternary;
            hdr.ipv4.dstAddr       : lpm;
            hdr.ipv4.srcAddr       : ternary;
            hdr.tcp.srcPort        : ternary;
            hdr.tcp.dstPort        : ternary;
            hdr.tcp.seqNo          : ternary;
            hdr.tcp.ackNo          : ternary;
            hdr.tcp.dataOffset     : ternary;
            hdr.tcp.res            : ternary;
            hdr.tcp.ecn            : ternary;
            hdr.tcp.ctrl           : ternary;
            hdr.tcp.window         : ternary;
            hdr.tcp.checksum       : ternary;
            hdr.tcp.urgentPtr      : ternary;
