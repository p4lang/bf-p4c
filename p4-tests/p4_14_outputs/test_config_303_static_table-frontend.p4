...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".et0") table et0_0 {
        ...
        key = {
            meta.meta.bm_0: exact @name("meta.meta.bm_0") ;
            meta.meta.bm_1: exact @name("meta.meta.bm_1") ;
        }
        size = 2048;
    ...
    @name(".et1") table et1_0 {
        ...
        key = {
            hdr.eg_intr_md_from_parser_aux.clone_src: exact @name("hdr.eg_intr_md_from_parser_aux.clone_src") ;
            hdr.eg_intr_md.pkt_length               : exact @name("hdr.eg_intr_md.pkt_length") ;
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".it0") table it0_0 {
        ...
        key = {
            hdr.ethernet.etherType[7:0]: exact @name("hdr.ethernet.etherType[7:0]") ;
        }
        size = 256;
        default_action = NoAction();
    }
