...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".action_1") action action_1(bit<32> param0) {
        hdr.pkt.field_a_32 = (bit<32>)~(param0 & hdr.pkt.field_c_32);
    }
    ...
    @name(".action_3") action action_3() {
        hdr.pkt.field_a_32 = (bit<32>)~hdr.pkt.field_d_32;
    }
    @name(".action_4") action action_4(bit<32> param0) {
        hdr.pkt.field_a_32 = (bit<32>)(hdr.pkt.field_d_32 <= param0 ? hdr.pkt.field_d_32 : param0);
    }
    @name(".action_5") action action_5(bit<32> param0) {
        hdr.pkt.field_a_32 = (bit<32>)(param0 >= hdr.pkt.field_d_32 ? param0 : hdr.pkt.field_d_32);
    }
    @name(".action_6") action action_6() {
        hdr.pkt.field_b_32 = (int<32>)(hdr.pkt.field_d_32 <= (bit<32>)32s7 ? hdr.pkt.field_d_32 : (bit<32>)32s7);
    }
    @name(".action_7") action action_7(int<32> param0) {
        hdr.pkt.field_b_32 = (int<32>)(param0 >= (int<32>)hdr.pkt.field_d_32 ? param0 : (int<32>)hdr.pkt.field_d_32);
    }
    @name(".action_8") action action_8(int<32> param0) {
        hdr.pkt.field_x_32 = (int<32>)(hdr.pkt.field_x_32 >= param0 ? hdr.pkt.field_x_32 : param0);
    }
    @name(".action_9") action action_9() {
        hdr.pkt.field_x_32 = (int<32>)(hdr.pkt.field_x_32 >> 7);
    }
    @name(".action_10") action action_10(bit<32> param0) {
        hdr.pkt.field_a_32 = (bit<32>)(~param0 & hdr.pkt.field_a_32);
    }
