...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".set_hash_1") action set_hash() {
        hash<bit<18>, bit<18>, tuple_0, bit<36>>(meta.meta.hash_1, HashAlgorithm.random, 18w0, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, hdr.tcp.srcPort }, 36w262144);
    }
    @name(".set_hash_2") action set_hash_0() {
        hash<bit<18>, bit<18>, tuple_0, bit<36>>(meta.meta.hash_2, HashAlgorithm.crc32, 18w0, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, hdr.tcp.srcPort }, 36w262144);
    }
