...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".meter_0") direct_meter<bit<4>>(MeterType.bytes) meter_5;
    @name(".meter_2") direct_meter<bit<8>>(MeterType.bytes) meter_6;
    @name(".meter_3") direct_meter<bit<8>>(MeterType.bytes) meter_7;
