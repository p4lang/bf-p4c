...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("stateful_cntr_1") register<bit<16>>(32w4294967295) stateful_cntr;
    @name("stateful_cntr_2") register<bit<16>>(32w4294967295) stateful_cntr_0;
    ...
    @name("match_cntr_2") table match_cntr_0 {
        ...
        key = {
            ...
            meta.meta.count_value: exact @name("meta.meta.count_value") ;
        }
        size = 16384;
        default_action = NoAction();
    }
