...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".assign_egress1_action") action assign_egress1_action() {
        hdr.ig_intr_md_for_tm.ucast_egress_port = (bit<9>)meta.ing_metadata.tmp1;
    }
    @name(".assign_egress2_action") action assign_egress2_action() {
        hdr.ig_intr_md_for_tm.ucast_egress_port = (bit<9>)meta.ing_metadata.tmp2;
    }
    @name(".assign_egress_interfaces") action assign_egress_interfaces(bit<9> value1, bit<9> value2) {
        meta.ing_metadata.tmp1 = (bit<9>)value1;
        meta.ing_metadata.tmp2 = (bit<9>)value2;
    }
