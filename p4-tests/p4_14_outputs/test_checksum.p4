...
control computeChecksum(inout headers hdr, inout metadata meta) {
    apply {
        ...
        update_checksum(meta.csum_ctrl.inner_v4_udp_enable == 1w1, { hdr.inner_ipv4.srcAddr, hdr.inner_ipv4.dstAddr, 8w0, hdr.inner_ipv4.protocol, hdr.inner_udp.srcPort, hdr.inner_udp.dstPort, hdr.inner_udp.len, hdr.inner_udp.checksum }, hdr.inner_udp.checksum, HashAlgorithm.csum16);
        update_checksum(true, { hdr.ipv4.version, hdr.ipv4.ihl, hdr.ipv4.diffserv, hdr.ipv4.totalLen, hdr.ipv4.identification, hdr.ipv4.flags, hdr.ipv4.fragOffset, hdr.ipv4.ttl, hdr.ipv4.protocol, hdr.ipv4.srcAddr, hdr.ipv4.dstAddr }, hdr.ipv4.hdrChecksum, HashAlgorithm.csum16);
        update_checksum(meta.csum_ctrl.v4_tcp_enable == 1w1, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, 8w0, hdr.ipv4.protocol, meta.l4_csum_len.len_delta, hdr.tcp.srcPort, hdr.tcp.dstPort, hdr.tcp.seqNo, hdr.tcp.ackNo, hdr.tcp.dataOffset, hdr.tcp.res, hdr.tcp.flags, hdr.tcp.window, hdr.tcp.urgentPtr }, hdr.tcp.checksum, HashAlgorithm.csum16);
        update_checksum(meta.csum_ctrl.v4_udp_enable == 1w1, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, 8w0, hdr.ipv4.protocol, meta.l4_csum_len.len_delta, hdr.udp.srcPort, hdr.udp.dstPort, hdr.udp.len, hdr.udp.checksum }, hdr.udp.checksum, HashAlgorithm.csum16);
        update_checksum(meta.csum_ctrl.v6_udp_enable == 1w1, { hdr.ipv6.srcAddr, hdr.ipv6.dstAddr, 24w0, hdr.ipv6.nextHdr, hdr.udp.srcPort, hdr.udp.dstPort, hdr.udp.len, hdr.udp.checksum }, hdr.udp.checksum, HashAlgorithm.csum16);
    }
}
