...
control verifyChecksum(inout headers hdr, inout metadata meta) {
    tuple<cesspool, bit<3>, bit<8>, bit<32>> tmp;
    bit<16> tmp_0;
    tuple<bit<7>, bit<32>, bit<5>, int<4>, int<16>, bit<48>, int<16>, bit<5>, int<48>, bit<3>, int<16>> tmp_1;
    int<16> tmp_2;
    apply {
        ...
        tmp = { hdr.airbags, hdr.shamelessness.natty, hdr.jerky.slyer, hdr.shamelessness.placebos };
        tmp_0 = hdr.airbags.nagy;
        verify_checksum<tuple<cesspool, bit<3>, bit<8>, bit<32>>, bit<16>>(true, tmp, tmp_0, HashAlgorithm.csum16);
        ...
        tmp_1 = { hdr.countersignatures.razzed, hdr.shamelessness.placebos, hdr.shamelessness.ordures, hdr.jerky.packinghouses, hdr.countersignatures.extensions, hdr.jerky.commingles, hdr.sapsucker.hatstands, hdr.jerky.epistle, hdr.countersignatures.welcomes, hdr.shamelessness.natty, hdr.shamelessness.dogcarts };
        tmp_2 = hdr.sapsucker.hatstands;
        verify_checksum<tuple<bit<7>, bit<32>, bit<5>, int<4>, int<16>, bit<48>, int<16>, bit<5>, int<48>, bit<3>, int<16>>, int<16>>(true, tmp_1, tmp_2, HashAlgorithm.csum16);
        hdr.sapsucker.hatstands = tmp_2;
    }
}

control computeChecksum(inout headers hdr, inout metadata meta) {
    tuple<bit<7>, bit<32>, bit<5>, int<4>, int<16>, bit<48>, int<16>, bit<5>, int<48>, bit<3>, int<16>> tmp_3;
    int<16> tmp_4;
    tuple<bit<7>, bit<32>, bit<5>, int<4>, int<16>, bit<48>, int<16>, bit<5>, int<48>, bit<3>, int<16>> tmp_5;
    int<16> tmp_6;
    apply {
        update_checksum<tuple<bit<7>, bit<32>, bit<5>, int<4>, int<16>, bit<48>, int<16>, bit<5>, int<48>, bit<3>, int<16>>, bit<16>>(true, { hdr.countersignatures.razzed, hdr.shamelessness.placebos, hdr.shamelessness.ordures, hdr.jerky.packinghouses, hdr.countersignatures.extensions, hdr.jerky.commingles, hdr.sapsucker.hatstands, hdr.jerky.epistle, hdr.countersignatures.welcomes, hdr.shamelessness.natty, hdr.shamelessness.dogcarts }, hdr.airbags.nagy, HashAlgorithm.csum16);
        tmp_3 = { hdr.countersignatures.razzed, hdr.shamelessness.placebos, hdr.shamelessness.ordures, hdr.jerky.packinghouses, hdr.countersignatures.extensions, hdr.jerky.commingles, hdr.sapsucker.hatstands, hdr.jerky.epistle, hdr.countersignatures.welcomes, hdr.shamelessness.natty, hdr.shamelessness.dogcarts };
        tmp_4 = hdr.sapsucker.hatstands;
        update_checksum<tuple<bit<7>, bit<32>, bit<5>, int<4>, int<16>, bit<48>, int<16>, bit<5>, int<48>, bit<3>, int<16>>, int<16>>(true, tmp_3, tmp_4, HashAlgorithm.csum16);
        hdr.sapsucker.hatstands = tmp_4;
        tmp_5 = { hdr.countersignatures.razzed, hdr.shamelessness.placebos, hdr.shamelessness.ordures, hdr.jerky.packinghouses, hdr.countersignatures.extensions, hdr.jerky.commingles, hdr.sapsucker.hatstands, hdr.jerky.epistle, hdr.countersignatures.welcomes, hdr.shamelessness.natty, hdr.shamelessness.dogcarts };
        tmp_6 = hdr.shamelessness.dogcarts;
        update_checksum<tuple<bit<7>, bit<32>, bit<5>, int<4>, int<16>, bit<48>, int<16>, bit<5>, int<48>, bit<3>, int<16>>, int<16>>(true, tmp_5, tmp_6, HashAlgorithm.csum16);
