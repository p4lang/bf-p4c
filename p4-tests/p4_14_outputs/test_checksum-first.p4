...
control computeChecksum(inout headers hdr, inout metadata meta) {
    apply {
        ...
        update_checksum<tuple<bit<32>, bit<32>, bit<8>, bit<8>, bit<16>, bit<16>, bit<16>, bit<16>, bit<16>>, bit<16>>(meta.csum_ctrl.v4_udp_enable == 1w1, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, 8w0, hdr.ipv4.protocol, meta.l4_csum_len.len_delta, hdr.udp.srcPort, hdr.udp.dstPort, hdr.udp.len, hdr.udp.checksum }, hdr.udp.checksum, HashAlgorithm.csum16);
        update_checksum<tuple<bit<128>, bit<128>, bit<24>, bit<8>, bit<16>, bit<16>, bit<16>, bit<16>>, bit<16>>(meta.csum_ctrl.v6_udp_enable == 1w1, { hdr.ipv6.srcAddr, hdr.ipv6.dstAddr, 24w0, hdr.ipv6.nextHdr, hdr.udp.srcPort, hdr.udp.dstPort, hdr.udp.len, hdr.udp.checksum }, hdr.udp.checksum, HashAlgorithm.csum16);
    }
}
