...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".set_hash_1") action set_hash_1() {
        hash(meta.meta.hash_1, HashAlgorithm.random, (bit<18>)0, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, hdr.tcp.srcPort }, (bit<36>)262144);
    }
    @name(".set_hash_2") action set_hash_2() {
        hash(meta.meta.hash_2, HashAlgorithm.crc32, (bit<18>)0, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, hdr.tcp.srcPort }, (bit<36>)262144);
    }
