...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("seq_num_gen") register_action<seq_num_gen_layout, bit<16>>(sflow_state_seq_num) seq_num_gen = {
    ...
    @name("sflow_exp_seq_num") register_action<sflow_exp_seq_num_layout, bit<16>>(sflow_state_exp_seq_num) sflow_exp_seq_num = {
    ...
    @name(".get_sflow_seq_num") action get_sflow_seq_num_0() {
        ...
        meta.meta.sflow_sample_seq_no = (bit<32>)tmp_1;
    }
