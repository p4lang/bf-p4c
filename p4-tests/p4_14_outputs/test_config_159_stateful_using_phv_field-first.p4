...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @stateful_table_counter("table_hit") @name("flow_cnt") register<bit<16>>(32w4294967295) flow_cnt;
    ...
    @name("match_tbl") table match_tbl {
        ...
        key = {
            ...
            hdr.pkt.field_i_16      : exact @name("hdr.pkt.field_i_16") ;
            hdr.pkt.field_j_16      : exact @name("hdr.pkt.field_j_16") ;
