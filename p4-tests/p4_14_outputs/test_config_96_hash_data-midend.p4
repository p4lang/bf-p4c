...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".action_0") action action_0(bit<16> param0) {
        ...
        tmp_0.field = hdr.pkt.field_a_28;
        tmp_0.field_0 = hdr.pkt.field_b_32;
        tmp_0.field_1 = hdr.pkt.field_i_8;
        hash<bit<28>, bit<32>, tuple_0, bit<64>>(tmp, HashAlgorithm.crc32, 32w0, tmp_0, 64w16384);
