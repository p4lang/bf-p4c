...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".rewrite_outer_ethtype") action rewrite_outer_ethtype_0(bit<16> etherType) {
        hdr.outer_etherType.etherType = etherType;
    }
    @name(".rewrite_vlan0_ethtype") action rewrite_vlan0_ethtype_0(bit<16> etherType) {
    ...
    @name(".gtp_tbl") table gtp_tbl {
        ...
        key = {
            hdr.gtpv1_hdr.isValid()    : exact @name("hdr.gtpv1_hdr.isValid()") ;
    ...
    @name(".rewrite_tbl") table rewrite_tbl {
        ...
        key = {
            ...
            meta.meta.mpls_tunnel_type : ternary @name("meta.meta.mpls_tunnel_type") ;
            meta.meta.inner_tunnel_type: ternary @name("meta.meta.inner_tunnel_type") ;
        }
        max_size = 16;
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".set_lb_hashed_index_ipv4") action set_lb_hashed_index_ipv4_0() {
        hash<bit<10>, bit<10>, tuple_0, bit<20>>(meta.meta.lb_hash, HashAlgorithm.crc16, 10w0, { hdr.inner_ipv4.srcAddr, hdr.inner_ipv4.dstAddr }, 20w1024);
    }
    @name(".set_lb_hashed_index_ipv6") action set_lb_hashed_index_ipv6_0() {
        hash<bit<10>, bit<10>, tuple_1, bit<20>>(meta.meta.lb_hash, HashAlgorithm.crc16, 10w0, { hdr.inner_ipv6.srcAddr, hdr.inner_ipv6.dstAddr }, 20w1024);
    }
    @name(".fp_strip") action fp_strip_0() {
    ...
    @name(".geneve_strip") action geneve_strip_0() {
    ...
    @name(".l2gre_decap") action l2gre_decap_0() {
        hdr.outer_macs.setInvalid();
        hdr.outer_etherType.setInvalid();
        hdr.outer_ipv4.setInvalid();
        hdr.gre.setInvalid();
    ...
    @name(".rewrite_outer_dmac") action rewrite_outer_dmac_0(bit<48> mac) {
        hdr.outer_macs.dstAddr[47:40] = mac[47:40];
    }
    @name(".vntag_strip") action vntag_strip_0() {
        hdr.vntag.setInvalid();
    }
    @entries_with_ranges(40) @name(".acl_tbl") table acl_tbl {
        actions = {
            nop_11();
            acl_deny_0();
            acl_permit_0();
        ...
        key = {
            ...
            meta.l3_metadata.lkp_outer_l4_sport: range @name("meta.l3_metadata.lkp_outer_l4_sport") ;
            meta.l3_metadata.lkp_outer_l4_dport: range @name("meta.l3_metadata.lkp_outer_l4_dport") ;
    ...
    @name(".fp_tbl") table fp_tbl {
        ...
        key = {
            hdr.fp_hdr.isValid()       : exact @name("hdr.fp_hdr.isValid()") ;
            hdr.ig_intr_md.ingress_port: exact @name("hdr.ig_intr_md.ingress_port") ;
        }
        max_size = 256;
    ...
    @name(".geneve_tbl") table geneve_tbl {
        ...
        key = {
            hdr.geneve_hdr.isValid()   : exact @name("hdr.geneve_hdr.isValid()") ;
            hdr.ig_intr_md.ingress_port: exact @name("hdr.ig_intr_md.ingress_port") ;
        }
        max_size = 256;
    ...
    @name(".l2gre_decap_tbl") table l2gre_decap_tbl {
        ...
        key = {
            hdr.gre.isValid()          : exact @name("hdr.gre.isValid()") ;
            hdr.ig_intr_md.ingress_port: exact @name("hdr.ig_intr_md.ingress_port") ;
        }
        max_size = 256;
    ...
    @name(".lb_group_tbl_ipv6") table lb_group_tbl_ipv6 {
        ...
        key = {
            hdr.outer_ipv6.srcAddr: ternary @name("hdr.outer_ipv6.srcAddr") ;
        }
        max_size = 16;
    ...
    @name(".lb_weight_tbl") table lb_weight_tbl {
        ...
        key = {
            hdr.gtpv1_hdr.isValid(): exact @name("hdr.gtpv1_hdr.isValid()") ;
            meta.meta.lb_hash      : exact @name("meta.meta.lb_hash") ;
        }
        size = 1024;
    ...
    @name(".mpls_tbl") table mpls_tbl {
        ...
        key = {
            ...
            meta.meta.pw_ctrl_word_present: exact @name("meta.meta.pw_ctrl_word_present") ;
            meta.meta.mpls_tunnel_type    : exact @name("meta.meta.mpls_tunnel_type") ;
        }
        max_size = 16;
    ...
    @name(".rewrite_dmac_tbl") table rewrite_dmac_tbl {
        ...
        key = {
            hdr.gtpv1_hdr.isValid()    : exact @name("hdr.gtpv1_hdr.isValid()") ;
            meta.meta.inner_tunnel_type: exact @name("meta.meta.inner_tunnel_type") ;
            meta.meta.lb_type          : exact @name("meta.meta.lb_type") ;
            meta.meta.lb_port_group    : exact @name("meta.meta.lb_port_group") ;
        }
        max_size = 64;
    ...
    @name(".vntag_tbl") table vntag_tbl {
        ...
        key = {
            hdr.vntag.isValid()        : exact @name("hdr.vntag.isValid()") ;
            hdr.ig_intr_md.ingress_port: exact @name("hdr.ig_intr_md.ingress_port") ;
        }
        max_size = 256;
...
control DeparserImpl(packet_out packet, in headers hdr) {
    apply {
        ...
        packet.emit<mpls_t>(hdr.mpls[5]);
        packet.emit<mpls_t>(hdr.mpls[6]);
        packet.emit<mpls_t>(hdr.mpls[7]);
