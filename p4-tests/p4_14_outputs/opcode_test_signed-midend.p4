...
struct headers {
    @pa_container_size("ingress", "data.b1", 8) @pa_container_size("ingress", "data.h1", 16) @pa_container_size("ingress", "data.f1", 32) @name(".data") 
    data_t                                         data;
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".a16bit_shrs") action a16bit_shrs_0() {
        hdr.data.h1 = hdr.data.h1 >> 3;
    }
    @name(".a16bit_mins") action a16bit_mins_0(int<16> value) {
        tmp_5 = (hdr.data.h1 <= value ? hdr.data.h1 : tmp_5);
        tmp_5 = (!(hdr.data.h1 <= value) ? value : tmp_5);
        hdr.data.h1 = tmp_5;
    }
    @name(".a16bit_maxs") action a16bit_maxs_0(int<16> value) {
        tmp_6 = (hdr.data.h1 >= value ? hdr.data.h1 : tmp_6);
        tmp_6 = (!(hdr.data.h1 >= value) ? value : tmp_6);
        hdr.data.h1 = tmp_6;
    }
    ...
    @name(".a32bit_shrs") action a32bit_shrs_0() {
        hdr.data.f1 = hdr.data.f1 >> 3;
    }
    @name(".a32bit_mins") action a32bit_mins_0(int<32> value) {
        tmp_7 = (hdr.data.f1 <= value ? hdr.data.f1 : tmp_7);
        tmp_7 = (!(hdr.data.f1 <= value) ? value : tmp_7);
        hdr.data.f1 = tmp_7;
    }
    @name(".a32bit_maxs") action a32bit_maxs_0(int<32> value) {
        tmp_8 = (hdr.data.f1 >= value ? hdr.data.f1 : tmp_8);
        tmp_8 = (!(hdr.data.f1 >= value) ? value : tmp_8);
        hdr.data.f1 = tmp_8;
    }
    @name(".a8bit_shrs") action a8bit_shrs_0() {
        hdr.data.b1 = hdr.data.b1 >> 3;
    }
    @name(".a8bit_mins") action a8bit_mins_0(int<8> value) {
        tmp_9 = (hdr.data.b1 <= value ? hdr.data.b1 : tmp_9);
        tmp_9 = (!(hdr.data.b1 <= value) ? value : tmp_9);
        hdr.data.b1 = tmp_9;
    }
    @name(".a8bit_maxs") action a8bit_maxs_0(int<8> value) {
        tmp_10 = (hdr.data.b1 >= value ? hdr.data.b1 : tmp_10);
        tmp_10 = (!(hdr.data.b1 >= value) ? value : tmp_10);
        hdr.data.b1 = tmp_10;
    }
    ...
    @name(".t16bit") table t16bit {
        ...
        key = {
            hdr.data.code: exact @name("data.code") ;
        }
