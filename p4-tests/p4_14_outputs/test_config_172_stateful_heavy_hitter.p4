...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".set_hash_3") action set_hash_3() {
        hash(meta.meta.hash_3, HashAlgorithm.identity, (bit<32>)0, { hdr.ipv4.srcAddr }, (bit<64>)4294967296);
    }
    @name(".set_hash_1_and_2") action set_hash_1_and_2() {
        hash(meta.meta.hash_1, HashAlgorithm.crc16, (bit<12>)0, { hdr.ipv4.srcAddr }, (bit<24>)4096);
        hash(meta.meta.hash_2, custom_hash("crc16_msb"), (bit<12>)0, { hdr.ipv4.srcAddr }, (bit<24>)4096);
    }
    ...
    @name(".react") table react {
        ...
        key = {
            meta.meta.is_not_heavy_hitter: exact;
        }
    }
