...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name("port_status_alu") register_action<bit<1>, bit<1>>(lag_mbrs_0) port_status_alu_0 = {
    ...
    @name(".lag_group") table lag_group_0 {
        ...
        key = {
            meta.meta.egress_ifindex: exact @name("meta.meta.egress_ifindex") ;
            ...
            hdr.tcp.srcPort         : selector @name("hdr.tcp.srcPort") ;
            hdr.tcp.dstPort         : selector @name("hdr.tcp.dstPort") ;
        }
    ...
    @name(".lag_group_fast_update") table lag_group_fast_update_0 {
        ...
        key = {
            meta.meta.down_port  : exact @name("meta.meta.down_port") ;
            meta.meta.instance_id: exact @name("meta.meta.instance_id") ;
        }
        default_action = NoAction();
    }
    apply {
