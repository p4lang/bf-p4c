...
@name(".cntr_1_math_unit") math_unit<bit<16>, tuple_0>(true, -2s1, 6s4, { 16w0xf, 16w14, 16w13, 16w0xc, 16w0xb, 16w10, 16w9, 16w8, 16w7, 16w6, 16w5, 16w4, 16w3, 16w2, 16w1, 16w0 }) cntr_1_math_unit;
