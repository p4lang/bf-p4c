...
control egress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".mirror_eg1") action mirror_eg1() {
        clone3<tuple<bit<8>, bit<8>>>(CloneType.E2E, 32w4, { meta.meta.m1, meta.meta.m2 });
    }
    @name(".mirror_eg2") action mirror_eg2() {
        clone3<tuple<bit<8>, bit<8>>>(CloneType.E2E, 32w5, { meta.meta.m3, meta.meta.m4 });
    }
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".mirror_ig1") action mirror_ig1() {
        clone3<tuple<bit<8>, bit<8>>>(CloneType.I2E, 32w1, { meta.meta.m1, meta.meta.m2 });
    }
    @name(".mirror_ig2") action mirror_ig2() {
        clone3<tuple<bit<8>, bit<8>>>(CloneType.I2E, 32w2, { meta.meta.m3, meta.meta.m4 });
    }
