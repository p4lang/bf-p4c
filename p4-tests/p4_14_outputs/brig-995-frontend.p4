...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".set_bd_properties") action _set_bd_properties_0(bit<14> bd, bit<8> vrf, bit<8> stp_group, bit<8> learning_enabled, bit<8> bd_label, bit<8> stats_idx, bit<8> rmac_group, bit<8> ipv4_unicast_enabled, bit<8> ipv6_unicast_enabled, bit<8> ipv4_urpf_mode, bit<8> ipv6_urpf_mode, bit<8> igmp_snooping_enabled, bit<8> mld_snooping_enabled, bit<8> ipv4_multicast_enabled, bit<8> ipv6_multicast_enabled, bit<8> mrpf_group, bit<8> ipv4_mcast_key, bit<8> ipv4_mcast_key_type, bit<8> ipv6_mcast_key, bit<8> ipv6_mcast_key_type, bit<16> ingress_rid) {
        hdr.ingress_metadata.bd = bd;
        hdr.ig_intr_md_for_tm.rid = ingress_rid;
    }
    @name(".set_bd_properties") action _set_bd_properties_2(bit<14> bd, bit<8> vrf, bit<8> stp_group, bit<8> learning_enabled, bit<8> bd_label, bit<8> stats_idx, bit<8> rmac_group, bit<8> ipv4_unicast_enabled, bit<8> ipv6_unicast_enabled, bit<8> ipv4_urpf_mode, bit<8> ipv6_urpf_mode, bit<8> igmp_snooping_enabled, bit<8> mld_snooping_enabled, bit<8> ipv4_multicast_enabled, bit<8> ipv6_multicast_enabled, bit<8> mrpf_group, bit<8> ipv4_mcast_key, bit<8> ipv4_mcast_key_type, bit<8> ipv6_mcast_key, bit<8> ipv6_mcast_key_type, bit<16> ingress_rid) {
        hdr.ingress_metadata.bd = bd;
        hdr.ig_intr_md_for_tm.rid = ingress_rid;
    }
    ...
    @name(".port_vlan_to_bd_mapping") table _port_vlan_to_bd_mapping {
        ...
        key = {
            hdr.ingress_metadata.port_lag_index: ternary @name("ingress_metadata.port_lag_index") ;
