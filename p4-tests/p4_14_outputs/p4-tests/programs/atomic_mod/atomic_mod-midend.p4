...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".set_dmac") action set_dmac_6(bit<48> d) {
        hdr.ethernet.dstAddr = d;
    }
    @name(".set_dmac") action set_dmac_7(bit<48> d) {
        hdr.ethernet.dstAddr = d;
    }
    ...
    @name(".set_smac") action set_smac_6(bit<48> s) {
        hdr.ethernet.srcAddr = s;
    }
    @name(".set_smac") action set_smac_7(bit<48> s) {
        hdr.ethernet.srcAddr = s;
    }
    ...
    @name(".set_dmac_ipv6") action set_dmac_ipv6_2(bit<48> dmac, bit<128> daddr) {
        hdr.ethernet.dstAddr = dmac;
        hdr.ipv6.dstAddr = daddr;
    }
