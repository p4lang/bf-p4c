...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @stage(1) @name(".set_eg") table set_eg {
        ...
        key = {
            hdr.ig_intr_md_for_tm.level2_exclusion_id: exact;
            hdr.ig_intr_md_for_tm.qid                : exact;
            hdr.ig_intr_md_for_tm.ingress_cos        : exact;
            hdr.ig_intr_md_for_tm.rid                : exact;
            hdr.ig_intr_md_for_tm.level1_mcast_hash  : exact;
        }
        size = 288;
    }
