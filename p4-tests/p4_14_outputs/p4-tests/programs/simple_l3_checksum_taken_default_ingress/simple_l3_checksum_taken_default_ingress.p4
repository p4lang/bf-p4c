...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".parse_ipv4_no_options") state parse_ipv4_no_options {
        meta.l4_lookup.word_1 = (packet.lookahead<bit<16>>())[15:0];
        meta.l4_lookup.word_2 = (packet.lookahead<bit<32>>())[15:0];
    ...
    @name(".parse_ipv4_options_1") state parse_ipv4_options_1 {
        packet.extract(hdr.ipv4_option_word_1);
        meta.l4_lookup.word_1 = (packet.lookahead<bit<16>>())[15:0];
        meta.l4_lookup.word_2 = (packet.lookahead<bit<32>>())[15:0];
        transition select(hdr.ipv4.fragOffset, hdr.ipv4.protocol) {
            (13w0x0, 8w0x1): parse_icmp;
    ...
    @name(".parse_ipv4_options_10") state parse_ipv4_options_10 {
        packet.extract(hdr.ipv4_option_word_1);
        packet.extract(hdr.ipv4_option_word_2);
        packet.extract(hdr.ipv4_option_word_3);
        packet.extract(hdr.ipv4_option_word_4);
        packet.extract(hdr.ipv4_option_word_5);
        packet.extract(hdr.ipv4_option_word_6);
        packet.extract(hdr.ipv4_option_word_7);
        packet.extract(hdr.ipv4_option_word_8);
        packet.extract(hdr.ipv4_option_word_9);
        packet.extract(hdr.ipv4_option_word_10);
        meta.l4_lookup.word_1 = (packet.lookahead<bit<16>>())[15:0];
        meta.l4_lookup.word_2 = (packet.lookahead<bit<32>>())[15:0];
        transition select(hdr.ipv4.fragOffset, hdr.ipv4.protocol) {
            (13w0x0, 8w0x1): parse_icmp;
    ...
    @name(".parse_tcp_v4") state parse_tcp_v4 {
        ...
        packet.extract(hdr.tcp_checksum_v4);
        transition parse_first_fragment;
    }
    @name(".parse_tcp_v6") state parse_tcp_v6 {
        packet.extract(hdr.tcp);
        packet.extract(hdr.tcp_checksum_v6);
        transition parse_first_fragment;
    }
    @name(".parse_udp_v4") state parse_udp_v4 {
        packet.extract(hdr.udp);
        packet.extract(hdr.udp_checksum_v4);
        transition parse_first_fragment;
    }
    @name(".parse_udp_v6") state parse_udp_v6 {
        packet.extract(hdr.udp);
        packet.extract(hdr.udp_checksum_v6);
        transition parse_first_fragment;
    }
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".ipv4_acl") table ipv4_acl {
        ...
        key = {
            ...
            hdr.ig_intr_md_from_parser_aux.ingress_parser_err: ternary;
        }
        size = 1024;
    }
    @name(".ipv4_l4_acl") table ipv4_l4_acl {
        actions = {
            send;
            discard;
            l3_forward_v4;
...
control DeparserImpl(packet_out packet, in headers hdr) {
    apply {
        ...
        packet.emit(hdr.ipv4_option_word_1);
        packet.emit(hdr.ipv4_option_word_2);
        packet.emit(hdr.ipv4_option_word_3);
        packet.emit(hdr.ipv4_option_word_4);
        packet.emit(hdr.ipv4_option_word_5);
        packet.emit(hdr.ipv4_option_word_6);
        packet.emit(hdr.ipv4_option_word_7);
        packet.emit(hdr.ipv4_option_word_8);
        packet.emit(hdr.ipv4_option_word_9);
        packet.emit(hdr.ipv4_option_word_10);
        packet.emit(hdr.udp);
        packet.emit(hdr.udp_checksum_v6);
        packet.emit(hdr.udp_checksum_v4);
        packet.emit(hdr.tcp);
        packet.emit(hdr.tcp_checksum_v6);
        packet.emit(hdr.tcp_checksum_v4);
...
control computeChecksum(inout headers hdr, inout metadata meta) {
    apply {
        update_checksum(meta.meta.ipv4_checksum_update == 1w1, { hdr.ipv4.version, hdr.ipv4.ihl, hdr.ipv4.diffserv, hdr.ipv4.totalLen, hdr.ipv4.identification, hdr.ipv4.flags, hdr.ipv4.fragOffset, hdr.ipv4.ttl, hdr.ipv4.protocol, hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, hdr.ipv4_option_word_1.data, hdr.ipv4_option_word_2.data, hdr.ipv4_option_word_3.data, hdr.ipv4_option_word_4.data, hdr.ipv4_option_word_5.data, hdr.ipv4_option_word_6.data, hdr.ipv4_option_word_7.data, hdr.ipv4_option_word_8.data, hdr.ipv4_option_word_9.data, hdr.ipv4_option_word_10.data }, hdr.ipv4.hdrChecksum, HashAlgorithm.csum16);
        update_checksum_with_payload(true, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, 8w0, hdr.ipv4.protocol, hdr.ipv4.totalLen, hdr.tcp.srcPort, hdr.tcp.dstPort, hdr.tcp.seqNo, hdr.tcp.ackNo, hdr.tcp.dataOffset, hdr.tcp.res, hdr.tcp.flags, hdr.tcp.window, hdr.tcp_checksum_v4.urgentPtr }, hdr.tcp_checksum_v4.checksum, HashAlgorithm.csum16);
        update_checksum_with_payload(true, { hdr.ipv6.srcAddr, hdr.ipv6.dstAddr, hdr.ipv6.payloadLen, 8w0, hdr.ipv6.nextHdr, hdr.tcp.srcPort, hdr.tcp.dstPort, hdr.tcp.seqNo, hdr.tcp.ackNo, hdr.tcp.dataOffset, hdr.tcp.res, hdr.tcp.flags, hdr.tcp.window, hdr.tcp_checksum_v6.urgentPtr }, hdr.tcp_checksum_v6.checksum, HashAlgorithm.csum16);
        update_checksum_with_payload(true, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, 8w0, hdr.ipv4.protocol, hdr.ipv4.totalLen, hdr.udp.srcPort, hdr.udp.dstPort }, hdr.udp_checksum_v4.checksum, HashAlgorithm.csum16);
        update_checksum_with_payload(true, { hdr.ipv6.srcAddr, hdr.ipv6.dstAddr, hdr.ipv6.payloadLen, 8w0, hdr.ipv6.nextHdr, hdr.udp.srcPort, hdr.udp.dstPort }, hdr.udp_checksum_v6.checksum, HashAlgorithm.csum16);
    }
}
