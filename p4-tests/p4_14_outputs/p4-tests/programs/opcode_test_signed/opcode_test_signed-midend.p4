...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".a16bit_mins") action a16bit_mins(int<16> value) {
        tmp = (hdr.ipv4.identification <= value ? hdr.ipv4.identification : tmp);
        tmp = (!(hdr.ipv4.identification <= value) ? value : tmp);
        hdr.ipv4.identification = tmp;
    }
    @name(".a16bit_maxs") action a16bit_maxs(int<16> value) {
        tmp_0 = (hdr.ipv4.identification >= value ? hdr.ipv4.identification : tmp_0);
        tmp_0 = (!(hdr.ipv4.identification >= value) ? value : tmp_0);
    ...
    @name(".a32bit_mins") action a32bit_mins(int<32> value) {
        tmp_1 = (hdr.ipv4.dstAddr <= value ? hdr.ipv4.dstAddr : tmp_1);
        tmp_1 = (!(hdr.ipv4.dstAddr <= value) ? value : tmp_1);
        hdr.ipv4.dstAddr = tmp_1;
    }
    @name(".a32bit_maxs") action a32bit_maxs(int<32> value) {
        tmp_2 = (hdr.ipv4.dstAddr >= value ? hdr.ipv4.dstAddr : tmp_2);
        tmp_2 = (!(hdr.ipv4.dstAddr >= value) ? value : tmp_2);
    ...
    @name(".a8bit_mins") action a8bit_mins(int<8> value) {
        tmp_3 = (hdr.ipv4.diffserv <= value ? hdr.ipv4.diffserv : tmp_3);
        tmp_3 = (!(hdr.ipv4.diffserv <= value) ? value : tmp_3);
        hdr.ipv4.diffserv = tmp_3;
    }
    @name(".a8bit_maxs") action a8bit_maxs(int<8> value) {
        tmp_4 = (hdr.ipv4.diffserv >= value ? hdr.ipv4.diffserv : tmp_4);
        tmp_4 = (!(hdr.ipv4.diffserv >= value) ? value : tmp_4);
