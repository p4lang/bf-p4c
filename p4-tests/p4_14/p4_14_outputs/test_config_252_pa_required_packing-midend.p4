...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".set_m2") action set_m2() {
        meta.m2.p = hdr.vlan2.priority;
        meta.m2.c = hdr.vlan2.cfi;
        meta.m2.v = hdr.vlan2.vid;
        meta.m2.t = hdr.vlan2.vtype;
    }
    ...
    @name(".t5") table t5_0 {
        ...
        key = {
            ...
            meta.m.c : exact @name("m.c") ;
            meta.m.v : exact @name("m.v") ;
            meta.m.t : exact @name("m.t") ;
            meta.m2.p: exact @name("m2.p") ;
            meta.m2.c: exact @name("m2.c") ;
            meta.m2.v: exact @name("m2.v") ;
