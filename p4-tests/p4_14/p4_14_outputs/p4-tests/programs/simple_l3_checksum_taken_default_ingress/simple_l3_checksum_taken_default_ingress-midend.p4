...
control computeChecksum(inout headers hdr, inout metadata meta) {
    apply {
        update_checksum<tuple_0, bit<16>>(meta.meta.ipv4_checksum_update == 1w1, { hdr.ipv4.version, hdr.ipv4.ihl, hdr.ipv4.diffserv, hdr.ipv4.totalLen, hdr.ipv4.identification, hdr.ipv4.flags, hdr.ipv4.fragOffset, hdr.ipv4.ttl, hdr.ipv4.protocol, hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, hdr.ipv4_option_word_1.data, hdr.ipv4_option_word_2.data, hdr.ipv4_option_word_3.data, hdr.ipv4_option_word_4.data, hdr.ipv4_option_word_5.data, hdr.ipv4_option_word_6.data, hdr.ipv4_option_word_7.data, hdr.ipv4_option_word_8.data, hdr.ipv4_option_word_9.data, hdr.ipv4_option_word_10.data }, hdr.ipv4.hdrChecksum, HashAlgorithm.csum16);
        update_checksum_with_payload<tuple_1, bit<16>>(true, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, 8w0, hdr.ipv4.protocol, hdr.ipv4.totalLen, hdr.tcp.srcPort, hdr.tcp.dstPort, hdr.tcp.seqNo, hdr.tcp.ackNo, hdr.tcp.dataOffset, hdr.tcp.res, hdr.tcp.flags, hdr.tcp.window, hdr.tcp_checksum_v4.urgentPtr }, hdr.tcp_checksum_v4.checksum, HashAlgorithm.csum16);
        update_checksum_with_payload<tuple_2, bit<16>>(true, { hdr.ipv6.srcAddr, hdr.ipv6.dstAddr, hdr.ipv6.payloadLen, 8w0, hdr.ipv6.nextHdr, hdr.tcp.srcPort, hdr.tcp.dstPort, hdr.tcp.seqNo, hdr.tcp.ackNo, hdr.tcp.dataOffset, hdr.tcp.res, hdr.tcp.flags, hdr.tcp.window, hdr.tcp_checksum_v6.urgentPtr }, hdr.tcp_checksum_v6.checksum, HashAlgorithm.csum16);
        update_checksum_with_payload<tuple_3, bit<16>>(true, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, 8w0, hdr.ipv4.protocol, hdr.ipv4.totalLen, hdr.udp.srcPort, hdr.udp.dstPort }, hdr.udp_checksum_v4.checksum, HashAlgorithm.csum16);
        update_checksum_with_payload<tuple_4, bit<16>>(true, { hdr.ipv6.srcAddr, hdr.ipv6.dstAddr, hdr.ipv6.payloadLen, 8w0, hdr.ipv6.nextHdr, hdr.udp.srcPort, hdr.udp.dstPort }, hdr.udp_checksum_v6.checksum, HashAlgorithm.csum16);
    }
}
