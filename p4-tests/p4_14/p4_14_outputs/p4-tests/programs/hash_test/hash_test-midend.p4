...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".a0") action a0_0() {
        hash<bit<32>, bit<32>, tuple_0, bit<64>>(meta.meta.calc1, HashAlgorithm.identity, 32w0, { hdr.ipv4.dstAddr }, 64w4294967296);
    }
    @name(".a1a") action a1a_0() {
        hash<bit<32>, bit<32>, tuple_0, bit<64>>(hdr.ipv4.srcAddr, HashAlgorithm.crc32, 32w0, { hdr.ipv4.dstAddr }, 64w4294967296);
    }
    @name(".a1b") action a1b_0() {
        tmp_1 = custom_hash<>("poly_0x11021_not_rev");
        hash<bit<32>, bit<16>, tuple_0, bit<32>>(hdr.ipv4.srcAddr, tmp_1, 16w0, { hdr.ipv4.dstAddr }, 32w65536);
    }
