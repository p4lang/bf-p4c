...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".a16bit_max") action a16bit_max_0(bit<16> value) {
        tmp_5 = (hdr.ipv4.identification >= value ? hdr.ipv4.identification : tmp_5);
        tmp_5 = (!(hdr.ipv4.identification >= value) ? value : tmp_5);
        hdr.ipv4.identification = tmp_5;
    }
    @name(".a16bit_min") action a16bit_min_0(bit<16> value) {
        tmp_6 = (hdr.ipv4.identification <= value ? hdr.ipv4.identification : tmp_6);
        tmp_6 = (!(hdr.ipv4.identification <= value) ? value : tmp_6);
    ...
    @name(".a32bit_max") action a32bit_max_0(bit<32> value) {
        tmp_7 = (hdr.ipv4.dstAddr >= value ? hdr.ipv4.dstAddr : tmp_7);
        tmp_7 = (!(hdr.ipv4.dstAddr >= value) ? value : tmp_7);
        hdr.ipv4.dstAddr = tmp_7;
    }
    @name(".a32bit_min") action a32bit_min_0(bit<32> value) {
        tmp_8 = (hdr.ipv4.dstAddr <= value ? hdr.ipv4.dstAddr : tmp_8);
        tmp_8 = (!(hdr.ipv4.dstAddr <= value) ? value : tmp_8);
    ...
    @name(".a8bit_max") action a8bit_max_0(bit<8> value) {
        tmp_9 = (hdr.ipv4.diffserv >= value ? hdr.ipv4.diffserv : tmp_9);
        tmp_9 = (!(hdr.ipv4.diffserv >= value) ? value : tmp_9);
        hdr.ipv4.diffserv = tmp_9;
    }
    @name(".a8bit_min") action a8bit_min_0(bit<8> value) {
        tmp_10 = (hdr.ipv4.diffserv <= value ? hdr.ipv4.diffserv : tmp_10);
        tmp_10 = (!(hdr.ipv4.diffserv <= value) ? value : tmp_10);
...
control computeChecksum(inout headers hdr, inout metadata meta) {
    apply {
        ...
        update_checksum_with_payload<tuple_1, bit<16>>(true, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, 8w0, hdr.ipv4.protocol, hdr.tcp.srcPort, hdr.tcp.dstPort, hdr.tcp.seqNo, hdr.tcp.ackNo, hdr.tcp.dataOffset, hdr.tcp.res, hdr.tcp.flags, hdr.tcp.window, hdr.tcp.urgentPtr }, hdr.tcp.checksum, HashAlgorithm.csum16);
    }
}
