...
control computeChecksum(inout headers hdr, inout metadata meta) {
    apply {
        update_checksum<tuple<bit<32>, bit<32>, bit<32>, bit<32>, bit<32>, bit<32>>, bit<16>>(true, { hdr.data2.f1, hdr.data2.f2, hdr.data2.f3, hdr.data2.f4, hdr.data2.f5, hdr.data2.f6 }, hdr.data2.cksum, HashAlgorithm.csum16);
    }
}
