...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Leoma") RegisterAction<bit<1>, bit<32>, bit<1>>(Helotes) _Leoma = {
        void apply(inout bit<1> value, out bit<1> rv) {
            ...
            value = _Montegut_in_value;
            rv = ~_Montegut_in_value;
        }
    };
    @name(".Rodessa") RegisterAction<bit<1>, bit<32>, bit<1>>(Bloomdale) _Rodessa = {
        void apply(inout bit<1> value, out bit<1> rv) {
            bit<1> _Montegut_in_value_0;
            _Montegut_in_value_0 = value;
            value = _Montegut_in_value_0;
            rv = value;
        }
    };
    ...
    @name(".Cutler") action _Cutler_0() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_Montegut_temp, HashAlgorithm.identity, 18w0, { meta.Ulysses.Chehalis, hdr.Pineville[0].Doyline }, 19w262144);
    ...
    @name(".Powelton") action _Powelton_0() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_Montegut_temp_0, HashAlgorithm.identity, 18w0, { meta.Ulysses.Chehalis, hdr.Pineville[0].Doyline }, 19w262144);
