...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Lansing") action _Lansing() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_Rockville_temp_1, HashAlgorithm.identity, 18w0, { meta.Orrum.Hobucken, hdr.Basalt[0].Montague }, 19w262144);
    ...
    @name(".Brainard") action _Brainard() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_Rockville_temp_2, HashAlgorithm.identity, 18w0, { meta.Orrum.Hobucken, hdr.Basalt[0].Montague }, 19w262144);
    ...
    apply {
        ...
        if (meta.Mantee.Alameda == 1w0 && meta.Mantee.Fries == 1w0 && meta.UtePark.Headland == 1w1 && meta.Waialua.Fleetwood == 1w1) {
            _Haley_tmp_0 = _Anguilla_0.apply().hit;
            if (_Haley_tmp_0) 
                _Lansdowne_0.apply();
        }
