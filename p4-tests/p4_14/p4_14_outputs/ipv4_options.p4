...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".parse_ether") state parse_ether {
    ...
    @name(".parse_ipv4_options_12b") state parse_ipv4_options_12b {
        packet.extract(hdr.ipv4_options_12b);
    ...
    @name(".parse_ipv4_options_16b") state parse_ipv4_options_16b {
        packet.extract(hdr.ipv4_options_16b);
        transition select(hdr.ipv4.fragOffset, hdr.ipv4.protocol) {
            (13w0, 8w1): parse_icmp;
            (13w0, 8w6): parse_tcp;
            (13w0, 8w17): parse_udp;
    ...
    @name(".parse_ipv4_options_20b") state parse_ipv4_options_20b {
        packet.extract(hdr.ipv4_options_20b);
        transition select(hdr.ipv4.fragOffset, hdr.ipv4.protocol) {
            (13w0, 8w1): parse_icmp;
            (13w0, 8w6): parse_tcp;
            (13w0, 8w17): parse_udp;
    ...
    @name(".parse_ipv4_options_24b") state parse_ipv4_options_24b {
        packet.extract(hdr.ipv4_options_24b);
        transition select(hdr.ipv4.fragOffset, hdr.ipv4.protocol) {
            (13w0, 8w1): parse_icmp;
            (13w0, 8w6): parse_tcp;
            (13w0, 8w17): parse_udp;
    ...
    @name(".parse_ipv4_options_28b") state parse_ipv4_options_28b {
        packet.extract(hdr.ipv4_options_28b);
        transition select(hdr.ipv4.fragOffset, hdr.ipv4.protocol) {
            (13w0, 8w1): parse_icmp;
            (13w0, 8w6): parse_tcp;
            (13w0, 8w17): parse_udp;
    ...
    @name(".parse_ipv4_options_36b") state parse_ipv4_options_36b {
        packet.extract(hdr.ipv4_options_36b);
        transition select(hdr.ipv4.fragOffset, hdr.ipv4.protocol) {
            (13w0, 8w1): parse_icmp;
            (13w0, 8w6): parse_tcp;
            (13w0, 8w17): parse_udp;
    ...
    @name(".parse_ipv4_options_40b") state parse_ipv4_options_40b {
        packet.extract(hdr.ipv4_options_40b);
        transition select(hdr.ipv4.fragOffset, hdr.ipv4.protocol) {
            (13w0, 8w1): parse_icmp;
            (13w0, 8w6): parse_tcp;
            (13w0, 8w17): parse_udp;
    ...
    @name(".parse_ipv4_options_4b") state parse_ipv4_options_4b {
        packet.extract(hdr.ipv4_options_4b);
        transition select(hdr.ipv4.fragOffset, hdr.ipv4.protocol) {
            (13w0, 8w1): parse_icmp;
            (13w0, 8w6): parse_tcp;
            (13w0, 8w17): parse_udp;
    ...
    @name(".parse_ipv4_options_8b") state parse_ipv4_options_8b {
        packet.extract(hdr.ipv4_options_8b);
        transition select(hdr.ipv4.fragOffset, hdr.ipv4.protocol) {
            (13w0, 8w1): parse_icmp;
            (13w0, 8w6): parse_tcp;
            (13w0, 8w17): parse_udp;
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".show_parser_error") action show_parser_error() {
        hdr.ether.mac_da = (bit<48>)hdr.ig_intr_md_from_parser_aux.ingress_parser_err;
        hdr.ig_intr_md_for_tm.ucast_egress_port = 9w0;
    }
    @name(".show_parser_error") table show_parser_error_0 {
        actions = {
            show_parser_error;
        }
        size = 1;
...
control DeparserImpl(packet_out packet, in headers hdr) {
    apply {
        ...
        packet.emit(hdr.etherII);
        packet.emit(hdr.ipv6);
        packet.emit(hdr.ipv4);
        packet.emit(hdr.ipv4_options_40b);
        packet.emit(hdr.ipv4_options_36b);
        packet.emit(hdr.ipv4_options_32b);
        packet.emit(hdr.ipv4_options_28b);
        packet.emit(hdr.ipv4_options_24b);
        packet.emit(hdr.ipv4_options_20b);
        packet.emit(hdr.ipv4_options_16b);
        packet.emit(hdr.ipv4_options_12b);
        packet.emit(hdr.ipv4_options_8b);
        packet.emit(hdr.ipv4_options_4b);
        packet.emit(hdr.udp);
        packet.emit(hdr.tcp);
...
control verifyChecksum(inout headers hdr, inout metadata meta) {
    apply {
        verify_checksum(true, { hdr.ipv4.version, hdr.ipv4.ihl, hdr.ipv4.diffserv, hdr.ipv4.totalLen, hdr.ipv4.identification, hdr.ipv4.flags, hdr.ipv4.fragOffset, hdr.ipv4.ttl, hdr.ipv4.protocol, hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, hdr.ipv4_options_4b.options, hdr.ipv4_options_8b.options, hdr.ipv4_options_12b.options, hdr.ipv4_options_16b.options, hdr.ipv4_options_20b.options, hdr.ipv4_options_24b.options, hdr.ipv4_options_28b.options, hdr.ipv4_options_32b.options, hdr.ipv4_options_40b.options }, hdr.ipv4.hdrChecksum, HashAlgorithm.csum16);
    }
}
