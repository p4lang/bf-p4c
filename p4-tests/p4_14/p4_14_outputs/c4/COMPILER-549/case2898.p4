...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".set_lb_hashed_index_ipv4") action set_lb_hashed_index_ipv4() {
        hash(meta.meta.lb_hash, HashAlgorithm.crc16, (bit<4>)0, { hdr.inner_ipv4.srcAddr, hdr.inner_ipv4.dstAddr }, (bit<8>)16);
    }
    @name(".set_lb_hashed_index_ipv6") action set_lb_hashed_index_ipv6() {
        hash(meta.meta.lb_hash, HashAlgorithm.crc16, (bit<4>)0, { hdr.inner_ipv6.srcAddr, hdr.inner_ipv6.dstAddr }, (bit<8>)16);
    }
