...
action mod_mac_addr(egress_port, dstmac) {
    modify_field(ig_intr_md_for_tm.ucast_egress_port, egress_port);
    modify_field(ethernet.dstAddr, dstmac);
}
...
table exm_2ways_4Entries_stage_5 {
    reads {
        ipv4.dstAddr : exact;
        ethernet.dstAddr : exact;
    }
