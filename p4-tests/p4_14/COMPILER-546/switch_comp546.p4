...
# 382 "../../p4c-tofino/p4c_tofino/target/tofino/p4_lib/tofino/intrinsic_metadata.p4"
...
# 425 "../../p4c-tofino/p4c_tofino/target/tofino/p4_lib/tofino/intrinsic_metadata.p4"
        force_tx_error : 1;
...
# 31 "switch.p4" 2
# 1 "../../p4c-tofino/p4c_tofino/target/tofino/p4_lib/tofino/primitives.p4" 1
# 10 "../../p4c-tofino/p4c_tofino/target/tofino/p4_lib/tofino/primitives.p4"
action deflect_on_drop(enable_dod) {
    modify_field(ig_intr_md_for_tm.deflect_on_drop, enable_dod);
}
# 32 "switch.p4" 2
# 1 "../../p4c-tofino/p4c_tofino/target/tofino/p4_lib/tofino/pktgen_headers.p4" 1
...
# 33 "switch.p4" 2
# 1 "../../p4c-tofino/p4c_tofino/target/tofino/p4_lib/tofino/stateful_alu_blackbox.p4" 1
...
# 81 "../../p4c-tofino/p4c_tofino/target/tofino/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: expression;
        expression_local_variables {register_lo, register_hi,
...
# 214 "../../p4c-tofino/p4c_tofino/target/tofino/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: string;
        optional;
    }

    attribute stateful_logging_mode {
# 228 "../../p4c-tofino/p4c_tofino/target/tofino/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: string;
        optional;
    }
# 246 "../../p4c-tofino/p4c_tofino/target/tofino/p4_lib/tofino/stateful_alu_blackbox.p4"
...
# 34 "switch.p4" 2
# 1 "../../p4c-tofino/p4c_tofino/target/tofino/p4_lib/tofino/wred_blackbox.p4" 1
...
# 59 "../../p4c-tofino/p4c_tofino/target/tofino/p4_lib/tofino/wred_blackbox.p4"
...
# 40 "switch.p4" 2
# 1 "./includes/drop_reason_codes.h" 1
# 41 "switch.p4" 2
# 1 "./includes/cpu_reason_codes.h" 1
# 42 "switch.p4" 2
# 1 "./includes/p4_pktgen.h" 1
# 43 "switch.p4" 2
# 1 "./includes/defines.p4" 1
# 44 "switch.p4" 2
# 1 "./includes/headers.p4" 1
# 24 "./includes/headers.p4"
...
header_type erspan_header_t3_t {
    fields {
        ...
        sgt : 16;
        ft_d_other: 16;
# 211 "./includes/headers.p4"
    }
}
# 225 "./includes/headers.p4"
...
# 1257 "./includes/parser.p4"
# 1 "./includes/telemetry_parser.p4" 1
# 1258 "./includes/parser.p4" 2
# 46 "switch.p4" 2
# 1 "./includes/p4_table_sizes.h" 1
# 47 "switch.p4" 2
# 1 "./includes/mirror_on_drop.h" 1
# 48 "switch.p4" 2
...
action unicast_replica_from_rid(bd, dmac_idx) {
...
action set_egress_ifindex_from_rid(egress_ifindex) {
    modify_field(ingress_metadata.egress_ifindex, egress_ifindex);
}
...
action set_ecmp_nexthop_details_with_tunnel(tunnel_index, tunnel) {
    bit_xor(tunnel_metadata.tunnel_if_check,
            tunnel_metadata.tunnel_terminate, tunnel);
    bit_and(ig_intr_md_for_tm.disable_ucast_cutthru,
            l2_metadata.non_ip_packet, tunnel);
...
action set_nexthop_details_with_tunnel(tunnel_index, tunnel) {
    bit_xor(tunnel_metadata.tunnel_if_check,
            tunnel_metadata.tunnel_terminate, tunnel);
    bit_and(ig_intr_md_for_tm.disable_ucast_cutthru,
            l2_metadata.non_ip_packet, tunnel);
...
action set_mirror_erspan_id(span_id) {
    modify_field(i2e_metadata.mirror_session_id, span_id);
}
...
# 169 "switch.p4" 2
# 1 "./telemetry_int.p4" 1
# 248 "./telemetry_int.p4"
control process_int_endpoint{
# 289 "./telemetry_int.p4"
}
# 353 "./telemetry_int.p4"
control process_int_upstream_report {
# 364 "./telemetry_int.p4"
}
# 170 "switch.p4" 2
# 1 "./telemetry_postcard.p4" 1
# 28 "./telemetry_postcard.p4"
