...
# 30 "includes/p4features.h"
# 1 "includes/p4userfeatures.h" 1
# 31 "includes/p4features.h" 2
# 39 "switch.p4" 2
...
parser parse_mpls {
# 290 "includes/parser.p4"
    return ingress;

}

parser parse_mpls_bos {
# 309 "includes/parser.p4"
