// This test includes 'eg_intr_md.egress_port' in a field list used for
// mirroring, and additionally reads from 'eg_intr_md.enq_tstamp'. This mix of
// cases (one sometimes comes from the mirrored field list, one never does)
...
table egress_mirror {
    reads { eg_intr_md.enq_tstamp : exact; }
    actions { e2e_mirror; }
    size : 1024;
}
