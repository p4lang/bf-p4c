/*
gcc -E -x c -w -I/tmp/_MEImif4vc/p4_lib -D__TARGET_TOFINO__ -I/tmp/_MEImif4vc/p4_hlir/p4_lib /media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4
*/
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 1 "/tmp/_MEImif4vc/p4_lib/tofino/constants.p4" 1
# 5 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4" 2
# 1 "/tmp/_MEImif4vc/p4_lib/tofino/intrinsic_metadata.p4" 1
# 10 "/tmp/_MEImif4vc/p4_lib/tofino/intrinsic_metadata.p4"
...
# 382 "/tmp/_MEImif4vc/p4_lib/tofino/intrinsic_metadata.p4"
...
# 425 "/tmp/_MEImif4vc/p4_lib/tofino/intrinsic_metadata.p4"
        force_tx_error : 1;
...
# 6 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4" 2
# 1 "/tmp/_MEImif4vc/p4_lib/tofino/primitives.p4" 1
# 10 "/tmp/_MEImif4vc/p4_lib/tofino/primitives.p4"
action deflect_on_drop(enable_dod) {
    modify_field(ig_intr_md_for_tm.deflect_on_drop, enable_dod);
}
# 7 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4" 2
# 1 "/tmp/_MEImif4vc/p4_lib/tofino/pktgen_headers.p4" 1
# 9 "/tmp/_MEImif4vc/p4_lib/tofino/pktgen_headers.p4"
...
# 8 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4" 2
# 1 "/tmp/_MEImif4vc/p4_lib/tofino/stateful_alu_blackbox.p4" 1
...
# 81 "/tmp/_MEImif4vc/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: expression;
        expression_local_variables {register_lo, register_hi,
...
# 214 "/tmp/_MEImif4vc/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: string;
        optional;
    }

    attribute stateful_logging_mode {
# 228 "/tmp/_MEImif4vc/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: string;
        optional;
    }
# 246 "/tmp/_MEImif4vc/p4_lib/tofino/stateful_alu_blackbox.p4"
...
# 9 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4" 2
...
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/defines.p4" 1
# 17 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/headers.p4" 1
...
# 18 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/parsers.p4" 1
...
# 19 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/hashes.p4" 1
...
# 20 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/tables.p4" 1
...
table update_counters_1 {
 ...
 default_action : do_update_counters_1;
 size : 1;
}
...
table update_counters_2 {
 ...
 default_action : do_update_counters_2;
 size : 1;
}
...
# 21 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/metadata.p4" 1
...
# 22 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/counters.p4" 1
...
# 23 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/actions.p4" 1
...
action do_update_counters_1() {
    count(counters_1, ebmeta.port_hash);
}

action do_update_counters_2() {
    count(counters_2, ebmeta.port_hash);
}
...
action do_add_ebheader() {
 ...
 modify_field(ebheader.dst_chain, ebmeta.chain);
 modify_field(ebheader.dst_main_agg, ebmeta.out_agg);
 modify_field(ebheader.dst_main_out, ebmeta.lanwan_out_port);
 modify_field(ebheader.dst_mirror_1, ebmeta.dst_mirror_1);
 modify_field(ebheader.dst_mirror_2, ebmeta.dst_mirror_2);
...
# 24 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/controls.p4" 1
...
# 25 "/media/psf/Home/trees/bfn/p4examples/cases/002675/p4src/balancer/balancer.p4" 2
...
control ingress {
 ...
 if((ebmeta.port_type == 1 or ebmeta.port_type == 2) and (ebmeta.port_hash & 0x8000 == 0x0000)) {
 ...
 if((ebmeta.port_type == 1 or ebmeta.port_type == 2) and (ebmeta.port_hash & 0x8000 == 0x8000)) {
 ...
 if (valid(ebheader) and (ebheader.dst_chain != 511) and (ebmeta.port_type == 3)) {
...
control egress {
 if (valid(ebheader) and ebheader.dst_mirror_1 != 511 and ebmeta.port_type == 3) {
  apply(mirror_from_dpi_1);
 }
 calculate_offsets();
 if (valid(ebheader) and ebheader.dst_mirror_2 != 511 and ebmeta.port_type == 3) {
