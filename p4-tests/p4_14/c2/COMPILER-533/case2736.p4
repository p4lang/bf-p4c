/*
gcc -E -x c -w -I/tmp/_MEIdNvzkT/p4_lib -D__TARGET_TOFINO__ -I/tmp/_MEIdNvzkT/p4_hlir/p4_lib /media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4
*/
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 1 "/tmp/_MEIdNvzkT/p4_lib/tofino/constants.p4" 1
# 5 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4" 2
# 1 "/tmp/_MEIdNvzkT/p4_lib/tofino/intrinsic_metadata.p4" 1
# 10 "/tmp/_MEIdNvzkT/p4_lib/tofino/intrinsic_metadata.p4"
...
# 382 "/tmp/_MEIdNvzkT/p4_lib/tofino/intrinsic_metadata.p4"
...
# 425 "/tmp/_MEIdNvzkT/p4_lib/tofino/intrinsic_metadata.p4"
        force_tx_error : 1;
...
# 6 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4" 2
# 1 "/tmp/_MEIdNvzkT/p4_lib/tofino/primitives.p4" 1
# 10 "/tmp/_MEIdNvzkT/p4_lib/tofino/primitives.p4"
action deflect_on_drop(enable_dod) {
    modify_field(ig_intr_md_for_tm.deflect_on_drop, enable_dod);
}
# 7 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4" 2
# 1 "/tmp/_MEIdNvzkT/p4_lib/tofino/pktgen_headers.p4" 1
# 9 "/tmp/_MEIdNvzkT/p4_lib/tofino/pktgen_headers.p4"
...
# 8 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4" 2
# 1 "/tmp/_MEIdNvzkT/p4_lib/tofino/stateful_alu_blackbox.p4" 1
...
# 81 "/tmp/_MEIdNvzkT/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: expression;
        expression_local_variables {register_lo, register_hi,
...
# 214 "/tmp/_MEIdNvzkT/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: string;
        optional;
    }

    attribute stateful_logging_mode {
# 228 "/tmp/_MEIdNvzkT/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: string;
        optional;
    }
# 246 "/tmp/_MEIdNvzkT/p4_lib/tofino/stateful_alu_blackbox.p4"
...
# 9 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4" 2
...
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/defines.p4" 1
# 17 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/headers.p4" 1
...
# 18 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/parsers.p4" 1
...
# 19 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/hashes.p4" 1
...
# 20 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/tables.p4" 1
...
# 21 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/metadata.p4" 1
...
# 22 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/counters.p4" 1
...
# 23 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/actions.p4" 1
...
# 24 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/controls.p4" 1
...
# 25 "/media/psf/Home/trees/bfn/p4examples/cases/002736/p4src/balancer.p4" 2
