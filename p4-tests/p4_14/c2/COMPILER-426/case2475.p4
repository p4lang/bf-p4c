/*
gcc -E -x c -w -I/tmp/_MEIFrTwjm/p4_lib -D__TARGET_TOFINO__ -I/tmp/_MEIFrTwjm/p4_hlir/p4_lib /media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4
*/
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 1 "/tmp/_MEIFrTwjm/p4_lib/tofino/constants.p4" 1
# 5 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4" 2
# 1 "/tmp/_MEIFrTwjm/p4_lib/tofino/intrinsic_metadata.p4" 1
# 10 "/tmp/_MEIFrTwjm/p4_lib/tofino/intrinsic_metadata.p4"
...
# 379 "/tmp/_MEIFrTwjm/p4_lib/tofino/intrinsic_metadata.p4"
...
# 422 "/tmp/_MEIFrTwjm/p4_lib/tofino/intrinsic_metadata.p4"
        force_tx_error : 1;
...
# 6 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4" 2
# 1 "/tmp/_MEIFrTwjm/p4_lib/tofino/primitives.p4" 1
# 10 "/tmp/_MEIFrTwjm/p4_lib/tofino/primitives.p4"
action deflect_on_drop(enable_dod) {
    modify_field(ig_intr_md_for_tm.deflect_on_drop, enable_dod);
}
# 7 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4" 2
# 1 "/tmp/_MEIFrTwjm/p4_lib/tofino/pktgen_headers.p4" 1
# 9 "/tmp/_MEIFrTwjm/p4_lib/tofino/pktgen_headers.p4"
...
# 8 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4" 2
# 1 "/tmp/_MEIFrTwjm/p4_lib/tofino/stateful_alu_blackbox.p4" 1
...
# 81 "/tmp/_MEIFrTwjm/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: expression;
        expression_local_variables {register_lo, register_hi,
...
# 214 "/tmp/_MEIFrTwjm/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: string;
        optional;
    }

    attribute stateful_logging_mode {
# 228 "/tmp/_MEIFrTwjm/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: string;
        optional;
    }
# 246 "/tmp/_MEIFrTwjm/p4_lib/tofino/stateful_alu_blackbox.p4"
...
# 9 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4" 2
...
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/defines.p4" 1
# 17 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/headers.p4" 1
...
# 18 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/parsers.p4" 1
...
# 19 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/hashes.p4" 1
...
field_list_calculation flow_lan_ipv4_calc_32 {
 input { flow_ipv4_hash_lan; flow_ipv4_hash_wan; }
 algorithm : crc32; output_width : 32;
}
field_list_calculation flow_wan_ipv4_calc_32 {
 input { flow_ipv4_hash_wan; flow_ipv4_hash_lan; }
 algorithm : crc32; output_width : 32;
}
field_list_calculation flow_lan_ipv4_calc_16 {
 input { flow_ipv4_hash_lan; }
 algorithm : crc16; output_width : 16;
}
field_list_calculation flow_wan_ipv4_calc_16 {
...
field_list_calculation flow_lan_ipv6_calc_32 {
 input { flow_ipv6_hash_lan; flow_ipv6_hash_wan; }
 algorithm : crc32; output_width : 32;
}
field_list_calculation flow_wan_ipv6_calc_32 {
 input { flow_ipv6_hash_wan; flow_ipv6_hash_lan; }
 algorithm : crc32; output_width : 32;
}
field_list_calculation flow_lan_ipv6_calc_16 {
 input { flow_ipv6_hash_lan; }
 algorithm : crc16; output_width : 16;
}
field_list_calculation flow_wan_ipv6_calc_16 {
...
field_list_calculation flow_lan_imac_calc_32 {
 input { flow_imac_hash_lan; flow_imac_hash_wan; }
 algorithm : crc32; output_width : 32;
}
field_list_calculation flow_wan_imac_calc_32 {
 input { flow_imac_hash_wan; flow_imac_hash_lan; }
 algorithm : crc32; output_width : 32;
}
field_list_calculation flow_lan_imac_calc_16 {
 input { flow_imac_hash_lan; }
 algorithm : crc16; output_width : 16;
}
field_list_calculation flow_wan_imac_calc_16 {
...
field_list_calculation flow_lan_omac_calc_32 {
 input { flow_omac_hash_lan; flow_omac_hash_wan; }
 algorithm : crc32; output_width : 32;
}
field_list_calculation flow_wan_omac_calc_32 {
 input { flow_omac_hash_wan; flow_omac_hash_lan; }
 algorithm : crc32; output_width : 32;
}
field_list_calculation flow_lan_omac_calc_16 {
 input { flow_omac_hash_lan; }
 algorithm : crc16; output_width : 16;
}
field_list_calculation flow_wan_omac_calc_16 {
 input { flow_omac_hash_wan; }
 algorithm : crc16; output_width : 16;
}
# 20 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/tables.p4" 1
...
table tbl_flow_hash_parts_ipv4 {
 reads {
  ebmeta.port_type : exact;
  outer_ipv4 : valid;
 }
...
table tbl_flow_hash_parts_ipv6 {
 reads {
  ebmeta.port_type : exact;
  outer_ipv6 : valid;
 }
...
table tbl_flow_hash_parts_imac {
 reads {
  ebmeta.port_type : exact;
  outer_ipv4 : valid;
  outer_ipv6 : valid;
...
table tbl_flow_hash_parts_omac {
 reads {
  ebmeta.port_type : exact;
  outer_ipv4 : valid;
  outer_ipv6 : valid;
...
# 21 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/counters.p4" 1
...
# 22 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/actions.p4" 1


action _nop() { no_op(); }
action _drop() { drop(); }

action set_mpls_offset(offset) {
 modify_field(ebmeta.offset_mpls, offset);
}
...
action calc_dpi_lan_outer_mac_mag_hash() {
 ...
 modify_field_with_hash_based_offset(ebmeta.port_hash, 0, port_lan_outer_mac_mag_hash, 65536);
}
...
action calc_dpi_wan_outer_mac_mag_hash() {
 ...
 modify_field_with_hash_based_offset(ebmeta.port_hash, 0, port_wan_outer_mac_mag_hash, 65536);
}
...
action calc_dpi_lan_inner_mac_mag_hash() {
 ...
 modify_field_with_hash_based_offset(ebmeta.port_hash, 0, port_lan_inner_mac_mag_hash, 65536);
}
...
action calc_dpi_wan_inner_mac_mag_hash() {
 ...
 modify_field_with_hash_based_offset(ebmeta.port_hash, 0, port_wan_inner_mac_mag_hash, 65536);
}
...
action calc_dpi_lan_ipv4_mag_hash() {
 ...
 modify_field_with_hash_based_offset(ebmeta.port_hash, 0, port_lan_ipv4_mag_hash, 65536);
}
...
action calc_flow_lan_ipv4() {
 modify_field_with_hash_based_offset(flowhash_meta.ipv4_lan, 0, flow_lan_ipv4_calc_32, 4294967296);
}
action calc_flow_wan_ipv4() {
 modify_field_with_hash_based_offset(flowhash_meta.ipv4_wan, 0, flow_wan_ipv4_calc_32, 4294967296);
}
action calc_flow_parts_ipv4() {
 modify_field_with_hash_based_offset(flowhash_meta.ipv4_l16, 0, flow_lan_ipv4_calc_16, 65536);
 modify_field_with_hash_based_offset(flowhash_meta.ipv4_w16, 0, flow_wan_ipv4_calc_16, 65536);
}
action calc_flow_lan_ipv6() {
 modify_field_with_hash_based_offset(flowhash_meta.ipv6_lan, 0, flow_lan_ipv6_calc_32, 4294967296);
}
action calc_flow_wan_ipv6() {
 modify_field_with_hash_based_offset(flowhash_meta.ipv6_wan, 0, flow_wan_ipv6_calc_32, 4294967296);
}
action calc_flow_parts_ipv6() {
 modify_field_with_hash_based_offset(flowhash_meta.ipv6_l16, 0, flow_lan_ipv6_calc_16, 65536);
 modify_field_with_hash_based_offset(flowhash_meta.ipv6_w16, 0, flow_wan_ipv6_calc_16, 65536);
}
action calc_flow_lan_imac() {
 modify_field_with_hash_based_offset(flowhash_meta.imac_lan, 0, flow_lan_imac_calc_32, 4294967296);
}
action calc_flow_wan_imac() {
 modify_field_with_hash_based_offset(flowhash_meta.imac_wan, 0, flow_wan_imac_calc_32, 4294967296);
}
action calc_flow_parts_imac() {
 modify_field_with_hash_based_offset(flowhash_meta.imac_l16, 0, flow_lan_imac_calc_16, 65536);
 modify_field_with_hash_based_offset(flowhash_meta.imac_w16, 0, flow_wan_imac_calc_16, 65536);
}
action calc_flow_lan_omac() {
 modify_field_with_hash_based_offset(flowhash_meta.omac_lan, 0, flow_lan_omac_calc_32, 4294967296);
}
action calc_flow_wan_omac() {
 modify_field_with_hash_based_offset(flowhash_meta.omac_wan, 0, flow_wan_omac_calc_32, 4294967296);
}
action calc_flow_parts_omac() {
 modify_field_with_hash_based_offset(flowhash_meta.omac_l16, 0, flow_lan_omac_calc_16, 65536);
 modify_field_with_hash_based_offset(flowhash_meta.omac_w16, 0, flow_wan_omac_calc_16, 65536);
}

action set_flow_hash_ipv4_lan() {
 modify_field(ebmeta.flowhash, flowhash_meta.ipv4_lan);
 modify_field(ebmeta.flowhash_hi, flowhash_meta.ipv4_l16);
 modify_field(ebmeta.flowhash_lo, flowhash_meta.ipv4_w16);
}
action set_flow_hash_ipv4_wan() {
 modify_field(ebmeta.flowhash, flowhash_meta.ipv4_wan);
 modify_field(ebmeta.flowhash_hi, flowhash_meta.ipv4_w16);
 modify_field(ebmeta.flowhash_lo, flowhash_meta.ipv4_l16);
}
action set_flow_hash_ipv6_lan() {
 modify_field(ebmeta.flowhash, flowhash_meta.ipv6_lan);
 modify_field(ebmeta.flowhash_hi, flowhash_meta.ipv6_l16);
 modify_field(ebmeta.flowhash_lo, flowhash_meta.ipv6_w16);
}
action set_flow_hash_ipv6_wan() {
 modify_field(ebmeta.flowhash, flowhash_meta.ipv6_wan);
 modify_field(ebmeta.flowhash_hi, flowhash_meta.ipv6_w16);
 modify_field(ebmeta.flowhash_lo, flowhash_meta.ipv6_l16);
}
action set_flow_hash_imac_lan() {
 modify_field(ebmeta.flowhash, flowhash_meta.imac_lan);
 modify_field(ebmeta.flowhash_hi, flowhash_meta.imac_l16);
 modify_field(ebmeta.flowhash_lo, flowhash_meta.imac_w16);
}
action set_flow_hash_imac_wan() {
 modify_field(ebmeta.flowhash, flowhash_meta.imac_wan);
 modify_field(ebmeta.flowhash_hi, flowhash_meta.imac_w16);
 modify_field(ebmeta.flowhash_lo, flowhash_meta.imac_l16);
}
action set_flow_hash_omac_lan() {
 modify_field(ebmeta.flowhash, flowhash_meta.omac_lan);
 modify_field(ebmeta.flowhash_hi, flowhash_meta.omac_l16);
 modify_field(ebmeta.flowhash_lo, flowhash_meta.omac_w16);
}
action set_flow_hash_omac_wan() {
 modify_field(ebmeta.flowhash, flowhash_meta.omac_wan);
 modify_field(ebmeta.flowhash_hi, flowhash_meta.omac_w16);
 modify_field(ebmeta.flowhash_lo, flowhash_meta.omac_l16);
}
...
action do_add_ebheader() {
 ...
 modify_field(ebheader.flowhash, ebmeta.flowhash);
...
# 23 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/controls.p4" 1
...
# 24 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4" 2
...
# 42 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4"
...
# 62 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4"
 apply(set_dpi_output);
# 78 "/media/psf/Home/trees/bfn/p4examples/cases/002475/p4src/balancer.p4"
 apply(forward_log);
