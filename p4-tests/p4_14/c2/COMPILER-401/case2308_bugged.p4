...
*/
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/balancer.p4"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 1 "/tmp/_MEI4yCbtW/p4_lib/tofino/constants.p4" 1
# 3 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/balancer.p4" 2
# 1 "/tmp/_MEI4yCbtW/p4_lib/tofino/intrinsic_metadata.p4" 1
# 10 "/tmp/_MEI4yCbtW/p4_lib/tofino/intrinsic_metadata.p4"
...
# 379 "/tmp/_MEI4yCbtW/p4_lib/tofino/intrinsic_metadata.p4"
...
# 422 "/tmp/_MEI4yCbtW/p4_lib/tofino/intrinsic_metadata.p4"
        force_tx_error : 1;
...
# 4 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/balancer.p4" 2
# 1 "/tmp/_MEI4yCbtW/p4_lib/tofino/primitives.p4" 1
# 10 "/tmp/_MEI4yCbtW/p4_lib/tofino/primitives.p4"
action deflect_on_drop(enable_dod) {
    modify_field(ig_intr_md_for_tm.deflect_on_drop, enable_dod);
}
# 5 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/balancer.p4" 2
# 1 "/tmp/_MEI4yCbtW/p4_lib/tofino/pktgen_headers.p4" 1
# 9 "/tmp/_MEI4yCbtW/p4_lib/tofino/pktgen_headers.p4"
...
# 6 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/balancer.p4" 2
# 1 "/tmp/_MEI4yCbtW/p4_lib/tofino/stateful_alu_blackbox.p4" 1
...
# 81 "/tmp/_MEI4yCbtW/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: expression;
        expression_local_variables {register_lo, register_hi,
...
# 214 "/tmp/_MEI4yCbtW/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: string;
        optional;
    }

    attribute stateful_logging_mode {
# 228 "/tmp/_MEI4yCbtW/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: string;
        optional;
    }
# 246 "/tmp/_MEI4yCbtW/p4_lib/tofino/stateful_alu_blackbox.p4"
...
# 7 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/balancer.p4" 2


# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/defines.p4" 1
# 10 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/headers.p4" 1
...
# 44 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/headers.p4"
...
# 98 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/headers.p4"
header_type mpls_t {
 fields {
  label : 20;
  tclass : 3;
...
# 11 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/parsers.p4" 1
parser start {
...
parser parse_outer_ethernet {
 extract(outer_ethernet);
 return ingress;
# 39 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/parsers.p4"
}
# 12 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/hashes.p4" 1
...
# 13 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/tables.p4" 1
...
# 14 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/balancer.p4" 2
# 1 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/actions.p4" 1
action _nop() { no_op(); }
action _drop() { drop(); }
...
# 15 "/media/psf/Home/trees/bfn/p4examples/cases/002308/p4src/balancer.p4" 2
