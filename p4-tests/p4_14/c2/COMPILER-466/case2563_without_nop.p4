...
# 1 "/tmp/_MEIDUocqD/p4_lib/tofino/constants.p4" 1
# 5 "/media/psf/Home/trees/bfn/p4examples/cases/002563/p4src/balancer.p4" 2
# 1 "/tmp/_MEIDUocqD/p4_lib/tofino/intrinsic_metadata.p4" 1
# 10 "/tmp/_MEIDUocqD/p4_lib/tofino/intrinsic_metadata.p4"
...
# 379 "/tmp/_MEIDUocqD/p4_lib/tofino/intrinsic_metadata.p4"
...
# 422 "/tmp/_MEIDUocqD/p4_lib/tofino/intrinsic_metadata.p4"
        force_tx_error : 1;
...
# 1 "/tmp/_MEIDUocqD/p4_lib/tofino/primitives.p4" 1
# 10 "/tmp/_MEIDUocqD/p4_lib/tofino/primitives.p4"
...
# 1 "/tmp/_MEIDUocqD/p4_lib/tofino/pktgen_headers.p4" 1
# 9 "/tmp/_MEIDUocqD/p4_lib/tofino/pktgen_headers.p4"
...
# 1 "/tmp/_MEIDUocqD/p4_lib/tofino/stateful_alu_blackbox.p4" 1
...
# 81 "/tmp/_MEIDUocqD/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: expression;
        expression_local_variables {register_lo, register_hi,
...
# 214 "/tmp/_MEIDUocqD/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: string;
        optional;
    }

    attribute stateful_logging_mode {
# 228 "/tmp/_MEIDUocqD/p4_lib/tofino/stateful_alu_blackbox.p4"
        type: string;
        optional;
    }
# 246 "/tmp/_MEIDUocqD/p4_lib/tofino/stateful_alu_blackbox.p4"
