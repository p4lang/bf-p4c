...
action action_1(param1){
    modify_field(ethernet.etherType, param1);
}

action action_select(){
    modify_field_with_hash_based_offset(ipv4.blah2, 0, first_hash, 16384);
}
...
//@pragma selector_num_max_groups 4000
table test_select {
    reads {
...
table test_select2 {
    ...
    action_profile : some_action_profile2;
    size : 4096;
}
...
action_profile some_action_profile2 {
    ...
    size : 2048;
    dynamic_action_selection : some_selector2 ;
}

action_selector some_selector2 {
    selection_key : first_hash;
    selection_mode : resilient;
}
