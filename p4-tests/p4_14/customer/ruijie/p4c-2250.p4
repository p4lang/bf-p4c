...
# 1 "/mnt/build-release/p4c/p4_14include/tofino/constants.p4" 1
/*
Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
# 41 "/mnt/build-release/p4c/p4_14include/tofino/constants.p4"
/////////////////////////////////////////////////////////////

/////////////////////////////////////////////////////////////
// Digest receivers
# 53 "/mnt/build-release/p4c/p4_14include/tofino/constants.p4"
/////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////
// Default priorities
# 30 "../../p4src/switch.p4" 2
# 1 "/mnt/build-release/p4c/p4_14include/tofino/intrinsic_metadata.p4" 1
/*
Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
# 31 "../../p4src/switch.p4" 2
# 1 "/mnt/build-release/p4c/p4_14include/tofino/primitives.p4" 1
/*
Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
# 32 "../../p4src/switch.p4" 2
# 1 "/mnt/build-release/p4c/p4_14include/tofino/pktgen_headers.p4" 1
/*
Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
# 33 "../../p4src/switch.p4" 2
# 1 "/mnt/build-release/p4c/p4_14include/tofino/stateful_alu_blackbox.p4" 1
/*
Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
/***************************************************************************/
# 34 "../../p4src/switch.p4" 2
# 1 "/mnt/build-release/p4c/p4_14include/tofino/wred_blackbox.p4" 1
/*
Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
/* Tofino */
# 51 "../../p4src/includes/p4features.h"
...
# 167 "../../p4src/includes/p4features.h"
...
# 596 "../../p4src/includes/p4features.h"
//#undef URPF_DISABLE
//#undef NVGRE_DISABLE
...
# 714 "../../p4src/includes/p4features.h"
// Defines for switchapi library
# 40 "../../p4src/switch.p4" 2
# 1 "../../p4src/includes/drop_reason_codes.h" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
 ...
 *
 ******************************************************************************/
# 41 "../../p4src/switch.p4" 2
# 1 "../../p4src/includes/cpu_reason_codes.h" 1
 ...
 */
# 42 "../../p4src/switch.p4" 2
# 1 "../../p4src/includes/p4_pktgen.h" 1
# 9 "../../p4src/includes/p4_pktgen.h"
/* AppIds 0-7 for various pktgen applications */
# 43 "../../p4src/switch.p4" 2
...
# 44 "../../p4src/switch.p4" 2
# 1 "../../p4src/includes/p4_table_sizes.h" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
// default table sizes
# 128 "../../p4src/includes/p4_table_sizes.h"
// 3 IP protocols supported * sessions + 1 default rule + 1 stash rule
# 190 "../../p4src/includes/p4_table_sizes.h"
/******************************************************************************
 *  Min Table Size profile
 *****************************************************************************/
# 887 "../../p4src/includes/p4_table_sizes.h"
// override disable
# 45 "../../p4src/switch.p4" 2
...
//#define ADV_FEATURES
# 50 "../../p4src/includes/parser.p4"
/* Tunnel types */
# 194 "../../p4src/includes/parser.p4"
@pragma parser_value_set_size 1
parser_value_set udp_port_vxlan;
# 256 "../../p4src/includes/parser.p4"
parser start {
...
parser parse_mpls {
# 473 "../../p4src/includes/parser.p4"
    return ingress;

}
# 504 "../../p4src/includes/parser.p4"
...
# 973 "../../p4src/includes/parser.p4"
header icmp_t icmp;
# 1015 "../../p4src/includes/parser.p4"
parser parse_icmp {
    extract(icmp);
...
# 1816 "../../p4src/includes/parser.p4"
        default : parse_fabric_payload_header;
    }
}
# 1841 "../../p4src/includes/parser.p4"
...
# 1 "../../p4src/includes/dtel_parser.p4" 1
# 1897 "../../p4src/includes/parser.p4" 2
# 47 "../../p4src/switch.p4" 2

# 1 "../../p4src/mtel/mtel.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
// @pragma pa_no_overlay ingress l3_metadata.lkp_ip_version
...
// @pragma pa_solitary ingress _ipv4_fib_lpm__metadata._ipv4_fib_lpm_partition_index
// @pragma pa_solitary ingress _ipv6_fib_lpm__metadata._ipv6_fib_lpm_partition_index
# 216 "../../p4src/ipv4.p4"
table ipv4_fib_lpm {
    reads {
...
/*****************************************************************************/
# 175 "../../p4src/multicast.p4"
/*****************************************************************************/
/* Outer IPv4 multicast lookup                                               */
/*****************************************************************************/
# 224 "../../p4src/multicast.p4"
control process_outer_ipv4_multicast {
# 240 "../../p4src/multicast.p4"
}
...
/*****************************************************************************/
# 291 "../../p4src/multicast.p4"
control process_outer_ipv6_multicast {
# 306 "../../p4src/multicast.p4"
}
...
control process_nexthop {
    if (nexthop_metadata.nexthop_type == 1) {
        ...
        /* resolve ecmp */
# 707 "../../p4src/nexthop.p4"
            apply(ecmp_group);
# 718 "../../p4src/nexthop.p4"
    } else {
        /* resolve nexthop */
        apply(nexthop);
    }
}
# 173 "../../p4src/switch.p4" 2
...
# 143 "../../p4src/security.p4"
control process_ip_sourceguard {
# 155 "../../p4src/security.p4"
}
# 175 "../../p4src/switch.p4" 2
# 1 "../../p4src/fabric.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
...
/*****************************************************************************/
# 68 "../../p4src/egress_filter.p4"
control process_egress_filter {
# 83 "../../p4src/egress_filter.p4"
}
# 177 "../../p4src/switch.p4" 2
# 1 "../../p4src/mirror.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
...
//#endif /* SRV6_ENABLE */
//}
# 184 "../../p4src/switch.p4" 2
# 1 "../../p4src/flowlet.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
# 108 "../../p4src/flowlet.p4"
}
# 185 "../../p4src/switch.p4" 2
# 1 "../../p4src/pktgen.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
...
# 186 "../../p4src/switch.p4" 2
# 1 "../../p4src/failover.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
 ...
 ******************************************************************************/
# 190 "../../p4src/switch.p4" 2
# 1 "../../p4src/dtel_int.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
# 219 "../../p4src/dtel_int.p4"
}
# 191 "../../p4src/switch.p4" 2
# 1 "../../p4src/dtel_postcard.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
//----------------------------------------------------------------------
    ...
    /* l2 lookups */
    process_mac();
# 1527 "../../p4src/switch.p4"
    process_ingress_port_mirroring();
# 1546 "../../p4src/switch.p4"
...
# 1671 "../../p4src/switch.p4"
    ...
    /* meter index */
    process_meter_index();
# 1727 "../../p4src/switch.p4"
    /* ecmp/nexthop lookup */
    process_nexthop();
# 1753 "../../p4src/switch.p4"
    /* meter action/stats */
