...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".port_status_alu") @reg("lag_mbrs") selector_action(lag_action_profile) port_status_alu = {
    ...
    @name(".lag_group") table lag_group {
        ...
        key = {
            meta.meta.egress_ifindex: exact;
    ...
    @name(".lag_group_fast_update") table lag_group_fast_update {
        ...
        key = {
            meta.meta.down_port  : exact;
            meta.meta.instance_id: exact;
        }
    }
    apply {
