...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".parse_hdr_pvs1") state parse_hdr_pvs1 {
        packet.extract<new_tag_24t>(hdr.new_tag24_);
    ...
    @name(".parse_hdr_pvs2") state parse_hdr_pvs2 {
        packet.extract<new_tag_32t>(hdr.new_tag32_);
        transition accept;
    }
    @name(".parse_hdr_pvs3") state parse_hdr_pvs3 {
        packet.extract<new_tag_48t>(hdr.new_tag48_);
        transition select(hdr.new_tag48_.t48_f2_32b) {
            pvs4: parse_hdr_pvs4;
            default: accept;
        }
    }
    @name(".parse_hdr_pvs4") state parse_hdr_pvs4 {
        packet.extract<new_tag_64t>(hdr.new_tag64_);
        transition accept;
    }
    @name(".parse_hdr_pvs5") state parse_hdr_pvs5 {
        packet.extract<new_tag_64t>(hdr.new_tag64_2_);
        transition accept;
    }
