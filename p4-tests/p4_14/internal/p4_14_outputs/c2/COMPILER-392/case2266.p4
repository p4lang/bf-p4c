...
control DeparserImpl(packet_out packet, in headers hdr) {
    apply {
        ...
        packet.emit(hdr.skip_40_o);
        packet.emit(hdr.skip_36_o);
        packet.emit(hdr.skip_32_o);
        packet.emit(hdr.skip_28_o);
        packet.emit(hdr.skip_24_o);
        packet.emit(hdr.skip_20_o);
        packet.emit(hdr.skip_16_o);
        packet.emit(hdr.skip_12_o);
        packet.emit(hdr.skip_8_o);
        packet.emit(hdr.skip_4_o);
        packet.emit(hdr.inner_ipv6);
        packet.emit(hdr.inner_ipv4);
        packet.emit(hdr.skip_40_i);
        packet.emit(hdr.skip_36_i);
        packet.emit(hdr.skip_32_i);
        packet.emit(hdr.skip_28_i);
        packet.emit(hdr.skip_24_i);
        packet.emit(hdr.skip_20_i);
        packet.emit(hdr.skip_16_i);
        packet.emit(hdr.skip_12_i);
        packet.emit(hdr.skip_8_i);
        packet.emit(hdr.skip_4_i);
        packet.emit(hdr.udp);
        packet.emit(hdr.tcp);
