...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".run_alu_1") action run_alu() {
        tmp_4 = sketch_cnt_alu_1.execute();
        meta.meta.is_not_heavy_hitter = (bit<1>)tmp_4;
    }
    @name(".run_alu_2") action run_alu_0() {
        tmp_5 = sketch_cnt_alu_2.execute();
        meta.meta.is_not_heavy_hitter = (bit<1>)tmp_5;
    }
    @name(".run_alu_3") action run_alu_4() {
        tmp_6 = sketch_cnt_alu_3.execute();
        meta.meta.is_not_heavy_hitter = (bit<1>)tmp_6;
    }
    ...
    @name(".set_hash_3") action set_hash() {
        hash<bit<32>, bit<32>, tuple_0, bit<64>>(meta.meta.hash_3, HashAlgorithm.identity, 32w0, { hdr.ipv4.srcAddr }, 64w4294967296);
    }
    @name(".set_hash_1_and_2") action set_hash_1_and() {
        hash<bit<12>, bit<12>, tuple_0, bit<24>>(meta.meta.hash_1, HashAlgorithm.crc16, 12w0, { hdr.ipv4.srcAddr }, 24w4096);
        tmp_7 = custom_hash<>("crc16_msb");
        hash<bit<12>, bit<12>, tuple_0, bit<24>>(meta.meta.hash_2, tmp_7, 12w0, { hdr.ipv4.srcAddr }, 24w4096);
    }
