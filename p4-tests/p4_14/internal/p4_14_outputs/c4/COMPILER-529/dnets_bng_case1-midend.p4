...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".ctr_ds_subsc") counter(32w8192, CounterType.packets) ctr_ds_subsc_0;
    @name(".ctr_us_subsc") counter(32w8192, CounterType.packets) ctr_us_subsc_0;
    @name(".mtr_ds_subsc") meter(32w8192, MeterType.bytes) mtr_ds_subsc_0;
    ...
    @name(".t_antispoof_ipv4") table t_antispoof_ipv4_0 {
        ...
        key = {
            ...
            meta.ingress_md.subsc_id: exact @name("ingress_md.subsc_id") ;
    ...
    @name(".t_antispoof_mac") table t_antispoof_mac_0 {
        ...
        key = {
            ...
            hdr.ethernet_inner.srcAddr: exact @name("ethernet_inner.srcAddr") ;
    ...
    @name(".t_line_map") table t_line_map_0 {
        ...
        key = {
            ...
            hdr.mpls0.label               : exact @name("mpls0.label") ;
            hdr.mpls1.label               : exact @name("mpls1.label") ;
    ...
    @name(".t_pppoe_cpdp") table t_pppoe_cpdp_0 {
        ...
        key = {
            ...
            hdr.vlan_service.etherType: exact @name("vlan_service.etherType") ;
