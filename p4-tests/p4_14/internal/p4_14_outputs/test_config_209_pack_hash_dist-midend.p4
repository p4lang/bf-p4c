...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @reduction_or_group("or_group_1") @name(".alu_1") RegisterAction<bit<8>, bit<32>, bit<8>>(reg_1) alu_2 = {
        void apply(inout bit<8> value, out bit<8> rv) {
            value = 8w0x30;
            rv = 8w0x30;
        }
    ...
    @name(".action_0") action action_0() {
        hash<bit<17>, bit<17>, tuple_0, bit<18>>(temp_1, HashAlgorithm.random, 17w0, { hdr.pkt.field_a_32, hdr.pkt.field_b_32 }, 18w131072);
        tmp = alu.execute((bit<32>)temp_1);
        meta.meta.result_8 = meta.meta.result_8 | tmp;
    }
    @name(".action_1") action action_1() {
        hash<bit<17>, bit<17>, tuple_1, bit<18>>(temp_2, HashAlgorithm.random, 17w0, { hdr.pkt.field_c_32, hdr.pkt.field_d_32, hdr.pkt.field_e_16 }, 18w131072);
        tmp_1 = alu_2.execute((bit<32>)temp_2);
