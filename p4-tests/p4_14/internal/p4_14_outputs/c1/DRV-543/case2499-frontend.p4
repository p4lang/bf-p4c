...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Salamatof") RegisterAction<bit<1>, bit<32>, bit<1>>(Midas) _Salamatof = {
        void apply(inout bit<1> value, out bit<1> rv) {
            bit<1> _Chunchula_in_value;
            _Chunchula_in_value = value;
            value = _Chunchula_in_value;
            rv = value;
        }
    };
    ...
    @name(".Billings") action _Billings_0() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_Chunchula_temp, HashAlgorithm.identity, 18w0, { meta.Waseca.Castolon, hdr.Dunnstown[0].Kansas }, 19w262144);
    ...
    @name(".Spenard") action _Spenard_0() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_Chunchula_temp_0, HashAlgorithm.identity, 18w0, { meta.Waseca.Castolon, hdr.Dunnstown[0].Kansas }, 19w262144);
