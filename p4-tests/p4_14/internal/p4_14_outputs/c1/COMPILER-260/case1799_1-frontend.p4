...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".HWMlwq") action _HWMlwq() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_TDPRYG_temp_1, HashAlgorithm.identity, 18w0, { meta.lwmijB.qDdnCn, hdr.UsqKHW[0].SdLIvH }, 19w262144);
        _TDPRYG_tmp_1 = _fcVprY_0.execute((bit<32>)_TDPRYG_temp_1);
        meta.njBqBq.ymFIux = _TDPRYG_tmp_1;
    }
    @name(".EAmgXn") action _EAmgXn() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_TDPRYG_temp_2, HashAlgorithm.identity, 18w0, { meta.lwmijB.qDdnCn, hdr.UsqKHW[0].SdLIvH }, 19w262144);
