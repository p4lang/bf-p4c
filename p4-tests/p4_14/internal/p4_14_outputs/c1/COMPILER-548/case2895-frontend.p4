...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".Dateland") action _Dateland() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_Bienville_temp_1, HashAlgorithm.identity, 18w0, { meta.ElkFalls.Lovilia, hdr.Mondovi[0].Toxey }, 19w262144);
    ...
    @name(".Gannett") action _Gannett() {
        hash<bit<18>, bit<18>, tuple<bit<6>, bit<12>>, bit<19>>(_Bienville_temp_2, HashAlgorithm.identity, 18w0, { meta.ElkFalls.Lovilia, hdr.Mondovi[0].Toxey }, 19w262144);
