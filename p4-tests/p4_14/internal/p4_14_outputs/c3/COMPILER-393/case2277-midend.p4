...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".compute_lkp_ipv6_hash") action _compute_lkp_ipv6_hash() {
        hash<bit<16>, bit<16>, tuple_3, bit<32>>(meta.hash_metadata.hash1, HashAlgorithm.crc16, 16w0, { meta.ipv6_metadata.lkp_ipv6_sa, meta.ipv6_metadata.lkp_ipv6_da, meta.l3_metadata.lkp_ip_proto, meta.l3_metadata.lkp_l4_sport, meta.l3_metadata.lkp_l4_dport }, 32w65536);
    }
...
control computeChecksum(inout headers hdr, inout metadata meta) {
    apply {
        ...
        update_checksum_with_payload<tuple_6, bit<16>>(meta.nat_metadata.update_inner_udp_checksum == 1w1, { hdr.inner_ipv4.srcAddr, hdr.inner_ipv4.dstAddr, 8w0, hdr.inner_ipv4.protocol, meta.nat_metadata.l4_len, hdr.inner_udp.srcPort, hdr.inner_udp.dstPort, hdr.inner_udp.length_ }, hdr.inner_udp.checksum, HashAlgorithm.csum16);
        ...
        update_checksum_with_payload<tuple_7, bit<16>>(meta.nat_metadata.update_tcp_checksum == 1w1, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, 8w0, hdr.ipv4.protocol, meta.nat_metadata.l4_len, hdr.tcp.srcPort, hdr.tcp.dstPort, hdr.tcp.seqNo, hdr.tcp.ackNo, hdr.tcp.dataOffset, hdr.tcp.res, hdr.tcp.flags, hdr.tcp.window, hdr.tcp.urgentPtr }, hdr.tcp.checksum, HashAlgorithm.csum16);
        update_checksum_with_payload<tuple_6, bit<16>>(meta.nat_metadata.update_udp_checksum == 1w1, { hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, 8w0, hdr.ipv4.protocol, meta.nat_metadata.l4_len, hdr.udp.srcPort, hdr.udp.dstPort, hdr.udp.length_ }, hdr.udp.checksum, HashAlgorithm.csum16);
    }
}
