...
parser ParserImpl(packet_in packet, out headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".parse_ipv4") state parse_ipv4 {
        ...
        hdr.ig_prsr_ctrl.parser_counter = (bit<8>)(hdr.ipv4.ihl * 4w4 - 4w5);
    ...
    @name(".parse_ipv4_option_addr_ext") state parse_ipv4_option_addr_ext {
        ...
        hdr.ig_prsr_ctrl.parser_counter = hdr.ig_prsr_ctrl.parser_counter - 8w10;
        transition parse_ipv4_options;
    }
    @name(".parse_ipv4_option_eol") state parse_ipv4_option_eol {
        packet.extract(hdr.ipv4_option_EOL);
        hdr.ig_prsr_ctrl.parser_counter = hdr.ig_prsr_ctrl.parser_counter - 8w1;
        transition parse_ipv4_options;
    }
    ...
    @name(".parse_ipv4_options") state parse_ipv4_options {
        transition select(hdr.ig_prsr_ctrl.parser_counter, (packet.lookahead<bit<8>>())[7:0]) {
...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".rewrite_ipv6_and_set_egress_port") action rewrite_ipv6_and_set_egress_port() {
