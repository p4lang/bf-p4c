...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    ...
    @name(".hop_ipv4") action hop_ipv4_11(bit<9> egress_port) {
        hdr.ig_intr_md_for_tm.ucast_egress_port = egress_port;
        hdr.ipv4.ttl = hdr.ipv4.ttl + 8w255;
    }
    @name(".hop_ipv4") action hop_ipv4_12(bit<9> egress_port) {
        hdr.ig_intr_md_for_tm.ucast_egress_port = egress_port;
        hdr.ipv4.ttl = hdr.ipv4.ttl + 8w255;
    }
    @name(".hop_ipv4") action hop_ipv4_13(bit<9> egress_port) {
        hdr.ig_intr_md_for_tm.ucast_egress_port = egress_port;
        hdr.ipv4.ttl = hdr.ipv4.ttl + 8w255;
    }
    @name(".hop_ipv4") action hop_ipv4_14(bit<9> egress_port) {
        hdr.ig_intr_md_for_tm.ucast_egress_port = egress_port;
        hdr.ipv4.ttl = hdr.ipv4.ttl + 8w255;
    }
    @name(".hop_ipv4") action hop_ipv4_15(bit<9> egress_port) {
        hdr.ig_intr_md_for_tm.ucast_egress_port = egress_port;
        hdr.ipv4.ttl = hdr.ipv4.ttl + 8w255;
    }
    @name(".hop_ipv4") action hop_ipv4_16(bit<9> egress_port) {
        hdr.ig_intr_md_for_tm.ucast_egress_port = egress_port;
        hdr.ipv4.ttl = hdr.ipv4.ttl + 8w255;
    }
    ...
    @name(".tcp_port_modify") action tcp_port_modify_2(bit<16> sPort, bit<9> port) {
        hdr.tcp.srcPort = sPort;
        hdr.ig_intr_md_for_tm.ucast_egress_port = port;
    }
    ...
    @immediate(1) @stage(10) @include_idletime(1) @idletime_precision(6) @name(".idle_6") table idle_4 {
        support_timeout = true;
        actions = {
            nop_27();
            hop_ipv4_10();
