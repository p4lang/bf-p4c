...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name(".exm_cnt") direct_counter(CounterType.packets) exm_cnt_0;
    ...
    @name(".tcp_port_modify") action tcp_port_modify_0(bit<16> sPort, bit<9> port) {
    ...
    @stage(9) @pack(1) @ways(4) @name(".exm_movereg") table exm_movereg_0 {
        actions = {
            nop_2();
            next_hop_ipv4_2();
            @defaultonly NoAction();
    ...
    @immediate(1) @stage(10) @include_idletime(1) @idletime_precision(3) @name(".idle_3") table idle_0 {
        support_timeout = true;
        actions = {
            nop_1();
            hop_ipv4_0();
    ...
    @immediate(1) @stage(10) @include_idletime(1) @idletime_precision(6) @name(".idle_6") table idle_1 {
        support_timeout = true;
        actions = {
            nop_1();
            hop_ipv4_0();
    ...
    @immediate(1) @stage(10) @include_idletime(1) @idletime_precision(1) @name(".idle_tcam_1") table idle_tcam {
        support_timeout = true;
        actions = {
            nop_1();
            hop_ipv4_0();
    ...
    @immediate(1) @stage(9) @include_idletime(1) @idletime_precision(2) @name(".idle_tcam_2") table idle_tcam_0 {
        support_timeout = true;
        actions = {
            nop_1();
            hop_ipv4_0();
    ...
    @immediate(1) @stage(11) @include_idletime(1) @idletime_precision(3) @name(".idle_tcam_3") table idle_tcam_4 {
        support_timeout = true;
        actions = {
            nop_1();
            hop_ipv4_0();
    ...
    @immediate(1) @stage(9) @include_idletime(1) @idletime_precision(3) @idletime_per_flow_idletime(0) @name(".idle_tcam_3d") table idle_tcam_3d_0 {
        support_timeout = true;
        actions = {
            nop_1();
            hop_ipv4_0();
    ...
    @immediate(1) @stage(9) @include_idletime(1) @idletime_precision(6) @name(".idle_tcam_6") table idle_tcam_5 {
        support_timeout = true;
        actions = {
            nop_1();
            hop_ipv4_0();
    ...
    @immediate(1) @stage(9) @include_idletime(1) @idletime_precision(6) @idletime_per_flow_idletime(0) @name(".idle_tcam_6d") table idle_tcam_6d_0 {
        support_timeout = true;
        actions = {
            nop_1();
            hop_ipv4_0();
    ...
    @stage(7) @selector_max_group_size(119040) @name(".tcp_port_select") table tcp_port_select_0 {
        actions = {
            tcp_port_modify_0();
            nop_1();
            @defaultonly NoAction();
    ...
    @stage(8) @selector_max_group_size(100) @name(".tcp_port_select_exm") table tcp_port_select_exm_0 {
        actions = {
            tcp_port_modify_0();
            nop_1();
            @defaultonly NoAction();
    ...
    apply {
        ...
        tcp_port_select_0.apply();
        tcp_port_select_exm_0.apply();
        idle_tcam_0.apply();
        idle_tcam_5.apply();
        idle_tcam_3d_0.apply();
        idle_tcam_6d_0.apply();
        exm_movereg_0.apply();
        idle_tcam.apply();
        idle.apply();
        idle_0.apply();
