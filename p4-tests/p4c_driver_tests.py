...
p4_14_program = os.path.join(tests_dir, 'internal/p4-programs/internal_p4_14/emulation/emulation.p4')
...
p4_16_path = os.path.join(tests_dir, 'internal/p4-programs/p4_16_programs')
...
p4c_3078_program = os.path.join(tests_dir, 'p4_16/internal/p4c-3078.p4')
...
test_matrix = {
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_lpm_match' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/bri_handle' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_timestamp' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_bridged_md' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_pvs' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_register' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_meter_lpf_wred' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_dkm' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_32q_multiprogram/program_b' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_32q_multiprogram/program_a' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_random' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_digest' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_multicast' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_port_metadata_extern' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_pktgen' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/bri_with_pdfixed_thrift' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_custom_hash' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_proxy_hash' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_exact_match' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_dyn_hashing' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_action_profile' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_symmetric_hash' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_idletimeout' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_port_metadata' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_meter_bytecount_adjust' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_ternary_match' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_snapshot' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_field_slice' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_action_selector' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_ports' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_32q_2pipe' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_counter' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_resubmit' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_operations' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_mirror' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_checksum' :
    ...
    'source.json: p4-tests/internal/p4-programs/p4_16_programs/tna_range_match' :
