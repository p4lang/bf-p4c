...
test_matrix = {
    ...
    'p4_16_jbay_t2na_too_few_stages': (['--target', 'tofino2', '--arch', 't2na', '-I', p4_16_includes_dir,
                                        '-o', 'override_too_few', '-Xp4c="--num-stages-override 3"',
                                        '-Xassembler="--num-stages-override3"', t2na_program],
    ...
    'p4_16_jbay_t2na_too_many_stages': (['--target', 'tofino2', '--arch', 't2na', '-I', p4_16_includes_dir,
                                         '-o', 'override_too_many', '-Xp4c="--num-stages-override 30"',
                                         '-Xassembler="--num-stages-override30"', t2na_program],
