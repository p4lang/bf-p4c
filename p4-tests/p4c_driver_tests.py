...
test_matrix = {
    ...
    # 'p4_16_t32q_archive_debug': (['--target', 'tofino', '--arch', 'tna', '--archive', '-g',
    ...
    # name the archive!
    # 'p4_14_archgraphs': (['--archive', '--create-graphs', '--std', 'p4-14',
    # '--target', 'tofino', '--arch', 'v1model', '-o', 'p4_14_archive', p4_14_program], None),
