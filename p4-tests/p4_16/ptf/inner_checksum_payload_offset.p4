...
struct Parsed_packet {
    ...
    ipv4_h outer_ipv4;
    ipv4_addr_h outer_ipv4_addr;
    udp_h outer_udp;
    vxlan_h vxlan; 
    ethernet_h inner_ethernet;   
    ipv4_h inner_ipv4;
    ipv4_addr_h inner_ipv4_addr;
    udp_h inner_udp;
}
...
parser SwitchIngressParser(packet_in pkt,
    ...
    state parse_outer_ipv4 {
        ...
        pkt.extract(hdr.outer_ipv4_addr);
        outer_udp_checksum.subtract({hdr.outer_ipv4_addr.src_addr,
                               hdr.outer_ipv4_addr.dst_addr,
    ...
    state parse_inner_ipv4 {
        ...
        pkt.extract(hdr.inner_ipv4_addr);
...
control SwitchIngressDeparser(packet_out pkt,
    ...
    apply {
       hdr.inner_ipv4.hdr_checksum = inner_ipv4_checksum.update({hdr.inner_ipv4.version,
                                                                  ...
                                                                  hdr.inner_ipv4_addr.src_addr,
                                                                  hdr.inner_ipv4_addr.dst_addr});
         hdr.outer_udp.checksum = outer_udp_checksum.update({hdr.outer_ipv4_addr.src_addr,
                                                             hdr.outer_ipv4_addr.dst_addr,
                                                             8w0, hdr.outer_ipv4.protocol,
                                                             hdr.outer_ipv4.total_len,
                                                             hdr.outer_udp.src_port,
                                                             ...
                                                             hdr.inner_ipv4_addr.dst_addr,
                                                             hdr.inner_udp,
                                                             ig_md.ig_brid_md.outer_udp_checksum_b_md});
        pkt.emit(hdr);
    }
}
