...
@pa_container_size("ingress","hdr.ipv6.version",8)
@pa_container_size("ingress","ipv6.payload_len",16)
@pa_container_size("ingress","hdr.ipv6.src_addr", 32)
...
parser SwitchIngressParser(
    ...
    state parse_ethernet {
        ...
        transition select(pkt.lookahead<bit<16>>()[15:0]) {
...
control SwitchIngress(
    ...
    action chg_src_send(PortId_t port){
     ...
     hdr.brid_md.a = ig_md.a;
     hdr.udpv6.src_port = 0x1111;
