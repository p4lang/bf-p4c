...
parser EgressParserImpl(packet_in buffer,
                        ...
                        in clone_e2e_data_t clone_e2e_meta)
{
    state start {
...
control EgressDeparserImpl(packet_out buffer,
                           out clone_e2e_data_t clone_e2e_meta,
                           ...
                           in psa_egress_deparser_input_metadata_t edstd)
{
    ...
    apply {
        if(psa_clone_e2e(istd)) {
            clone_e2e_meta.custom_tag = (bit<8>) meta.custom_clone_id;
            if (meta.custom_clone_id == 1) {
                clone_e2e_meta.srcAddr = 0xf;
            }
        }
        cp.apply(buffer, hdr);
    }
