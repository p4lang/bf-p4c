...
control SwitchIngress(
        ...
        action sliced_wide_add_1() {
            hdr.ipv6.dst_addr[63:0] = hdr.ipv6.dst_addr[63:0] + hdr.ipv6.src_addr[63:0];
        }

        action sliced_wide_add_2() {
            hdr.ipv6.dst_addr[95:32] = hdr.ipv6.dst_addr[95:32] + hdr.ipv6.src_addr[95:32];
        }
