 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 20 "upf/p4src/pipe0/upf_0.p4" 2

# 1 "upf/p4src/pipe0/UPFIngress1_0.p4" 1
/*******************************************************************************
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 14 "upf/p4src/pipe0/UPFIngress1_0.p4" 2
# 1 "common/p4lib/core/headers/types.p4" 1
/****************************************************************
 * Copyright (c) Kaloom Inc., 2018
 *
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 15 "upf/p4src/pipe0/UPFIngress1_0.p4" 2
...
# 17 "upf/p4src/pipe0/UPFIngress1_0.p4" 2
...
# 18 "upf/p4src/pipe0/UPFIngress1_0.p4" 2
...
# 19 "upf/p4src/pipe0/UPFIngress1_0.p4" 2
...
control UPFIngress_Uplink_1_0(
    ...
    FlowTableUplink(50000) flow_table;
    ...
    */
    ...
    apply {
        ...
        if (ig_md.gtp_echo == 1) {
            ...
            flow_table.apply(hdr, ig_md.innerDstAddrv6, ig_md.innerNextHdrv6);
            send_on_folded();
        }
    }
}
...
# 22 "upf/p4src/pipe0/upf_0.p4" 2
# 1 "upf/p4src/pipe0/UPFEgress8_0.p4" 1
/*******************************************************************************
* Copyright (c) Kaloom Inc., 2019
*
* This unpublished material is property of Kaloom Inc.
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 14 "upf/p4src/pipe0/UPFEgress8_0.p4" 2
# 1 "common/p4lib/core/headers/types.p4" 1
/****************************************************************
 * Copyright (c) Kaloom Inc., 2018
 *
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 15 "upf/p4src/pipe0/UPFEgress8_0.p4" 2
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 17 "upf/p4src/pipe0/UPFEgress8_0.p4" 2
...
# 18 "upf/p4src/pipe0/UPFEgress8_0.p4" 2
...
# 19 "upf/p4src/pipe0/UPFEgress8_0.p4" 2
...
# 20 "upf/p4src/pipe0/UPFEgress8_0.p4" 2
...
control UPFEgress_Downlink_8_0(
        inout headers hdr,
        inout upf_egress_metadata_t eg_md,
        in egress_intrinsic_metadata_t eg_intr_md,
    ...
    @pragma user_annotation "linked_counter:encap_cntr_downlink_egress,16,2,0"
    Counter<bit<32>, dl_flow_id_indirect_counter_t>(65536, CounterType_t.PACKETS_AND_BYTES) dl_encap_cntr0;
    @pragma user_annotation "linked_counter:encap_cntr_downlink_egress,16,2,1"
    Counter<bit<32>, dl_flow_id_indirect_counter_t>(65536, CounterType_t.PACKETS_AND_BYTES) dl_encap_cntr1;
    @pragma user_annotation "linked_counter:encap_cntr_downlink_egress,16,2,2"
    Counter<bit<32>, dl_flow_id_indirect_counter_t>(65536, CounterType_t.PACKETS_AND_BYTES) dl_encap_cntr2;
    @pragma user_annotation "linked_counter:encap_cntr_downlink_egress,16,2,3"
    Counter<bit<32>, dl_flow_id_indirect_counter_t>(65536, CounterType_t.PACKETS_AND_BYTES) dl_encap_cntr3;
...
# 23 "upf/p4src/pipe0/upf_0.p4" 2

Pipeline(UPFIngress1_0Parser(),
  UPFIngress_Uplink_1_0(),
  UPFIngress1_0Deparser(),
  UPFEgress8_0Parser(),
  UPFEgress_Downlink_8_0(),
  UPFEgress8_0Deparser()) pipe;
