...
# 1 "/home/parallels/bf-sde-9.0.0/install/share/p4c/p4include/core.p4" 1
/*
...
# 11 "leaf.p4" 2
# 1 "/home/parallels/bf-sde-9.0.0/install/share/p4c/p4include/tna.p4" 1
/*
...
/* This is the P4-16 core library, which declares some built-in P4 constructs using P4 */
# 23 "/home/parallels/bf-sde-9.0.0/install/share/p4c/p4include/tna.p4" 2
# 1 "/home/parallels/bf-sde-9.0.0/install/share/p4c/p4include/tofino.p4" 1
/*
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
 *
 * All Rights Reserved.
...
/* This is the P4-16 core library, which declares some built-in P4 constructs using P4 */
# 23 "/home/parallels/bf-sde-9.0.0/install/share/p4c/p4include/tofino.p4" 2
...
# 24 "/home/parallels/bf-sde-9.0.0/install/share/p4c/p4include/tna.p4" 2
...
const bit<32> VNET_SMAC_LOCAL_PORT_TABLE_SIZE = 15360;
const bit<32> VNET_SMAC_KVS_TABLE_SIZE = 15360;
...
control KnfPackets(
    ...
    action knf_dst_ip_is_to_kvs_hit(iface_id_t lag_id, kvs_id_t kvs_id) {
        knf_dst_ip_is_local_cntr.count();
...
control VnetDmac(
     ...
     */
    action vnet_dmac_kvs_hit(iface_id_t lag_id, kvs_id_t kvs_id) {
        ig_md.ktep_meta.egress_iface_id = lag_id;
        ig_md.ktep_meta.kvs_id = kvs_id;
        ig_md.ktep_meta.egress_pkt_type = PKT_TYPE_KNF;
        ig_md.ktep_meta.send_to_kvs = 1;
