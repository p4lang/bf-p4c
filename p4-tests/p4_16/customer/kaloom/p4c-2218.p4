...
# 12 "case9796/leaf.p4" 2

# 1 "case9796/core/headers/headers.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
...
# 14 "case9796/core/headers/headers.p4" 2
...
# 14 "case9796/leaf.p4" 2
# 1 "case9796/core/modules/common.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 16 "case9796/leaf.p4" 2
# 1 "case9796/types.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
...
typedef bit<16> lag_failover_reg_index_t;
...
@pa_mutually_exclusive("egress", "eg_md.mirror.queue_depth", "eg_md.kvtep_meta.kvtep_id")
@pa_mutually_exclusive("egress", "eg_md.mirror.ingress_tstamp", "hdr.bridged_md.ingress_tstamp")
@pa_mutually_exclusive("egress", "eg_md.mirror.src", "eg_md.ktep_meta.kvs_id")
...
# 17 "case9796/leaf.p4" 2
# 1 "case9796/parde.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 16 "case9796/parde.p4" 2
# 1 "case9796/core/parsers/tofino_parser.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
...
# 17 "case9796/parde.p4" 2
# 1 "case9796/core/deparsers/egress_mirror.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
...
# 18 "case9796/leaf.p4" 2
# 1 "case9796/leaf_profile.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
...
const bit<32> lag_failover_reg_instance_count = 130;
# 19 "case9796/leaf.p4" 2
# 1 "case9796/core/modules/port.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 14 "case9796/core/modules/port.p4" 2
...
# 20 "case9796/leaf.p4" 2
# 1 "case9796/core/modules/l2.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 14 "case9796/core/modules/l2.p4" 2
...
control LagFailover(
    ...
    action lag_failover_hit(lag_failover_reg_index_t index) {
        lag_port_down.execute(index);
    }

    action lag_failover_miss() {}

    /* this table has to be placed in the same stage as lag_groups table as they
     * share a register.
     */
    @stage(9)
    table lag_failover {
...
control VnetEgressIfaces(
    ...
    // internal_counter_t lag_groups_cntr;
...
# 21 "case9796/leaf.p4" 2
# 1 "case9796/core/modules/l3_vxlan.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 14 "case9796/core/modules/l3_vxlan.p4" 2
...
# 22 "case9796/leaf.p4" 2
# 1 "case9796/core/modules/l3.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 14 "case9796/core/modules/l3.p4" 2
...
# 23 "case9796/leaf.p4" 2
# 1 "case9796/core/modules/cpu.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 14 "case9796/core/modules/cpu.p4" 2
...
# 24 "case9796/leaf.p4" 2
# 1 "case9796/core/modules/fabric.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 14 "case9796/core/modules/fabric.p4" 2
# 1 "case9796/./core/modules/port_failover.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
...
# 15 "case9796/core/modules/fabric.p4" 2
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 26 "case9796/leaf.p4" 2
# 1 "case9796/core/modules/replication.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
...
# 27 "case9796/leaf.p4" 2
# 1 "case9796/core/modules/knf_tunnel.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
...
# 28 "case9796/leaf.p4" 2
# 1 "case9796/core/modules/tel_watchlist.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
...
# 29 "case9796/leaf.p4" 2
# 1 "case9796/core/modules/tel_postcard.p4" 1
/****************************************************************
 * Copyright (c) Kaloom, 2019
 *
 * This unpublished material is property of Kaloom Inc.
...
control SwitchIngress(
    ...
    /* LAG link failover */
    Register<bit<1>, lag_failover_reg_index_t>(lag_failover_reg_instance_count) lag_failover_reg;
    RegisterAction<bit<1>, lag_failover_reg_index_t, bit<1>>(lag_failover_reg) lag_port_down = {
        void apply(inout bit<1> value) {
            value = 1w0;
        }
    };

    RegisterAction<bit<1>, lag_failover_reg_index_t, bit<1>>(lag_failover_reg) lag_port_up = {
        void apply(inout bit<1> value) {
            value = 1w1;
        }
    };
