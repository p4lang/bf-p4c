...
const port_id_t RECIRC_PORT_PIPE_0 = 1;
...
control SwitchIngress(
    ...
    apply {
        ...
        /** (TODO:) Fix this. For now just avoiding the egress_port != cpu_port check for tofino2
         * use a bool instead? That seems to cause compilation issues. Until that's solved the right
         * way, using a value that's DP0_PORT_ID-1 (i.e., 510)
         */
        ig_intr_md_for_tm.ucast_egress_port = 0x1FE;
