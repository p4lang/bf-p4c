...
const bit<32> NPB_ING_SF_BAS_ADV_POLICY_L2_TABLE_DEPTH = 512;
const bit<32> NPB_ING_SF_BAS_ADV_POLICY_L3_V4_TABLE_DEPTH = 512;
const bit<32> NPB_ING_SF_BAS_ADV_POLICY_L3_V6_TABLE_DEPTH = 512;
...
parser NpbEgressParser(
 ...
 bit<8> inner_protocol;
  ...
  pkt.extract(hdr.bridged_md);
        ...
        eg_md.nsh_extr.extr_srvc_func_bitmask_local = hdr.bridged_md.base.nsh_extr_srvc_func_bitmask_local;
        eg_md.nsh_extr.extr_srvc_func_bitmask_remote = hdr.bridged_md.base.nsh_extr_srvc_func_bitmask_remote;
 ...
 apply {
  if(hdr.nsh_extr_underlay.isValid()) {
   ...
   if(ing_sfc_flowtype_class_1.apply().hit) {
    if(ing_sfc_sfc_class_2.apply().hit) {
     ing_sfc_flow_schd_3.apply();
    }
   }
  }
...
control npb_ing_sf_npb_basic_adv_top (
 ...
 table npb_ing_sf_policy_l2347_v4 {
  ...
  const default_action = NoAction;
  size = NPB_ING_SF_BAS_ADV_POLICY_L2_TABLE_DEPTH;
 }
 ...
 table npb_ing_sf_policy_l34_v4 {
  ...
  const default_action = NoAction;
  size = NPB_ING_SF_BAS_ADV_POLICY_L3_V4_TABLE_DEPTH;
 }
 table npb_ing_sf_policy_l34_v6 {
  ...
  const default_action = NoAction;
  size = NPB_ING_SF_BAS_ADV_POLICY_L3_V6_TABLE_DEPTH;
 }
