...
control PortMirror(
	...
	action set_mirror_id(
		...
		mirror_md.type = SWITCH_MIRROR_TYPE_CPU;
		mirror_md.src = src;
...
control LAG(
	...
	switch_uint32_t LAG_SELECTOR_TABLE_SIZE,
	switch_uint32_t LAG_MAX_MEMBERS_PER_GROUP,
	switch_uint32_t LAG_GROUP_TABLE_SIZE,
	switch_uint32_t LAG_TABLE_SIZE
) {
