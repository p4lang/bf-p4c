...
const bool TRANSPORT_EoMPLS_INGRESS_ENABLE_PIPELINE_NPB_DEDUP_DTEL_B_VCPFW = true;
...
const bool TRANSPORT_EoMPLS_INGRESS_ENABLE_PIPELINE_NPB_DEDUP_DTEL_B_CHTR = true;
