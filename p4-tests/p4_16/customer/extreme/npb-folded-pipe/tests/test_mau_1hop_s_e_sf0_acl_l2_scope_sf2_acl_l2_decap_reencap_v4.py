...
#			rmac = dmac
			...
			npb_tunnel_encap_sip_rewrite_v4_add(self, self.target, ig_pipe, tunnel_encap_bd, sip)
			npb_tunnel_encap_dip_rewrite_v4_add(self, self.target, ig_pipe, tunnel_encap_ptr, dip)
