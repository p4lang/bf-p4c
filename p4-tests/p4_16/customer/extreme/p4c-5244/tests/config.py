...
BF_P4C_PATH = os.path.abspath(os.path.dirname(__file__)).replace('/p4c/extensions/p4_tests/p4_16/customer/extreme/p4c-5244/tests','')
TEST_JSON_PATH = os.path.join(BF_P4C_PATH, "p4-tests/p4_16/customer/extreme/p4c-5244/tests")
