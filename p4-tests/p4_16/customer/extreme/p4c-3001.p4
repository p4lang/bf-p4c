...
const switch_egress_bypass_t SWITCH_EGRESS_BYPASS_NPB = 8w0x80; // derek: hijacking 0x80 for NPB
...
*/
# 125 "npb_ing_sf_npb_basic_adv_sfp_sel.p4"
/*
...
*/
# 130 "npb_ing_sf_npb_basic_adv_sfp_sel.p4"
/*
...
*/
# 135 "npb_ing_sf_npb_basic_adv_sfp_sel.p4"
...
*/
# 312 "npb_ing_sf_npb_basic_adv_top.p4"
//			}
...
*/
# 327 "npb_ing_sf_npb_basic_adv_top.p4"
 }
}
# 3 "npb_ing_top.p4" 2
...
*/
# 182 "npb_egr_sf_multicast_top.p4"
 // =========================================================================
 // Apply
 // =========================================================================
...
*/
# 228 "npb_egr_sf_multicast_top.p4"
 }
}
# 5 "npb_ing_top.p4" 2
...
//		eg_md.timestamp = eg_intr_md_from_prsr.global_tstamp[31:0];
  ...
  if (!(eg_md.bypass & SWITCH_EGRESS_BYPASS_NPB != 0)) {
   npb_egr_top.apply (
    hdr.transport,
    eg_md.tunnel_0,
    hdr.outer,
