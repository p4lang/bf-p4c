...
# 1 "/home/parallels/bf-sde-9.2.0/install/share/p4c/p4include/core.p4" 1
/*
...
# 1 "/home/parallels/bf-sde-9.2.0/install/share/p4c/p4include/t2na.p4" 1
/*
...
# 1 "/home/parallels/bf-sde-9.2.0/install/share/p4c/p4include/tofino2arch.p4" 1
/*
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
 *
 * All Rights Reserved.
...
/* This is the P4-16 core library, which declares some built-in P4 constructs using P4 */
# 23 "/home/parallels/bf-sde-9.2.0/install/share/p4c/p4include/tofino2arch.p4" 2
# 1 "/home/parallels/bf-sde-9.2.0/install/share/p4c/p4include/tofino2.p4" 1
/*
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
 *
 * All Rights Reserved.
...
/* This is the P4-16 core library, which declares some built-in P4 constructs using P4 */
# 23 "/home/parallels/bf-sde-9.2.0/install/share/p4c/p4include/tofino2.p4" 2
...
# 24 "/home/parallels/bf-sde-9.2.0/install/share/p4c/p4include/tofino2arch.p4" 2
...
# 21 "/home/parallels/bf-sde-9.2.0/install/share/p4c/p4include/t2na.p4" 2
# 26 "npb.p4" 2
...
const switch_ingress_bypass_t SWITCH_INGRESS_BYPASS_NPB = 16w0x0080; // derek: hijacking 0x80 for NPB
...
const switch_ingress_bypass_t SWITCH_INGRESS_BYPASS_METER = 8w0x20;
const switch_ingress_bypass_t SWITCH_INGRESS_BYPASS_STORM_CONTROL = 8w0x40;
//const switch_ingress_bypass_t SWITCH_INGRESS_BYPASS_STP = 8w0x80;
//const switch_ingress_bypass_t SWITCH_INGRESS_BYPASS_SMAC = 8w0x00;
const switch_ingress_bypass_t SWITCH_INGRESS_BYPASS_NPB = 8w0x80; // derek: hijacking 0x80 for NPB
...
//      eg_md.ingress_timestamp = port_md.timestamp;
        ...
        hdr.cpu.reason_code = (bit<16>) 0; // derek, what to set to?
...
// Derek: this line is needed in the code, but get a compiler error!
        hdr.cpu.ether_type = hdr.outer.ethernet.ether_type;
...
# 128 "npb_ing_sf_npb_basic_adv_top.p4"
 // =========================================================================
...
# 169 "npb_ing_sf_npb_basic_adv_top.p4"
 // =========================================================================
...
# 210 "npb_ing_sf_npb_basic_adv_top.p4"
 // =========================================================================
 // Apply
 // =========================================================================
...
# 188 "npb_egr_sf_proxy_hdr_strip.p4"
...
control npb_egr_sf_proxy_hdr_edit (
 ...
 // Table: bd_to_vlan_mapping
 // -----------------------------------------------------------------
# 35 "npb_egr_sf_proxy_hdr_edit.p4"
 // -----------------------------------------------------------------
 // Table: hdr_add
 // -----------------------------------------------------------------
...
# 211 "npb_egr_sf_proxy_hdr_edit.p4"
   // case 0 (eth  to vlan)
   ( false, false): hdr_add_0__from_eth_____to_vlan_tag0(); // empty

   // case 1 (eth  to vlan)
   ( true, false): hdr_add_1__from_eth_____to_vlan_tag0(); // one full
