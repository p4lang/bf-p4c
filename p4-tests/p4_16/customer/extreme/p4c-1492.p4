...
control npb_ing_sfc_top (
 ...
 apply {
  if(hdr.nsh_extr.isValid()) {
   ...
   ig_md.nsh_extr.extr_srvc_func_bitmask = hdr.nsh_extr.extr_srvc_func_bitmask;
   ig_md.nsh_extr.extr_tenant_id = hdr.nsh_extr.extr_tenant_id;
   ig_md.nsh_extr.extr_flow_type = hdr.nsh_extr.extr_flow_type;
  } else {
