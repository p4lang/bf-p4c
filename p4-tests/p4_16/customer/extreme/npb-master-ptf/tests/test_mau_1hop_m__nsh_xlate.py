...
#		self.target = gc.Target(self.dev, pipe_id=0xffff)
	...
	def runTest(self):
		...
		#print "Peter Test2"
		#npb_sfc_sf_sel_nsh_xlate_add(self, self.target, ta, 63, spi, si, si-(popcount(sf_bitmask&6)) )
		#print "Peter Test3"
...
#		time.sleep(1)
		...
		src_pkt, exp_pkt = npb_simple_1lyr_udp(
			dmac_nsh=dmac, smac_nsh=smac, spi=spi, si=si, ta=ta, nshtype=1, sap=sap,  vpn=vpn, ttl=63, scope=1,
		...
		#npb_sfc_sf_sel_nsh_xlate_del(self, self.target, ta)
