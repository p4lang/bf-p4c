...
#		self.target = gc.Target(self.dev, pipe_id=0xffff)
	...
	def runTest(self):
		...
		npb_npb_sf2_policy_l34_v4_add(self, self.target, dsap=dsap, l3_len_bitmask=0x0000, l3_len_bitmask_mask=0xffff, drop=0) # don't drop
		npb_npb_sf2_policy_l34_v4_add(self, self.target, dsap=dsap, l3_len_bitmask=0x0001, l3_len_bitmask_mask=0xffff, drop=1) # drop
...
#		testutils.verify_packets(self, exp_pkt, [eg_port])
		...
		npb_npb_sf2_policy_l34_v4_del(self, self.target, dsap=dsap, l3_len_bitmask=0x0000, l3_len_bitmask_mask=0xffff) # don't drop
		npb_npb_sf2_policy_l34_v4_del(self, self.target, dsap=dsap, l3_len_bitmask=0x0001, l3_len_bitmask_mask=0xffff) # drop
