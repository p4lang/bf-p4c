...
#		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, tun_type=IngressTunnelType.NONE.value,   tun_type_mask=0xf)

#		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, tun_type=IngressTunnelType.VXLAN.value,  tun_type_mask=0xf)
#		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, tun_type=IngressTunnelType.IPINIP.value, tun_type_mask=0xf)
#		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, tun_type=IngressTunnelType.NVGRE.value,  tun_type_mask=0xf)
#		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, tun_type=IngressTunnelType.GRE.value,    tun_type_mask=0xf)
#		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, tun_type=IngressTunnelType.GTPC.value,   tun_type_mask=0xf)
#		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, tun_type=IngressTunnelType.GTPU.value,   tun_type_mask=0xf)
#		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, tun_type=IngressTunnelType.ERSPAN.value, tun_type_mask=0xf)

		npb_pre_mirror_add(self, self.target, 5, "INGRESS", eg_port2)
		npb_ing_port_mirror_add(self, self.target, eg_port, 5);
...
#		npb_npb_sf0_policy_l2_del(self, self.target, sap=sap, tun_type=IngressTunnelType.ERSPAN.value, tun_type_mask=0xf)
		...
		npb_ing_port_mirror_del(self, self.target, eg_port);
