...
#		self.target = gc.Target(self.dev, pipe_id=0xffff)
	...
	def runTest(self):
		...
		npb_npb_sf0_policy_l34_v6_add(self, self.target, sap=sap, l3_len_rng=0x0000, l3_len_rng_mask=0xffff, flow_class=flow_class_acl, drop=0) # don't drop
		npb_npb_sf0_policy_l34_v6_add(self, self.target, sap=sap, l3_len_rng=0x0001, l3_len_rng_mask=0xffff, flow_class=flow_class_acl, drop=1) # drop
...
#		testutils.verify_packets(self, exp_pkt, [eg_port])
		...
		npb_npb_sf0_policy_l34_v6_del(self, self.target, sap=sap, l3_len_rng=0x0000, l3_len_rng_mask=0xffff) # don't drop
		npb_npb_sf0_policy_l34_v6_del(self, self.target, sap=sap, l3_len_rng=0x0001, l3_len_rng_mask=0xffff) # drop
