...
#			tunnel_encap_ptr, EgressTunnelType.NSH.value, tunnel_encap_nexthop_ptr, tunnel_encap_bd, dmac, tunnel_encap_smac_ptr, smac
		...
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.ERSPAN.value, tun_type_mask=0xf, mirror_enable=1, mirror_id=250, cpu_reason_code=5)
