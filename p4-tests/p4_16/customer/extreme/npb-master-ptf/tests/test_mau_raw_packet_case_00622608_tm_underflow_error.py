...
#		self.target = gc.Target(self.dev, pipe_id=0xffff)
	...
	def runTest(self):
		...
		for ig_pipe in ig_pipes:
			...
			ig_port_cpu = ig_swports[ig_pipe][0]   # cpu tx port
			eg_port_cpu = eg_swports[0]
			ig_port_cpu_2 = ig_swports[ig_pipe][1] # cpu rx port
			eg_port_cpu_2 = eg_swports[1]
			ig_port = ig_swports[ig_pipe][3]       # front panel port
