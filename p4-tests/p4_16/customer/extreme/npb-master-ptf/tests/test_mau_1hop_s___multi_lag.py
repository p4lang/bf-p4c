...
#			npb_tunnel_network_dst_vtep_add(self, self.target,ig_pipe, l3_src=sip, l3_src_mask=0xffffffff, l3_dst=dip, l3_dst_mask=0xffffffff, tun_type=IngressTunnelType.VXLAN.value,   tun_type_mask=0xf, sap=sap+1, vpn=vpn+1, port_lag_ptr=ig_lag_ptr+1, drop=0)
			...
			npb_nsh_bridge_no_eg_lag_add(self, self.target,ig_pipe, 
