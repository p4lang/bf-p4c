...
#			time.sleep(1)
			...
			src_pkt, exp_pkt = npb_simple_2lyr_gre_ip(
				...
				dmac=dmac, smac=smac,
				transport_decap=False, sf_bitmask=sf_bitmask, start_of_chain=True, end_of_chain=True, scope_term_list=[1], transport_encap=EgressTunnelType.IPV6_GRE.value,
			...
			src_pkt, exp_pkt = npb_simple_2lyr_erspan_udp(
				dmac_nsh=dmac, smac_nsh=smac, spi=spi, si=si, sap=sap, vpn=vpn, ttl=63, scope=1,
				dmac=dmac, smac=smac,
				transport_decap=True, sf_bitmask=sf_bitmask, start_of_chain=True, end_of_chain=True, scope_term_list=[], transport_encap=EgressTunnelType.IPV6_ERSPAN.value,
				spi_exp=spi, si_exp=si, sap_exp=sap, vpn_exp=vpn+1
			)
