...
#		rmac = dmac
		...
		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, vpn=vpn, tun_type=IngressTunnelType.GRE.value,    tun_type_mask=0xf, terminate=1)
		...
		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, vpn=vpn, tun_type=IngressTunnelType.GTPU.value,   tun_type_mask=0xf, terminate=1)
		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, vpn=vpn, tun_type=IngressTunnelType.ERSPAN.value, tun_type_mask=0xf, terminate=1)
