...
#			npb_npb_sf2_policy_l2_add(self, self.target, ig_pipe, dsap=dsap, tun_type=IngressTunnelType.NONE.value,   tun_type_mask=0xf)

#			npb_npb_sf2_policy_l2_add(self, self.target, ig_pipe, dsap=dsap, tun_type=IngressTunnelType.VXLAN.value,  tun_type_mask=0xf)
#			npb_npb_sf2_policy_l2_add(self, self.target, ig_pipe, dsap=dsap, tun_type=IngressTunnelType.IPINIP.value, tun_type_mask=0xf)
#			npb_npb_sf2_policy_l2_add(self, self.target, ig_pipe, dsap=dsap, tun_type=IngressTunnelType.NVGRE.value,  tun_type_mask=0xf)
#			npb_npb_sf2_policy_l2_add(self, self.target, ig_pipe, dsap=dsap, tun_type=IngressTunnelType.GRE.value,    tun_type_mask=0xf)
#			npb_npb_sf2_policy_l2_add(self, self.target, ig_pipe, dsap=dsap, tun_type=IngressTunnelType.GTPC.value,   tun_type_mask=0xf)
#			npb_npb_sf2_policy_l2_add(self, self.target, ig_pipe, dsap=dsap, tun_type=IngressTunnelType.GTPU.value,   tun_type_mask=0xf)
#			npb_npb_sf2_policy_l2_add(self, self.target, ig_pipe, dsap=dsap, tun_type=IngressTunnelType.ERSPAN.value, tun_type_mask=0xf)

			npb_pre_mirror_add(self, self.target, ig_pipe, 5, "EGRESS", eg_port2)
			npb_egr_port_mirror_add(self, self.target, ig_pipe, eg_port, 5);
