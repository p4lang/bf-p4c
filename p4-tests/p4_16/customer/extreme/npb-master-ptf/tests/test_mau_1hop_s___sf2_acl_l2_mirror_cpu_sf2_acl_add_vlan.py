...
#			[ig_port2], ig_lag_ptr, rmac, 0x0800, 0, vid, dmac2, eg_lag_ptr+1, 0+1, 0+1, [eg_port], False
		...
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.NONE.value,   tun_type_mask=0xf, mirror_enable=1, mirror_id=250, cpu_reason_code=5, add_tag_vlan_bd=5)

		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.VXLAN.value,  tun_type_mask=0xf, mirror_enable=1, mirror_id=250, cpu_reason_code=5, add_tag_vlan_bd=5)
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.IPINIP.value, tun_type_mask=0xf, mirror_enable=1, mirror_id=250, cpu_reason_code=5, add_tag_vlan_bd=5)
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.NVGRE.value,  tun_type_mask=0xf, mirror_enable=1, mirror_id=250, cpu_reason_code=5, add_tag_vlan_bd=5)
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.GRE.value,    tun_type_mask=0xf, mirror_enable=1, mirror_id=250, cpu_reason_code=5, add_tag_vlan_bd=5)
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.GTPC.value,   tun_type_mask=0xf, mirror_enable=1, mirror_id=250, cpu_reason_code=5, add_tag_vlan_bd=5)
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.GTPU.value,   tun_type_mask=0xf, mirror_enable=1, mirror_id=250, cpu_reason_code=5, add_tag_vlan_bd=5)
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.ERSPAN.value, tun_type_mask=0xf, mirror_enable=1, mirror_id=250, cpu_reason_code=5, add_tag_vlan_bd=5)

		npb_npb_sf2_policy_hdr_edit_add(self, self.target, bd=5, pcp=0, vid=0)

#		npb_pre_port_add(self, self.target, eg_port2)
		npb_pre_mirror_add(self, self.target, 250, "EGRESS", eg_port2) # this is defined in the p4 code: SWITCH_MIRROR_SESSION_CPU = 250
