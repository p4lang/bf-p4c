...
#include "../../src/multicast.p4"
#include "../../src/meter.p4"
#include "../../src/dtel.p4"

#include "../../src/npb_ing_parser.p4"
#include "../../src/npb_ing_set_lkp.p4"
#include "../../src/npb_ing_hdr_stack_counters.p4"
#include "../../src/npb_ing_top.p4"
#include "../../src/npb_ing_deparser.p4"
#include "../../src/npb_egr_parser.p4"
#include "../../src/npb_egr_set_lkp.p4"
#include "../../src/npb_egr_top.p4"
#include "../../src/npb_egr_deparser.p4"
...
//	MulticastFlooding(BD_FLOOD_TABLE_SIZE) flood;
	...
	IngressDtel() dtel;
#endif
	IngressHdrStackCounters(INSTANCE_DEPLOYMENT_PARAMS) IngressHdrStackCounters_inst;
...
//		if((hdr.transport.ethernet.isValid() == false) && (ig_md.nsh_md.l2_fwd_en == true)) {
		...
		if (ig_md.lkp_1.ip_type == SWITCH_IP_TYPE_NONE) {
			compute_non_ip_hash_symmetric.apply(ig_md.lkp_1, ig_md.hash[31:0]);
