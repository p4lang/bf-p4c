...
#		npb_npb_sf0_policy_l7_add(self, self.target, sap=sap, udf=0x000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f, udf_mask=0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff, scope=1)
		npb_npb_sf0_policy_l7_add(self, self.target, sap=sap, udf=0x000102030405060708090a0b0c0d0e0f, udf_mask=0xffffffffffffffffffffffffffffffff, scope=1)
