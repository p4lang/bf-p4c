...
#			[ig_port2], ig_lag_ptr, rmac, 0x0800, 0, vid, dmac2, eg_lag_ptr+1, 0+1, 0+1, [eg_port], False
		...
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.NONE.value,   tun_type_mask=0xf, copy_to_cpu=1, cpu_reason_code=5, add_tag_vlan_bd=5)

		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.VXLAN.value,  tun_type_mask=0xf, copy_to_cpu=1, cpu_reason_code=5, add_tag_vlan_bd=5)
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.IPINIP.value, tun_type_mask=0xf, copy_to_cpu=1, cpu_reason_code=5, add_tag_vlan_bd=5)
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.NVGRE.value,  tun_type_mask=0xf, copy_to_cpu=1, cpu_reason_code=5, add_tag_vlan_bd=5)
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.GRE.value,    tun_type_mask=0xf, copy_to_cpu=1, cpu_reason_code=5, add_tag_vlan_bd=5)
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.GTPC.value,   tun_type_mask=0xf, copy_to_cpu=1, cpu_reason_code=5, add_tag_vlan_bd=5)
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.GTPU.value,   tun_type_mask=0xf, copy_to_cpu=1, cpu_reason_code=5, add_tag_vlan_bd=5)
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.ERSPAN.value, tun_type_mask=0xf, copy_to_cpu=1, cpu_reason_code=5, add_tag_vlan_bd=5)
