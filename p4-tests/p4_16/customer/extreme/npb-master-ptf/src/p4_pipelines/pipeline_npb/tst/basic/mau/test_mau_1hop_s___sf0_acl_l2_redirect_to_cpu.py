...
#			tunnel_encap_ptr, EgressTunnelType.NSH.value, tunnel_encap_nexthop_ptr, tunnel_encap_bd, dmac, tunnel_encap_smac_ptr, smac
		...
		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, vpn=vpn, tun_type=IngressTunnelType.NONE.value,   tun_type_mask=0xf, flow_class=flow_class_acl, redirect_to_cpu=1, cpu_reason_code=5)

		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, vpn=vpn, tun_type=IngressTunnelType.VXLAN.value,  tun_type_mask=0xf, flow_class=flow_class_acl, redirect_to_cpu=1, cpu_reason_code=5)
		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, vpn=vpn, tun_type=IngressTunnelType.IPINIP.value, tun_type_mask=0xf, flow_class=flow_class_acl, redirect_to_cpu=1, cpu_reason_code=5)
		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, vpn=vpn, tun_type=IngressTunnelType.NVGRE.value,  tun_type_mask=0xf, flow_class=flow_class_acl, redirect_to_cpu=1, cpu_reason_code=5)
		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, vpn=vpn, tun_type=IngressTunnelType.GRE.value,    tun_type_mask=0xf, flow_class=flow_class_acl, redirect_to_cpu=1, cpu_reason_code=5)
		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, vpn=vpn, tun_type=IngressTunnelType.GTPC.value,   tun_type_mask=0xf, flow_class=flow_class_acl, redirect_to_cpu=1, cpu_reason_code=5)
		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, vpn=vpn, tun_type=IngressTunnelType.GTPU.value,   tun_type_mask=0xf, flow_class=flow_class_acl, redirect_to_cpu=1, cpu_reason_code=5)
		npb_npb_sf0_policy_l2_add(self, self.target, sap=sap, vpn=vpn, tun_type=IngressTunnelType.ERSPAN.value, tun_type_mask=0xf, flow_class=flow_class_acl, redirect_to_cpu=1, cpu_reason_code=5)
