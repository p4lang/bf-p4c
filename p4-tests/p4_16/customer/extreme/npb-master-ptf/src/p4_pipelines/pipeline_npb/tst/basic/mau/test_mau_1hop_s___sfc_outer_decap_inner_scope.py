...
#		self.target = gc.Target(self.dev, pipe_id=0xffff)
	...
	def runTest(self):
		...
		npb_tunnel_inner_sap_add(self, self.target, sap=sap, tun_type=IngressTunnelType.VXLAN.value,  tun_type_mask=0xf, sap_new=sap, vpn=vpn+2, scope=1)
		...
		npb_tunnel_inner_sap_add(self, self.target, sap=sap, tun_type=IngressTunnelType.NVGRE.value,  tun_type_mask=0xf, sap_new=sap, vpn=vpn+2, scope=1)
		npb_tunnel_inner_sap_add(self, self.target, sap=sap, tun_type=IngressTunnelType.GTPC.value,   tun_type_mask=0xf, sap_new=sap, vpn=vpn+2, scope=0)
		npb_tunnel_inner_sap_add(self, self.target, sap=sap, tun_type=IngressTunnelType.GTPU.value,   tun_type_mask=0xf, sap_new=sap, vpn=vpn+2, scope=1)
		npb_tunnel_inner_sap_add(self, self.target, sap=sap, tun_type=IngressTunnelType.ERSPAN.value, tun_type_mask=0xf, sap_new=sap, vpn=vpn+2, scope=1)
		npb_tunnel_inner_sap_add(self, self.target, sap=sap, tun_type=IngressTunnelType.GRE.value,    tun_type_mask=0xf, sap_new=sap, vpn=vpn+2, scope=1)
...
#		time.sleep(1)
		...
		src_pkt, exp_pkt = npb_simple_3lyr_vxlan_gre_ip(
			...
			sf_bitmask=sf_bitmask, start_of_chain=True, end_of_chain=False, scope_term_list=[1, 0],
