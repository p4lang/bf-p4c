...
*/
    ...
    defined(ERSPAN_TRANSPORT_INGRESS_ENABLE_V6)
       ...
       // defined(ERSPAN_TRANSPORT_INGRESS_ENABLE_V6)
#ifdef MPLS_SR_TRANSPORT_INGRESS_ENABLE
            ETHERTYPE_MPLS: parse_transport_mpls_0;
#endif // MPLS_SR_TRANSPORT_INGRESS_ENABLE       
            default: accept;
        }
    }
...
//#endif
        transition select(hdr.transport.gre.S, hdr.transport.gre.proto) {
            ...
            (0,ETHERTYPE_IPV6): parse_outer_ipv6;
#if defined(MPLSoGRE_ENABLE) && defined(MPLS_SR_TRANSPORT_INGRESS_ENABLE)
            (0,,ETHERTYPE_MPLS): parse_transport_mpls_0;
...
//         ig_md.lkp_0.tunnel_id = 0;
// //#endif
//         transition select(hdr.transport.gre.proto) {
//             ETHERTYPE_IPV4: parse_outer_ipv4;
//             ETHERTYPE_IPV6: parse_outer_ipv6;
//             default: parse_transport_erspan_t2;
//         }
//     }
