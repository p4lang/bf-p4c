...
control Npb_Ing_Top (
	...
	TunnelDecapTransport(INSTANCE_DEPLOYMENT_PARAMS, switch_tunnel_mode_t.PIPE) tunnel_decap_transport;
	...
	Npb_Ing_Sff_Top(INSTANCE_DEPLOYMENT_PARAMS) npb_ing_sff_top;

	Npb_Ing_Sf_Multicast_Top_Part1(INSTANCE_DEPLOYMENT_PARAMS, NPB_ING_SF_1_MULTICAST_SFF_TABLE_DEPTH) npb_ing_sf_multicast_top_part1;
...
*/
		...
		tunnel_decap_transport.apply(hdr_0, tunnel_0, hdr_1, tunnel_1, hdr_2, tunnel_2, hdr_3);
...
//		tunnel_0.encap = true;
//		tunnel_encap_transport.apply(hdr_0, tunnel_0, hdr_1);
