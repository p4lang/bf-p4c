...
struct switch_header_t {
    ...
    sctp_h sctp;
    esp_h esp;
    udf_opaque_h udf_opaque_0;
    udf_opaque_h udf_opaque_1;
    udf_opaque_h udf_opaque_2;
    udf_opaque_h udf_opaque_3;
    udf_opaque_h udf_opaque_4;
    udf_opaque_h udf_opaque_5;
    udf_opaque_h udf_opaque_6;
    udf_opaque_h udf_opaque_7;
    udf_opaque_h udf_opaque_8;
    udf_opaque_h udf_opaque_9;
    udf_opaque_h udf_opaque_10;
    udf_opaque_h udf_opaque_11;
    udf_opaque_h udf_opaque_12;
    udf_opaque_h udf_opaque_13;
    udf_opaque_h udf_opaque_14;
    udf_opaque_h udf_opaque_15;
    udf_opaque_h udf_opaque_16;
    udf_opaque_h udf_opaque_17;
    udf_opaque_h udf_opaque_18;
    udf_opaque_h udf_opaque_19;
    udf_opaque_h udf_opaque_20;
    udf_opaque_h udf_opaque_21;
    udf_opaque_h udf_opaque_22;
    udf_opaque_h udf_opaque_23;
    udf_opaque_h udf_opaque_24;
    udf_opaque_h udf_opaque_25;
    udf_opaque_h udf_opaque_26;
    udf_opaque_h udf_opaque_27;
    udf_opaque_h udf_opaque_28;
    udf_opaque_h udf_opaque_29;
    udf_opaque_h udf_opaque_30;
    udf_opaque_h udf_opaque_31;
...
const bit<32> IPV4_RACL_TABLE_SIZE = 1024;
 ...
 bit<8> inner_protocol;
    ...
    state parse_udp {
        ...
        transition select(hdr.udp.src_port, hdr.udp.dst_port) {
            (_, 4789): parse_vxlan;
            default : parse_udf_opaque;
        }
    }
    state parse_tcp {
        pkt.extract(hdr.tcp);
        transition parse_udf_opaque;
    }
    state parse_sctp {
    ...
    state parse_udf_opaque {
        pkt.extract(hdr.udf_opaque_0);
        pkt.extract(hdr.udf_opaque_1);
        pkt.extract(hdr.udf_opaque_2);
        pkt.extract(hdr.udf_opaque_3);
        pkt.extract(hdr.udf_opaque_4);
        pkt.extract(hdr.udf_opaque_5);
        pkt.extract(hdr.udf_opaque_6);
        pkt.extract(hdr.udf_opaque_7);
        pkt.extract(hdr.udf_opaque_8);
        pkt.extract(hdr.udf_opaque_9);
        pkt.extract(hdr.udf_opaque_10);
        pkt.extract(hdr.udf_opaque_11);
        pkt.extract(hdr.udf_opaque_12);
        pkt.extract(hdr.udf_opaque_13);
        pkt.extract(hdr.udf_opaque_14);
        pkt.extract(hdr.udf_opaque_15);
        pkt.extract(hdr.udf_opaque_16);
        pkt.extract(hdr.udf_opaque_17);
        pkt.extract(hdr.udf_opaque_18);
        pkt.extract(hdr.udf_opaque_19);
        pkt.extract(hdr.udf_opaque_20);
        pkt.extract(hdr.udf_opaque_21);
        pkt.extract(hdr.udf_opaque_22);
        pkt.extract(hdr.udf_opaque_23);
        pkt.extract(hdr.udf_opaque_24);
        pkt.extract(hdr.udf_opaque_25);
        pkt.extract(hdr.udf_opaque_26);
        pkt.extract(hdr.udf_opaque_27);
        pkt.extract(hdr.udf_opaque_28);
        pkt.extract(hdr.udf_opaque_29);
        pkt.extract(hdr.udf_opaque_30);
        pkt.extract(hdr.udf_opaque_31);
        transition accept;
    }
}
...
control PktValidation(
    ...
    action udf_miss() {}
    action udf_offset0_hit(bit<5> udf_offset) {
        if (udf_offset == 0) { lkp.udf_0 = hdr.udf_opaque_0.data; }
        else if(udf_offset == 1) { lkp.udf_0 = hdr.udf_opaque_1.data; }
        else if(udf_offset == 2) { lkp.udf_0 = hdr.udf_opaque_2.data; }
        else if(udf_offset == 3) { lkp.udf_0 = hdr.udf_opaque_3.data; }
    }
    table udf_offset0 {
        key = {
            lkp.ip_proto : ternary;
...
control npb_ing_sfc_top (
 ...
 action ing_sfc_flowtype_class_hit (
  bit<8> flow_type
 ) {
  ig_md.nsh_extr.extr_flow_type = flow_type;
 }
 table ing_sfc_flowtype_class {
  key = {
  ...
  actions = {
   NoAction;
   ing_sfc_flowtype_class_hit;
  }
  const default_action = NoAction;
  size = NPB_ING_SFC_FLOW_TYPE_TABLE_DEPTH;
 }
 action ing_sfc_sfc_class_hit (
  bit<24> nsh_sph_spi,
  bit<8> nsh_sph_si,
 ...
 apply {
  if(hdr.nsh_extr_underlay.isValid()) {
   ...
   if(ing_sfc_flowtype_class.apply().hit) {
    ing_sfc_sfc_class.apply();
   }
  }
 }
}
control npb_ing_sf_npb_basic_adv_top (
 ...
 table npb_ing_sf_policy_v4_exact {
  key = {
            ig_md.lkp_nsh.ip_type : exact;
   ig_md.lkp_nsh.ip_proto : exact;
 ...
 table npb_ing_sf_policy_v4_lpm {
  key = {
            ig_md.lkp_nsh.ip_type : exact;
   ig_md.lkp_nsh.ip_proto : exact;
 ...
 table npb_ing_sf_policy_v6_exact {
  key = {
            ig_md.lkp_nsh.ip_type : exact;
   ig_md.lkp_nsh.ip_proto : exact;
 ...
 table npb_ing_sf_policy_v6_lpm {
  key = {
            ig_md.lkp_nsh.ip_type : exact;
   ig_md.lkp_nsh.ip_proto : exact;
 ...
 apply {
  ...
  if(ig_md.lkp_nsh.ip_type == SWITCH_IP_TYPE_IPV4) {
   if (npb_ing_sf_policy_v4_exact.apply().hit) {
    sf_actions();
    npb_ing_sf_flow_schd.apply();
   } else {
    if(npb_ing_sf_policy_v4_lpm.apply().hit) {
     sf_actions();
     npb_ing_sf_flow_schd.apply();
    }
   }
  } else if(ig_md.lkp_nsh.ip_type == SWITCH_IP_TYPE_IPV6) {
   if (npb_ing_sf_policy_v6_exact.apply().hit) {
    sf_actions();
    npb_ing_sf_flow_schd.apply();
   } else {
    if(npb_ing_sf_policy_v6_lpm.apply().hit) {
     sf_actions();
     npb_ing_sf_flow_schd.apply();
    }
   }
...
control npb_ing_sf_npb_basic_adv_dedup (
 ...
 apply {
  bit<8> return_value;
  flowtable_hash_lo = h1.get({eg_md.lkp.ipv4_src_addr, eg_md.lkp.ipv4_dst_addr, eg_md.lkp.ip_proto, eg_md.lkp.l4_src_port, eg_md.lkp.l4_dst_port});
  flowtable_hash_hi = h2.get({eg_md.lkp.ipv4_src_addr, eg_md.lkp.ipv4_dst_addr, eg_md.lkp.ip_proto, eg_md.lkp.l4_src_port, eg_md.lkp.l4_dst_port});
