...
//		out bool copp_enable_,
//		out switch_copp_meter_id_t copp_meter_id_
) (
...
//     }
    ...
    state parse_outer_gre {
        ...
        transition select(
          ...
          // C R K S s r f v
            (0,0,0,0,0,0,0,0): extract_outer_gre;
            (1,0,0,0,0,0,0,0): extract_outer_gre;
            (0,0,1,0,0,0,0,0): extract_outer_gre;
            (0,0,0,1,0,0,0,0): extract_outer_gre;
            default: parse_udf;
        }
    }

    state extract_outer_gre {
        pkt.extract(hdr.outer.gre);
        ig_md.lkp_1.tunnel_type = SWITCH_TUNNEL_TYPE_GRE;
        ig_md.lkp_1.tunnel_id = 0;
        ...
        transition select(
          ...
          // C K S
            ...
            (0,1,0,0x6558): extract_outer_nvgre;
            ...
            (1,0,0,_): extract_outer_gre_optional;
            (0,1,0,_): extract_outer_gre_optional;
            (0,0,1,_): extract_outer_gre_optional;
            default: parse_udf;
        }
    }


    state extract_outer_gre_optional {
...
//     }    
    ...
    state parse_inner_gre {
        ...
        transition select(
          ...
          // C R K S s r f v
            (0,0,0,0,0,0,0,0): extract_inner_gre;
            (1,0,0,0,0,0,0,0): extract_inner_gre;
            (0,0,1,0,0,0,0,0): extract_inner_gre;
            (0,0,0,1,0,0,0,0): extract_inner_gre;
            default: parse_udf;
        }
    }

    state extract_inner_gre {
        pkt.extract(hdr.inner.gre);
        ig_md.lkp_2.tunnel_type = SWITCH_TUNNEL_TYPE_GRE;
        ig_md.lkp_2.tunnel_id = 0;
        ...
        transition select(
            ...
            (1,0,0,_): extract_inner_gre_optional;
            (0,1,0,_): extract_inner_gre_optional;
            (0,0,1,_): extract_inner_gre_optional;
            default: parse_udf;
        }
    }

    state extract_inner_gre_optional {
...
//     }
    ...
    state parse_outer_gre_scope0 {
        ...
        transition select(
          ...
          // C R K S s r f v
            (0,0,0,0,0,0,0,0): extract_outer_gre_scope0;
            (1,0,0,0,0,0,0,0): extract_outer_gre_scope0;
            (0,0,1,0,0,0,0,0): extract_outer_gre_scope0;
            (0,0,0,1,0,0,0,0): extract_outer_gre_scope0;
            default: accept;
        }
    }
    ...
    state parse_outer_gre_scope1 {
        ...
        transition select(
          ...
          // C R K S s r f v
            (0,0,0,0,0,0,0,0): extract_outer_gre_scope1;
            (1,0,0,0,0,0,0,0): extract_outer_gre_scope1;
            (0,0,1,0,0,0,0,0): extract_outer_gre_scope1;
            (0,0,0,1,0,0,0,0): extract_outer_gre_scope1;
            default: accept;
        }
    }


    state extract_outer_gre_scope0 {
        pkt.extract(hdr.outer.gre);
        ...
        transition select(
          ...
          // C K S
            ...
            (0,1,0,0x6558): extract_outer_nvgre_scope0;
            ...
            (1,0,0,_): extract_outer_gre_optional_scope0;
            (0,1,0,_): extract_outer_gre_optional_scope0;
            (0,0,1,_): extract_outer_gre_optional_scope0;
            default: accept;
        }
    }

    state extract_outer_gre_scope1 {
        pkt.extract(hdr.outer.gre);
        eg_md.lkp_1.tunnel_inner_type = SWITCH_TUNNEL_TYPE_GRE; // note: inner here means "current scope - 1"
        ...
        transition select(
          ...
          // C K S
            ...
            (0,1,0,0x6558): extract_outer_nvgre_scope1;
            ...
            (1,0,0,_): extract_outer_gre_optional_scope1;
            (0,1,0,_): extract_outer_gre_optional_scope1;
            (0,0,1,_): extract_outer_gre_optional_scope1;
            default: accept;
        }
    }


    state extract_outer_gre_optional_scope0 {
        pkt.extract(hdr.outer.gre_optional);
        transition select(hdr.outer.gre.proto) {
    ...
    state extract_outer_gre_optional_scope1 {
        pkt.extract(hdr.outer.gre_optional);
        transition select(hdr.outer.gre.proto) {
...
//     }
    ...
    state parse_inner_gre_scope0 {
        ...
        transition select(
          ...
          // C R K S s r f v
            (0,0,0,0,0,0,0,0): extract_inner_gre_scope0;
            (1,0,0,0,0,0,0,0): extract_inner_gre_scope0;
            (0,0,1,0,0,0,0,0): extract_inner_gre_scope0;
            (0,0,0,1,0,0,0,0): extract_inner_gre_scope0;
            default: accept;
        }
    }
    ...
    state parse_inner_gre_scope1 {
        ...
        transition select(
          ...
          // C R K S s r f v
            (0,0,0,0,0,0,0,0): extract_inner_gre_scope1;
            (1,0,0,0,0,0,0,0): extract_inner_gre_scope1;
            (0,0,1,0,0,0,0,0): extract_inner_gre_scope1;
            (0,0,0,1,0,0,0,0): extract_inner_gre_scope1;
            default: accept;
        }
    }


    state extract_inner_gre_scope0 {
        pkt.extract(hdr.inner.gre);
    ...
    state extract_inner_gre_scope1 {
        pkt.extract(hdr.inner.gre);
        eg_md.lkp_1.tunnel_type = SWITCH_TUNNEL_TYPE_GRE;
        eg_md.lkp_1.tunnel_id = 0;
