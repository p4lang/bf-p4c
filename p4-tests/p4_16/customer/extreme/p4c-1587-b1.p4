...
control npb_ing_sf_npb_basic_adv_dedup (
 ...
 apply {
  flowtable_hash_lo = h_lo.get({eg_md.lkp.ipv4_src_addr, eg_md.lkp.ipv4_dst_addr, eg_md.lkp.ip_proto, eg_md.lkp.l4_src_port, eg_md.lkp.l4_dst_port});
  flowtable_hash_hi = h_hi.get({eg_md.lkp.ipv4_src_addr, eg_md.lkp.ipv4_dst_addr, eg_md.lkp.ip_proto, eg_md.lkp.l4_src_port, eg_md.lkp.l4_dst_port});
