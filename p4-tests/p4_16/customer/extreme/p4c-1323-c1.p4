...
action add_bridged_md(
  ...
  bridged_md.ipv4_src_addr = ig_md.lkp.ipv4_src_addr;
  bridged_md.ipv4_dst_addr = ig_md.lkp.ipv4_dst_addr;
  bridged_md.ip_proto = ig_md.lkp.ip_proto;
}
...
parser NpbEgressParser(
 ...
 bit<8> inner_protocol;
  ...
  eg_md.lkp.ipv4_src_addr = hdr.bridged_md.ipv4_src_addr;
  eg_md.lkp.ipv4_dst_addr = hdr.bridged_md.ipv4_dst_addr;
  eg_md.lkp.ip_proto = hdr.bridged_md.ip_proto;
...
control npb_ing_sf_npb_basic_adv_dedup (
 ...
 apply {
  ...
  bit<32> temp_lo;
  bit<32> temp_hi;
  flowtable_hash = h.get ({eg_md.lkp.ipv4_src_addr, eg_md.lkp.ipv4_dst_addr, eg_md.lkp.ip_proto, eg_md.lkp.l4_src_port, eg_md.lkp.l4_dst_port});
