...
Pipeline(
    IngressParser(INSTANCE_DEPLOYMENT_PARAMS_PIPELINE_NPB_IGONLY_EGONLY_IGONLY),
    IngressControl(INSTANCE_DEPLOYMENT_PARAMS_PIPELINE_NPB_IGONLY_EGONLY_IGONLY),
    IngressDeparser(INSTANCE_DEPLOYMENT_PARAMS_PIPELINE_NPB_IGONLY_EGONLY_IGONLY),
    EgressParser(INSTANCE_DEPLOYMENT_PARAMS_PIPELINE_NPB_IGONLY_EGONLY_IGONLY),
    EgressControl(INSTANCE_DEPLOYMENT_PARAMS_PIPELINE_NPB_IGONLY_EGONLY_IGONLY),
    EgressDeparser(INSTANCE_DEPLOYMENT_PARAMS_PIPELINE_NPB_IGONLY_EGONLY_IGONLY)) pipeline_npb_igOnly_C;
...
Pipeline(
    ...
    EgressParser(INSTANCE_DEPLOYMENT_PARAMS_PIPELINE_NPB_IGONLY_EGONLY_IGONLY),
    EgressControl(INSTANCE_DEPLOYMENT_PARAMS_PIPELINE_NPB_IGONLY_EGONLY_IGONLY),
    EgressDeparser(INSTANCE_DEPLOYMENT_PARAMS_PIPELINE_NPB_IGONLY_EGONLY_IGONLY)) pipeline_npb_igOnly_B;
...
Pipeline(
    ...
    EgressParser(INSTANCE_DEPLOYMENT_PARAMS_PIPELINE_NPB_IGONLY_EGONLY_IGONLY),
    EgressControl(INSTANCE_DEPLOYMENT_PARAMS_PIPELINE_NPB_IGONLY_EGONLY_IGONLY),
    EgressDeparser(INSTANCE_DEPLOYMENT_PARAMS_PIPELINE_NPB_IGONLY_EGONLY_IGONLY)) pipeline_npb_igOnly_A;
