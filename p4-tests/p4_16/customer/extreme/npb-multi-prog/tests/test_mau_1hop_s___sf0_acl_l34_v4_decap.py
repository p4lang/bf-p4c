...
#		self.target = gc.Target(self.dev, pipe_id=0xffff)
	...
	def runTest(self):
		...
		for ig_pipe in ig_pipes:
			...
			npb_npb_sf0_policy_l34_v4_add(self, self.target, ig_pipe, sap=sap, tun_type=IngressTunnelType.VXLAN.value,  tun_type_mask=0xf, flow_class=flow_class_acl, terminate=1)
			npb_npb_sf0_policy_l34_v4_add(self, self.target, ig_pipe, sap=sap, tun_type=IngressTunnelType.IPINIP.value, tun_type_mask=0xf, flow_class=flow_class_acl, terminate=1)
			npb_npb_sf0_policy_l34_v4_add(self, self.target, ig_pipe, sap=sap, tun_type=IngressTunnelType.NVGRE.value,  tun_type_mask=0xf, flow_class=flow_class_acl, terminate=1)
			npb_npb_sf0_policy_l34_v4_add(self, self.target, ig_pipe, sap=sap, tun_type=IngressTunnelType.GRE.value,    tun_type_mask=0xf, flow_class=flow_class_acl, terminate=1)
			npb_npb_sf0_policy_l34_v4_add(self, self.target, ig_pipe, sap=sap, tun_type=IngressTunnelType.GTPC.value,   tun_type_mask=0xf, flow_class=flow_class_acl, terminate=0)
			npb_npb_sf0_policy_l34_v4_add(self, self.target, ig_pipe, sap=sap, tun_type=IngressTunnelType.GTPU.value,   tun_type_mask=0xf, flow_class=flow_class_acl, terminate=1)
			npb_npb_sf0_policy_l34_v4_add(self, self.target, ig_pipe, sap=sap, tun_type=IngressTunnelType.ERSPAN.value, tun_type_mask=0xf, flow_class=flow_class_acl, terminate=1)
