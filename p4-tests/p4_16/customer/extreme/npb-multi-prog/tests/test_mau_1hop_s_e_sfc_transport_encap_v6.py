...
#			dip = "0.0.0.4"
			...
			npb_tunnel_network_dst_vtep_add(self, self.target,ig_pipe,                                                                         tun_type=IngressTunnelType.VXLAN.value,   tun_type_mask=0xf, sap=sap, vpn=vpn+1, port_lag_ptr=ig_lag_ptr, drop=0)
			npb_tunnel_network_dst_vtep_add(self, self.target,ig_pipe,                                                                         tun_type=IngressTunnelType.IPINIP.value,  tun_type_mask=0xf, sap=sap, vpn=vpn+2, port_lag_ptr=ig_lag_ptr, drop=0)
			npb_tunnel_network_dst_vtep_add(self, self.target,ig_pipe,                                                                         tun_type=IngressTunnelType.NVGRE.value,   tun_type_mask=0xf, sap=sap, vpn=vpn+4, port_lag_ptr=ig_lag_ptr, drop=0)
			npb_tunnel_network_dst_vtep_add(self, self.target,ig_pipe,                                                                         tun_type=IngressTunnelType.GTPC.value,    tun_type_mask=0xf, sap=sap, vpn=vpn+5, port_lag_ptr=ig_lag_ptr, drop=0)
			npb_tunnel_network_dst_vtep_add(self, self.target,ig_pipe,                                                                         tun_type=IngressTunnelType.GTPU.value,    tun_type_mask=0xf, sap=sap, vpn=vpn+6, port_lag_ptr=ig_lag_ptr, drop=0)
			npb_tunnel_network_dst_vtep_add(self, self.target,ig_pipe,                                                                         tun_type=IngressTunnelType.ERSPAN.value,  tun_type_mask=0xf, sap=sap, vpn=vpn+7, port_lag_ptr=ig_lag_ptr, drop=0)
			npb_tunnel_network_dst_vtep_add(self, self.target,ig_pipe,                                                                         tun_type=IngressTunnelType.GRE.value,     tun_type_mask=0xf, sap=sap, vpn=vpn+8, port_lag_ptr=ig_lag_ptr, drop=0)
