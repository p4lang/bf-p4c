...
#			dip = "0.0.0.4"
			...
			npb_tunnel_network_dst_vtep_add(self=self, target=self.target, ig_pipe=ig_pipe,
				l2_dst = dmac, l2_dst_mask = 0xffffffffffff,
				l2_vid = 20, l2_vid_mask = 0xfff,
				tun_type=IngressTunnelType.SPBM.value,   tun_type_mask=0xf, 
				tun_id=(1<<29)|(20011<<0), tun_id_mask=0xffffffff,
...
#			time.sleep(1)
			...
			src_pkt, exp_pkt = npb_simple_2lyr_spbm_tcp(
