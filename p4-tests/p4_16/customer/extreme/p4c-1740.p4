...
struct switch_header_t {
    ...
    sctp_h sctp;
    esp_h esp;
    udf_byte_h udf_byte_0;
    udf_byte_h udf_byte_1;
    udf_byte_h udf_byte_2;
    udf_byte_h udf_byte_3;
...
parser ParserUdf(
    packet_in pkt,
    in bit<5> udf_offset,
    inout udf_byte_h udf_byte) {
    state start {
        transition select(udf_offset) {
            0 : parse_udf_0;
            1 : parse_udf_1;
            2 : parse_udf_2;
            3 : parse_udf_3;
...
parser NpbIngressParser(
 ...
 bit<5> udf_offset_3;
    ...
    state parse_port_metadata {
        ...
        udf_offset_0 = port_md.udf_offset_0;
        udf_offset_1 = port_md.udf_offset_1;
        udf_offset_2 = port_md.udf_offset_2;
        udf_offset_3 = port_md.udf_offset_3;
    ...
    state parse_udf_0 {
        parser_udf.apply(pkt, udf_offset_0, hdr.udf_byte_0);
        transition parse_udf_1;
    }
    state parse_udf_1 {
        parser_udf.apply(pkt, udf_offset_1, hdr.udf_byte_1);
        transition parse_udf_2;
    }
    state parse_udf_2 {
        parser_udf.apply(pkt, udf_offset_2, hdr.udf_byte_2);
        transition parse_udf_3;
    }
    state parse_udf_3 {
        parser_udf.apply(pkt, udf_offset_3, hdr.udf_byte_3);
        transition accept;
    }
}
