// p4c-bfn -I/usr/share/p4c/p4include -DP416=1 -DPROFILE_P416_NAT_STATIC=1 -Ibf_arista_switch_p416_nat_static/includes  --parser-timing-reports --verbose 2 --display-power-budget -g -Xp4c='--disable-power-check --auto-init-metadata --create-graphs --disable-parser-state-merging -T table_summary:3,table_placement:3,input_xbar:6,live_range_report:1 --Wdisable=uninitialized_out_param --Wdisable=unused --Wdisable=table-placement' --o bf_arista_switch_p416_nat_static --bf-rt-schema bf_arista_switch_p416_nat_static/context/bf-rt.json
...
@pa_container_size("ingress" , "McCracken.Shirley.$valid" , 16) @pa_container_size("ingress" , "McCracken.Paulding.$valid" , 16) @pa_atomic("egress" , "McCracken.Grays.Fabens") @pa_atomic("egress" , "McCracken.Grays.Connell") @pa_container_size("egress" , "McCracken.Grays.McCaulley" , 16) @pa_atomic("ingress" , "LaMoille.Cutten.Quebrada") @pa_atomic("ingress" , "LaMoille.Naubinway.Heppner") @pa_atomic("ingress" , "LaMoille.Cutten.Merrill") @pa_atomic("ingress" , "LaMoille.Bessie.Whitewood") @pa_atomic("ingress" , "LaMoille.Cutten.Naruna") @pa_mutually_exclusive("egress" , "LaMoille.Naubinway.Blencoe" , "McCracken.Broadwell.Blencoe") @pa_mutually_exclusive("egress" , "McCracken.Maumee.Mankato" , "McCracken.Broadwell.Blencoe") @pa_mutually_exclusive("ingress" , "LaMoille.Cutten.Naruna" , "LaMoille.Wisdom.Mystic") @pa_no_init("ingress" , "LaMoille.Cutten.Naruna") @pa_atomic("ingress" , "LaMoille.Cutten.Naruna") @pa_atomic("ingress" , "LaMoille.Wisdom.Mystic") @pa_no_overlay("ingress" , "LaMoille.Cutten.Montross") @pa_container_size("ingress" , "LaMoille.Cutten.Glenmora" , 16) @pa_no_overlay("ingress" , "LaMoille.McCaskill.Pajaros") @pa_no_overlay("ingress" , "LaMoille.McCaskill.Wauconda") @pa_no_overlay("ingress" , "LaMoille.Stennett.Satolah") @pa_no_overlay("ingress" , "LaMoille.Cutten.Redden") @pa_no_overlay("ingress" , "LaMoille.Cutten.Uvalde") @pa_no_overlay("ingress" , "LaMoille.Naubinway.Dyess") @pa_no_overlay("ingress" , "ig_intr_md_for_tm.copy_to_cpu") @pa_alias("ingress" , "LaMoille.Burwell.Roachdale" , "ig_intr_md_for_dprsr.mirror_type") @pa_alias("egress" , "LaMoille.Burwell.Roachdale" , "eg_intr_md_for_dprsr.mirror_type") header Sagerton {
    bit<8> Exell;
}
...
@pa_no_init("ingress" , "LaMoille.Moose.Kaluaaha") @pa_no_init("ingress" , "LaMoille.Moose.Calcasieu") @pa_no_init("ingress" , "LaMoille.Moose.Chevak") @pa_no_init("ingress" , "LaMoille.Moose.Mendocino") @pa_no_init("ingress" , "LaMoille.Moose.LasVegas") @pa_no_init("ingress" , "LaMoille.Moose.PineCity") @pa_no_init("ingress" , "LaMoille.Moose.Exton") @pa_no_init("ingress" , "LaMoille.Moose.Noyes") @pa_no_init("ingress" , "LaMoille.Moose.Hueytown") @pa_atomic("ingress" , "LaMoille.Moose.Kaluaaha") @pa_atomic("ingress" , "LaMoille.Moose.Calcasieu") @pa_atomic("ingress" , "LaMoille.Moose.Chevak") @pa_atomic("ingress" , "LaMoille.Moose.Mendocino") @pa_atomic("ingress" , "LaMoille.Moose.Noyes") control Pound(inout GlenAvon McCracken, inout Sublett LaMoille, in ingress_intrinsic_metadata_t Hayfield, in ingress_intrinsic_metadata_from_parser_t Guion, inout ingress_intrinsic_metadata_for_deparser_t ElkNeck, inout ingress_intrinsic_metadata_for_tm_t Calabash) {
...
@pa_no_init("ingress" , "LaMoille.Burwell.Roachdale") @pa_no_init("ingress" , "LaMoille.Burwell.Miller") control Almeria(inout GlenAvon McCracken, inout Sublett LaMoille, in ingress_intrinsic_metadata_t Hayfield, in ingress_intrinsic_metadata_from_parser_t Guion, inout ingress_intrinsic_metadata_for_deparser_t ElkNeck, inout ingress_intrinsic_metadata_for_tm_t Calabash) {
