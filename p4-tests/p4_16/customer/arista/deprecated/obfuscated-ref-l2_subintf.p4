/* obfuscated-1GWvx */
// p4c-bfn -I/usr/share/p4c/p4include -DP416=1 -DPROFILE_L2SUBINTF=1 -Ibf_arista_switch_l2subintf/includes   --verbose 3 --display-power-budget -g -Xp4c='--disable-mpr-config --disable-power-check --auto-init-metadata --create-graphs -T table_summary:3,table_placement:3,input_xbar:6,live_range_report:1,clot_info:6 --verbose --Wdisable=uninitialized_out_param --Wdisable=unused --Wdisable=table-placement' --target tofino-tna --o bf_arista_switch_l2subintf --bf-rt-schema bf_arista_switch_l2subintf/context/bf-rt.json
...
@pa_container_size("ingress" , "Balmorhea.Doddridge.Sardinia" , 32)
@pa_mutually_exclusive("ingress" , "Balmorhea.Pawtucket.Tombstone" , "Balmorhea.Buckhorn.Tombstone")
@pa_alias("ingress" , "Balmorhea.Bridger.Selawik" , "ig_intr_md_for_dprsr.mirror_type")
@pa_alias("egress" , "Balmorhea.Bridger.Selawik" , "eg_intr_md_for_dprsr.mirror_type")
@pa_atomic("ingress" , "Balmorhea.Cassa.Devers") @gfm_parity_enable header Sudbury {
    bit<8> Allgood;
}
...
@pa_alias("egress" , "Balmorhea.NantyGlo.Matheson" , "eg_intr_md.egress_port")
...
@pa_alias("ingress" , "Balmorhea.Mickleton.Pachuta" , "Balmorhea.Mickleton.Whitefish")
@pa_alias("egress" , "Balmorhea.Mentone.Pachuta" , "Balmorhea.Mentone.Whitefish")
@pa_mutually_exclusive("egress" , "Balmorhea.Rainelle.Manilla" , "Balmorhea.Rainelle.Lecompte")
@pa_alias("ingress" , "Balmorhea.Dateland.Wauconda" , "Balmorhea.Dateland.Pajaros")
...
@pa_alias("ingress" , "Balmorhea.Barnhill.Florien" , "ig_intr_md_for_tm.ingress_cos")
@pa_alias("ingress" , "ig_intr_md_for_tm.ingress_cos" , "Balmorhea.Barnhill.Florien")
@pa_alias("ingress" , "Balmorhea.Rainelle.Bushland" , "Daisytown.Toluca.Oriskany")
@pa_alias("egress" , "Balmorhea.Rainelle.Bushland" , "Daisytown.Toluca.Oriskany")
@pa_alias("ingress" , "Balmorhea.Rainelle.Madera" , "Daisytown.Toluca.Bowden")
@pa_alias("egress" , "Balmorhea.Rainelle.Madera" , "Daisytown.Toluca.Bowden")
@pa_alias("ingress" , "Balmorhea.Rainelle.Horton" , "Daisytown.Toluca.Cabot")
@pa_alias("egress" , "Balmorhea.Rainelle.Horton" , "Daisytown.Toluca.Cabot")
@pa_alias("ingress" , "Balmorhea.Rainelle.Lacona" , "Daisytown.Toluca.Keyes")
@pa_alias("egress" , "Balmorhea.Rainelle.Lacona" , "Daisytown.Toluca.Keyes")
@pa_alias("ingress" , "Balmorhea.Rainelle.Ivyland" , "Daisytown.Toluca.Basic")
@pa_alias("egress" , "Balmorhea.Rainelle.Ivyland" , "Daisytown.Toluca.Basic")
@pa_alias("ingress" , "Balmorhea.Rainelle.Lovewell" , "Daisytown.Toluca.Freeman")
@pa_alias("egress" , "Balmorhea.Rainelle.Lovewell" , "Daisytown.Toluca.Freeman")
@pa_alias("ingress" , "Balmorhea.Rainelle.Quinhagak" , "Daisytown.Toluca.Exton")
@pa_alias("egress" , "Balmorhea.Rainelle.Quinhagak" , "Daisytown.Toluca.Exton")
@pa_alias("ingress" , "Balmorhea.Rainelle.Waipahu" , "Daisytown.Toluca.Floyd")
@pa_alias("egress" , "Balmorhea.Rainelle.Waipahu" , "Daisytown.Toluca.Floyd")
@pa_alias("ingress" , "Balmorhea.Rainelle.Ipava" , "Daisytown.Toluca.Fayette")
@pa_alias("egress" , "Balmorhea.Rainelle.Ipava" , "Daisytown.Toluca.Fayette")
@pa_alias("ingress" , "Balmorhea.Rainelle.Bufalo" , "Daisytown.Toluca.Osterdock")
@pa_alias("egress" , "Balmorhea.Rainelle.Bufalo" , "Daisytown.Toluca.Osterdock")
@pa_alias("ingress" , "Balmorhea.Rainelle.Lenexa" , "Daisytown.Toluca.PineCity")
@pa_alias("egress" , "Balmorhea.Rainelle.Lenexa" , "Daisytown.Toluca.PineCity")
@pa_alias("ingress" , "Balmorhea.Rainelle.LakeLure" , "Daisytown.Toluca.Alameda")
@pa_alias("egress" , "Balmorhea.Rainelle.LakeLure" , "Daisytown.Toluca.Alameda")
@pa_alias("ingress" , "Balmorhea.Millston.Pinole" , "Daisytown.Toluca.Rexville")
@pa_alias("egress" , "Balmorhea.Millston.Pinole" , "Daisytown.Toluca.Rexville")
@pa_alias("egress" , "Balmorhea.Barnhill.Florien" , "Daisytown.Toluca.Quinwood")
@pa_alias("ingress" , "Balmorhea.Cassa.Toklat" , "Daisytown.Toluca.Marfa")
@pa_alias("egress" , "Balmorhea.Cassa.Toklat" , "Daisytown.Toluca.Marfa")
@pa_alias("ingress" , "Balmorhea.Cassa.Lordstown" , "Daisytown.Toluca.Palatine")
@pa_alias("egress" , "Balmorhea.Cassa.Lordstown" , "Daisytown.Toluca.Palatine")
@pa_alias("egress" , "Balmorhea.HillTop.Staunton" , "Daisytown.Toluca.Mabelle")
@pa_alias("ingress" , "Balmorhea.Sopris.Allison" , "Daisytown.Toluca.Cisco")
@pa_alias("egress" , "Balmorhea.Sopris.Allison" , "Daisytown.Toluca.Cisco")
@pa_alias("ingress" , "Balmorhea.Sopris.Kenney" , "Daisytown.Toluca.Connell")
@pa_alias("egress" , "Balmorhea.Sopris.Kenney" , "Daisytown.Toluca.Connell")
@pa_alias("ingress" , "Balmorhea.Sopris.Helton" , "Daisytown.Toluca.Hoagland")
@pa_alias("egress" , "Balmorhea.Sopris.Helton" , "Daisytown.Toluca.Hoagland") header Adona {
    bit<8>  Selawik;
    bit<3>  Connell;
    bit<1>  Cisco;
    bit<4>  Higginson;
...
@pa_mutually_exclusive("egress" , "Daisytown.Eolia.Joslin" , "Daisytown.Goodwin.Idalia") struct BealCity {
    Adona      Toluca;
    Ocoee      Goodwin;
    Cecilton   Livonia;
    Albemarle  Bernice;
...
control Baker(inout BealCity Daisytown, inout Provencal Balmorhea, in ingress_intrinsic_metadata_t Hapeville, in ingress_intrinsic_metadata_from_parser_t Earling, inout ingress_intrinsic_metadata_for_deparser_t Udall, inout ingress_intrinsic_metadata_for_tm_t Barnhill) {
    ...
    @name(".Glenoma") action Glenoma(bit<16> Pajaros) {
        Balmorhea.Dateland.Renick = (bit<2>)2w0;
        Balmorhea.Dateland.Pajaros = Pajaros;
    }
    @name(".Thurmond") action Thurmond(bit<16> Pajaros) {
        Balmorhea.Dateland.Renick = (bit<2>)2w2;
        Balmorhea.Dateland.Pajaros = Pajaros;
    }
    @name(".Lauada") action Lauada(bit<16> Pajaros) {
        Balmorhea.Dateland.Renick = (bit<2>)2w3;
        Balmorhea.Dateland.Pajaros = Pajaros;
    }
    @name(".RichBar") action RichBar(bit<16> Wauconda) {
        Balmorhea.Dateland.Wauconda = Wauconda;
        Balmorhea.Dateland.Renick = (bit<2>)2w1;
    }
    @name(".Harding") action Harding(bit<16> Nephi, bit<16> Pajaros) {
        Balmorhea.Pawtucket.Tombstone = Nephi;
        Glenoma(Pajaros);
    }
    @name(".Tofte") action Tofte(bit<16> Nephi, bit<16> Pajaros) {
        Balmorhea.Pawtucket.Tombstone = Nephi;
        Thurmond(Pajaros);
    }
    @name(".Jerico") action Jerico(bit<16> Nephi, bit<16> Pajaros) {
        Balmorhea.Pawtucket.Tombstone = Nephi;
        Lauada(Pajaros);
    }
    @name(".Wabbaseka") action Wabbaseka(bit<16> Nephi, bit<16> Wauconda) {
        Balmorhea.Pawtucket.Tombstone = Nephi;
        RichBar(Wauconda);
    }
...
control Swanlake(inout BealCity Daisytown, inout Provencal Balmorhea, in ingress_intrinsic_metadata_t Hapeville, in ingress_intrinsic_metadata_from_parser_t Earling, inout ingress_intrinsic_metadata_for_deparser_t Udall, inout ingress_intrinsic_metadata_for_tm_t Barnhill) {
    ...
    @name(".Geistown") action Geistown(bit<16> Nephi, bit<16> Pajaros) {
        Balmorhea.Buckhorn.Tombstone = Nephi;
        Glenoma(Pajaros);
    }
    @name(".Lindy") action Lindy(bit<16> Nephi, bit<16> Pajaros) {
        Balmorhea.Buckhorn.Tombstone = Nephi;
        Thurmond(Pajaros);
    }
    @name(".Brady") action Brady(bit<16> Nephi, bit<16> Pajaros) {
        Balmorhea.Buckhorn.Tombstone = Nephi;
        Lauada(Pajaros);
    }
    @name(".Emden") action Emden(bit<16> Nephi, bit<16> Wauconda) {
        Balmorhea.Buckhorn.Tombstone = Nephi;
        RichBar(Wauconda);
    }
...
control Westoak(inout BealCity Daisytown, inout Provencal Balmorhea, in ingress_intrinsic_metadata_t Hapeville, in ingress_intrinsic_metadata_from_parser_t Earling, inout ingress_intrinsic_metadata_for_deparser_t Udall, inout ingress_intrinsic_metadata_for_tm_t Barnhill) {
    ...
    @name(".Lefor") action Lefor(bit<16> Nephi, bit<16> Pajaros) {
        Balmorhea.Buckhorn.Tombstone = Nephi;
        Glenoma(Pajaros);
    }
    @name(".Starkey") action Starkey(bit<16> Nephi, bit<16> Pajaros) {
        Balmorhea.Buckhorn.Tombstone = Nephi;
        Thurmond(Pajaros);
    }
    @name(".Volens") action Volens(bit<16> Nephi, bit<16> Pajaros) {
        Balmorhea.Buckhorn.Tombstone = Nephi;
        Lauada(Pajaros);
    }
    @name(".Ravinia") action Ravinia(bit<16> Nephi, bit<16> Wauconda) {
        Balmorhea.Buckhorn.Tombstone = Nephi;
        RichBar(Wauconda);
    }
    ...
    @name(".Robstown") action Robstown(bit<16> Ponder) {
        Glenoma(Ponder);
    }
    ...
    @ways(2) @atcam_partition_index("Pawtucket.Tombstone") @atcam_number_partitions(10240) @idletime_precision(1) @force_immediate(1) @disable_atomic_modify(1) @name(".Philip") table Philip {
        actions = {
            Glenoma();
            Thurmond();
            Lauada();
...
control Boyle(inout BealCity Daisytown, inout Provencal Balmorhea, in ingress_intrinsic_metadata_t Hapeville, in ingress_intrinsic_metadata_from_parser_t Earling, inout ingress_intrinsic_metadata_for_deparser_t Udall, inout ingress_intrinsic_metadata_for_tm_t Barnhill) {
    @name(".Ackerly") action Ackerly(bit<2> Renick, bit<16> Pajaros) {
        Balmorhea.Dateland.Renick = (bit<2>)2w0;
        Balmorhea.Dateland.Pajaros = Pajaros;
    }
    ...
    @disable_atomic_modify(1) @name(".Wauconda") table Wauconda {
        ...
        key = {
            Balmorhea.Dateland.Wauconda & 16w0x3ff: exact @name("Dateland.Wauconda") ;
...
control Hemlock(inout BealCity Daisytown, inout Provencal Balmorhea, in ingress_intrinsic_metadata_t Hapeville, in ingress_intrinsic_metadata_from_parser_t Earling, inout ingress_intrinsic_metadata_for_deparser_t Udall, inout ingress_intrinsic_metadata_for_tm_t Barnhill) {
    ...
    @disable_atomic_modify(1) @name(".Goodlett") table Goodlett {
        ...
        key = {
            ...
            Balmorhea.Rainelle.Edgemoor & 20w0x80000: ternary @name("Rainelle.Edgemoor") ;
        }
        requires_versioning = false;
        default_action = NoAction();
    }
...
control Bostic(inout BealCity Daisytown, inout Provencal Balmorhea, in ingress_intrinsic_metadata_t Hapeville, in ingress_intrinsic_metadata_from_parser_t Earling, inout ingress_intrinsic_metadata_for_deparser_t Udall, inout ingress_intrinsic_metadata_for_tm_t Barnhill) {
    @name(".Danbury") action Danbury(bit<3> Suwannee, QueueId_t Monse) {
    ...
    @disable_atomic_modify(1) @name(".Chatom") table Chatom {
        ...
        default_action = Danbury(3w0, 5w0);
        size = 306;
        requires_versioning = false;
    }
    apply {
...
control Papeton(inout BealCity Daisytown, inout Provencal Balmorhea, in egress_intrinsic_metadata_t NantyGlo, in egress_intrinsic_metadata_from_parser_t Yatesboro, inout egress_intrinsic_metadata_for_deparser_t Maxwelton, inout egress_intrinsic_metadata_for_output_port_t Ihlen) {
    @name(".Faulkton") action Faulkton(bit<6> Helton, bit<2> Philmont) {
...
control Brule(inout BealCity Daisytown, inout Provencal Balmorhea, in egress_intrinsic_metadata_t NantyGlo, in egress_intrinsic_metadata_from_parser_t Yatesboro, inout egress_intrinsic_metadata_for_deparser_t Maxwelton, inout egress_intrinsic_metadata_for_output_port_t Ihlen) {
    ...
    @name(".Tekonsha") action Tekonsha(bit<24> Lowes, bit<8> Aguilita) {
    ...
    @disable_atomic_modify(1) @stage(1) @name(".Blanding") table Blanding {
        actions = {
            Durant();
        }
        key = {
...
control Haugen(inout BealCity Daisytown, inout Provencal Balmorhea, in egress_intrinsic_metadata_t NantyGlo, in egress_intrinsic_metadata_from_parser_t Yatesboro, inout egress_intrinsic_metadata_for_deparser_t Maxwelton, inout egress_intrinsic_metadata_for_output_port_t Ihlen) {
    ...
    @name(".Dunkerton") action Dunkerton(bit<24> Clarkdale, bit<24> Talbert, bit<16> Ragley) {
        Nowlin(Daisytown.Gastonia.StarLake, 16w30, Clarkdale, Talbert, Clarkdale, Talbert, Ragley);
        Cowley(Daisytown.Gastonia.StarLake, 16w50);
        Daisytown.Gastonia.Garibaldi = Daisytown.Gastonia.Garibaldi - 8w1;
    }
    @name(".Gunder") action Gunder(bit<24> Clarkdale, bit<24> Talbert, bit<16> Ragley) {
        Nowlin(Daisytown.Hillsview.Killen, 16w70, Clarkdale, Talbert, Clarkdale, Talbert, Ragley);
        Cowley(Daisytown.Hillsview.Killen, 16w90);
        Daisytown.Hillsview.Riner = Daisytown.Hillsview.Riner - 8w1;
    }
    ...
    @name(".Estrella") action Estrella(bit<16> Bonney, bit<16> Ashburn, bit<16> Luverne, bit<24> Grabill, bit<24> Moorcroft, bit<24> Clarkdale, bit<24> Talbert, bit<16> Ragley) {
        Maury(Bonney, Ashburn, Grabill, Moorcroft, Clarkdale, Talbert, Ragley);
        Cowley(Bonney, Luverne);
    }
    @name(".Amsterdam") action Amsterdam(bit<24> Clarkdale, bit<24> Talbert, bit<16> Ragley) {
        Daisytown.Greenwood.setValid();
        Estrella(Balmorhea.NantyGlo.Uintah, 16w12, 16w32, Daisytown.Kamrar.Grabill, Daisytown.Kamrar.Moorcroft, Clarkdale, Talbert, Ragley);
    }
    @name(".Gwynn") action Gwynn(bit<24> Clarkdale, bit<24> Talbert, bit<16> Ragley) {
        Saxis(8w0);
        Amsterdam(Clarkdale, Talbert, Ragley);
    }
    @name(".Rolla") action Rolla(bit<24> Clarkdale, bit<24> Talbert, bit<16> Ragley) {
        Amsterdam(Clarkdale, Talbert, Ragley);
    }
    @name(".Brookwood") action Brookwood(bit<24> Clarkdale, bit<24> Talbert, bit<16> Ragley) {
        Saxis(8w255);
        Estrella(Daisytown.Gastonia.StarLake, 16w30, 16w50, Clarkdale, Talbert, Clarkdale, Talbert, Ragley);
    }
    @name(".Granville") action Granville(bit<24> Clarkdale, bit<24> Talbert, bit<16> Ragley) {
        Baldridge(8w255);
        Estrella(Daisytown.Hillsview.Killen, 16w70, 16w90, Clarkdale, Talbert, Clarkdale, Talbert, Ragley);
    }
...
parser Mocane(packet_in Lindsborg, out BealCity Daisytown, out Provencal Balmorhea, out egress_intrinsic_metadata_t NantyGlo) {
    ...
    state start {
        ...
        transition select(NantyGlo.egress_port, (Lindsborg.lookahead<Chaska>()).Selawik) {
            (9w66 &&& 9w0x1fe, 8w0 &&& 8w0): Wyandanch;
            (9w0 &&& 9w0, 8w0 &&& 8w0x7): Slick;
            default: Lansdale;
        }
    }
    state Wyandanch {
