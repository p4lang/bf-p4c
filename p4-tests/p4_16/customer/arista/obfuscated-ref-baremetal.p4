// p4c-bfn -I/usr/share/p4c/p4include -DP416=1 -DPROFILE_P416_BAREMETAL=1 -Ibf_arista_switch_p416_baremetal/includes  --parser-timing-reports --verbose 2 --display-power-budget -g -Xp4c='--disable-power-check --create-graphs --disable-parser-state-merging -T table_summary:3,table_placement:3,input_xbar:6,live_range_report:1 --Wdisable=uninitialized_out_param --Wdisable=unused --Wdisable=table-placement' --o bf_arista_switch_p416_baremetal --bf-rt-schema bf_arista_switch_p416_baremetal/context/bf-rt.json
...
@pa_container_size("ingress", "Cassa.Sublett.Chevak", 32)
@pa_container_size("ingress", "Cassa.Ackley.Kenbridge", 32)
