...
@pa_mutually_exclusive("egress" , "Alstown.Elkville.Bushland" , "Lookeba.Wesson.Bushland") @pa_mutually_exclusive("egress" , "Lookeba.Masontown.Oriskany" , "Lookeba.Wesson.Bushland") @pa_mutually_exclusive("egress" , "Lookeba.Wesson.Bushland" , "Alstown.Elkville.Bushland") @pa_mutually_exclusive("egress" , "Lookeba.Wesson.Bushland" , "Lookeba.Masontown.Oriskany") @pa_mutually_exclusive("ingress" , "Alstown.Mickleton.Steger" , "Alstown.Nuyaka.Glenmora") @pa_no_init("ingress" , "Alstown.Mickleton.Steger") @pa_mutually_exclusive("ingress" , "Alstown.Mickleton.Luzerne" , "Alstown.Nuyaka.Hickox") @pa_mutually_exclusive("ingress" , "Alstown.Mickleton.Belfair" , "Alstown.Nuyaka.Merrill") @pa_no_init("ingress" , "Alstown.Mickleton.Luzerne") @pa_no_init("ingress" , "Alstown.Mickleton.Belfair") @pa_atomic("ingress" , "Alstown.Mickleton.Belfair") @pa_atomic("ingress" , "Alstown.Nuyaka.Merrill") @pa_alias("ingress" , "Alstown.Wildorado.Garibaldi" , "Alstown.Mickleton.Garibaldi") @pa_alias("ingress" , "Alstown.Wildorado.Joslin" , "Alstown.Mickleton.Steger") @pa_alias("ingress" , "Alstown.Wildorado.Coalwood" , "Alstown.Mickleton.Soledad") @pa_container_size("egress" , "Lookeba.Wesson.Hackett" , 32) @pa_container_size("egress" , "Alstown.Elkville.Atoka" , 16) @pa_container_size("egress" , "Lookeba.HighRock.Findlay" , 32) @pa_atomic("ingress" , "Alstown.Elkville.Edgemoor") @pa_atomic("ingress" , "Alstown.Elkville.LakeLure") @pa_atomic("ingress" , "Alstown.McBrides.Bonduel") @pa_atomic("ingress" , "Alstown.Mentone.Norland") @pa_atomic("ingress" , "Alstown.Dozier.Joslin") @pa_no_init("ingress" , "Alstown.Mickleton.Colona") @pa_no_init("ingress" , "Alstown.Barnhill.Miranda") @pa_no_init("ingress" , "Alstown.Barnhill.Peebles") @pa_atomic("ingress" , "Alstown.Astor.Freeny") @pa_atomic("ingress" , "Alstown.Astor.Tiburon") @pa_atomic("ingress" , "Alstown.Astor.Sonoma") @pa_no_init("ingress" , "Alstown.Astor.Freeny") @pa_no_init("ingress" , "Alstown.Astor.Belgrade") @pa_no_init("ingress" , "Alstown.Astor.Burwell") @pa_no_init("ingress" , "Alstown.Astor.GlenAvon") @pa_no_init("ingress" , "Alstown.Astor.Wondervu") @pa_container_size("ingress" , "Lookeba.Udall.Findlay" , 8 , 8 , 16 , 32 , 32 , 32) @pa_container_size("ingress" , "Lookeba.Wesson.Laurelton" , 8) @pa_container_size("ingress" , "Alstown.Mickleton.Garibaldi" , 8) @pa_container_size("ingress" , "Alstown.Baytown.Wauconda" , 32) @pa_container_size("ingress" , "Alstown.McBrides.Sardinia" , 32) @pa_container_size("ingress" , "Alstown.Astor.Freeny" , 32) @pa_solitary("ingress" , "Alstown.Dozier.Dowell") @pa_container_size("ingress" , "Alstown.Dozier.Dowell" , 16) @pa_container_size("ingress" , "Alstown.Dozier.Findlay" , 16) @pa_container_size("ingress" , "Alstown.Dozier.Basalt" , 8) @pa_atomic("ingress" , "Alstown.Baytown.Pajaros") @pa_atomic("ingress" , "Alstown.Baytown.Wauconda") @pa_mutually_exclusive("ingress" , "Alstown.Mentone.Tombstone" , "Alstown.Elvaston.Tombstone") @pa_alias("ingress" , "Alstown.Hohenwald.Selawik" , "ig_intr_md_for_dprsr.mirror_type") @pa_alias("egress" , "Alstown.Hohenwald.Selawik" , "eg_intr_md_for_dprsr.mirror_type") @pa_atomic("ingress" , "Alstown.Mickleton.Devers") @gfm_parity_enable header Sudbury {
    bit<8> Allgood;
}
