// p4c-bfn -I/usr/share/p4c/p4include -DP416=1 -DPROFILE_P416_DEFAULT=1 -Ibf_arista_switch_p416_default/includes  --parser-timing-reports --verbose 2 --display-power-budget -g -Xp4c='--disable-power-check --auto-init-metadata --create-graphs --disable-parser-state-merging -T table_summary:3,table_placement:3,input_xbar:6,live_range_report:1 --Wdisable=uninitialized_out_param --Wdisable=unused --Wdisable=table-placement' --o bf_arista_switch_p416_default --bf-rt-schema bf_arista_switch_p416_default/context/bf-rt.json
