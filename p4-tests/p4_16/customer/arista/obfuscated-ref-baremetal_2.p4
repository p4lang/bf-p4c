/* obfuscated-czAdf.p4 */
// p4c-bfn -I/usr/share/p4c/p4include -DP416=1 -DPROFILE_BAREMETAL=1 -Ibf_arista_switch_baremetal/includes   --verbose 3 --display-power-budget -g -Xp4c='--disable-mpr-config --disable-power-check --auto-init-metadata --create-graphs -T table_summary:3,table_placement:3,input_xbar:6,live_range_report:1,clot_info:6 --verbose --Wdisable=uninitialized_out_param --Wdisable=unused --Wdisable=table-placement' --target tofino-tna --o bf_arista_switch_baremetal --bf-rt-schema bf_arista_switch_baremetal/context/bf-rt.json
...
control Cruso(inout Sumner Boonsboro, inout Dateland Talco, in egress_intrinsic_metadata_t Livonia, in egress_intrinsic_metadata_from_parser_t Duchesne, inout egress_intrinsic_metadata_for_deparser_t Centre, inout egress_intrinsic_metadata_for_output_port_t Pocopson) {
    ...
    @name(".Millican") action Millican() {
        bit<19> Bellmead;
        Bellmead = Valmont.get<tuple<bit<9>, bit<12>>>({ Livonia.egress_port, Talco.Lawai.Grassflat });
...
@pa_no_init("ingress" , "Talco.Lawai.Rudolph") control Rodessa(inout Sumner Boonsboro, inout Dateland Talco, in ingress_intrinsic_metadata_t Toluca, in ingress_intrinsic_metadata_from_parser_t Terral, inout ingress_intrinsic_metadata_for_deparser_t HighRock, inout ingress_intrinsic_metadata_for_tm_t Goodwin) {
    ...
    @name(".Unity") action Unity() {
        Talco.LaMoille.Crestone = Hookstown.get<tuple<bit<24>, bit<24>, bit<24>, bit<24>, bit<16>>>({ Boonsboro.Masontown.Horton, Boonsboro.Masontown.Lacona, Boonsboro.Masontown.Grabill, Boonsboro.Masontown.Moorcroft, Talco.Emida.Lathrop });
    }
    ...
    @name(".SandCity") action SandCity() {
        Talco.McCracken.Peebles = Almont.get<tuple<bit<32>, bit<32>, bit<8>>>({ Talco.Sopris.Findlay, Talco.Sopris.Dowell, Talco.Doddridge.Glenmora });
    }
    @name(".Newburgh.Roosville") Hash<bit<16>>(HashAlgorithm_t.CRC16) Newburgh;
    @name(".Baroda") action Baroda() {
        Talco.McCracken.Peebles = Newburgh.get<tuple<bit<128>, bit<128>, bit<20>, bit<8>>>({ Talco.Thaxton.Findlay, Talco.Thaxton.Dowell, Boonsboro.Daisytown.Littleton, Talco.Doddridge.Glenmora });
    }
