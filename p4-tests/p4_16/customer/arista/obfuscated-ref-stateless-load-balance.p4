/* obfuscated-CrfNV.p4 */
// p4c-bfn -I/usr/share/p4c/p4include -DP416=1 -DPROFILE_STATELESS_LOAD_BALANCE=1 -Ibf_arista_switch_stateless_load_balance/includes   --verbose 3 --display-power-budget -g -Xp4c='--disable-mpr-config --disable-power-check --auto-init-metadata --create-graphs -T table_summary:3,table_placement:3,input_xbar:6,live_range_report:1,clot_info:6 --verbose --Wdisable=uninitialized_out_param --Wdisable=unused --Wdisable=table-placement' --target tofino-tna --o bf_arista_switch_stateless_load_balance --bf-rt-schema bf_arista_switch_stateless_load_balance/context/bf-rt.json
...
control McDonough(inout Westbury Jayton, inout McCracken Millstone, in ingress_intrinsic_metadata_t Astor, in ingress_intrinsic_metadata_from_parser_t Lookeba, inout ingress_intrinsic_metadata_for_deparser_t Alstown, inout ingress_intrinsic_metadata_for_tm_t Hohenwald) {
    ...
    @disable_atomic_modify(1) @ways(3) @placement_priority(2) @name(".Skene") table Skene {
        actions = {
            Earlham();
            @defaultonly NoAction();
        }
