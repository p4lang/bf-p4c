...
@pa_container_size("ingress" , "Daisytown.Makawao.$valid" , 8) @pa_container_size("ingress" , "Daisytown.Millhaven.$valid" , 8) @pa_atomic("ingress" , "Daisytown.Toluca.Rexville") @pa_container_size("ingress" , "Daisytown.Toluca.Rexville" , 16) @pa_atomic("ingress" , "Daisytown.Toluca.Alameda") @pa_atomic("ingress" , "Balmorhea.Rainelle.Edgemoor") @pa_container_size("ingress" , "Balmorhea.Dateland.Renick" , 8) @pa_atomic("ingress" , "Balmorhea.Cassa.Belfair") @pa_container_size("ingress" , "Balmorhea.Doddridge.Sardinia" , 32) @pa_mutually_exclusive("ingress" , "Balmorhea.Pawtucket.Tombstone" , "Balmorhea.Buckhorn.Tombstone") @pa_alias("ingress" , "Balmorhea.Bridger.Selawik" , "ig_intr_md_for_dprsr.mirror_type") @pa_alias("egress" , "Balmorhea.Bridger.Selawik" , "eg_intr_md_for_dprsr.mirror_type") @pa_atomic("ingress" , "Balmorhea.Cassa.Devers") @gfm_parity_enable header Sudbury {
    bit<8> Allgood;
}
