...
control Mabana(inout Grassflat Standish, inout Provo Blairsden, inout ingress_intrinsic_metadata_for_tm_t Earling) {
    ...
    action BigPoint(bit<20> Alameda, bit<32> Tenstrike) {
        ...
        Earling.disable_ucast_cutthru = 1w1;
    }
    @ways(1) table Castle {
        actions = {
            McCracken();
    ...
    action Rives() {
        {
            ...
            Standish.Whitewood.Madera = Blairsden.Daphne.Woodfield;
            Standish.Whitewood.Cardenas = Blairsden.Daphne.Fairhaven;
        }
    }
