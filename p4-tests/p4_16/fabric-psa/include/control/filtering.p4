...
control Filtering (inout parsed_headers_t hdr,
     ...
     */
    DirectCounter<bit<32>>(PSA_CounterType_t.PACKETS_AND_BYTES) ingress_port_vlan_counter;
     ...
     *   IP(0x0800 or 0x86dd)
     */
    DirectCounter<bit<32>>(PSA_CounterType_t.PACKETS_AND_BYTES) fwd_classifier_counter;
