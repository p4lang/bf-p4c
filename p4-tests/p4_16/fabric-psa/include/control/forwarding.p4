...
control Forwarding (inout parsed_headers_t hdr,
     ...
     * Bridging Table.
     */
    DirectCounter<bit<32>>(PSA_CounterType_t.PACKETS_AND_BYTES) bridging_counter;
     ...
     * MPLS Table.
     */
    DirectCounter<bit<32>>(PSA_CounterType_t.PACKETS_AND_BYTES) mpls_counter;
     ...
     * IPv4 Routing Table.
     */
    DirectCounter<bit<32>>(PSA_CounterType_t.PACKETS_AND_BYTES) routing_v4_counter;
     ...
     * IPv6 Routing Table.
     */
    DirectCounter<bit<32>>(PSA_CounterType_t.PACKETS_AND_BYTES) routing_v6_counter;
