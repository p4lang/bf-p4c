...
#else
        /* expect error@-4: "Using checksum verify in direct assignment to set .*; is \
not supported when the left-hand side of the assignment can be written multiple times for one packet\." */
#endif
