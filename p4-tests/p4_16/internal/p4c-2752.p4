    ...
    out ingress_intrinsic_metadata_t  ig_intr_md)
{
    ...
    state start {
        ...
        packet_parser.apply(pkt, hdr, pkt_meta);
    ...
    inout ingress_intrinsic_metadata_for_tm_t        ig_tm_md)
{
    ...
    apply {
        ...
        meta.bridge.l4_payload_checksum = meta.l4_payload_checksum;
        ...
        meta.bridge.udp_checksum_update = (bit<1>)meta.udp_checksum_update;
    }
}
