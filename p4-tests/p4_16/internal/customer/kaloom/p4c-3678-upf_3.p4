 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 20 "upf/p4src/pipe3/upf_3.p4" 2

# 1 "upf/p4src/pipe3/UPFIngress7_3.p4" 1
/*******************************************************************************
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 12 "upf/p4src/pipe3/UPFIngress7_3.p4" 2
# 1 "common/p4lib/core/headers/types.p4" 1
/****************************************************************
 * Copyright (c) Kaloom Inc., 2018
 *
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 13 "upf/p4src/pipe3/UPFIngress7_3.p4" 2
...
# 15 "upf/p4src/pipe3/UPFIngress7_3.p4" 2
...
# 16 "upf/p4src/pipe3/UPFIngress7_3.p4" 2
...
# 17 "upf/p4src/pipe3/UPFIngress7_3.p4" 2
...
# 18 "upf/p4src/pipe3/UPFIngress7_3.p4" 2
...
# 19 "upf/p4src/pipe3/UPFIngress7_3.p4" 2
...
//=============================================================================
// Ingress 7_3 Parser (Downlink)
//=============================================================================
parser UPFIngress7_3Parser(
    packet_in pkt,
    out headers hdr,
...
//=============================================================================
// Ingress7_3 control (Downlink)
//=============================================================================

control UPFIngress_Downlink_7_3(
    inout headers hdr,
    inout upf_ingress_metadata_t ig_md,
    in ingress_intrinsic_metadata_t ig_intr_md,
    ...
    SessionTableDownlink(100000) session_table;
    Punt() punt;
    LAGDownlink() lag;
    ...
    apply {
        ...
        port_cntr.count(hdr.bridged_md.ingress_port);
         if (hdr.outer_ipv4.isValid() == true) {
            set_ip_lkpv4();
        } else {
            set_ip_lkpv6();
        }
...
# 22 "upf/p4src/pipe3/upf_3.p4" 2
# 1 "upf/p4src/pipe3/UPFEgress6_3.p4" 1
/*******************************************************************************
* Copyright (c) Kaloom Inc., 2019
*
* This unpublished material is property of Kaloom Inc.
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 13 "upf/p4src/pipe3/UPFEgress6_3.p4" 2
# 1 "common/p4lib/core/headers/types.p4" 1
/****************************************************************
 * Copyright (c) Kaloom Inc., 2018
 *
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 14 "upf/p4src/pipe3/UPFEgress6_3.p4" 2
 ...
 * forbidden except by express written permission of Kaloom Inc.
 ****************************************************************/
# 16 "upf/p4src/pipe3/UPFEgress6_3.p4" 2
# 1 "upf/p4src/common/session_table.p4" 1
/*******************************************************************************
* Copyright (c) Kaloom Inc., 2018
*
...
* forbidden except by express written permission of Kaloom Inc.
****************************************************************/
# 17 "upf/p4src/pipe3/UPFEgress6_3.p4" 2

//=============================================================================
// Egress 6_3 Parser (Downlink)
//=============================================================================
parser UPFEgress6_3Parser(
            packet_in pkt,
            out headers hdr,
...
//=============================================================================
// Egress 6_3 control (Dowlink)
//=============================================================================

control UPFEgress_Downlink_6_3(
    inout headers hdr,
    ...
    SessionTableDownlink(105000) session_table;
    PolicyTableDownlink(4096) policy_table;
    ...
    apply {
        ...
        if(hdr.bridged_md.flow_table == 0x0){
            policy_table.apply(hdr,eg_md.srcAddrv6, eg_md.dstAddrv6, eg_md.nextHdrv6);
        }
...
# 23 "upf/p4src/pipe3/upf_3.p4" 2

Pipeline(UPFIngress7_3Parser(),
  UPFIngress_Downlink_7_3(),
  UPFIngress7_3Deparser(),
  UPFEgress6_3Parser(),
  UPFEgress_Downlink_6_3(),
  UPFEgress6_3Deparser()) pipe;
