...
@pa_no_init("egress" , "Moosic.Moultrie.Townville")
@pa_no_init("egress" , "Moosic.Moultrie.Monahans")
@pa_mutually_exclusive("egress" , "Uniopolis.Rochert.Montross" , "Moosic.Moultrie.Townville")
@pa_mutually_exclusive("egress" , "Uniopolis.Rochert.Osterdock" , "Moosic.Moultrie.Monahans")
@pa_mutually_exclusive("egress" , "Uniopolis.Thurmond.Spearman" , "Uniopolis.Lauada.Dowell")
@pa_mutually_exclusive("egress" , "Uniopolis.Thurmond.Ronda" , "Uniopolis.Harding.Turkey")
@pa_mutually_exclusive("egress" , "Uniopolis.Thurmond.Laurelton" , "Uniopolis.Harding.Killen")
@pa_mutually_exclusive("egress" , "Uniopolis.Tofte.Madawaska" , "Moosic.Nooksack.Baytown")
@pa_mutually_exclusive("egress" , "Uniopolis.Jerico.Madawaska" , "Moosic.Nooksack.Baytown")
...
control Eaton(inout Olmitz Uniopolis, inout Harriet Moosic, in ingress_intrinsic_metadata_t Sedan, in ingress_intrinsic_metadata_from_parser_t Ossining, inout ingress_intrinsic_metadata_for_deparser_t Nason, inout ingress_intrinsic_metadata_for_tm_t Almota) {
    ...
    @ways(1) @disable_atomic_modify(1) @name(".Hagewood") table Hagewood {
        ...
        key = {
            Uniopolis.Lauada.Quogue     : exact @name("Lauada.Quogue") ;
            Uniopolis.Lindy[0].Woodfield: exact @name("Lindy[0].Woodfield") ;
        }
    ...
    apply {
        switch (Beeler.apply().action_run) {
            ...
            default: {
                if (Uniopolis.Lauada.Quogue == 1w0) {
                    Slinger.apply();
                }
...
control Rockfield(inout Olmitz Uniopolis, inout Harriet Moosic, in egress_intrinsic_metadata_t Lemont, in egress_intrinsic_metadata_from_parser_t Langford, inout egress_intrinsic_metadata_for_deparser_t Cowley, inout egress_intrinsic_metadata_for_output_port_t Lackey) {
    ...
    @ternary(1) @disable_atomic_modify(1) @name(".Shevlin") table Shevlin {
        ...
        key = {
            ...
            Moosic.Lemont.Harbor: exact @name("Lemont.Harbor") ;
        }
        size = 1024;
...
control Eudora(inout Olmitz Uniopolis, inout Harriet Moosic, in egress_intrinsic_metadata_t Lemont, in egress_intrinsic_metadata_from_parser_t Langford, inout egress_intrinsic_metadata_for_deparser_t Cowley, inout egress_intrinsic_metadata_for_output_port_t Lackey) {
    ...
    @disable_atomic_modify(1) @name(".Mantee") table Mantee {
        ...
        key = {
            ...
            Uniopolis.Skillman.Coalwood : ternary @name("Skillman.Coalwood") ;
            Uniopolis.Olcott.McBride    : ternary @name("Olcott.McBride") ;
            Moosic.Swifton.Greenland    : ternary @name("Swifton.Greenland") ;
        }
        const default_action = NoAction();
        requires_versioning = false;
...
control Keltys(inout Olmitz Uniopolis, inout Harriet Moosic, in egress_intrinsic_metadata_t Lemont, in egress_intrinsic_metadata_from_parser_t Langford, inout egress_intrinsic_metadata_for_deparser_t Cowley, inout egress_intrinsic_metadata_for_output_port_t Lackey) {
    ...
    @use_hash_action(1) @disable_atomic_modify(1) @stage(2) @name(".BigPark") table BigPark {
        actions = {
            Maupin();
        }
        key = {
...
control Turney(inout Olmitz Uniopolis, inout Harriet Moosic, in egress_intrinsic_metadata_t Lemont, in egress_intrinsic_metadata_from_parser_t Langford, inout egress_intrinsic_metadata_for_deparser_t Cowley, inout egress_intrinsic_metadata_for_output_port_t Lackey) {
    ...
    @ways(2) @disable_atomic_modify(1) @name(".English") table English {
        ...
        key = {
            ...
            Moosic.Lemont.Harbor & 9w0x7f: exact @name("Lemont.Harbor") ;
...
control Bairoil(inout Olmitz Uniopolis, inout Harriet Moosic, in egress_intrinsic_metadata_t Lemont, in egress_intrinsic_metadata_from_parser_t Langford, inout egress_intrinsic_metadata_for_deparser_t Cowley, inout egress_intrinsic_metadata_for_output_port_t Lackey) {
    ...
    @name(".Benitez") action Benitez() {
        bit<12> Basye;
        Basye = Berrydale.get<tuple<bit<9>, bit<5>>>({ Moosic.Lemont.Harbor, Lemont.egress_qid[4:0] });
...
control Anniston(inout Olmitz Uniopolis, inout Harriet Moosic, in egress_intrinsic_metadata_t Lemont, in egress_intrinsic_metadata_from_parser_t Langford, inout egress_intrinsic_metadata_for_deparser_t Cowley, inout egress_intrinsic_metadata_for_output_port_t Lackey) {
    ...
    @name(".Nashua") action Nashua() {
        bit<19> Basye;
        Basye = Humble.get<tuple<bit<9>, bit<12>>>({ Moosic.Lemont.Harbor, (bit<12>)Moosic.Moultrie.RedElm });
...
control Dovray(inout Olmitz Uniopolis, inout Harriet Moosic, in egress_intrinsic_metadata_t Lemont, in egress_intrinsic_metadata_from_parser_t Langford, inout egress_intrinsic_metadata_for_deparser_t Cowley, inout egress_intrinsic_metadata_for_output_port_t Lackey) {
    @name(".Ellinger") action Ellinger(bit<8> Westbury) {
        Moosic.Peoria.Westbury = Westbury;
        Moosic.Moultrie.Chavies = (bit<3>)3w0;
    }
    @ternary(1) @disable_atomic_modify(1) @name(".BoyRiver") table BoyRiver {
        actions = {
            Ellinger();
        }
        key = {
        ...
        const default_action = Ellinger(8w0);
        size = 8192;
    }
    apply {
        BoyRiver.apply();
...
control Waukegan(inout Olmitz Uniopolis, inout Harriet Moosic, in egress_intrinsic_metadata_t Lemont, in egress_intrinsic_metadata_from_parser_t Langford, inout egress_intrinsic_metadata_for_deparser_t Cowley, inout egress_intrinsic_metadata_for_output_port_t Lackey) {
    @name(".Clintwood") DirectCounter<bit<64>>(CounterType_t.PACKETS) Clintwood;
    @name(".Thalia") action Thalia(bit<3> Almedia) {
        Clintwood.count();
        Moosic.Moultrie.Chavies = Almedia;
    }
    @ignore_table_dependency(".Melrude") @ignore_table_dependency(".Cisne") @disable_atomic_modify(1) @name(".Trammel") table Trammel {
        key = {
            Moosic.Peoria.Westbury     : ternary @name("Peoria.Westbury") ;
            Uniopolis.Skillman.Commack : ternary @name("Skillman.Commack") ;
            Uniopolis.Skillman.Bonney  : ternary @name("Skillman.Bonney") ;
            Uniopolis.Skillman.Coalwood: ternary @name("Skillman.Coalwood") ;
            Uniopolis.Lefor.Joslin     : ternary @name("Lefor.Joslin") ;
            Uniopolis.Lefor.Weyauwega  : ternary @name("Lefor.Weyauwega") ;
            Moosic.Moultrie.McCammon   : ternary @name("Volens.Chugwater") ;
            Moosic.Swifton.Greenland   : ternary @name("Swifton.Greenland") ;
        }
        actions = {
            Thalia();
...
control Caldwell(inout Olmitz Uniopolis, inout Harriet Moosic, in egress_intrinsic_metadata_t Lemont, in egress_intrinsic_metadata_from_parser_t Langford, inout egress_intrinsic_metadata_for_deparser_t Cowley, inout egress_intrinsic_metadata_for_output_port_t Lackey) {
    @name(".Sahuarita") DirectCounter<bit<64>>(CounterType_t.PACKETS) Sahuarita;
    @name(".Thalia") action Thalia(bit<3> Almedia) {
        Sahuarita.count();
        Moosic.Moultrie.Chavies = Almedia;
    }
    @ignore_table_dependency(".Trammel") @ignore_table_dependency("Cisne") @disable_atomic_modify(1) @name(".Melrude") table Melrude {
        key = {
            Moosic.Peoria.Westbury   : ternary @name("Peoria.Westbury") ;
            Uniopolis.Olcott.Commack : ternary @name("Olcott.Commack") ;
            Uniopolis.Olcott.Bonney  : ternary @name("Olcott.Bonney") ;
...
control Waukesha(inout Olmitz Uniopolis, inout Harriet Moosic, in ingress_intrinsic_metadata_t Sedan, in ingress_intrinsic_metadata_from_parser_t Ossining, inout ingress_intrinsic_metadata_for_deparser_t Nason, inout ingress_intrinsic_metadata_for_tm_t Almota) {
    @name(".Harney") action Harney(bit<2> Meridean, bit<32> Freeburg) {
        Moosic.Tinaja.Meridean = Meridean;
    ...
    @name(".Ikatan") action Ikatan(bit<9> Noyes) {
        Almota.ucast_egress_port = Noyes;
    }
    @name(".Seagrove") CRCPolynomial<bit<10>>(10w0x5, true, false, true, 10w0x0, 10w0x0) Seagrove;
    @name(".Dubuque") Hash<bit<10>>(HashAlgorithm_t.CRC16, Seagrove) Dubuque;
    @name(".Senatobia") ActionProfile(32w512) Senatobia;
    @name(".Danforth") ActionSelector(Senatobia, Dubuque, SelectorMode_t.FAIR, 32w512, 32w4) Danforth;
    @disable_atomic_modify(1) @name(".Opelika") table Opelika {
        ...
        key = {
            Moosic.Tinaja.Meridean: exact @name("Tinaja.Meridean") ;
            Moosic.Garrison.Nuyaka: selector @name("Garrison.Nuyaka") ;
        }
        size = 256;
        const default_action = NoAction();
...
control Needham(inout Olmitz Uniopolis, inout Harriet Moosic, in egress_intrinsic_metadata_t Lemont, in egress_intrinsic_metadata_from_parser_t Langford, inout egress_intrinsic_metadata_for_deparser_t Cowley, inout egress_intrinsic_metadata_for_output_port_t Lackey) {
    @name(".Kamas") action Kamas() {
        Cowley.mirror_type = (bit<4>)4w2;
        @in_hash {
            Moosic.Hillside.Broussard[7:0] = Moosic.Moultrie.Toklat[7:0];
        }
        Cowley.mirror_io_select = (bit<1>)1w1;
        Cowley.mtu_trunc_len = (bit<14>)14w64;
        Uniopolis.Contact.Moorcroft = (bit<368>)368w0;
        Uniopolis.Contact.setValid();
    }
    @hidden @disable_atomic_modify(1) @name(".Norco") table Norco {
        actions = {
            Kamas();
            @defaultonly NoAction();
        }
        key = {
            Uniopolis.Faith.isValid(): exact @name("Faith") ;
        }
        size = 1;
        const entries = {
                        true : Kamas();
    ...
    apply {
        if (Moosic.Lemont.IttaBena[15:8] == 8w0 && Moosic.Lemont.IttaBena[7:0] < 8w68) {
            Norco.apply();
        }
    }
}

control Sandpoint(inout Olmitz Uniopolis, inout Harriet Moosic, in egress_intrinsic_metadata_t Lemont, in egress_intrinsic_metadata_from_parser_t Langford, inout egress_intrinsic_metadata_for_deparser_t Cowley, inout egress_intrinsic_metadata_for_output_port_t Lackey) {
    @name(".Petroleum") action Petroleum() {
    }
@pa_no_init("egress" , "eg_intr_md_for_dprsr.mirror_egress_port")
@pa_mutually_exclusive("egress" , "eg_intr_md_for_dprsr.mirror_egress_port" , "Uniopolis.Thurmond")
@name(".Frederic") action Frederic() {
        Cowley.mirror_egress_port = Moosic.Lemont.Harbor;
        @in_hash {
            Moosic.Lemont.Harbor[7:0] = Moosic.Hillside.Broussard[7:0];
        }
        Cowley.mirror_type = (bit<4>)4w3;
        Cowley.mirror_io_select = (bit<1>)1w1;
        Cowley.mirror_qid = Lemont.egress_qid;
        Cowley.drop_ctl = (bit<3>)3w1;
        Moosic.Hillside.Broussard = (bit<10>)10w192;
    }
    @hidden @disable_atomic_modify(1) @name(".Armstrong") table Armstrong {
        ...
        const entries = {
                        ...
                        (default, default, default, default, default, default, default, true, default, default, default, default) : Petroleum();
    ...
    apply {
        if (Uniopolis.Thurmond.isValid() && Cowley.drop_ctl == 3w0) {
            Armstrong.apply();
        }
    }
}
...
control Tatum(inout Olmitz Uniopolis, inout Harriet Moosic, in egress_intrinsic_metadata_t Lemont, in egress_intrinsic_metadata_from_parser_t Langford, inout egress_intrinsic_metadata_for_deparser_t Cowley, inout egress_intrinsic_metadata_for_output_port_t Lackey) {
    ...
    @name(".Bassett") Sandpoint() Bassett;
    @name(".Perkasie") Needham() Perkasie;
    ...
    @name(".Qulin") Waukegan() Qulin;
    @name(".Caliente") Caldwell() Caliente;
    apply {
        ...
        if (Uniopolis.Glenoma.isValid()) {
            ...
            Yemassee.apply(Uniopolis, Moosic, Lemont, Langford, Cowley, Lackey);
            if (Lemont.egress_rid == 16w0) {
            ...
            if (Uniopolis.Olcott.isValid()) {
                Caliente.apply(Uniopolis, Moosic, Lemont, Langford, Cowley, Lackey);
            }
            if (Uniopolis.Skillman.isValid()) {
                Qulin.apply(Uniopolis, Moosic, Lemont, Langford, Cowley, Lackey);
            }
            ...
            Bassett.apply(Uniopolis, Moosic, Lemont, Langford, Cowley, Lackey);
        } else if (Uniopolis.Faith.isValid()) {
            Perkasie.apply(Uniopolis, Moosic, Lemont, Langford, Cowley, Lackey);
        } else {
...
parser Seibert(packet_in Oneonta, out Olmitz Uniopolis, out Harriet Moosic, out egress_intrinsic_metadata_t Lemont) {
    ...
    state Chewalla {
        Moosic.Dushore.Havana = (bit<3>)3w6;
        Oneonta.extract<Whitten>(Uniopolis.Lefor);
        Moosic.Moultrie.McCammon = (Oneonta.lookahead<Powderly>()).Chugwater;
        transition Point;
    }
    state McIntyre {
        transition Sunman;
    ...
    state start {
        ...
        Moosic.Lemont.Harbor = Lemont.egress_port;
        transition select(Moosic.Lemont.Harbor ++ (Oneonta.lookahead<Grabill>()).Uintah) {
            17w3 &&& 17w0xff: Villanova;
            Maybee: TenSleep;
    ...
    state Milnor {
        Oneonta.extract<Matheson>(Uniopolis.Glenoma);
        transition select(Moosic.Lemont.IttaBena) {
    ...
    state Ogunquit {
        ...
        Uniopolis.BigRun.Moorcroft = (bit<168>)168w0;
        transition Fairborn;
    }
    state TenSleep {
    ...
    state Tusayan {
        transition select(Moosic.Lemont.IttaBena[7:0]) {
            8w0x0 &&& 8w0xe0: Nicolaus;
            8w0x20 &&& 8w0xf8: Nicolaus;
            8w0x28 &&& 8w0xf8: Laramie;
            8w0x30 &&& 8w0xf8: Pinebluff;
            8w0x38 &&& 8w0xf8: Fentress;
            8w0x40 &&& 8w0xf8: Molino;
            default: Fairborn;
        }
    }
    state Nicolaus {
        Oneonta.extract<Brazil>(Uniopolis.Faith);
        transition Caborn;
    }
    state Laramie {
        Oneonta.extract<Brazil>(Uniopolis.Faith);
        Oneonta.extract<Cistern>(Uniopolis.Dilia);
        transition Caborn;
    }
    state Pinebluff {
        Oneonta.extract<Brazil>(Uniopolis.Faith);
        Oneonta.extract<Cistern>(Uniopolis.Dilia);
        Oneonta.extract<Cistern>(Uniopolis.NewCity);
        transition Caborn;
    }
    state Fentress {
        Oneonta.extract<Brazil>(Uniopolis.Faith);
        Oneonta.extract<Cistern>(Uniopolis.Dilia);
        Oneonta.extract<Cistern>(Uniopolis.NewCity);
        Oneonta.extract<Cistern>(Uniopolis.Richlawn);
        transition Caborn;
    }
    state Molino {
        Oneonta.extract<Brazil>(Uniopolis.Faith);
        ...
        Oneonta.extract<Cistern>(Uniopolis.NewCity);
        Oneonta.extract<Cistern>(Uniopolis.Richlawn);
        Oneonta.extract<Cistern>(Uniopolis.Carlsbad);
        transition Caborn;
    }
    state Caborn {
        transition select(Moosic.Lemont.IttaBena[2:0]) {
            3w0: Fairborn;
            default: Goodrich;
        }
    }
    state Goodrich {
        Oneonta.extract<Palmhurst>(Uniopolis.Rhinebeck, (bit<32>)((bit<8>)(Moosic.Lemont.IttaBena[2:0] - 3w1) * 8w8));
        transition Fairborn;
    }
    state Fairborn {
        transition accept;
    ...
    apply {
        {
            ...
            } else if (Cowley.mirror_type == 4w3) {
                Grabill Baranof;
                Baranof.setValid();
                Baranof.Uintah = Moosic.Saugatuck.Uintah;
                Baranof.Moorcroft = Moosic.Saugatuck.Uintah;
            ...
            Oneonta.emit<Powderly>(Uniopolis.Volens);
            Oneonta.emit<Thayne>(Uniopolis.Philip);
            Oneonta.emit<Brazil>(Uniopolis.Faith);
            Oneonta.emit<Cistern>(Uniopolis.Dilia);
            Oneonta.emit<Cistern>(Uniopolis.NewCity);
            Oneonta.emit<Cistern>(Uniopolis.Richlawn);
            Oneonta.emit<Cistern>(Uniopolis.Carlsbad);
            Oneonta.emit<Palmhurst>(Uniopolis.Rhinebeck);
            Oneonta.emit<Vinita>(Uniopolis.Contact);
        }
    }
}
