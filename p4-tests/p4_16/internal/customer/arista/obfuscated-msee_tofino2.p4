...
@pa_atomic("pipe_a" , "egress" , "Lefor.Ekwok.Delavan")
...
@pa_atomic("pipe_a" , "egress" , "Westoak.Peoria.Garibaldi")
@pa_container_type("pipe_b" , "ingress" , "Lefor.Swifton.Plains" , "normal")
@pa_container_type("pipe_b" , "ingress" , "Lefor.Courtdale.Plains" , "normal")
@pa_container_type("pipe_b" , "ingress" , "Lefor.Courtdale.Salix" , "normal")
@pa_container_type("pipe_b" , "ingress" , "Lefor.Swifton.Salix" , "normal")
@pa_container_type("pipe_b" , "ingress" , "Lefor.Circle.Salix" , "normal")
@pa_container_type("pipe_b" , "ingress" , "Lefor.Covert.Sublett" , "normal")
@pa_container_type("pipe_b" , "ingress" , "Lefor.Ekwok.FortHunt" , "normal")
@pa_container_type("pipe_b" , "ingress" , "Lefor.Ekwok.Satolah" , "normal")
@pa_container_type("pipe_b" , "ingress" , "Lefor.Circle.Moose" , "normal")
...
@pa_alias("ingress" , "Westoak.Peoria.Kooskia" , "Lefor.Ekwok.Suring")
@pa_alias("ingress" , "Westoak.Peoria.Elmore" , "Lefor.Ekwok.Brave")
...
@pa_alias("ingress" , "ig_intr_md_for_tm.ucast_egress_port" , "Lefor.Ekwok.Standish")
...
@pa_atomic("ingress" , "Lefor.HighRock.Delavan") @gfm_parity_enable header Anacortes {
    bit<8> Corinth;
}
...
struct Freeny {
    ...
    bit<13>          Calabash;
    bit<12>          Wondervu;
    AppFilterResId_t Hadley;
    AppFilterResId_t Neubert;
}
...
@pa_mutually_exclusive("egress" , "Westoak.Eunice" , "Westoak.Flaherty") struct Wanamassa {
    Allison               Peoria;
    Idalia                Frederika;
    Freeman               Saugatuck;
    Cornell               Flaherty;
...
control Nixon(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    ...
    @name(".Midas") action Midas() {
        ...
        Lefor.HighRock.Placedo = Lefor.Terral.Ambrose[2:0];
    ...
    @name(".Lakeside") action Lakeside() {
        Lefor.Ekwok.FortHunt = (bit<3>)3w6;
        Lefor.HighRock.Riner = Westoak.Arapahoe.Riner;
        Lefor.HighRock.Palmhurst = Westoak.Arapahoe.Palmhurst;
        Lefor.HighRock.Clyde = Westoak.Arapahoe.Clyde;
        Lefor.HighRock.Clarion = Westoak.Arapahoe.Clarion;
    ...
    @name(".Mulvane") action Mulvane() {
        ...
        Lefor.HighRock.Clyde = Westoak.Arapahoe.Clyde;
        Lefor.HighRock.Clarion = Westoak.Arapahoe.Clarion;
        Lefor.HighRock.Placedo = Lefor.Terral.Sledge[2:0];
...
control Cairo(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    ...
    @name(".Yulee") action Yulee() {
        Lefor.Crump.Grays = Exeter.get<tuple<bit<24>, bit<24>, bit<24>, bit<24>, bit<16>>>({ Westoak.Thurmond.Riner, Westoak.Thurmond.Palmhurst, Westoak.Thurmond.Clyde, Westoak.Thurmond.Clarion, Westoak.Lauada.Cisco });
    }
...
control Salitpa(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    ...
    @name(".Notus") action Notus() {
        Lefor.Crump.Maumee = Spanaway.get<tuple<bit<8>, bit<32>, bit<32>>>({ Westoak.Sespe.Commack, Westoak.Sespe.Pilar, Westoak.Sespe.Loris });
    }
    @name(".Dahlgren.Davie") Hash<bit<16>>(HashAlgorithm_t.CRC16) Dahlgren;
    @name(".Andrade") action Andrade() {
        Lefor.Crump.Maumee = Dahlgren.get<tuple<bit<128>, bit<128>, bit<20>, bit<8>>>({ Westoak.Callao.Pilar, Westoak.Callao.Loris, Westoak.Callao.McBride, Westoak.Callao.Kenbridge });
    }
...
control Absecon(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    ...
    apply {
        if (Westoak.Eunice.isValid() == false) {
            Beatrice.apply();
        }
        Morrow.apply();
    }
...
control Trevorton(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    ...
    @name(".Bajandas") ActionSelector(Chilson, Wakeman, SelectorMode_t.FAIR, 32w120, 32w4) Bajandas;
...
control Lovelady(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    ...
    @name(".Reinbeck") ActionSelector(Hagewood, Ozark, SelectorMode_t.RESILIENT, 32w120, 32w4) Reinbeck;
...
control Gladys(inout Wanamassa Westoak, inout Talco Lefor, in egress_intrinsic_metadata_t Garrison, in egress_intrinsic_metadata_from_parser_t Franktown, inout egress_intrinsic_metadata_for_deparser_t Willette, inout egress_intrinsic_metadata_for_output_port_t Mayview) {
    ...
    @disable_atomic_modify(1) @name(".Bigfork") table Bigfork {
        ...
        key = {
            ...
            Lefor.Ekwok.Pajaros     : ternary @name("Ekwok.Pajaros") ;
            Westoak.Sespe.isValid() : ternary @name("Sespe") ;
            Westoak.Callao.isValid(): ternary @name("Callao") ;
            Westoak.Callao.Loris    : ternary @name("Callao.Loris") ;
...
control Jauca(inout Wanamassa Westoak, inout Talco Lefor, in egress_intrinsic_metadata_t Garrison, in egress_intrinsic_metadata_from_parser_t Franktown, inout egress_intrinsic_metadata_for_deparser_t Willette, inout egress_intrinsic_metadata_for_output_port_t Mayview) {
    ...
    @name(".Wenona") ActionSelector(Kelliher, Linville, SelectorMode_t.RESILIENT, 32w120, 32w4) Wenona;
...
@name(".Brinson") table Brinson {
        ...
        key = {
            ...
            Lefor.HighRock.Biddle               : exact @name("HighRock.Biddle") ;
    ...
    @pa_no_init("ingress" , "Lefor.HighRock.Etter") @disable_atomic_modify(1) @name(".Addicks") table Addicks {
        actions = {
            Westend();
        }
        key = {
    ...
    @name(".Vananda") action Vananda() {
        Wyandanch.count();
        Lefor.HighRock.Biddle = (bit<1>)1w1;
    }
...
control Pearcy(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    ...
    @disable_atomic_modify(1) @name(".Truro") table Truro {
        ...
        key = {
            ...
            Westoak.Sparr.isValid()     : ternary @name("Sparr") ;
        }
...
control Bethune(inout Wanamassa Westoak, inout Talco Lefor, in egress_intrinsic_metadata_t Garrison, in egress_intrinsic_metadata_from_parser_t Franktown, inout egress_intrinsic_metadata_for_deparser_t Willette, inout egress_intrinsic_metadata_for_output_port_t Mayview) {
    ...
    @use_hash_action(1) @disable_atomic_modify(1) @stage(0) @name(".Sanborn") table Sanborn {
        actions = {
            PawCreek();
        }
        key = {
...
control Stone(inout Wanamassa Westoak, inout Talco Lefor, in egress_intrinsic_metadata_t Garrison, in egress_intrinsic_metadata_from_parser_t Franktown, inout egress_intrinsic_metadata_for_deparser_t Willette, inout egress_intrinsic_metadata_for_output_port_t Mayview) {
    ...
    @name(".Unionvale") action Unionvale(bit<16> Bigspring, bit<16> Advance, bit<32> Mondovi, bit<8> Commack) {
        ...
        Westoak.Sedan.Coalwood = (bit<1>)1w0;
        Westoak.Sedan.Beasley = (bit<13>)13w0;
        Westoak.Sedan.Armona = Lefor.Ekwok.Suring;
    ...
    @name(".Redfield") action Redfield(bit<16> Algoa, bit<16> Baskin, bit<24> Clyde, bit<24> Clarion, bit<24> Silvertip, bit<24> Thatcher, bit<16> Wakenda, bit<16> Hibernia) {
        ...
        Westoak.Lemont.Welcome = Hibernia;
    ...
    @name(".Mynard") action Mynard(bit<24> Silvertip, bit<24> Thatcher, bit<16> Wakenda, bit<32> Mondovi, bit<16> Hibernia) {
        Redfield(Westoak.Sespe.Antlers, 16w30, Silvertip, Thatcher, Silvertip, Thatcher, Wakenda, Lefor.Ekwok.SomesBar);
        Unionvale(Westoak.Sespe.Antlers, 16w50, Mondovi, 8w17);
        Westoak.Sespe.Armona = Westoak.Sespe.Armona - 8w1;
        Albany();
    }
    @name(".Crystola") action Crystola(bit<24> Silvertip, bit<24> Thatcher, bit<16> Wakenda, bit<32> Mondovi, bit<16> Hibernia) {
        Redfield(Westoak.Callao.Vinemont, 16w70, Silvertip, Thatcher, Silvertip, Thatcher, Wakenda, Lefor.Ekwok.SomesBar);
        Unionvale(Westoak.Callao.Vinemont, 16w90, Mondovi, 8w17);
        Westoak.Callao.Parkville = Westoak.Callao.Parkville - 8w1;
        Albany();
    }
    @name(".LasLomas") action LasLomas(bit<16> Algoa, bit<16> Deeth, bit<24> Clyde, bit<24> Clarion, bit<24> Silvertip, bit<24> Thatcher, bit<16> Wakenda, bit<16> Hibernia) {
        Westoak.Sunbury.setValid();
        Westoak.Casnovia.setValid();
        Westoak.Funston.setValid();
        Westoak.Hookdale.setValid();
        Westoak.Lemont.setValid();
        Westoak.Mayflower.setValid();
        Redfield(Algoa, Deeth, Clyde, Clarion, Silvertip, Thatcher, Wakenda, Hibernia);
    }
    @name(".Devola") action Devola(bit<16> Algoa, bit<16> Deeth, bit<16> Shevlin, bit<24> Clyde, bit<24> Clarion, bit<24> Silvertip, bit<24> Thatcher, bit<16> Wakenda, bit<32> Mondovi, bit<16> Hibernia) {
        LasLomas(Algoa, Deeth, Clyde, Clarion, Silvertip, Thatcher, Wakenda, Hibernia);
        Unionvale(Algoa, Shevlin, Mondovi, 8w17);
    }
    @name(".Eudora") action Eudora(bit<24> Silvertip, bit<24> Thatcher, bit<16> Wakenda, bit<32> Mondovi, bit<16> Hibernia) {
        Westoak.Sedan.setValid();
        Devola(Lefor.Garrison.Blencoe, 16w12, 16w32, Westoak.Arapahoe.Clyde, Westoak.Arapahoe.Clarion, Silvertip, Thatcher, Wakenda, Mondovi, Lefor.Ekwok.SomesBar);
    }
    @name(".Buras") action Buras(bit<16> Bigspring, int<16> Advance, bit<32> Kearns, bit<32> Malinta, bit<32> Blakeley, bit<32> Poulan) {
        ...
        Westoak.Almota.Parkville = Lefor.Ekwok.Suring;
        Westoak.Casnovia.Cisco = 16w0x86dd;
    }
    @name(".Mantee") action Mantee(bit<16> Algoa, bit<16> Deeth, bit<16> Walland, bit<24> Clyde, bit<24> Clarion, bit<24> Silvertip, bit<24> Thatcher, bit<32> Kearns, bit<32> Malinta, bit<32> Blakeley, bit<32> Poulan, bit<16> Wakenda, bit<16> Hibernia) {
        LasLomas(Algoa, Deeth, Clyde, Clarion, Silvertip, Thatcher, Wakenda, Hibernia);
        Buras(Algoa, (int<16>)Walland, Kearns, Malinta, Blakeley, Poulan);
    }
    @name(".Melrose") action Melrose(bit<24> Silvertip, bit<24> Thatcher, bit<32> Kearns, bit<32> Malinta, bit<32> Blakeley, bit<32> Poulan, bit<16> Wakenda, bit<16> Hibernia) {
        Mantee(Lefor.Garrison.Blencoe, 16w12, 16w12, Westoak.Arapahoe.Clyde, Westoak.Arapahoe.Clarion, Silvertip, Thatcher, Kearns, Malinta, Blakeley, Poulan, Wakenda, Lefor.Ekwok.SomesBar);
    }
    @name(".Angeles") action Angeles(bit<24> Silvertip, bit<24> Thatcher, bit<32> Kearns, bit<32> Malinta, bit<32> Blakeley, bit<32> Poulan, bit<16> Wakenda, bit<16> Hibernia) {
        Redfield(Westoak.Sespe.Antlers, 16w30, Silvertip, Thatcher, Silvertip, Thatcher, Wakenda, Lefor.Ekwok.SomesBar);
        Buras(Westoak.Sespe.Antlers, 16s30, Kearns, Malinta, Blakeley, Poulan);
        Westoak.Sespe.Armona = Westoak.Sespe.Armona - 8w1;
        Albany();
    }
    @name(".Ammon") action Ammon(bit<24> Silvertip, bit<24> Thatcher, bit<32> Kearns, bit<32> Malinta, bit<32> Blakeley, bit<32> Poulan, bit<16> Wakenda, bit<16> Hibernia) {
        Redfield(Westoak.Callao.Vinemont, 16w70, Silvertip, Thatcher, Silvertip, Thatcher, Wakenda, Lefor.Ekwok.SomesBar);
...
control Stewart(inout Wanamassa Westoak, inout Talco Lefor, in egress_intrinsic_metadata_t Garrison, in egress_intrinsic_metadata_from_parser_t Franktown, inout egress_intrinsic_metadata_for_deparser_t Willette, inout egress_intrinsic_metadata_for_output_port_t Mayview) {
    @name(".Bavaria") DirectCounter<bit<32>>(CounterType_t.PACKETS) Bavaria;
    @name(".Annandale") action Annandale() {
        Bavaria.count();
    }
    @disable_atomic_modify(1) @name(".ElmPoint") table ElmPoint {
        key = {
            Westoak.Mayflower.DonaAna         : exact @name("Mayflower.DonaAna") ;
            Lefor.Ekwok.Monahans & 32w0x3fffff: exact @name("Ekwok.Monahans") ;
        }
        actions = {
            Annandale();
            @defaultonly NoAction();
    ...
    apply {
        if (Lefor.Ekwok.Monahans & 32w0x3fffff != 32w0) {
            ElmPoint.apply();
        }
    }
}
...
control BigPark(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    ...
    apply {
        if (Lefor.HighRock.Placedo & 3w0x3 == 3w0x1) {
            Bellville.apply();
            Boyes.apply();
...
control Asher(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    ...
    apply {
        if (Lefor.HighRock.Placedo & 3w0x3 == 3w0x1 && Lefor.Jayton.Sunflower != 1w0) {
            Chamois.apply();
        }
    }
}
...
control Ancho(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    @name(".Maceo") action Maceo(bit<32> Wynnewood, bit<32> Venice, bit<32> JimFalls, bit<32> Tahlequah, bit<32> Swansboro, bit<32> Wanilla, bit<32> Gilmanton, bit<32> Allegan, bit<32> Ouachita, bit<32> Gorman, bit<32> Hayfield, bit<32> Belgrade) {
        Lefor.Neponset.Wynnewood = Wynnewood;
        Lefor.Neponset.Venice = Venice;
        Lefor.Neponset.JimFalls = JimFalls;
        Lefor.Neponset.Tahlequah = Tahlequah;
        Lefor.Neponset.Swansboro = Swansboro;
        Lefor.Neponset.Wanilla = Wanilla;
        Lefor.Neponset.Gilmanton = Gilmanton;
        Lefor.Neponset.Allegan = Allegan;
        Lefor.Neponset.Ouachita = Ouachita;
        Lefor.Neponset.Gorman = Gorman;
        Lefor.Neponset.Hayfield = Hayfield;
        Lefor.Neponset.Belgrade = Belgrade;
    }
    @name(".Pearce") action Pearce(bit<32> Wynnewood, bit<32> Venice, bit<32> JimFalls, bit<32> Tahlequah, bit<32> Swansboro, bit<32> Wanilla, bit<32> Gilmanton, bit<32> Allegan, bit<32> Ouachita, bit<32> Gorman, bit<32> Hayfield, bit<32> Belgrade, bit<12> Wondervu) {
        Maceo(Wynnewood, Venice, JimFalls, Tahlequah, Swansboro, Wanilla, Gilmanton, Allegan, Ouachita, Gorman, Hayfield, Belgrade);
        Lefor.Neponset.Wondervu = Wondervu;
    }
    @name(".Belfalls") action Belfalls(bit<32> Wynnewood, bit<32> Venice, bit<32> JimFalls, bit<32> Tahlequah, bit<32> Swansboro, bit<32> Wanilla, bit<32> Gilmanton, bit<32> Allegan, bit<32> Ouachita, bit<32> Gorman, bit<32> Hayfield, bit<32> Belgrade, bit<16> Calabash) {
        Maceo(Wynnewood, Venice, JimFalls, Tahlequah, Swansboro, Wanilla, Gilmanton, Allegan, Ouachita, Gorman, Hayfield, Belgrade);
        Lefor.Neponset.Sonoma = (bit<1>)1w1;
        Lefor.Neponset.Calabash = (bit<13>)Calabash;
    }
    @name(".Biloxi") action Biloxi() {
        Maceo(32w0, 32w0, 32w0, 32w0, 32w0, 32w0, 32w0, 32w0, 32w0, 32w0, 32w0, 32w0);
    }
    @name(".Romero") action Romero(bit<16> KawCity) {
        Lefor.Neponset.Neubert = (AppFilterResId_t)KawCity;
    }
    @name(".Falmouth") action Falmouth(bit<16> KawCity) {
        Lefor.Neponset.Hadley = (AppFilterResId_t)KawCity;
    }
    ...
    @name(".Edmeston") action Edmeston(bit<32> Wynnewood, bit<32> Venice, bit<32> JimFalls, bit<32> Tahlequah, bit<32> Swansboro, bit<32> Wanilla, bit<32> Gilmanton, bit<32> Allegan, bit<32> Ouachita, bit<32> Gorman, bit<32> Hayfield, bit<32> Belgrade) {
        Lefor.Neponset.Wynnewood = Lefor.Neponset.Wynnewood & Wynnewood;
        Lefor.Neponset.Venice = Lefor.Neponset.Venice & Venice;
        Lefor.Neponset.JimFalls = Lefor.Neponset.JimFalls & JimFalls;
        Lefor.Neponset.Tahlequah = Lefor.Neponset.Tahlequah & Tahlequah;
        Lefor.Neponset.Swansboro = Lefor.Neponset.Swansboro & Swansboro;
        Lefor.Neponset.Wanilla = Lefor.Neponset.Wanilla & Wanilla;
        Lefor.Neponset.Gilmanton = Lefor.Neponset.Gilmanton & Gilmanton;
        Lefor.Neponset.Allegan = Lefor.Neponset.Allegan & Allegan;
        Lefor.Neponset.Ouachita = Lefor.Neponset.Ouachita & Ouachita;
        Lefor.Neponset.Gorman = Lefor.Neponset.Gorman & Gorman;
        Lefor.Neponset.Hayfield = Lefor.Neponset.Hayfield & Hayfield;
        Lefor.Neponset.Belgrade = Lefor.Neponset.Belgrade & Belgrade;
    }
    @name(".Lamar") action Lamar(bit<32> Wynnewood, bit<32> Venice, bit<32> JimFalls, bit<32> Tahlequah, bit<32> Swansboro, bit<32> Wanilla, bit<32> Gilmanton, bit<32> Allegan, bit<32> Ouachita, bit<32> Gorman, bit<32> Hayfield, bit<32> Belgrade) {
    ...
    @ways(1) @disable_atomic_modify(1) @name(".Varna") table Varna {
        ...
        key = {
            Lefor.Neponset.Kahua    : exact @name("Neponset.Kahua") ;
            Lefor.Neponset.Merritt  : exact @name("Neponset.Merritt") ;
            Lefor.Neponset.WestGate : exact @name("Neponset.WestGate") ;
            Lefor.Neponset.Malmo    : exact @name("Neponset.Malmo") ;
            Lefor.Neponset.Rocky    : exact @name("Neponset.Rocky") ;
            Lefor.Neponset.Hiseville: exact @name("Neponset.Hiseville") ;
            Lefor.Neponset.Abbott   : exact @name("Neponset.Abbott") ;
            Lefor.Neponset.Kasigluk : exact @name("Neponset.Kasigluk") ;
            Lefor.Neponset.Everett  : exact @name("Neponset.Everett") ;
            Lefor.Neponset.Alakanuk : exact @name("Neponset.Alakanuk") ;
            Lefor.Neponset.Calamine : exact @name("Neponset.Calamine") ;
            Lefor.Neponset.Gilliatt : exact @name("Neponset.Gilliatt") ;
        }
        size = 1;
        default_action = NoAction();
    }
@pa_no_init("ingress" , "Lefor.Neponset.Gilliatt")
@pa_no_init("ingress" , "Lefor.Neponset.Calamine")
@pa_no_init("ingress" , "Lefor.Neponset.Alakanuk")
@pa_no_init("ingress" , "Lefor.Neponset.Everett")
@pa_no_init("ingress" , "Lefor.Neponset.Kasigluk")
@pa_no_init("ingress" , "Lefor.Neponset.Abbott")
@pa_no_init("ingress" , "Lefor.Neponset.Hiseville")
@pa_no_init("ingress" , "Lefor.Neponset.Rocky")
@pa_no_init("ingress" , "Lefor.Neponset.Malmo")
@pa_no_init("ingress" , "Lefor.Neponset.WestGate")
@pa_no_init("ingress" , "Lefor.Neponset.Merritt")
@pa_no_init("ingress" , "Lefor.Neponset.Kahua")
@pa_mutually_exclusive("ingress" , "Lefor.Neponset.Gilliatt" , "Lefor.Neponset.Belgrade")
@pa_mutually_exclusive("ingress" , "Lefor.Neponset.Calamine" , "Lefor.Neponset.Hayfield")
@pa_mutually_exclusive("ingress" , "Lefor.Neponset.Alakanuk" , "Lefor.Neponset.Gorman")
@pa_mutually_exclusive("ingress" , "Lefor.Neponset.Everett" , "Lefor.Neponset.Ouachita")
@pa_mutually_exclusive("ingress" , "Lefor.Neponset.Kasigluk" , "Lefor.Neponset.Allegan")
@pa_mutually_exclusive("ingress" , "Lefor.Neponset.Abbott" , "Lefor.Neponset.Gilmanton")
@pa_mutually_exclusive("ingress" , "Lefor.Neponset.Hiseville" , "Lefor.Neponset.Wanilla")
@pa_mutually_exclusive("ingress" , "Lefor.Neponset.Rocky" , "Lefor.Neponset.Swansboro")
@pa_mutually_exclusive("ingress" , "Lefor.Neponset.Malmo" , "Lefor.Neponset.Tahlequah")
@pa_mutually_exclusive("ingress" , "Lefor.Neponset.WestGate" , "Lefor.Neponset.JimFalls")
@pa_mutually_exclusive("ingress" , "Lefor.Neponset.Merritt" , "Lefor.Neponset.Venice")
@pa_mutually_exclusive("ingress" , "Lefor.Neponset.Kahua" , "Lefor.Neponset.Wynnewood")
@name(".Lantana") action Lantana() {
        Lefor.Neponset.Gilliatt = (bit<1>)(Lefor.Neponset.Belgrade != 32w0);
        Lefor.Neponset.Calamine = (bit<1>)(Lefor.Neponset.Hayfield != 32w0);
        Lefor.Neponset.Alakanuk = (bit<1>)(Lefor.Neponset.Gorman != 32w0);
        Lefor.Neponset.Everett = (bit<1>)(Lefor.Neponset.Ouachita != 32w0);
        Lefor.Neponset.Kasigluk = (bit<1>)(Lefor.Neponset.Allegan != 32w0);
        Lefor.Neponset.Abbott = (bit<1>)(Lefor.Neponset.Gilmanton != 32w0);
        Lefor.Neponset.Hiseville = (bit<1>)(Lefor.Neponset.Wanilla != 32w0);
        Lefor.Neponset.Rocky = (bit<1>)(Lefor.Neponset.Swansboro != 32w0);
        Lefor.Neponset.Malmo = (bit<1>)(Lefor.Neponset.Tahlequah != 32w0);
        Lefor.Neponset.WestGate = (bit<1>)(Lefor.Neponset.JimFalls != 32w0);
        Lefor.Neponset.Merritt = (bit<1>)(Lefor.Neponset.Venice != 32w0);
        Lefor.Neponset.Kahua = (bit<1>)(Lefor.Neponset.Wynnewood != 32w0);
    }
    ...
    @disable_atomic_modify(1) @ternary(1) @name(".Ivydale") table Ivydale {
        actions = {
            Edmeston();
            Lamar();
            @defaultonly Biloxi();
        ...
        key = {
            ...
            Lefor.Neponset.Neubert: exact @name("Neponset.Neubert") ;
        }
        size = 2048;
        const default_action = Biloxi();
    }
    @disable_atomic_modify(1) @name(".Titonka") table Titonka {
        actions = {
            Pearce();
            Belfalls();
            @defaultonly NoAction();
        ...
        key = {
            Lefor.Neponset.Hadley: exact @name("Neponset.Hadley") ;
        }
        size = 2048;
        const default_action = NoAction();
    }
...
control Lushton(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    ...
    @disable_atomic_modify(1) @use_hash_action(1) @name(".Gerster") table Gerster {
        actions = {
            Waxhaw();
        }
        key = {
...
control Rodessa(inout Wanamassa Westoak, inout Talco Lefor, in egress_intrinsic_metadata_t Garrison, in egress_intrinsic_metadata_from_parser_t Franktown, inout egress_intrinsic_metadata_for_deparser_t Willette, inout egress_intrinsic_metadata_for_output_port_t Mayview) {
    ...
    @disable_atomic_modify(1) @use_hash_action(1) @name(".Hecker") table Hecker {
        actions = {
            Munday();
        }
        key = {
...
@pa_mutually_exclusive("egress" , "Lefor.Ekwok.Delavan" , "Lefor.Ekwok.Bennet")
@disable_atomic_modify(1)
...
control Indrio(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    @name(".Tarlton") DirectCounter<bit<16>>(CounterType_t.PACKETS) Tarlton;
    ...
    @disable_atomic_modify(1) @stage(1) @name(".Harvard") table Harvard {
        ...
        key = {
            Westoak.Volcano.app_id & 4w0x1       : exact @name("Volcano.app_id") ;
            Westoak.Volcano.packet_id & 16w0x3fff: exact @name("Volcano.packet_id") ;
        }
        size = 32768;
    ...
    @name(".Kinards") action Kinards(bit<10> Hitchland, bit<12> Westboro, bit<32> Pilar, bit<32> Loris, bit<32> OakCity, bit<32> Terrell, bit<2> Buckfield, bit<5> Guadalupe, bit<1> Towaoc) {
        ...
        Westoak.Parkway[0].Westboro = Westboro;
        Lefor.Hillside.Humarock = Hitchland;
    ...
    @name(".Dunnville") action Dunnville(bit<32> Sunrise, bit<32> Wolsey, bit<32> Cogar, bit<8> Moquah, bit<16> Welcome) {
        Westoak.Farson.Sunrise = Sunrise;
        Westoak.Farson.Wolsey = Wolsey;
        Westoak.Farson.Cogar = Cogar;
        Westoak.Farson.Moquah = Moquah;
        Westoak.Rienzi.Welcome = Welcome;
    }
    @use_hash_action(1) @disable_atomic_modify(1) @name(".Jarreau") table Jarreau {
        actions = {
            Dunnville();
        }
        key = {
            Lefor.Hillside.Humarock: exact @name("Hillside.Humarock") ;
        }
        size = 1024;
        const default_action = Dunnville(32w0, 32w0, 32w0, 8w0, 16w0);
    }
    @name(".ElRio") action ElRio(PortId_t Helton) {
        {
    ...
    @disable_atomic_modify(1) @name(".Powers") table Powers {
        actions = {
            @defaultonly ElRio();
            @tableonly Ossipee();
        }
        ...
        default_action = ElRio(9w6);
        size = 1;
    }
    @disable_atomic_modify(1) @name(".Yorkville") table Yorkville {
        actions = {
            VanHorn();
        }
        key = {
...
control Almont(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    @name(".Trooper") DirectCounter<bit<16>>(CounterType_t.PACKETS) Trooper;
    @name(".Winner") action Winner() {
        Trooper.count();
    }
    @name(".SandCity") action SandCity(bit<8> Moquah, bit<32> Mayday, bit<13> Millhaven) {
        Lefor.Hillside.Twain = (bit<1>)(Moquah == Westoak.Rochert.Moquah);
        Lefor.Hillside.Boonsboro = (bit<1>)(Mayday == Westoak.Rochert.Mayday);
        Lefor.Hillside.Heron = Millhaven;
    }
    @idletime_precision(3) @disable_atomic_modify(1) @ternary(1) @stage(17 , 6144) @name(".Newburgh") table Newburgh {
        actions = {
            SandCity();
            @defaultonly NoAction();
        }
    ...
    @disable_atomic_modify(1) @name(".Taopi") table Taopi {
        actions = {
            Winner();
        }
        key = {
            Lefor.Hillside.Heron: exact @name("Hillside.Heron") ;
        }
        size = 8192;
        const default_action = Winner();
        counters = Trooper;
    }
    ...
    apply {
        ...
        if (Lefor.Hillside.Heron != 13w0) {
            Taopi.apply();
        }
    }
}

control Warba(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    @name(".BigWater") DirectCounter<bit<32>>(CounterType_t.PACKETS) BigWater;
    @name(".Rehoboth") action Rehoboth() {
        BigWater.count();
    }
    @disable_atomic_modify(1) @name(".Rotterdam") table Rotterdam {
        actions = {
            Rehoboth();
        }
        key = {
            Lefor.HighRock.Eastwood     : exact @name("HighRock.Eastwood") ;
            Westoak.Tofte.Pridgen & 16w1: exact @name("Tofte.Pridgen") ;
        }
        counters = BigWater;
        const default_action = Rehoboth();
        size = 16384;
    }
    apply {
        if (Westoak.Tofte.isValid() && !Westoak.Flaherty.isValid()) {
            if ((Lefor.HighRock.Rudolph == 1w1 || Lefor.Jayton.Sunflower == 1w1) && (Westoak.Tofte.Pridgen == 16w1 || Westoak.Tofte.Pridgen == 16w2)) {
                Rotterdam.apply();
            }
        }
    }
...
control Toxey(inout Wanamassa Westoak, inout Talco Lefor, in egress_intrinsic_metadata_t Garrison, in egress_intrinsic_metadata_from_parser_t Franktown, inout egress_intrinsic_metadata_for_deparser_t Willette, inout egress_intrinsic_metadata_for_output_port_t Mayview) {
    @name(".Lamoni") DirectCounter<bit<32>>(CounterType_t.PACKETS) Lamoni;
    ...
    @disable_atomic_modify(1) @ternary(1) @name(".Gallion") table Gallion {
        ...
        key = {
            Lefor.Garrison.Bledsoe & 9w0x7f: exact @name("Garrison.Bledsoe") ;
            Westoak.Parkway[0].Westboro    : exact @name("Colmar") ;
            Westoak.Parkway[1].Westboro    : exact @name("Proctor") ;
        }
        counters = Lamoni;
        const default_action = NoAction();
        size = 4096;
...
@name(".Lenox") table Lenox {
    ...
    @name(".Webbville") ActionSelector(Mocane, Conklin, SelectorMode_t.FAIR, 32w40, 32w130) Webbville;
...
@name(".Nashua") table Nashua {
    ...
    @disable_atomic_modify(1) @name(".Slick") table Slick {
        ...
        key = {
            Lefor.Ekwok.Standish      : exact @name("Pinetop.ucast_egress_port") ;
...
control Moorpark(inout Wanamassa Westoak, inout Talco Lefor, in egress_intrinsic_metadata_t Garrison, in egress_intrinsic_metadata_from_parser_t Franktown, inout egress_intrinsic_metadata_for_deparser_t Willette, inout egress_intrinsic_metadata_for_output_port_t Mayview) {
    apply {
    }
}
...
@pa_container_size("ingress" , "Lefor.Circle.Salix" , 8) control Chispa(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    ...
    @force_immediate(1) @disable_atomic_modify(1) @stage(0 , 147456) @stage(1 , 147456) @stage(2 , 147456) @name(".Hagerman") table Hagerman {
        actions = {
            Vincent();
            Stratton();
            Warsaw();
...
parser Shawville(packet_in Kinsley, out Wanamassa Westoak, out Talco Lefor, out ingress_intrinsic_metadata_t Moultrie) {
    ...
    @name(".Wauseon") value_set<bit<9>>(32) Wauseon;
    ...
    state Caguas {
        ...
        transition select((Kinsley.lookahead<bit<24>>())[7:0], (Kinsley.lookahead<bit<16>>())[15:0]) {
            ...
            (8w0x40 &&& 8w0xfc, 16w0x800 &&& 16w0xffff): McCloud;
            (8w0x44 &&& 8w0xff, 16w0x800 &&& 16w0xffff): McCloud;
    ...
    state Spindale {
        transition select((bit<8>)(Kinsley.lookahead<bit<24>>())[7:0] ++ (bit<16>)(Kinsley.lookahead<bit<16>>())) {
            ...
            24w0x400800 &&& 24w0xfcffff: McCloud;
            24w0x440800 &&& 24w0xffffff: McCloud;
    ...
    state Hurdtown {
        Lefor.HighRock.Cisco = 16w0x800;
        Lefor.HighRock.Jenners = (bit<3>)3w5;
        transition select((Kinsley.lookahead<bit<8>>())[7:0]) {
            8w0x45 &&& 8w0xff: Pettigrew;
            default: Mellott;
        }
    ...
    state Jigger {
        ...
        Dunstable Bonner;
        Bonner = Kinsley.lookahead<Dunstable>();
        Westoak.Sespe.Loris = (Kinsley.lookahead<bit<160>>())[31:0];
        Westoak.Sespe.Pilar = (Kinsley.lookahead<bit<128>>())[31:0];
        ...
        transition select(Bonner.Hampton, Bonner.Commack, Bonner.Beasley) {
            (4w0x6, 8w6, 13w0): Corbin;
            (4w0x6, 8w0x1 &&& 8w0xef, 13w0): Corbin;
            (4w0x7, 8w6, 13w0): Schaller;
            (4w0x7, 8w0x1 &&& 8w0xef, 13w0): Schaller;
            (4w0x8, 8w6, 13w0): ElkPoint;
            (4w0x8, 8w0x1 &&& 8w0xef, 13w0): ElkPoint;
            (default, 8w6, 13w0): KentPark;
            (default, 8w0x1 &&& 8w0xef, 13w0): KentPark;
    ...
    state Hillister {
        ...
        transition select(Westoak.Rienzi.Welcome ++ Moultrie.ingress_port[2:0]) {
            Herald: Camden;
            Zeeland: Melvina;
            19w30272 &&& 19w0x7fff8: Huxley;
            19w38272 &&& 19w0x7fff8: Huxley;
            default: accept;
        }
    }
    state Huxley {
    ...
    state Mellott {
        ...
        Lefor.WebbCity.Loris = (Kinsley.lookahead<Dunstable>()).Loris;
        Lefor.WebbCity.Pilar = (Kinsley.lookahead<Dunstable>()).Pilar;
        Lefor.WebbCity.Tallassee = (Kinsley.lookahead<Dunstable>()).Tallassee;
        Lefor.Terral.Wartburg = (Kinsley.lookahead<Dunstable>()).Commack;
        Lefor.Terral.Lakehills = (Kinsley.lookahead<Dunstable>()).Armona;
        transition accept;
    }
    state FlatLick {
    ...
    state Deering {
        Lefor.Picabo.Lewiston = (bit<14>)14w509;
        Kinsley.advance(32w192);
        transition select((Kinsley.lookahead<pktgen_timer_header_t>()).app_id) {
            4w6 &&& 4w0x7: Southdown;
            4w7 &&& 4w0x7: Southdown;
            default: Goessel;
        }
    }
    @dontmerge("ingress") state Southdown {
        Kinsley.extract<pktgen_timer_header_t>(Westoak.Volcano);
        Kinsley.extract<Altus>(Westoak.Dunnegan);
        transition Onava;
    }
    state Onava {
        Kinsley.extract<Turkey>(Westoak.Arapahoe);
        ...
        Kinsley.extract<Level>(Westoak.Ambler);
        Kinsley.extract<Thayne>(Westoak.Baker);
        Kinsley.extract<Boutte>(Westoak.Farson);
        transition accept;
    }
    ...
    state Corbin {
        Lefor.Terral.Dyess = (bit<3>)3w2;
        bit<32> Bonner;
        Bonner = (Kinsley.lookahead<bit<224>>())[31:0];
        Westoak.Rienzi.Powderly = Bonner[31:16];
        Westoak.Rienzi.Welcome = Bonner[15:0];
        transition accept;
    }
    state Schaller {
        Lefor.Terral.Dyess = (bit<3>)3w2;
        bit<32> Bonner;
        Bonner = (Kinsley.lookahead<bit<256>>())[31:0];
        Westoak.Rienzi.Powderly = Bonner[31:16];
        Westoak.Rienzi.Welcome = Bonner[15:0];
        transition accept;
    }
    state ElkPoint {
        Lefor.Terral.Dyess = (bit<3>)3w2;
        Kinsley.extract<Garlin>(Westoak.EastLake);
        bit<32> Bonner;
        Bonner = (Kinsley.lookahead<bit<32>>())[31:0];
        Westoak.Rienzi.Powderly = Bonner[31:16];
        Westoak.Rienzi.Welcome = Bonner[15:0];
        transition accept;
    }
    state Vesuvius {
        bit<32> Bonner;
        Bonner = (Kinsley.lookahead<bit<64>>())[31:0];
        Westoak.Rienzi.Powderly = Bonner[31:16];
        Westoak.Rienzi.Welcome = Bonner[15:0];
        transition accept;
    }
    state Bairoa {
        bit<32> Bonner;
        Bonner = (Kinsley.lookahead<bit<96>>())[31:0];
        Westoak.Rienzi.Powderly = Bonner[31:16];
        Westoak.Rienzi.Welcome = Bonner[15:0];
        transition accept;
    }
    state Trout {
        bit<32> Bonner;
        Bonner = (Kinsley.lookahead<bit<128>>())[31:0];
        Westoak.Rienzi.Powderly = Bonner[31:16];
        Westoak.Rienzi.Welcome = Bonner[15:0];
        transition accept;
    }
    state Eldora {
        bit<32> Bonner;
        Bonner = (Kinsley.lookahead<bit<160>>())[31:0];
        Westoak.Rienzi.Powderly = Bonner[31:16];
        Westoak.Rienzi.Welcome = Bonner[15:0];
        transition accept;
    }
    state Alvordton {
        bit<32> Bonner;
        Bonner = (Kinsley.lookahead<bit<192>>())[31:0];
        Westoak.Rienzi.Powderly = Bonner[31:16];
        Westoak.Rienzi.Welcome = Bonner[15:0];
        transition accept;
    }
    ...
    state KentPark {
        ...
        Bonner = Kinsley.lookahead<Dunstable>();
        Kinsley.extract<Garlin>(Westoak.EastLake);
        transition select(Bonner.Hampton) {
            4w0x9: Vesuvius;
            4w0xa: Bairoa;
            4w0xb: Trout;
            4w0xc: Eldora;
...
control Simla(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    ...
    @name(".Sidnaw") action Sidnaw() {
        Lefor.Crump.Gotham = Maryville.get<tuple<bit<32>, bit<32>, bit<8>>>({ Lefor.WebbCity.Pilar, Lefor.WebbCity.Loris, Lefor.Terral.Wartburg });
    }
    @name(".Toano.Rayville") Hash<bit<16>>(HashAlgorithm_t.CRC16) Toano;
    @name(".Kekoskee") action Kekoskee() {
        Lefor.Crump.Gotham = Toano.get<tuple<bit<128>, bit<128>, bit<20>, bit<8>>>({ Lefor.Covert.Pilar, Lefor.Covert.Loris, Westoak.Harding.McBride, Lefor.Terral.Wartburg });
    }
    ...
    @name(".BigRun") action BigRun() {
        Lefor.Wyndmoor.Hoven = Suwanee.get<tuple<bit<24>, bit<24>, bit<24>, bit<24>, bit<16>>>({ Westoak.Arapahoe.Riner, Westoak.Arapahoe.Palmhurst, Westoak.Arapahoe.Clyde, Westoak.Arapahoe.Clarion, Lefor.HighRock.Cisco });
    }
    ...
    @name(".Arpin") Warba() Arpin;
    @name(".Iredell") Indrio() Iredell;
    @name(".Norco") Forman() Norco;
    @name(".Mossville") Telephone() Mossville;
    ...
    @name(".Macedonia") action Macedonia(bit<8> Radom) {
        Lefor.Paisley.McGovern = Radom;
    }
    @name(".Angus") action Angus(bit<16> Radom) {
        Lefor.Paisley.Eggleston = (bit<10>)Radom;
    }
    @name(".Dalkeith") action Dalkeith(bool Cornville, bit<6> Tallassee, bool Nankin, bit<3> Steger, QueueId_t Yatesboro) {
        if (Cornville) {
            Lefor.Lookeba.Tallassee = Tallassee;
        }
        if (Nankin) {
            Lefor.Pinetop.Moorcroft = Steger;
            Westoak.Saugatuck.LaPalma = Yatesboro;
        }
    }
    @disable_atomic_modify(1) @name(".Springlee") table Springlee {
        actions = {
            Macedonia();
        }
        key = {
    ...
    @disable_atomic_modify(1) @name(".Pidcoke") table Pidcoke {
        actions = {
            Dalkeith();
            @defaultonly NoAction();
        }
        key = {
            Lefor.Paisley.Eggleston: exact @name("Paisley.Eggleston") ;
        }
        size = 1024;
        const default_action = NoAction();
    }
    apply {
        if (Westoak.Farson.isValid()) {
            Iredell.apply(Westoak, Lefor, Moultrie, Starkey, Volens, Pinetop);
        } else {
            ...
            Mossville.apply(Westoak, Lefor, Moultrie, Starkey, Volens, Pinetop);
            ...
            if (!Westoak.Flaherty.isValid() && (Lefor.HighRock.Placedo == 3w0x1 || Lefor.HighRock.Placedo == 3w0x2)) {
                Springlee.apply();
            }
            Gould.apply();
            ...
            Arpin.apply(Westoak, Lefor, Moultrie, Starkey, Volens, Pinetop);
...
control Dresser(packet_out Kinsley, inout Wanamassa Westoak, in Talco Lefor, in ingress_intrinsic_metadata_for_deparser_t Volens) {
    ...
    apply {
        ...
        {
            Kinsley.emit<Altus>(Westoak.Dunnegan);
        }
...
parser Belfast(packet_in Kinsley, out Wanamassa Westoak, out Talco Lefor, out egress_intrinsic_metadata_t Garrison) {
    ...
    state Hitterdal {
        Kinsley.extract<Fairhaven>(Westoak.Parkway[0]);
        transition select((Kinsley.lookahead<bit<16>>())[15:0]) {
            16w0x8100: Cashmere;
            default: Gomez;
        }
    }
    ...
    state Caguas {
        Kinsley.extract<Turkey>(Westoak.Arapahoe);
        transition select(Lefor.Ekwok.FortHunt, (Kinsley.lookahead<bit<24>>())[7:0], (Kinsley.lookahead<bit<16>>())[15:0]) {
            (3w2, default, 16w0x8100): Hitterdal;
            (3w2, default, default): Gomez;
            (default, 8w0x0 &&& 8w0x0, 16w0x9100 &&& 16w0xffff): Duncombe;
            (default, 8w0x0 &&& 8w0x0, 16w0x88a8 &&& 16w0xffff): Duncombe;
            (default, 8w0x0 &&& 8w0x0, 16w0x8100 &&& 16w0xffff): Duncombe;
            (default, 8w0x45 &&& 8w0xff, 16w0x800): Waimalu;
            (default, 8w0x0 &&& 8w0x0, 16w0x800 &&& 16w0xffff): Jigger;
            (default, 8w0x60 &&& 8w0xf0, 16w0x86dd &&& 16w0xffff): Villanova;
            default: Gomez;
        }
    }
    state Duncombe {
        Westoak.Clearmont.setValid();
        Kinsley.extract<Fairhaven>(Westoak.LakeHart);
        transition select((Kinsley.lookahead<bit<24>>())[7:0], (Kinsley.lookahead<bit<16>>())[15:0]) {
            (8w0x45 &&& 8w0xff, 16w0x800): Waimalu;
            (8w0x0 &&& 8w0x0, 16w0x800 &&& 16w0xffff): Jigger;
            (8w0x60 &&& 8w0xf0, 16w0x86dd &&& 16w0xffff): Villanova;
...
control Geeville(inout Wanamassa Westoak, inout Talco Lefor, in egress_intrinsic_metadata_t Garrison, in egress_intrinsic_metadata_from_parser_t Franktown, inout egress_intrinsic_metadata_for_deparser_t Willette, inout egress_intrinsic_metadata_for_output_port_t Mayview) {
    ...
    @name(".Escondido") action Escondido(bit<2> Rains) {
        Fowlkes(Rains);
        Westoak.Arapahoe.Riner = (bit<24>)24w0xbfbfbf;
        Westoak.Arapahoe.Palmhurst = (bit<24>)24w0xbfbfbf;
    }
    ...
    apply {
        ...
        if (!Westoak.Flaherty.isValid() && Westoak.Peoria.isValid()) {
            ...
            Manteo.apply(Westoak, Lefor, Garrison, Franktown, Willette, Mayview);
            if (Lefor.Ekwok.FortHunt != 3w2) {
    ...
    apply {
        {
            ...
            Kinsley.emit<Altus>(Westoak.Eunice);
            ...
            Kinsley.emit<Turkey>(Westoak.Arapahoe);
            Kinsley.emit<Fairhaven>(Westoak.LakeHart);
            Kinsley.emit<Comfrey>(Westoak.Palouse);
            Kinsley.emit<Dunstable>(Westoak.Sespe);
            Kinsley.emit<Mackville>(Westoak.Callao);
            Kinsley.emit<Boerne>(Westoak.Wagener);
...
parser Moreland(packet_in Kinsley, out Wanamassa Westoak, out Talco Lefor, out ingress_intrinsic_metadata_t Moultrie) {
    ...
    state start {
        Kinsley.extract<ingress_intrinsic_metadata_t>(Moultrie);
        Lefor.HighRock.Standish = Moultrie.ingress_port;
        transition Dubach;
    }
...
control Sawmills(inout Wanamassa Westoak, inout Talco Lefor, in ingress_intrinsic_metadata_t Moultrie, in ingress_intrinsic_metadata_from_parser_t Starkey, inout ingress_intrinsic_metadata_for_deparser_t Volens, inout ingress_intrinsic_metadata_for_tm_t Pinetop) {
    ...
    @name(".Johnstown") ActionProfile(32w4096) Johnstown;
    @name(".Newhalen") ActionSelector(Johnstown, Kansas, SelectorMode_t.RESILIENT, 32w120, 32w4) Newhalen;
    ...
    apply {
        ...
        } else if (Lefor.Jayton.Sunflower == 1w1 && Lefor.Ekwok.RedElm == 1w0 && (Lefor.HighRock.Grassflat == 1w1 || Lefor.Jayton.Juneau & 4w0x1 == 4w0x1 && Lefor.HighRock.Placedo == 3w0x5)) {
            Kisatchie.apply();
        }
