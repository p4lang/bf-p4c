...
# 39 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/headers.p4" 1
/*******************************************************************************
...
header underlay_ethernet_snoop_h {
    mac_addr_t dst_addr;
    mac_addr_t src_addr;
    bit<16> ether_type1;
    bit<3> pcp;
...
struct nsh_extr_internal_lkp_t {
 ...
 // ---------------
    ...
    // word 3: ext type 2 word 1, 2, 3, etc...
    bit<16> sfc_data; // set by table
    bit<16> extr_vpn_id; //  2 bytes **see note below
}
...
*/
# 40 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/types.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
//-----------------------------------------------------------------------------
# 37 "/mnt/ws_tofino/extreme_2313/types.p4"
// -------------------------------------
// Extreme Networks - Added
// -------------------------------------
# 50 "/mnt/ws_tofino/extreme_2313/types.p4"
//#define ETHERTYPE_VN   0x892F
# 63 "/mnt/ws_tofino/extreme_2313/types.p4"
// -------------------------------------
// Extreme Networks - Added
// -------------------------------------
# 74 "/mnt/ws_tofino/extreme_2313/types.p4"
// -------------------------------------
// Extreme Networks - Added
// -------------------------------------
# 87 "/mnt/ws_tofino/extreme_2313/types.p4"
...
struct switch_ingress_flags_t {
    ...
    bool mac_pkt_class;
    bool pfc_wd_drop;
    bool transport_ipv4_checksum_err; // extreme added
    // Add more flags here.
}
...
# 725 "/mnt/ws_tofino/extreme_2313/types.p4"
...
struct switch_ingress_metadata_t {
    ...
    switch_tunnel_metadata_t tunnel_underlay; // extreme added
...
struct switch_header_underlay_t {
    ...
    nsh_extr_h nsh_extr;
# 898 "/mnt/ws_tofino/extreme_2313/types.p4"
}
...
struct switch_header_outer_t {
    ...
    ipv4_h ipv4;
    //ipv4_option_h ipv4_option; // extreme removed
    ipv6_h ipv6;
    arp_h arp;
    udp_h udp;
    icmp_h icmp;
...
struct switch_header_inner_t {
    ...
    vlan_tag_h[1] vlan_tag;
    sctp_h sctp;
# 988 "/mnt/ws_tofino/extreme_2313/types.p4"
    udf_h udf;
}
...
struct switch_header_t {
 ...
 switch_header_underlay_t underlay;
...
# 41 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
...
*/
# 1 "/mnt/ws_tofino/extreme_2313/table_sizes.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
const bit<32> MAC_TABLE_SIZE = 16384;
# 61 "/mnt/ws_tofino/extreme_2313/table_sizes.p4"
// IP Hosts/Routes
const bit<32> IPV4_LPM_TABLE_SIZE = 16384;
const bit<32> IPV6_LPM_TABLE_SIZE = 1024; // 8192;
...
// Ingress ACLs
# 112 "/mnt/ws_tofino/extreme_2313/table_sizes.p4"
const bit<32> INGRESS_MAC_ACL_TABLE_SIZE = 512;
const bit<32> INGRESS_IPV4_ACL_TABLE_SIZE = 512;
const bit<32> INGRESS_IPV6_ACL_TABLE_SIZE = 512;
const bit<32> INGRESS_MIRROR_ACL_TABLE_SIZE = 512;
...
const bit<32> NPB_ING_SFC_FLOW_CLASS_TABLE_DEPTH = 512;
const bit<32> NPB_ING_SFC_SFC_TABLE_DEPTH = 1024;
const bit<32> NPB_ING_SFC_MYMAC_TABLE_DEPTH = 64;
const bit<32> NPB_ING_SFC_SF_SEL_TABLE_DEPTH = 1024;
...
const bit<32> NPB_ING_SF_0_BAS_ADV_POLICY_L7_TABLE_DEPTH = 512;
...
// --------------------------------------------
# 234 "/mnt/ws_tofino/extreme_2313/table_sizes.p4"
// --------------------------------------------

// Derek: Missing from switch.p4's table_sizes.p4 file -- open a case???
const bit<32> OUTER_ECMP_SELECT_TABLE_SIZE = 16384;
const bit<32> NUM_TUNNELS = 4096;
# 138 "/mnt/ws_tofino/extreme_2313/npb.p4" 2


# 1 "/mnt/ws_tofino/extreme_2313/util.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
 ...
 *
 ******************************************************************************/
# 24 "/mnt/ws_tofino/extreme_2313/util.p4" 2
...
action add_bridged_md(
    ...
    bridged_md.base = {
        ...
        ig_md.nsh_extr.extr_sf_bitmask, //  1 byte
        ig_md.nsh_extr.extr_flow_class, //  1 byte?
  ...
  ig_md.nsh_extr.sfc_data,
        ig_md.nsh_extr.extr_vpn_id //  3 bytes
...
# 93 "/mnt/ws_tofino/extreme_2313/util.p4"
    bridged_md.tunnel = {ig_md.tunnel.index,
                         ig_md.outer_nexthop,
                         ig_md.hash[15:0],
                         ig_md.vrf,
                         ig_md.tunnel_underlay.terminate, // extreme added
                         ig_md.tunnel.terminate};
# 107 "/mnt/ws_tofino/extreme_2313/util.p4"
}
...
# 141 "/mnt/ws_tofino/extreme_2313/npb.p4" 2





# 1 "/mnt/ws_tofino/extreme_2313/l3.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
# 1 "/mnt/ws_tofino/extreme_2313/acl.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
//-----------------------------------------------------------------------------
# 155 "/mnt/ws_tofino/extreme_2313/acl.p4"
// ============================================================================
// ============================================================================
// Ingress ACL ================================================================
// ============================================================================
...
control LOU(in bit<16> src_port,
    ...
    apply {
# 377 "/mnt/ws_tofino/extreme_2313/acl.p4"
    }
}
...
# 444 "/mnt/ws_tofino/extreme_2313/acl.p4"
...
control RouterAcl(in switch_lookup_fields_t lkp,
    ...
    apply {
# 608 "/mnt/ws_tofino/extreme_2313/acl.p4"
    }
}
...
control MirrorAcl(
    ...
    apply {
# 762 "/mnt/ws_tofino/extreme_2313/acl.p4"
    }
}
...
control EgressMirrorAcl(
    ...
    apply {
# 883 "/mnt/ws_tofino/extreme_2313/acl.p4"
    }
}
...
# 997 "/mnt/ws_tofino/extreme_2313/acl.p4"
...
control EgressAcl(in switch_header_outer_t hdr,
    ...
    apply {
        eg_md.flags.acl_deny = false;
# 1212 "/mnt/ws_tofino/extreme_2313/acl.p4"
    }
}
...
# 1276 "/mnt/ws_tofino/extreme_2313/acl.p4"
            //TODO add more
        }
...
# 24 "/mnt/ws_tofino/extreme_2313/l3.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/l2.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
control IngressSTP(in switch_ingress_metadata_t ig_md,
    ...
    apply {
# 86 "/mnt/ws_tofino/extreme_2313/l2.p4"
    }
}
...
control EgressSTP(in switch_egress_metadata_t eg_md, in switch_port_t port, out bool stp_state) {
    ...
    apply {
        stp_state = false;
# 118 "/mnt/ws_tofino/extreme_2313/l2.p4"
    }
}
...
control EgressBd(in switch_header_outer_t hdr,
                 in switch_bd_t bd,
...
// @flag QINQ_ENABLE
//-----------------------------------------------------------------------------
control VlanDecap(inout switch_header_outer_t hdr, in switch_egress_metadata_t eg_md) {
...
// @flag QINQ_ENABLE
//-----------------------------------------------------------------------------
control VlanXlate(inout switch_header_outer_t hdr,
                  inout switch_header_underlay_t hdr_underlay,
...
# 446 "/mnt/ws_tofino/extreme_2313/l2.p4"
   }
    ...
    action set_underlay_vlan_tagged(vlan_id_t vid) {
        ...
        hdr_underlay.vlan_tag[0].setValid();
        hdr_underlay.vlan_tag[0].ether_type = hdr_underlay.ethernet.ether_type;

        hdr_underlay.vlan_tag[0].pcp = eg_md.lkp.pcp;
        hdr_underlay.vlan_tag[0].cfi = 0;
        hdr_underlay.vlan_tag[0].vid = vid;
        hdr_underlay.ethernet.ether_type = 0x8100;
    }
    ...
    table set_ether_type {
        key = {
            ...
            hdr_underlay.vlan_tag[0].isValid() : exact; // extreme added
        }
...
*/
            ...
            //(_,   _,     true ) : set_type_vlan_nsh(); // v9.0.0 compile error
            (false, false, true ) : set_type_vlan_nsh();
            (false, true, true ) : set_type_vlan_nsh();
            (true, false, true ) : set_type_vlan_nsh();
            (true, true, true ) : set_type_vlan_nsh();
        }
    }
...
# 25 "/mnt/ws_tofino/extreme_2313/l3.p4" 2

# 1 "/mnt/ws_tofino/extreme_2313/npb_ing_sfc_top.p4" 1

control npb_ing_sfc_top (
 inout switch_header_underlay_t hdr,
 inout switch_ingress_metadata_t ig_md,
 ...
 action ing_sfc_sfc_class_12_permit (
  bit<8> sfc,
  bit<16> sfc_data,
  ...
  // ext type 1 - word 0
  ig_md.nsh_extr.extr_flow_class = flow_class;
  ig_md.nsh_extr.extr_sf_bitmask = sf_bitmask;
 ...
 table ing_sfc_sfc_class_12 {
  key = {
   ...
   ig_md.nsh_extr.extr_vpn_id : ternary;
  }

  actions = {
   NoAction;
   ing_sfc_sfc_class_12_permit;
   ing_sfc_sfc_class_drop;
  }

  const default_action = NoAction;
  size = NPB_ING_SFC_FLOW_CLASS_TABLE_DEPTH;
 }

 // =========================================================================
 // W/O NSH... Table #1: FlowType Classifier
 // =========================================================================

 action ing_sfc_flowclass_class_1_hit (
  bit<8> flow_class
 ) {
  // ext type 1 - word 0
  ig_md.nsh_extr.extr_flow_class = flow_class;
 ...
 table ing_sfc_flowclass_class_1 {
  key = {
   // l2
   ig_md.lkp.pkt_type : ternary;
   ig_md.lkp.mac_type : ternary;
 ...
 // =========================================================================
 // W/O NSH... Table #2: SFC Classifier
 // =========================================================================

 action ing_sfc_sfc_class_2_permit (
  bit<8> sfc,
  bit<16> sfc_data,
 ...
 table ing_sfc_sfc_class_2 {
  key = {
   ig_md.nsh_extr.extr_vpn_id : exact;
   ig_md.nsh_extr.extr_flow_class : exact;
  }

  actions = {
   NoAction;
   ing_sfc_sfc_class_2_permit;
   ing_sfc_sfc_class_drop;
  }
 ...
 action ing_sfc_sf_sel_miss(
  ...
  ig_md.nsh_extr.extr_sf_bitmask = 0;
 }
...
//			hdr.nsh_extr.si  : exact;
 ...
 apply {
  ...
  if(hdr.nsh_extr.isValid()) {
   ...
   // ext: type 2 - word 1+
//			ig_md.nsh_extr.extr_vpn_id                  = hdr.nsh_extr.extr_vpn_id;  //  3 bytes
//			ig_md.nsh_extr.extr_flow_class              = hdr.nsh_extr.extr_flow_class;  //  1 byte?
...
# 309 "/mnt/ws_tofino/extreme_2313/npb_ing_sfc_top.p4"
  }
...
//		ig_md.nsh_extr.extr_vpn_id                   = ig_md.tunnel.id;
  ig_md.nsh_extr.extr_vpn_id = (bit<16>)ig_md.bd;
 }

}
# 27 "/mnt/ws_tofino/extreme_2313/l3.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/npb_ing_sff_top.p4" 1
# 1 "/mnt/ws_tofino/extreme_2313/npb_ing_sf_npb_basic_adv_top.p4" 1
# 1 "/mnt/ws_tofino/extreme_2313/npb_ing_sf_npb_basic_adv_acl.p4" 1
...
control NpbIngSfPolicyL2(
 ...
 table ing_sf_policy_l2 {
  key = {
   ...
   // metadata
   ig_md.nsh_extr.extr_vpn_id : ternary;
//			ig_md.nsh_extr.extr_flow_class      : ternary;
   ig_md.ifindex : ternary;
  }
...
control npb_ing_sf_npb_basic_adv_acl (
 ...
 apply {
  ...
  // ----- l3/4 -----
# 427 "/mnt/ws_tofino/extreme_2313/npb_ing_sf_npb_basic_adv_acl.p4"
  if (!(ig_md.bypass & SWITCH_INGRESS_BYPASS_ACL != 0) && (!mac_packet_class_enable || !ig_md.flags.mac_pkt_class)) {
...
# 455 "/mnt/ws_tofino/extreme_2313/npb_ing_sf_npb_basic_adv_acl.p4"
  stats.count(stats_index);
 }
}
...
//		ig_md.nsh_extr.spi                    = nsh_sph_spi; // set in scheduler
 ...
 table ing_sf_policy_l2347 {
  key = {
            ...
            ig_md.bd_label : ternary;
            ig_md.ifindex : ternary;
            ig_md.l4_port_label : ternary; // derek added -- not in acl.p4, but seems like it shoudl be there....
   ...
   // ----- Flags -----
            ...
            ig_md.flags.link_local : ternary;
# 606 "/mnt/ws_tofino/extreme_2313/npb_ing_sf_npb_basic_adv_acl.p4"
            ig_md.ipv4.unicast_enable : ternary;
            ig_md.ipv6.unicast_enable : ternary;
...
# 2 "/mnt/ws_tofino/extreme_2313/npb_ing_sf_npb_basic_adv_top.p4" 2
...
//		ig_md.nsh_extr.si = ig_md.nsh_extr.si |-| 1; // decrement sp_index
  ...
  // code won't fit in tofino 1, so just hardcode things :(
  action_bitmask_internal = 0x3;
  ...
  if(action_bitmask_internal[0:0] == 1) {
   ...
   npb_ing_sf_npb_basic_adv_system_acl.apply (
    hdr,
    ig_md,
    ig_intr_md,
...
# 167 "/mnt/ws_tofino/extreme_2313/npb_ing_sf_npb_basic_adv_top.p4"
  }
...
# 2 "/mnt/ws_tofino/extreme_2313/npb_ing_sff_top.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/npb_ing_sff_flow_schd.p4" 1
...
# 54 "/mnt/ws_tofino/extreme_2313/npb_ing_sff_flow_schd.p4"
 // ---------------------------------
...
# 3 "/mnt/ws_tofino/extreme_2313/npb_ing_sff_top.p4" 2
...
//		if(ig_md.nsh_extr.valid == 1) {
   ...
   if(ig_md.nsh_extr.extr_sf_bitmask[0:0] == 1) {
...
control npb_ing_sff_top_part2 (
 ...
 action dmac_miss(
  ...
  ig_md.tunnel_underlay.terminate = end_of_chain;
 }
...
/*
    ...
    table ing_sff_dec_si {
        key = { ig_md.nsh_extr.extr_sf_bitmask[2:1] : exact; }
        actions = { new_si; }
        const entries = {
...
*/
    ...
    table ing_sff_dec_si {
        key = { ig_md.nsh_extr.extr_sf_bitmask[2:0] : exact; }
        actions = { new_si; }
        const entries = {
            0 : new_si(0); // 0 bits set
...
//			if((ig_md_nsh_extr_si == 0) && (ig_md.tunnel_underlay.terminate == false)) { // check for si of 0 (or underflow, since we used a saturating subtract)
//				ig_intr_md_for_dprsr.drop_ctl = 0x1; // drop packet
//			}
...
# 28 "/mnt/ws_tofino/extreme_2313/l3.p4" 2
...
# 210 "/mnt/ws_tofino/extreme_2313/l3.p4"
    apply {
        if (!fib.apply().hit) {
...
# 147 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/nexthop.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
# 148 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/parde.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
// Protocol Header Definitions
//-----------------------------------------------------------------------------
# 22 "/mnt/ws_tofino/extreme_2313/parde.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/types.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 ...
 *
 ******************************************************************************/
# 23 "/mnt/ws_tofino/extreme_2313/parde.p4" 2

# 1 "/mnt/ws_tofino/extreme_2313/npb_ing_parser.p4" 1



# 1 "/mnt/ws_tofino/extreme_2313/npb_sub_parsers.p4" 1
...
parser NpbIngressParser(
 ...
 bit<8> protocol_inner;
    ...
    state parse_port_metadata {
        ...
        transition snoop_transport_ethernet_ETH_T;
    ...
    ///////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////////
    // Tofino1: NSH support only via lookahead (no ERSPAN or VXLAN)
    // Tofino2: NSH, ERSPAN, VXLAN support via parser overwrite
    ...
    state snoop_transport_ethernet_ETH_T {
...
# 363 "/mnt/ws_tofino/extreme_2313/npb_ing_parser.p4"
    ///////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////////
    // "Outer" Headers
    ///////////////////////////////////////////////////////////////////////////
    ...
    // Layer X
    ///////////////////////////////////////////////////////////////////////////////
# 587 "/mnt/ws_tofino/extreme_2313/npb_ing_parser.p4"
    ///////////////////////////////////////////////////////////////////////////
    // Tunnels
    ///////////////////////////////////////////////////////////////////////////
...
//      ig_md.tunnel.id = (bit<32>)hdr.outer.vxlan.vni;
...
//#if defined(IPINIP) && defined(IPV6_TUNNEL_ENABLE)
    ...
    state parse_gre {
     pkt.extract(hdr.outer.gre);
        // todo: verify(hdr.outer.gre.version == 0, error.GreVersionNotZero);
        transition select(
            hdr.outer.gre.C,
            hdr.outer.gre.R,
            hdr.outer.gre.K,
...
// derek: can't get this to compile!?!?
//		ig_md.tunnel.id =  (bit<32>)hdr.outer.nvgre.vsid; // extreme added
     transition parse_inner_ethernet;
    }
    ...
    // Inner - Layer 2.5
    ///////////////////////////////////////////////////////////////////////////
# 820 "/mnt/ws_tofino/extreme_2313/npb_ing_parser.p4"
    ///////////////////////////////////////////////////////////////////////////
...
# 905 "/mnt/ws_tofino/extreme_2313/npb_ing_parser.p4"
    ///////////////////////////////////////////////////////////////////////////
    ...
    // Inner Tunnels
    ///////////////////////////////////////////////////////////////////////////
# 946 "/mnt/ws_tofino/extreme_2313/npb_ing_parser.p4"
    ///////////////////////////////////////////////////////////////////////////
...
# 25 "/mnt/ws_tofino/extreme_2313/parde.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/npb_egr_parser.p4" 1
...
# 39 "/mnt/ws_tofino/extreme_2313/npb_egr_parser.p4"
...
//#if defined(EGRESS_IP_ACL_ENABLE) || defined(EGRESS_MIRROR_ACL_ENABLE)
  ...
  eg_md.vrf = hdr.bridged_md.tunnel.vrf;
        eg_md.tunnel_underlay.terminate = hdr.bridged_md.tunnel.terminate_nsh; // extreme added
  ...
  // ---------------
        ...
        eg_md.nsh_extr.extr_sf_bitmask = hdr.bridged_md.base.nsh_extr_sf_bitmask; //  1 byte
        eg_md.nsh_extr.extr_flow_class = hdr.bridged_md.base.nsh_extr_flow_class; //  1 byte?
  ...
  eg_md.nsh_extr.sfc_data = hdr.bridged_md.base.nsh_extr_sfc_data;
        eg_md.nsh_extr.extr_vpn_id = hdr.bridged_md.base.nsh_extr_vpn_id; //  3 bytes
...
# 148 "/mnt/ws_tofino/extreme_2313/npb_egr_parser.p4"
    }
...
# 197 "/mnt/ws_tofino/extreme_2313/npb_egr_parser.p4"
        transition reject;

    }

    state parse_dtel_switch_local_metadata {
# 223 "/mnt/ws_tofino/extreme_2313/npb_egr_parser.p4"
        transition reject;
    ...
    // // Snoop ahead here to determine type of underlay
    // state snoop_transport_ethernet_ETH_T {
    //     underlay_ethernet_snoop_h snoop_enet = pkt.lookahead<underlay_ethernet_snoop_h>();
...
# 302 "/mnt/ws_tofino/extreme_2313/npb_egr_parser.p4"
    ///////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////////////////////////
    // ETH
    ///////////////////////////////////////////////////////////////////////////
...
//#endif
    ...
    // Layer X
    ///////////////////////////////////////////////////////////////////////////////
# 480 "/mnt/ws_tofino/extreme_2313/npb_egr_parser.p4"
    ///////////////////////////////////////////////////////////////////////////
    // Tunnels
    ///////////////////////////////////////////////////////////////////////////
...
# 26 "/mnt/ws_tofino/extreme_2313/parde.p4" 2
...
// header.
    ...
    apply {
# 728 "/mnt/ws_tofino/extreme_2313/parde.p4"
    }
}
...
// Egress deparser first construct the output packet and then prepend the mirror header.
    ...
    apply {
# 783 "/mnt/ws_tofino/extreme_2313/parde.p4"
    }
}
...
*/
        ...
        // ***** UNDERLAY *****
        // these are needed here for the "bridge case"
        pkt.emit(hdr.underlay.ethernet);
        //pkt.emit(hdr.underlay.vlan_tag);
        pkt.emit(hdr.underlay.nsh_extr);
# 849 "/mnt/ws_tofino/extreme_2313/parde.p4"
        // ***** OUTER *****
...
# 883 "/mnt/ws_tofino/extreme_2313/parde.p4"
        // ***** INNER *****
        pkt.emit(hdr.inner.ethernet);
...
# 906 "/mnt/ws_tofino/extreme_2313/parde.p4"
    }
}
...
control SwitchEgressDeparser(
    ...
    apply {
        ...
        // Extreme Networks - Modified
        // -------------------------------------
# 949 "/mnt/ws_tofino/extreme_2313/parde.p4"
        hdr.outer.ipv4.hdr_checksum = ipv4_checksum.update({
        ...
        // if (hdr.outer.ipv4_option.isValid()) {
        //     hdr.outer.ipv4.hdr_checksum = ipv4_checksum.update({
        //         hdr.outer.ipv4.version,
        //         hdr.outer.ipv4.ihl,
        //         hdr.outer.ipv4.diffserv,
        ...
        //         hdr.outer.ipv4.src_addr,
        //         hdr.outer.ipv4.dst_addr,
        //         hdr.outer.ipv4_option.type,
        //         hdr.outer.ipv4_option.length,
        //         hdr.outer.ipv4_option.value});
        // } else if (hdr.outer.ipv4.isValid()) {
        //     hdr.outer.ipv4.hdr_checksum = ipv4_checksum.update({
        //         hdr.outer.ipv4.version,
        //         hdr.outer.ipv4.ihl,
        //         hdr.outer.ipv4.diffserv,
        ...
        hdr.inner.ipv4.hdr_checksum = inner_ipv4_checksum.update({
            hdr.inner.ipv4.version,
            hdr.inner.ipv4.ihl,
            hdr.inner.ipv4.diffserv,
            hdr.inner.ipv4.total_len,
            hdr.inner.ipv4.identification,
            hdr.inner.ipv4.flags,
            hdr.inner.ipv4.frag_offset,
            hdr.inner.ipv4.ttl,
            hdr.inner.ipv4.protocol,
            hdr.inner.ipv4.src_addr,
...
*/
        ...
        //pkt.emit(hdr.underlay.vlan_tag);
        pkt.emit(hdr.underlay.nsh_extr);
# 1050 "/mnt/ws_tofino/extreme_2313/parde.p4"
        // ***** OUTER *****
        pkt.emit(hdr.outer.ethernet);
...
//todo: this erspan is original switch stuff.
//      now that we support erspan transport, can this stuff be removed?
# 1073 "/mnt/ws_tofino/extreme_2313/parde.p4"
        pkt.emit(hdr.outer.nvgre);
        pkt.emit(hdr.outer.udp);
        pkt.emit(hdr.outer.sctp);
        pkt.emit(hdr.outer.esp);
        ...
        pkt.emit(hdr.inner.tcp);
        pkt.emit(hdr.inner.sctp);
# 1111 "/mnt/ws_tofino/extreme_2313/parde.p4"
    }
}
# 149 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/port.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
# 1 "/mnt/ws_tofino/extreme_2313/rewrite.p4" 1
 ...
 *
 ******************************************************************************/
# 28 "/mnt/ws_tofino/extreme_2313/rewrite.p4" 2
...
control MirrorRewrite(inout switch_header_outer_t hdr,
    ...
    action rewrite_erspan_type2(
        ...
        //TODO(msharif): Support for GRE sequence number.
# 158 "/mnt/ws_tofino/extreme_2313/rewrite.p4"
    }
    ...
    action rewrite_erspan_type2_with_vlan(
            ...
            ipv4_addr_t sip, ipv4_addr_t dip, bit<8> tos, bit<8> ttl) {
# 182 "/mnt/ws_tofino/extreme_2313/rewrite.p4"
    }
    ...
    action rewrite_erspan_type3(
            ...
            mac_addr_t smac, mac_addr_t dmac,
            ipv4_addr_t sip, ipv4_addr_t dip, bit<8> tos, bit<8> ttl) {
# 205 "/mnt/ws_tofino/extreme_2313/rewrite.p4"
    }
    ...
    action rewrite_erspan_type3_with_vlan(
            ...
            bit<3> pcp, vlan_id_t vid,
            ipv4_addr_t sip, ipv4_addr_t dip, bit<8> tos, bit<8> ttl) {
# 229 "/mnt/ws_tofino/extreme_2313/rewrite.p4"
    }
    ...
    action rewrite_erspan_type3_platform_specific(
            ...
            mac_addr_t smac, mac_addr_t dmac,
            ipv4_addr_t sip, ipv4_addr_t dip, bit<8> tos, bit<8> ttl) {
# 252 "/mnt/ws_tofino/extreme_2313/rewrite.p4"
    }
    ...
    action rewrite_erspan_type3_platform_specific_with_vlan(
            ...
            bit<3> pcp, vlan_id_t vid,
            ipv4_addr_t sip, ipv4_addr_t dip, bit<8> tos, bit<8> ttl) {
# 278 "/mnt/ws_tofino/extreme_2313/rewrite.p4"
    }
    ...
    action rewrite_dtel_report(
            ...
            ipv4_addr_t sip, ipv4_addr_t dip, bit<8> tos, bit<8> ttl,
            bit<16> udp_dst_port) {
# 303 "/mnt/ws_tofino/extreme_2313/rewrite.p4"
    }
    ...
    apply {
# 376 "/mnt/ws_tofino/extreme_2313/rewrite.p4"
    }
}
...
control Rewrite(inout switch_header_outer_t hdr,
 ...
 // the ip ttl.
    ...
    action rewrite_underlay(switch_bd_t bd, mac_addr_t dmac) {
        eg_md.flags.routed = true;
        hdr_underlay.ethernet.dst_addr = dmac;
        eg_md.bd = bd;
  ...
  hdr_underlay.ethernet.setValid();
  hdr_underlay.ethernet.ether_type = 0x894F;
    }
 ...
 // ---------------------------------------------
    ...
    action rewrite_underlay_smac(mac_addr_t smac) {
        hdr_underlay.ethernet.src_addr = smac;
    }
...
//        eg_intr_md_for_dprsr.drop_ctl = 1;
    ...
    table npb_egr_sff_dec_ttl {
        key = { hdr_underlay.nsh_extr.ttl : exact; }
        actions = { new_ttl; discard; }
        const entries = {
            0 : new_ttl(63);
//          1  : discard();
...
//		derek:  actions can't call tables (why?), so have to do it below in the apply block instead...
    ...
    table ip_rewrite {
        key = {
            ...
            hdr_underlay.nsh_extr.isValid() : exact; // extreme added
        }
...
# 24 "/mnt/ws_tofino/extreme_2313/port.p4" 2
...
# 363 "/mnt/ws_tofino/extreme_2313/port.p4"
...
# 377 "/mnt/ws_tofino/extreme_2313/port.p4"
    }
}
...
# 150 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/validation.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
control PktValidation(
        in switch_header_outer_t hdr,
        in switch_header_underlay_t hdr_underlay,
...
//-----------------------------------------------------------------------------
    ...
    table validate_nsh {
        ...
        key = {
            hdr_underlay.nsh_extr.version : range;
            hdr_underlay.nsh_extr.o : ternary;
            hdr_underlay.nsh_extr.ttl : ternary;
            hdr_underlay.nsh_extr.len : range;
            hdr_underlay.nsh_extr.md_type : range;
            hdr_underlay.nsh_extr.next_proto : range;
            hdr_underlay.nsh_extr.si : ternary;
            //hdr_underlay.nsh_extr.md_class : ternary;
            //hdr_underlay.nsh_extr.type : ternary;
            //hdr_underlay.nsh_extr.md_len : range;
            //hdr_underlay.nsh_extr.extr_xxx : ternary;
        }
...
//          malformed_pkt(SWITCH_DROP_REASON_UNDERLAY_NSH_MD_LEN_INVALID);
    ...
    // Extreme Networks - Added
    // -------------------------------------
# 513 "/mnt/ws_tofino/extreme_2313/validation.p4"
    // -------------------------------------
...
*/
        ...
        if (hdr_underlay.nsh_extr.isValid()) { // extreme added
            // --- PACKET HAS UNDERLAY ---
...
# 151 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/rewrite.p4" 1
 ...
 *
 ******************************************************************************/
# 152 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/tunnel.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
//-----------------------------------------------------------------------------
control IngressTunnel(in switch_header_inner_t hdr,
                      inout switch_ingress_metadata_t ig_md,
...
control TunnelDecap(inout switch_header_outer_t hdr,
                    ...
                    in switch_tunnel_metadata_t tunnel_underlay
) (
  ...
  hdr.vlan_tag[0] = hdr_inner.vlan_tag[0]; // extreme added
    ...
    action invalidate_underlay_tunneling_headers() {
        // Removing tunneling headers by default.
        hdr_underlay.nsh_extr.setInvalid();
    }
    ...
    action decap_underlay() {
        ...
        hdr_underlay.ethernet.setInvalid();
        hdr_underlay.vlan_tag[0].setInvalid();
    ...
    apply {
        ...
        // Extreme Networks - Added
        // -------------------------------------
        if (!(eg_md.bypass & SWITCH_EGRESS_BYPASS_REWRITE != 0) && tunnel_underlay.terminate)
            decap_underlay();
...
control TunnelRewrite(inout switch_header_outer_t hdr,
                      inout switch_header_underlay_t hdr_underlay,
                      inout switch_egress_metadata_t eg_md,
                      in switch_tunnel_metadata_t tunnel
) (
...
/*
            switch(nexthop_rewrite.apply().action_run) {
                rewrite_tunnel : {
                    if(hdr_underlay.vlan_tag[0].isValid()) {
...
//
//-----------------------------------------------------------------------------
control TunnelEncap(inout switch_header_outer_t hdr,
                    inout switch_header_inner_t hdr_inner,
                    inout switch_header_underlay_t hdr_underlay,
                    inout switch_egress_metadata_t eg_md,
...
//              if(eg_md.nsh_extr.valid == 1) {
                        hdr_underlay.nsh_extr.setValid();
//              }

                // base: word 0
                hdr_underlay.nsh_extr.version = 0x0;
                hdr_underlay.nsh_extr.o = 0x0;
                hdr_underlay.nsh_extr.reserved = 0x0;
                hdr_underlay.nsh_extr.ttl = 0x3f; // will be decremented to 63, which is the rfc's recommended default value.
                hdr_underlay.nsh_extr.len = 0x6; // in 4-byte words (1 + 1 + 4).
                hdr_underlay.nsh_extr.reserved2 = 0x0;
                hdr_underlay.nsh_extr.md_type = 0x1; // 0 = reserved, 1 = fixed len, 2 = variable len.
                hdr_underlay.nsh_extr.next_proto = 0x3; // 1 = ipv4, 2 = ipv6, 3 = ethernet, 4 = nsh, 5 = mpls.

                // base: word 1
                // (nothing to do -- these fields get set in the parser from the bridged metadata)

                // ext: type 2 - word 0-3
                hdr_underlay.nsh_extr.ver = 0x2; // word 0
                hdr_underlay.nsh_extr.reserved4 = 0x0; // word 0

                hdr_underlay.nsh_extr.reserved5 = 0x0; // word 2
 }
...
# 953 "/mnt/ws_tofino/extreme_2313/tunnel.p4"
    }
...
//        hdr_inner.vlan_tag[0] = hdr.vlan_tag[0]; // extreme added COMMENTED OUT DUE TO 9.0.0 COMPILER BUG!
        add_ipv4_header(17);
...
//        add_vxlan_header(tunnel_.id); // extreme modified
        add_vxlan_header(tunnel_.id[23:0]); // extreme modified
        hdr.ethernet.ether_type = 0x0800;
    }
    ...
    action rewrite_ipv4_nvgre() {
        ...
        add_nvgre_header((bit<24>)tunnel_.id, 0);
...
//        hdr_inner.vlan_tag[0] = hdr.vlan_tag[0]; // extreme added COMMENTED OUT DUE TO 9.0.0 COMPILER BUG!
        ...
        //   NVGRE (8)
        hdr.ipv6.payload_len = payload_len + 16w8;
  ...
  /*
		...
		const entries = {
			...
			(SWITCH_TUNNEL_TYPE_NSH)      = rewrite_underlay_nsh(); // extreme added
...
//            encap_outer.apply(); // extreme modified
            ...
            // todo: do we need to account for ERSPAN underlay here too?
   if(tunnel_.type != SWITCH_TUNNEL_TYPE_NSH) { // extreme added
...
# 153 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/multicast.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
//      bit<FLOW_CLASS_WIDTH> flow_class
        ...
        eg_md.nsh_extr.extr_sf_bitmask = sf_bitmask;
//      eg_md.nsh_extr.extr_vpn_id                   = vpn_id;
//      eg_md.nsh_extr.extr_flow_class               = flow_class;
    }
...
# 154 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/qos.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
 ...
 *
 ******************************************************************************/
# 27 "/mnt/ws_tofino/extreme_2313/qos.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/meter.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
 ...
 *
 ******************************************************************************/
# 27 "/mnt/ws_tofino/extreme_2313/meter.p4" 2
...
control IngressPolicer(in switch_ingress_metadata_t ig_md,
    ...
    apply {
# 102 "/mnt/ws_tofino/extreme_2313/meter.p4"
    }
}
...
# 183 "/mnt/ws_tofino/extreme_2313/meter.p4"
    }
}
...
# 28 "/mnt/ws_tofino/extreme_2313/qos.p4" 2
...
control IngressQoS(
    ...
    apply {
# 415 "/mnt/ws_tofino/extreme_2313/qos.p4"
    }
}
...
control EgressQoS(inout switch_header_outer_t hdr,
    ...
    apply {
# 512 "/mnt/ws_tofino/extreme_2313/qos.p4"
    }
}
# 155 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/meter.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 ...
 *
 ******************************************************************************/
# 156 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/wred.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
control WRED(inout switch_header_outer_t hdr,
    ...
    apply {
# 140 "/mnt/ws_tofino/extreme_2313/wred.p4"
    }
}
# 157 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/dtel.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
control FlowReport(inout switch_egress_metadata_t eg_md, out bit<2> flag) {
    ...
    apply {
# 428 "/mnt/ws_tofino/extreme_2313/dtel.p4"
    }
}
...
control IngressDtel(in switch_header_outer_t hdr,
    ...
    apply {
# 486 "/mnt/ws_tofino/extreme_2313/dtel.p4"
    }
}
...
control EgressDtel(inout switch_header_outer_t hdr,
    ...
    apply {
# 649 "/mnt/ws_tofino/extreme_2313/dtel.p4"
    }
}
# 158 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
...
# 1 "/mnt/ws_tofino/extreme_2313/npb_egr_sff_top.p4" 1
# 1 "/mnt/ws_tofino/extreme_2313/npb_egr_sf_proxy_top.p4" 1
...
# 1 "/mnt/ws_tofino/extreme_2313/npb_egr_sf_proxy_meter.p4" 1
...
# 186 "/mnt/ws_tofino/extreme_2313/npb_egr_sf_proxy_top.p4" 2
# 1 "/mnt/ws_tofino/extreme_2313/npb_ing_sf_npb_basic_adv_dedup.p4" 1
/* -*- P4_16 -*- */
...
control npb_ing_sf_npb_basic_adv_dedup_reg (
 in switch_header_underlay_t hdr,
 inout switch_egress_metadata_t eg_md,
 in egress_intrinsic_metadata_t eg_intr_md,
 in egress_intrinsic_metadata_from_parser_t eg_intr_md_from_prsr,
 inout egress_intrinsic_metadata_for_deparser_t eg_intr_md_for_dprsr,
...
# 187 "/mnt/ws_tofino/extreme_2313/npb_egr_sf_proxy_top.p4" 2
...
control npb_egr_sf_proxy_top_part2 (
 ...
 apply {
  ...
  if(eg_md.action_bitmask[3:3] == 1) {
   ...
   // Action #3 - Meter
   // ----------------------------------
# 279 "/mnt/ws_tofino/extreme_2313/npb_egr_sf_proxy_top.p4"
  }
  ...
  if(eg_md.action_bitmask[4:4] == 1) {
   ...
   // ----------------------------------
# 296 "/mnt/ws_tofino/extreme_2313/npb_egr_sf_proxy_top.p4"
  }

 }

}
# 2 "/mnt/ws_tofino/extreme_2313/npb_egr_sff_top.p4" 2
...
control npb_egr_sff_top_part1 (
 ...
 apply {
  ...
  // Note: All constants are set in tunnel.p4, when the header is first added!
  ...
  hdr.nsh_extr.ifclass = 0x0; // word 2 TODO: fix

  hdr.nsh_extr.timestamp = 0x0; // word 3 TODO: fix
...
//		if(eg_md.nsh_extr.valid == 1) {
   ...
   if(eg_md.nsh_extr.extr_sf_bitmask[1:1] == 1) {
...
//				if(hdr.nsh_extr.si == 0) {
//					eg_intr_md_for_dprsr.drop_ctl = 0x1; // drop packet
//				}
   }

   if(eg_md.nsh_extr.extr_sf_bitmask[2:2] == 1) {
...
//			if((hdr.nsh_extr.si == 0) && (eg_md.tunnel_underlay.terminate == false)) { // check for si of 0 (or underflow, since we used a saturating subtracts)
//				eg_intr_md_for_dprsr.drop_ctl = 0x1; // drop packet
//			}

   if(eg_md.tunnel_underlay.terminate == false) { // check for si of 0 (or underflow, since we used a saturating subtracts)
...
# 167 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
//#include "npb_egr_sff_tunnel.p4"


# 1 "/mnt/ws_tofino/extreme_2313/npb_ing_hdr_stack_counters.p4" 1
...
# 309 "/mnt/ws_tofino/extreme_2313/npb_ing_hdr_stack_counters.p4"
        else {
            cntrs_inner_addr_l4 = 0;
        }
...
# 171 "/mnt/ws_tofino/extreme_2313/npb.p4" 2
...
*/
        ...
        IngressHdrStackCounters.apply(hdr.outer, hdr.underlay, hdr.inner);
...
//      pkt_validation.apply(hdr.outer, hdr.underlay, ig_md.flags, ig_md.lkp, ig_intr_md_for_tm, ig_md.drop_reason); // extreme modified
        pkt_validation.apply(hdr.outer, hdr.underlay, ig_md.flags, ig_md.lkp, ig_md, ig_intr_from_prsr, ig_intr_md_for_dprsr, ig_intr_md_for_tm, ig_md.drop_reason); // extreme modified


        ingress_port_mapping.apply(hdr.outer, ig_md, ig_intr_md_for_tm, ig_intr_md_for_dprsr);
        stp.apply(ig_md, ig_md.stp);

        tunnel.apply(hdr.inner, ig_md, ig_md.flags.inner_ipv4_checksum_err, ig_md.lkp, ig_md.tunnel);
//      smac.apply(ig_md.lkp.mac_src_addr, ig_md, ig_intr_md_for_dprsr.digest_type); // extreme modified
//      bd_stats.apply(ig_md.bd, ig_md.lkp.pkt_type); // extreme modified
//      acl.apply(ig_md.lkp, ig_md); // extreme modified
...
*/
  ...
  unicast.apply(
   ig_md.lkp,
        ...
        qos.apply(hdr.outer, ig_md.lkp, ig_md);
...
//        system_acl.apply(ig_md, ig_intr_md_for_tm, ig_intr_md_for_dprsr);
        dtel.apply(
            hdr.outer, ig_md.lkp, ig_md, ig_md.hash[15:0], ig_intr_md_for_dprsr, ig_intr_md_for_tm);
...
# 342 "/mnt/ws_tofino/extreme_2313/npb.p4"
    }
}
...
control SwitchEgress(
    ...
    apply {
        ...
        mirror_rewrite.apply(hdr.outer, eg_md);
        ...
        vlan_decap.apply(hdr.outer, eg_md);
        tunnel_decap.apply(hdr.outer, hdr.inner, hdr.underlay, eg_md, eg_md.tunnel, eg_md.tunnel_underlay);
        qos.apply(hdr.outer, eg_intr_md.egress_port, eg_md);
        wred.apply(hdr.outer, eg_md, eg_intr_md, eg_md.flags.wred_drop);

        rewrite.apply(hdr.outer, hdr.underlay, eg_md);
//        acl.apply(hdr.outer, eg_md.lkp, eg_md);
        tunnel_encap.apply(hdr.outer, hdr.inner, hdr.underlay, eg_md, eg_md.tunnel);
        tunnel_rewrite.apply(hdr.outer, hdr.underlay, eg_md, eg_md.tunnel);
  ...
  //   *maybe the compiler is smart enough to move this stuff around already, so no need to split?
        ...
        mtu.apply(hdr.outer, eg_md, eg_md.checks.mtu);
        vlan_xlate.apply(hdr.outer, hdr.underlay, eg_md);

        dtel.apply(hdr.outer, eg_md, eg_intr_md, eg_md.dtel.hash, eg_intr_md_for_dprsr);
//        system_acl.apply(hdr.outer, eg_md, eg_intr_md, eg_intr_md_for_dprsr);
