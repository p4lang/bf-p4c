...
#		self.target = gc.Target(self.dev, pipe_id=0xffff)
	...
	def runTest(self):
        ...
        # use this sfc to switch to the second path and the packet is received.
			...
			npb_npb_sf0_policy_l2_add(self, self.target, ig_pipe, sap=sap, vpn=vpn, l2_etype=0x0800, l2_etype_mask=0xffff, flow_class=flow_class_acl, sfc_enable=1, sfc=sfc)
