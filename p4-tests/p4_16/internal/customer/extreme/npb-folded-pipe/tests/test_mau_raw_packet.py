	...
	def runTest(self):
		...
		for ig_pipe in ig_pipes:
			...
			npb_nsh_chain_start_end_add(self, self.target,ig_pipe,
				#ingress
				[ig_port_0], ig_lag_ptr, 0, sap, vpn, spi, si, sf_bitmask, rmac, nexthop_ptr, bd, eg_lag_ptr, 0, 0, [eg_port], False, 0, dsap
				#tunnel
#				tunnel_encap_ptr, EgressTunnelType.NSH.value, tunnel_encap_nexthop_ptr, tunnel_encap_bd, dmac, tunnel_encap_smac_ptr, smac
			...
			npb_nsh_chain_start_end_add(self, self.target,ig_pipe,
				#ingress
				[ig_port_1], ig_lag_ptr, 0, sap, vpn, spi_new, si_new, sf_bitmask, rmac, nexthop_ptr, bd, eg_lag_ptr, 0, 0, [eg_port], False, 0, dsap
				#tunnel
#				tunnel_encap_ptr, EgressTunnelType.NSH.value, tunnel_encap_nexthop_ptr, tunnel_encap_bd, dmac, tunnel_encap_smac_ptr, smac
				#egress
			)
