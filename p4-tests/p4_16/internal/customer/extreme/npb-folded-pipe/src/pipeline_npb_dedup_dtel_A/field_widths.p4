...
#define _P4_FIELD_WIDTHS_
    ...
    #define switch_tunnel_index_width        8                                // original value: 16
    #define switch_tunnel_ip_index_width    16                                // original value: 16
    #define switch_tunnel_id_width          32 // 32 for teid field           // original value: 24
    
    #define switch_hash_width               32 // smallest can go is 26       // original value: 32
    
    // -------------------------------------
    // NPB Widths
    // -------------------------------------
    
	#define SPI_WIDTH                       24                                // original value: 24
	...
	#define BRIDGED_METADATA_WIDTH          40 // number of bytes in the bridged metadata -- must be set manually -- can change between compiler runs
  #else
