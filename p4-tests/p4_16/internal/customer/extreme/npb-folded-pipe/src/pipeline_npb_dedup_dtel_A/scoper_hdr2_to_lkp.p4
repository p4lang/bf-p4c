...
*/
	action scope_l2_none(bit<16> ethertype) {
#ifdef INGRESS_MAU_NO_LKP_2
		// do nothing...keep previous layer's values
#else
//		lkp.l2_valid     = false;
...
//	action scope_l2_none_l3_none_l4_none() { scope_l2_none();               scope_l3_none(); scope_l4_none(); }
	...
	// l3, l4 only (no l2)
	action scope_l2_none_l3_v4_l4_none()   { scope_l2_none(ETHERTYPE_IPV4); scope_l3_v4();   scope_l4_none(); }
	action scope_l2_none_l3_v6_l4_none()   { scope_l2_none(ETHERTYPE_IPV6); scope_l3_v6();   scope_l4_none(); }
	action scope_l2_none_l3_v4_l4_tcp()    { scope_l2_none(ETHERTYPE_IPV4); scope_l3_v4();   scope_l4_tcp();  }
	action scope_l2_none_l3_v6_l4_tcp()    { scope_l2_none(ETHERTYPE_IPV6); scope_l3_v6();   scope_l4_tcp();  }
	action scope_l2_none_l3_v4_l4_udp()    { scope_l2_none(ETHERTYPE_IPV4); scope_l3_v4();   scope_l4_udp();  }
	action scope_l2_none_l3_v6_l4_udp()    { scope_l2_none(ETHERTYPE_IPV6); scope_l3_v6();   scope_l4_udp();  }
	action scope_l2_none_l3_v4_l4_sctp()   { scope_l2_none(ETHERTYPE_IPV4); scope_l3_v4();   scope_l4_sctp(); }
	action scope_l2_none_l3_v6_l4_sctp()   { scope_l2_none(ETHERTYPE_IPV6); scope_l3_v6();   scope_l4_sctp(); }
