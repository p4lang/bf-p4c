...
#			rmac = dmac
			...
			npb_nsh_chain_start_end_with_tunnel_add(self, self.target, ig_pipe,
				#ingress
			...
			npb_npb_sf0_policy_l2_add(self, self.target, ig_pipe, sap=sap, vpn=vpn, tun_type=IngressTunnelType.VXLAN.value,  tun_type_mask=0xf, scope=1)
			npb_npb_sf0_policy_l2_add(self, self.target, ig_pipe, sap=sap, vpn=vpn, tun_type=IngressTunnelType.IPINIP.value, tun_type_mask=0xf, scope=1)
			npb_npb_sf0_policy_l2_add(self, self.target, ig_pipe, sap=sap, vpn=vpn, tun_type=IngressTunnelType.NVGRE.value,  tun_type_mask=0xf, scope=1)
			npb_npb_sf0_policy_l2_add(self, self.target, ig_pipe, sap=sap, vpn=vpn, tun_type=IngressTunnelType.GRE.value,    tun_type_mask=0xf, scope=1)
			npb_npb_sf0_policy_l2_add(self, self.target, ig_pipe, sap=sap, vpn=vpn, tun_type=IngressTunnelType.GTPC.value,   tun_type_mask=0xf, scope=0)
			npb_npb_sf0_policy_l2_add(self, self.target, ig_pipe, sap=sap, vpn=vpn, tun_type=IngressTunnelType.GTPU.value,   tun_type_mask=0xf, scope=1)
			npb_npb_sf0_policy_l2_add(self, self.target, ig_pipe, sap=sap, vpn=vpn, tun_type=IngressTunnelType.ERSPAN.value, tun_type_mask=0xf, scope=1)
			...
			npb_npb_sf2_policy_l2_add(self, self.target, ig_pipe, dsap=dsap, tun_type=IngressTunnelType.GTPC.value,   tun_type_mask=0xf, terminate=0)
			...
			npb_npb_sf2_policy_l2_add(self, self.target, ig_pipe, dsap=dsap, tun_type=IngressTunnelType.ERSPAN.value, tun_type_mask=0xf, terminate=1)

			# -----------------

			npb_tunnel_encap_sip_rewrite_v6_add(self, self.target, ig_pipe, tunnel_encap_bd, sip)
			npb_tunnel_encap_dip_rewrite_v6_add(self, self.target, ig_pipe, tunnel_encap_ptr, dip)
...
#			time.sleep(1)
			...
			src_pkt, exp_pkt = npb_simple_3lyr_nvgre_gre_ip(
				...
				dmac=dmac, smac=smac,
				transport_decap=False, sf_bitmask=sf_bitmask, start_of_chain=True, end_of_chain=True, scope_term_list=[0, 1], transport_encap=EgressTunnelType.IPV6_GRE.value,
			...
			src_pkt, exp_pkt = npb_simple_3lyr_nvgre_gtpc_udp(
				dmac_nsh=dmac, smac_nsh=smac, spi=spi, si=si, sap=sap, vpn=vpn, ttl=63, scope=1,
				dmac=dmac, smac=smac,
				transport_decap=False, sf_bitmask=sf_bitmask, start_of_chain=True, end_of_chain=True, scope_term_list=[0], transport_encap=EgressTunnelType.IPV6_GRE.value,
				spi_exp=spi, si_exp=si, sap_exp=sap, vpn_exp=vpn+1
			)
