...
#		self.target = gc.Target(self.dev, pipe_id=0xffff)
	...
	def runTest(self):
		...
		for ig_pipe in ig_pipes:
			...
			npb_npb_sf0_policy_l34_v4_add(self, self.target, ig_pipe, sap=sap, l4_src_rng=0, l4_src_rng_mask=0xffff,  flow_class=flow_class_acl, drop=0) # don't drop
			npb_npb_sf0_policy_l34_v4_add(self, self.target, ig_pipe, sap=sap, l4_src_rng=1, l4_src_rng_mask=0xffff,  flow_class=flow_class_acl, drop=1) # drop
...
#			testutils.verify_packets(self, exp_pkt, [eg_port])
			...
			npb_npb_sf0_policy_l34_v4_del(self, self.target, ig_pipe, sap=sap, l4_src_rng=0, l4_src_rng_mask=0xffff) # don't drop
			npb_npb_sf0_policy_l34_v4_del(self, self.target, ig_pipe, sap=sap, l4_src_rng=1, l4_src_rng_mask=0xffff) # drop
			...
			npb_npb_sf0_policy_l34_v4_add(self, self.target, ig_pipe, sap=sap, l4_dst_rng=0, l4_dst_rng_mask=0xffff,  flow_class=flow_class_acl, drop=0) # don't drop
			npb_npb_sf0_policy_l34_v4_add(self, self.target, ig_pipe, sap=sap, l4_dst_rng=1, l4_dst_rng_mask=0xffff,  flow_class=flow_class_acl, drop=1) # drop
