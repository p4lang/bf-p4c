...
@pa_container_type("egress", "hdr.transport.ipv4.hdr_checksum", "mocha")
@pa_container_size("egress", "hdr.transport.ipv4.hdr_checksum", 16)
@pa_container_size("egress", "hdr.transport.ipv4.protocol", 16)
