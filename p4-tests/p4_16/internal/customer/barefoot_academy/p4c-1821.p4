    ...
    inout ingress_intrinsic_metadata_for_tm_t        ig_tm_md)
{
...
#else
        hdr.icmp.msg_type = ICMP_TYPE_ECHO_REPLY;
#endif        
        hdr.icmp.checksum = 0;
    ...
    table forward_or_respond {
        ...
        const entries = {
            ...
            send_icmp_echo_reply();
#else
            (true,  true,  false, false, ARP_OPCODE_REQUEST, _ ) :
            send_arp_reply();
            
            (false, false, true,   true, _, ICMP_TYPE_ECHO_REQUEST) :
            send_icmp_echo_reply();
