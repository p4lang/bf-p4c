...
# 10 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2




# 1 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/headers.p4" 1
# 20 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/headers.p4"
...
# 15 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2
# 1 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/packet_parser_ingress.p4" 1
/*!
 ...
 * @date
 */
# 16 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/packet_parser_ingress.p4"
parser PacketParserIngress(packet_in pkt,
    ...
    state parseIpv6 {
        ...
        bit<4> data_offset = pkt.lookahead<tcp_h>().data_offset;
        transition select(hdr.ipv6.next_hdr, hdr.ipv6.payload_len, data_offset) {
            (IP_PROTOCOLS_GRE, _, _): parseGre;
            (IP_PROTOCOLS_IPV4, _, _): parseInnerIpv4;
            (IP_PROTOCOLS_ICMPv6, _, _): parseIcmp;
            (IP_PROTOCOLS_UDP, _, _): parseUdp;
            (IP_PROTOCOLS_TCP, _, 8&&&8 ) : parseTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x10 &&& 16w0xfff, 7&&&8 ) : parseTcpAccept;
            (IP_PROTOCOLS_TCP, 16w0x18 &&& 16w0xfff8, _ ) : parseTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x20 &&& 16w0x20, _): parseTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x40 &&& 16w0x40, _): parseTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x80 &&& 16w0x80, _): parseTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x100 &&& 16w0x100, _): parseTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x200 &&& 16w0x200, _): parseTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x400 &&& 16w0x400, _): parseTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x800 &&& 16w0x800, _): parseTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x1000 &&& 16w0x1000, _): parseTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x2000 &&& 16w0x2000, _): parseTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x4000 &&& 16w0x4000, _): parseTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x8000 &&& 16w0x8000, _): parseTcpL23;
            (_, 16w0x18 &&& 16w0xfff8, _) : parseL23;
            (_, 16w0x10 &&& 16w0xfff8, _) : parseAccept;
            default: parseL23;
        }
    }
    ...
    state parseUdp {
        ...
        transition select(hdr.udp.dst_port, hdr.udp.udp_length) {
            ...
            (PORT_GTP_v2, _): parseGtpC;
            (PORT_GTP_C, _): parseGtpC;
    ...
    state parseInnerIpv6 {
        ...
        bit<4> data_offset = pkt.lookahead<tcp_h>().data_offset;
        transition select(hdr.inner_ipv6.next_hdr, hdr.inner_ipv6.payload_len, data_offset) {
            // for particular inner decode
            (IP_PROTOCOLS_TCP, _, 8&&&8 ) : parseInnerTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x10 &&& 16w0xfff, 7&&&8 ) : parseInnerTcpAccept;
            (IP_PROTOCOLS_TCP, 16w0x18 &&& 16w0xfff8, _ ) : parseInnerTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x20 &&& 16w0x20, _): parseInnerTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x40 &&& 16w0x40, _): parseInnerTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x80 &&& 16w0x80, _): parseInnerTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x100 &&& 16w0x100, _): parseInnerTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x200 &&& 16w0x200, _): parseInnerTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x400 &&& 16w0x400, _): parseInnerTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x800 &&& 16w0x800, _): parseInnerTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x1000 &&& 16w0x1000, _): parseInnerTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x2000 &&& 16w0x2000, _): parseInnerTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x4000 &&& 16w0x4000, _): parseInnerTcpL23;
            (IP_PROTOCOLS_TCP, 16w0x8000 &&& 16w0x8000, _): parseInnerTcpL23;
            (IP_PROTOCOLS_UDP, _, _): parseInnerUdp;
            (_, 16w0x18 &&& 16w0xfff8, _) : parseL23;
            (_, 16w0x10 &&& 16w0xfff8, _) : parseAccept;
            default: parseL23;
        }
...
# 16 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2
# 1 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/packet_parser_egress.p4" 1
/*!
 ...
 * @date
 */
# 16 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/packet_parser_egress.p4"
...
# 17 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2
//#include "hash_generator.p4"
# 1 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/outbound_l47.p4" 1
/*!
...
# 19 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2
# 1 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/inbound_l47.p4" 1
/*!
 * @file inbound_l47.p4
 * @brief lookup table for queue range, queue offset and queue mask
 */
# 13 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/inbound_l47.p4"
...
# 20 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2
# 1 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/timestamp.p4" 1
/*!
 * @file timestamp.p4
...
# 21 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2
# 1 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/latency_stat.p4" 1
/*!
...
# 22 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2
# 1 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/egress_mirror_overhead.p4" 1
/*!
...
# 23 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2
# 1 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/ingress_metadata_map.p4" 1
/*!
...
# 24 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2
# 1 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/checksum_correction.p4" 1
/*!
...
# 25 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2
# 1 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/l2offset_map.p4" 1
/*!
 * @file ingress_metadata_map.p4
 * @brief map ingress metadata ( muxing inner ip, ip to metadata)
 */
...
# 26 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2
# 1 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/capture_filter.p4" 1
/*!
 * @file inbound_l47.p4
 * @brief lookup table for queue range, queue offset and queue mask
 */
# 13 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/capture_filter.p4"
...
# 27 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2
# 1 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/length_filter.p4" 1
/*!
 * @file inbound_l47.p4
 * @brief lookup table for queue range, queue offset and queue mask
 */
# 13 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/length_filter.p4"
...
# 28 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2
# 1 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/ingress_cmp.p4" 1
...
# 29 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2
# 1 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/egress_cmp.p4" 1
...
# 30 "/data/bf-p4c-compilers/master-git/p4-tests/p4_16/customer/keysight/p4c-5126/p4/eagle_l47.p4" 2
