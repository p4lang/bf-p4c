...
const size_t ETH_MIN_SIZE = 0xe;
const size_t IPV4_MIN_SIZE = 0x14;
const size_t UDP_SIZE = 0x8;
const size_t GTP_MIN_SIZE = 0x8;
const size_t VLAN_SIZE = 0x4;
...
control UPFEgressDeparser(packet_out pkt, inout headers hdr, in upf_egress_metadata_t eg_md, in egress_intrinsic_metadata_for_deparser_t eg_intr_md_for_dprsr) {
    ...
    apply {
        hdr.outer_ipv4.hdrChecksum = outer_ipv4_checksum.update({ hdr.outer_ipv4.version, hdr.outer_ipv4.ihl, hdr.outer_ipv4.diffserv, hdr.outer_ipv4.totalLen, hdr.outer_ipv4.identification, hdr.outer_ipv4.flags, hdr.outer_ipv4.fragOffset, hdr.outer_ipv4.ttl, hdr.outer_ipv4.protocol, hdr.outer_ipv4.srcAddr, hdr.outer_ipv4.dstAddr });
        hdr.inner_ipv4.hdrChecksum = inner_ipv4_checksum.update({ hdr.inner_ipv4.version, hdr.inner_ipv4.ihl, hdr.inner_ipv4.diffserv, hdr.inner_ipv4.totalLen, hdr.inner_ipv4.identification, hdr.inner_ipv4.flags, hdr.inner_ipv4.fragOffset, hdr.inner_ipv4.ttl, hdr.inner_ipv4.protocol, hdr.inner_ipv4.srcAddr, hdr.inner_ipv4.dstAddr });
        pkt.emit(hdr.dp_ctrl);
        pkt.emit(hdr.ethernet);
        pkt.emit(hdr.vlan);
        pkt.emit(hdr.outer_ipv4);
...
Pipeline(UPFIngressParser(), UPFIngress(), UPFIngressDeparser(), UPFEgressParser(), UPFEgress(), UPFEgressDeparser()) pipe;
