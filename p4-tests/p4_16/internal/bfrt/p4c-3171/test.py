...
#		self.target = gc.Target(self.dev, pipe_id=0xffff)
	...
	def runTest(self):
		...
		npb_npb_sf2_policy_l2_add(self, self.target, dsap=dsap, tun_type=IngressTunnelType.ERSPAN.value, tun_type_mask=0xf, trunc_enable=1, trunc=0x100)
...
#		exp_pkt[IP].len     = 0x01f2
#		exp_pkt[IP].chksum  = 0xf7a6
#		exp_pkt[UDP].len    = 0x01de
#		exp_pkt[UDP].chksum = 0x3dfe
		exp_pkt[IP].len     = 0x01f2
		exp_pkt[IP].chksum  = 0xf7a6
		exp_pkt[UDP].len    = 0x01de
		exp_pkt[UDP].chksum = 0x3a97
