...
#define switch_tunnel_index_width 17
#define switch_nexthop_width 17
...
// IP Hosts/Routes
const bit<32> IPV4_HOST_TABLE_SIZE = 65536; //128K
const bit<32> IPV4_LPM_TABLE_SIZE = 16384;
const bit<32> IPV6_HOST_TABLE_SIZE = 4096;
const bit<32> IPV6_LPM_TABLE_SIZE = 4096; //10K
...
control SwitchIngress(
    ...
    apply {
        ...
        system_acl.apply(
            ig_md, ig_md.lkp, ig_intr_md_for_tm, ig_intr_md_for_dprsr);
...
control SwitchEgress(
    ...
    apply {
        ...
        if (eg_md.port_type == SWITCH_PORT_TYPE_NORMAL && eg_md.pkt_src == SWITCH_PKT_SRC_BRIDGED) {
