...
if [ "$1" == "1" ]; then
    ...
    #./run_p4_tests.sh --target hw --no-veth -f /npb-dp/tests/npb/ports.json -t $test_path --arch tofino -s test_mau_1hop_s_e.test || status=1
    ./run_p4_tests.sh --target hw --no-veth -f /npb-dp/tests/npb/ports.json -t $test_path --arch tofino || status=1
    ...
    #./run_p4_tests.sh --target hw --no-veth -f /npb-dp/tests/npb/ports.json -t $test_path --arch tofino2 -s test_mau_1hop_s_e.test || status=1
    #./run_p4_tests.sh --target hw --no-veth -f /npb-dp/tests/npb/ports.json -t $test_path --arch tofino2 -s test_parser_ing_cpu.test || status=1
    ./run_p4_tests.sh --target hw --no-veth -f /npb-dp/tests/npb/ports.json -t $test_path --arch tofino2 || status=1
    cp ptf.log $log_path/ptf.log || status=1
