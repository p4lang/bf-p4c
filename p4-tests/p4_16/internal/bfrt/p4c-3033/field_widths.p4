...
#define _P4_FIELD_WIDTHS_
    ...
    #define switch_outer_nexthop_width      12                                // original value: 16
    ...
    #define SSAP_ID_WIDTH                   12                                // original value: 16
    #define DSAP_ID_WIDTH                   10                                // original value: 16
    ...
    #define switch_outer_nexthop_width      16                                // original value: 16
    #define switch_smac_index_width         16                                // original value: 16
    #define switch_cpu_reason_width          8                                // original value: 16
    #define switch_drop_reason_width         8                                // original value:  8
