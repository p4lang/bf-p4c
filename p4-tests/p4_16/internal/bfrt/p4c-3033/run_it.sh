...
#    fi
    ...
    ./run_p4_tests.sh -t $test_path --arch tofino2 -s test_mau_1hop_s___sfc_transport.test || status=1
    #./run_p4_tests.sh -t $test_path --arch tofino2 -s test_mau_1hop_____bridge.test || status=1
    #./run_p4_tests.sh -t $test_path --arch tofino2 -s test_mau_1hop_____bridge_cpu.test || status=1
    #./run_p4_tests.sh -t $test_path --arch tofino2 -s test_mau_1hop_s___sf0_acl_l2_truncate.test || status=1
