/*
 * Tests the partial exclusion of a match field from the exact match hash calculation.
 *
 * The same P4 code is used in gtest MaskExactMatchHashBitsTest.PartialFieldExclusion
