...
//      Ether/IPv4/m1/m2
//      Ether/IPv4/m1/m2_lookahead_greedy
//
// Ether/IPv4/m1/m2:
// (scapy syntax)
//
...
//
//  p_m2_lookahead_greedy = Ether()/IP()/'eeee'/'eeee'/'eeee'/'eeee'/'eeee'/'eeee'/'eeee'/'eeee'/'eeee'/'eeee'/'DDDD'/'DDDD'/'DDDD'/'DDDD'/'DDDD'/'DDDD'/'DDDD'/'DDDD'/'DDDD'/'DDDD'
//
...
parser ParserImpl(packet_in packet, out headers hdr,
    ...
    state parse_m1 {
        ...
        transition select(meta.m1.v0) {
            ...
            0x65656565 : parse_m2_lookahead_greedy;     // 'eeee'
            default: accept;
        }
    }
    ...
    state parse_m2_lookahead_greedy {
        meta.m2.v0 = lookahead_greedy<bit<32>>(packet);
        transition accept;
    }
}
    ...
    inout ingress_intrinsic_metadata_for_tm_t        ig_tm_md)
{
    ...
    table check_meta2 {
        ...
        const entries = {
            0x44444444: action_m2_set_extract_value(0x44);
            0x44444400: action_m2_set_extract_value(0x33);
            0x44440000: action_m2_set_extract_value(0x22);
            0x44000000: action_m2_set_extract_value(0x11);
            0x00000000: action_m2_set_extract_value(0x00);
        }
