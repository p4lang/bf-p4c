/*
 * Program to test state merging
 *
 * This program should produce a shortest path of 3 ingress states (see
...
# 1 "/data/bf-sde-9.13.1.89-cpr/install/share/p4c/p4include/t2na.p4" 1
/**
         ...
         in ghost_intrinsic_metadata_t g_intr_md)
{
   ...
   */
    ...
    latch_timestamp = {
        void apply(inout lat_tot_layout value)
        {
            value.lo = (bit<32>)(ig_intr_md.ingress_mac_tstamp[31:0]);
