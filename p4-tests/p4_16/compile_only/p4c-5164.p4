# 1 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4"
/*******************************************************************************
...
// Mirror
# 55 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4"
// QoS
...
// #define ADJUST_BYTE_COUNT 4 // FCS
...
// const bit<32> EIP_TABLE_SIZE = 80000;

const bit<32> DROP_STATS_TABLE_SIZE = 1024;

# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/headers.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
...
# 138 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
//#include "types.p4"
//#include "util.p4"
# 1 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
...
//-----------------------------------------------------------------------------
# 35 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
//#define ETHERTYPE_QINQ 0x88A8 // Note: uncomment once ptf/scapy-vxlan are fixed
# 87 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
// ----------------------------------------------------------------------------
// Common table sizes
//-----------------------------------------------------------------------------
...
// LPM
//-----------------------------------------------------------------------------
# 178 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
// ----------------------------------------------------------------------------
// Common types
//-----------------------------------------------------------------------------
...
# 193 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
...
# 257 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
...
const gw_drop_reason_t GW_DROP_REASON_EIP_INFO_MISS = 130;
const gw_drop_reason_t GW_DROP_REASON_EIP_IN_METER_MISS = 131;
const gw_drop_reason_t GW_DROP_REASON_EIP_OUT_METER_MISS = 132;
const gw_drop_reason_t GW_DROP_REASON_GW_PKT_TYPE_NONE = 133;
const gw_drop_reason_t GW_DROP_REASON_EIP_MISS = 134;
const gw_drop_reason_t GW_DROP_REASON_PRIVATE_IP_MISS = 135;
...
# 451 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
...
const gw_pkt_type_t GW_PKT_TYPE_IN_FROM_INTERNET = 0;
const gw_pkt_type_t GW_PKT_TYPE_OUT_FROM_ENI = 1;
...
# 653 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
...
# 741 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
...
struct switch_tunnel_metadata_t {
    ...
    bit<18> meter_id;
    bool terminate;
    //bit<32> eip_hash_digest;
    //bit<32> private_ip_hash_digest;
    bit<128> eip;
    //add for xlt device
    bit<128> private_ip;
    bit<128> vtep;
...
# 846 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
...
# 1101 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
...
# 1144 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
...
struct switch_bridged_metadata_acl_extension_t {
    ...
    bit<16> l4_dst_port;
    bit<8> tcp_flags;
# 1324 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
}
...
# 1412 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
...
# 1600 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
...
# 1623 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
}
...
# 1859 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
...
struct switch_header_t {
    ...
    nic_bridged_metadata_h nic_bridged_md;
    ...
    igmp_h igmp;
    tcp_h tcp;
# 1916 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
    ...
    gtpu_h gtp;
# 1931 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_types.p4"
    vxlan_h vxlan;
    gre_h gre;
    nvgre_h nvgre;
    geneve_h geneve;
...
# 141 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_util.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
...
action add_bridged_md(
    ...
    //xlt bridged_meta_data
    bridged_md.table_result.encap = local_md.tunnel.encap;
    bridged_md.table_result.terminate = local_md.tunnel.terminate;
    bridged_md.table_result.hash = local_md.lag_hash;
    bridged_md.table_result.gw_pkt_type = local_md.tunnel.gw_pkt_type;
    bridged_md.flags.services = local_md.flags.services;
...
# 99 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_util.p4"
}
...
action hash_copy_bridged_md(
        inout nic_bridged_metadata_h nic_bridged_md, in switch_bridged_metadata_h bridged_md2) {
    // nic_bridged_md.src = bridged_md2.src;
    // nic_bridged_md.type = bridged_md2.type;
    // //nic_bridged_md.ingress_port = bridged_md2.base.ingress_port;
    // //nic_bridged_md.ingress_port_lag_index = bridged_md2.base.ingress_port_lag_index;
    // //nic_bridged_md.ingress_bd = bridged_md2.base.ingress_bd;
    // //nic_bridged_md.nexthop = bridged_md2.base.nexthop;
    @in_hash{nic_bridged_md.pkt_type = bridged_md2.base.pkt_type;}
    // nic_bridged_md.routed = bridged_md2.base.routed;
    // @in_hash{nic_bridged_md.bypass_egress = bridged_md2.base.bypass_egress;}
    // //nic_bridged_md.cpu_reason = bridged_md2.base.cpu_reason;
    // //nic_bridged_md.timestamp = bridged_md2.base.timestamp;
    @in_hash{nic_bridged_md.tc = bridged_md2.base.tc;}
    // @in_hash{nic_bridged_md.qid = bridged_md2.base.qid;}
    // //nic_bridged_md.color = bridged_md2.base.color;
    // //nic_bridged_md.vrf = bridged_md2.base.vrf;
    // nic_bridged_md.l4_src_port = bridged_md2.acl.l4_src_port;
    // nic_bridged_md.l4_dst_port = bridged_md2.acl.l4_dst_port;
    // nic_bridged_md.tcp_flags = bridged_md2.acl.tcp_flags;
    @in_hash{nic_bridged_md.gw_pkt_type = bridged_md2.table_result.gw_pkt_type;}
    // // nic_bridged_md.hash = bridged_md2.table_result.hash;
    @in_hash{nic_bridged_md.terminate = bridged_md2.table_result.terminate;}
    @in_hash{nic_bridged_md.encap = bridged_md2.table_result.encap;}
    // // nic_bridged_md.drop_reason = bridged_md2.table_result.drop_reason;
    @in_hash{nic_bridged_md.tofino_to_nic = bridged_md2.nic.tofino_to_nic;}
    // @in_hash{nic_bridged_md.services = bridged_md2.flags.services;}
    // nic_bridged_md.to_fpga = bridged_md2.flags.to_fpga;
}

// action hash1_copy_bridged_md(
//         inout nic_bridged_metadata_h nic_bridged_md, in switch_bridged_metadata_h bridged_md2) {
//     // nic_bridged_md.src = bridged_md2.src;
//     // nic_bridged_md.type = bridged_md2.type;
//     // //nic_bridged_md.ingress_port = bridged_md2.base.ingress_port;
...
//     // //nic_bridged_md.ingress_bd = bridged_md2.base.ingress_bd;
//     // //nic_bridged_md.nexthop = bridged_md2.base.nexthop;
//     // nic_bridged_md.pkt_type = bridged_md2.base.pkt_type;
//     // nic_bridged_md.routed = bridged_md2.base.routed;
//     // @in_hash{nic_bridged_md.bypass_egress = bridged_md2.base.bypass_egress;}
//     // //nic_bridged_md.cpu_reason = bridged_md2.base.cpu_reason;
//     // //nic_bridged_md.timestamp = bridged_md2.base.timestamp;
...
action copy_bridged_md(
    ...
    // nic_bridged_md.pkt_type = bridged_md2.base.pkt_type;
    // nic_bridged_md.routed = bridged_md2.base.routed;
    // nic_bridged_md.bypass_egress = bridged_md2.base.bypass_egress;
    // //nic_bridged_md.cpu_reason = bridged_md2.base.cpu_reason;
    // nic_bridged_md.timestamp = bridged_md2.base.timestamp;
    // nic_bridged_md.tc = bridged_md2.base.tc;
    nic_bridged_md.qid = bridged_md2.base.qid;
    // //nic_bridged_md.color = bridged_md2.base.color;
    nic_bridged_md.vrf = bridged_md2.base.vrf;
    nic_bridged_md.l4_src_port = bridged_md2.acl.l4_src_port;
    nic_bridged_md.l4_dst_port = bridged_md2.acl.l4_dst_port;
    nic_bridged_md.tcp_flags = bridged_md2.acl.tcp_flags;
    // nic_bridged_md.gw_pkt_type = bridged_md2.table_result.gw_pkt_type;
    // nic_bridged_md.hash = bridged_md2.table_result.hash;
    // nic_bridged_md.terminate = bridged_md2.table_result.terminate;
    // nic_bridged_md.encap = bridged_md2.table_result.encap;
    // nic_bridged_md.drop_reason = bridged_md2.table_result.drop_reason;
    // nic_bridged_md.tofino_to_nic = bridged_md2.nic.tofino_to_nic;
    // nic_bridged_md.services = bridged_md2.flags.services;
    // nic_bridged_md.to_fpga = bridged_md2.flags.to_fpga;
}

action fpga_hash_construct_bridged_md(
        inout switch_bridged_metadata_h bridged_md1, in hash_bridged_metadata_h hash_bridged_md2) {
    bridged_md1.table_result.hash = hash_bridged_md2.hash;
}

action hash_construct_bridged_md(
        inout switch_bridged_metadata_h bridged_md1, in nic_bridged_metadata_h nic_bridged_md2) {
    // bridged_md1.src = nic_bridged_md2.src;
    // bridged_md1.type = nic_bridged_md2.type;
    // //bridged_md1.base.ingress_port = nic_bridged_md2.ingress_port;
    // //bridged_md1.base.ingress_port_lag_index = nic_bridged_md2.ingress_port_lag_index;
    // //bridged_md1.base.ingress_bd = nic_bridged_md2.ingress_bd;
    // //bridged_md1.base.nexthop = nic_bridged_md2.nexthop;
    @in_hash{bridged_md1.base.pkt_type = nic_bridged_md2.pkt_type;}
    // @in_hash{bridged_md1.base.routed = true;}
    // @in_hash{bridged_md1.base.bypass_egress = nic_bridged_md2.bypass_egress;}
    // //bridged_md1.base.cpu_reason = nic_bridged_md2.cpu_reason;
    // //bridged_md1.base.timestamp = nic_bridged_md2.timestamp;
    @in_hash{bridged_md1.base.tc = nic_bridged_md2.tc;}
    // @in_hash{bridged_md1.base.qid = nic_bridged_md2.qid;}
    // //bridged_md1.base.color = nic_bridged_md2.color;
    // //bridged_md1.base.vrf = nic_bridged_md2.vrf;
    // bridged_md1.acl.l4_src_port = nic_bridged_md2.l4_src_port;
    // bridged_md1.acl.l4_dst_port = nic_bridged_md2.l4_dst_port;
    // bridged_md1.acl.tcp_flags = nic_bridged_md2.tcp_flags;
    @in_hash{bridged_md1.table_result.gw_pkt_type = nic_bridged_md2.gw_pkt_type;}
    // bridged_md1.table_result.hash = nic_bridged_md2.hash;
    @in_hash{bridged_md1.table_result.terminate = nic_bridged_md2.terminate;}
    @in_hash{bridged_md1.table_result.encap = nic_bridged_md2.encap;}
    // bridged_md1.table_result.drop_reason = nic_bridged_md2.drop_reason;
    @in_hash{bridged_md1.nic.tofino_to_nic = nic_bridged_md2.tofino_to_nic;}
    // @in_hash{bridged_md1.flags.services = nic_bridged_md2.services;}
    // bridged_md1.flags.to_fpga = nic_bridged_md2.to_fpga;
}

// action hash1_construct_bridged_md(
//         inout switch_bridged_metadata_h bridged_md1, in nic_bridged_metadata_h nic_bridged_md2) {
//     // bridged_md1.src = nic_bridged_md2.src;
//     // bridged_md1.type = nic_bridged_md2.type;
//     // //bridged_md1.base.ingress_port = nic_bridged_md2.ingress_port;
...
//     // //bridged_md1.base.ingress_bd = nic_bridged_md2.ingress_bd;
//     // //bridged_md1.base.nexthop = nic_bridged_md2.nexthop;
//     // bridged_md1.base.pkt_type = nic_bridged_md2.pkt_type;
//     // bridged_md1.base.routed = nic_bridged_md2.routed;
//     // @in_hash{bridged_md1.base.bypass_egress = nic_bridged_md2.bypass_egress;}
//     // //bridged_md1.base.cpu_reason = nic_bridged_md2.cpu_reason;
//     // //bridged_md1.base.timestamp = nic_bridged_md2.timestamp;
//     // @in_hash{bridged_md1.base.tc = nic_bridged_md2.tc;}
...
action set_default_value_bridged_md(
        inout switch_bridged_metadata_h bridged_md1) {
    @in_hash{bridged_md1.base.routed = true;}
    @in_hash{bridged_md1.base.bypass_egress = false;}
}

action construct_bridged_md(
        inout switch_bridged_metadata_h bridged_md1, in nic_bridged_metadata_h nic_bridged_md2) {
    bridged_md1.src = nic_bridged_md2.src;
    bridged_md1.type = nic_bridged_md2.type;
    // //bridged_md1.base.ingress_port = nic_bridged_md2.ingress_port;
    ...
    // bridged_md1.base.pkt_type = nic_bridged_md2.pkt_type;
    // bridged_md1.base.routed = nic_bridged_md2.routed;
    // bridged_md1.base.bypass_egress = nic_bridged_md2.bypass_egress;
    // //bridged_md1.base.cpu_reason = nic_bridged_md2.cpu_reason;
    // bridged_md1.base.timestamp = nic_bridged_md2.timestamp;
    // bridged_md1.base.tc = nic_bridged_md2.tc;
    bridged_md1.base.qid = nic_bridged_md2.qid;
    // //bridged_md1.base.color = nic_bridged_md2.color;
    bridged_md1.base.vrf = nic_bridged_md2.vrf;
    bridged_md1.acl.l4_src_port = nic_bridged_md2.l4_src_port;
    bridged_md1.acl.l4_dst_port = nic_bridged_md2.l4_dst_port;
    bridged_md1.acl.tcp_flags = nic_bridged_md2.tcp_flags;
    // bridged_md1.table_result.gw_pkt_type = nic_bridged_md2.gw_pkt_type;
    // bridged_md1.table_result.hash = nic_bridged_md2.hash;
    // bridged_md1.table_result.terminate = nic_bridged_md2.terminate;
    // bridged_md1.table_result.encap = nic_bridged_md2.encap;
    // bridged_md1.table_result.drop_reason = nic_bridged_md2.drop_reason;
    // bridged_md1.nic.tofino_to_nic = nic_bridged_md2.tofino_to_nic;
    // bridged_md1.flags.services = nic_bridged_md2.services;
    // bridged_md1.flags.to_fpga = nic_bridged_md2.to_fpga;
}
...
# 337 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_util.p4"
control SetEgIntrMd(inout switch_header_t hdr,
                    in switch_local_metadata_t local_md,
                    inout egress_intrinsic_metadata_for_deparser_t eg_intr_md_for_dprsr,
                    inout egress_intrinsic_metadata_for_output_port_t eg_intr_md_for_oport) {
    apply {
# 360 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_util.p4"
        if (local_md.mirror.type != 0) {

            eg_intr_md_for_dprsr.mirror_type = (bit<3>) local_md.mirror.type;
# 371 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_util.p4"
        }
...
# 142 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2

# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/hash.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
...
# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/types.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
 ...
 *  License.
 ******************************************************************************/
# 21 "/data/bf-p4c-compilers/build/p4c-5164/shared/hash.p4" 2

// Flow hash calculation.
# 108 "/data/bf-p4c-compilers/build/p4c-5164/shared/hash.p4"
...
# 228 "/data/bf-p4c-compilers/build/p4c-5164/shared/hash.p4"
/******************************************************************************
...
# 588 "/data/bf-p4c-compilers/build/p4c-5164/shared/hash.p4"
...
# 144 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2

# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/l3.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
...
# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
...
//-----------------------------------------------------------------------------
# 97 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
//-----------------------------------------------------------------------------
// Common Egress ACL match keys and Actions
//-----------------------------------------------------------------------------
# 149 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
//-----------------------------------------------------------------------------
// Common Ingress ACL actions.
//-----------------------------------------------------------------------------
# 221 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
// fib_lpm_miss reset in nexthop.p4 for TF2
# 257 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
// Common Egress ACL actions.
//-----------------------------------------------------------------------------
# 295 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
//-----------------------------------------------------------------------------
// Pre Ingress ACL
//-----------------------------------------------------------------------------
...
control IngressIpAcl(inout switch_local_metadata_t local_md,
    ...
    table acl {
        key = {
            ...
            local_md.lkp.mac_type : ternary;
# 411 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
        ...
        actions = {
            ...
            mirror_in;
# 445 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
            no_action;
        }
...
control IngressIpv4Acl(inout switch_local_metadata_t local_md,
    ...
    table acl {
        key = {
            ...
            local_md.lkp.mac_type : ternary;
# 576 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
            local_md.ingress_port_lag_label : ternary;
        ...
        actions = {
            ...
            copy_to_cpu;
            permit;
# 602 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
            mirror_in;
# 613 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
            no_action;
        }
...
control IngressIpv6Acl(inout switch_local_metadata_t local_md,
    ...
    table acl {
        key = {
            ...
            local_md.lkp.mac_type : ternary;
# 665 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
            local_md.ingress_port_lag_label : ternary;
        ...
        actions = {
            ...
            mirror_in;
# 699 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
            no_action;
        }
...
# 1088 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
...
# 1385 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
        }
...
control EgressIpv6Acl(in switch_header_t hdr,
    ...
    table acl {
        key = {
            ...
            hdr.ethernet.ether_type : ternary;
# 1444 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
        }
...
control EgressSystemAcl(
    ...
    table system_acl {
        key = {
            ...
            local_md.flags.pfc_wd_drop : ternary;
# 1606 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4"
            //TODO add more
        }
...
# 21 "/data/bf-p4c-compilers/build/p4c-5164/shared/l3.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/l2.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
...
control IngressSTP(in switch_local_metadata_t local_md,
    ...
    apply {
# 86 "/data/bf-p4c-compilers/build/p4c-5164/shared/l2.p4"
    }
}
...
control EgressSTP(in switch_local_metadata_t local_md, in switch_port_t port, out bool stp_state) {
    ...
    apply {
# 118 "/data/bf-p4c-compilers/build/p4c-5164/shared/l2.p4"
    }
}
...
# 238 "/data/bf-p4c-compilers/build/p4c-5164/shared/l2.p4"
    @name(".dmac_redirect")
...
# 420 "/data/bf-p4c-compilers/build/p4c-5164/shared/l2.p4"
    @name(".vlan_decap")
    table vlan_decap {
        key = {
...
# 492 "/data/bf-p4c-compilers/build/p4c-5164/shared/l2.p4"
...
# 566 "/data/bf-p4c-compilers/build/p4c-5164/shared/l2.p4"
    apply {
        if (!local_md.flags.bypass_egress) {
...
# 22 "/data/bf-p4c-compilers/build/p4c-5164/shared/l3.p4" 2
...
# 208 "/data/bf-p4c-compilers/build/p4c-5164/shared/l3.p4"
...
# 278 "/data/bf-p4c-compilers/build/p4c-5164/shared/l3.p4"
    apply {
        ...
        if (!host.apply().hit) {
            ...
            {
# 296 "/data/bf-p4c-compilers/build/p4c-5164/shared/l3.p4"
            }
        }

    }
}
# 453 "/data/bf-p4c-compilers/build/p4c-5164/shared/l3.p4"
//-----------------------------------------------------------------------------
// VRF Properties
...
# 146 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/nexthop.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
...
# 46 "/data/bf-p4c-compilers/build/p4c-5164/shared/nexthop.p4"
...
# 144 "/data/bf-p4c-compilers/build/p4c-5164/shared/nexthop.p4"
    @ways(2)
    @name(".ecmp")
    table ecmp {
        key = {
    ...
    apply {
# 208 "/data/bf-p4c-compilers/build/p4c-5164/shared/nexthop.p4"
...
# 264 "/data/bf-p4c-compilers/build/p4c-5164/shared/nexthop.p4"
//--------------------------------------------------------------------------
...
# 147 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
...
// Protocol Header Definitions
//-----------------------------------------------------------------------------
# 21 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/types.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 ...
 *  License.
 ******************************************************************************/
# 22 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4" 2
...
# 151 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
    state parse_cpu {
...
# 205 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
    state parse_ipv4 {
...
# 240 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
...
# 292 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
        transition select(hdr.ipv6.next_hdr) {
            58 : parse_icmp;
            6 : parse_tcp;
            17 : parse_udp;
# 306 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
            default : accept;
        }
...
# 480 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
    state parse_udp {
        pkt.extract(hdr.udp);
# 491 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
    ...
    state parse_tcp {
        pkt.extract(hdr.tcp);
# 517 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
        transition accept;
    }
...
# 565 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
    state parse_ipinip {
...
# 711 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
}
...
# 796 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
...
# 839 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
        transition parse_ethernet;
    }

    state parse_deflected_pkt {
# 885 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
        transition reject;
...
# 997 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
        transition reject;
...
# 1044 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
        transition reject;

    }
# 1065 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
    state parse_dtel_switch_local_metadata {
# 1114 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
        transition reject;

    }

    state parse_simple_mirrored_metadata {
# 1128 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
        transition reject;
...
# 1183 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
    ...
    state parse_ipv4_options {
        pkt.extract(hdr.ipv4_option);
        transition select(hdr.ipv4.protocol, hdr.ipv4.frag_offset) {
# 1204 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
            default : parse_pad;
        }
    }
...
# 1228 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
    state parse_ipv6 {

        pkt.extract(hdr.ipv6);
        transition select(hdr.ipv6.next_hdr) {
# 1243 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
            default : parse_pad;
        }
...
# 1296 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
    state parse_udp {
        pkt.extract(hdr.udp);
        transition select(hdr.udp.dst_port) {

            udp_port_vxlan : parse_vxlan;
# 1310 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
            default : parse_pad;
        }
    }
...
# 1339 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
    state parse_inner_ethernet {
        pkt.extract(hdr.inner_ethernet);
        transition select(hdr.inner_ethernet.ether_type) {
            0x0800 : parse_inner_ipv4;
...
# 1416 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
        } else if (ig_intr_md_for_dprsr.mirror_type == 6) {
# 1429 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
        }
...
# 1462 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
...
# 1494 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
        } else if (eg_intr_md_for_dprsr.mirror_type == 3) {
# 1515 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
        } else if (eg_intr_md_for_dprsr.mirror_type == 5) {
# 1526 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
        }
...
control IngressNatChecksum(
    ...
    apply {
# 1554 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
    }
}
...
# 1681 "/data/bf-p4c-compilers/build/p4c-5164/shared/parde.p4"
        pkt.emit(hdr.ethernet);
...
# 148 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_parde.p4" 1
//=============================================================================
...
parser Tablep23IParser(
    ...
    state parse_fake {// To make sure the field can be emitted
        pkt.extract(hdr.flow_trace);
    ...
    state parse_ipv4 {
        ...
        local_md.flags.services = hdr.bridged_md.flags.services;
        pkt.extract(hdr.ipv4);//?
        //ipv4_checksum.add(hdr.ipv4);
        transition select(hdr.ipv4.ihl) {
            5 : parse_ipv4_no_options;
    ...
    state parse_nic_ipv4 {
        ...
        pkt.extract(hdr.nic_bridged_md);
        // local_md.hash = hdr.nic_bridged_md.hash;
        // local_md.tunnel.encap = hdr.nic_bridged_md.encap;
        // local_md.tunnel.terminate = hdr.nic_bridged_md.terminate;
        // local_md.tunnel.gw_pkt_type = hdr.nic_bridged_md.gw_pkt_type;
        // local_md.nic.tofino_to_nic = hdr.nic_bridged_md.tofino_to_nic;
        // local_md.flags.services = hdr.nic_bridged_md.services;     
        pkt.extract(hdr.ipv4);//?
        //ipv4_checksum.add(hdr.ipv4);
        transition select(hdr.ipv4.ihl) {
            5 : parse_ipv4_no_options;
...
control Tablep23IDeparser(
    packet_out pkt,
    inout switch_header_t hdr,
    in switch_local_metadata_t lcoal_md,
    in ingress_intrinsic_metadata_for_deparser_t ig_intr_md_for_dprsr) {
...
//             ETHERTYPE_FPT : parse_flow_trace;
...
//         pkt.extract(hdr.fpga_mh);
//         transition select(hdr.fpga_mh.table_enable) {
//             0b10000 : parse_table_10000_key;
//             0b01000 : parse_table_01000_key;
//         }    
//     }

//     state parse_table_10000_key {
//         pkt.extract(hdr.table_1_key);
//         transition select(hdr.fpga_mh.next_hdr) {
//             0 : parse_ipv4;
//             1 : parse_ipv6;
...
//     state parse_no_vxlan_ethernet {
//         pkt.extract(hdr.ethernet);
//         transition select(hdr.ethernet.ether_type) {
//             ETHERTYPE_IPV4 : parse_no_vxlan_ipv4;
//             ETHERTYPE_IPV6 : parse_no_vxlan_ipv6;
//             default : accept;
//         }
//     }
...
//     state parse_no_vxlan_ipv4 {
//         pkt.extract(hdr.ipv4);
//         transition select(hdr.ipv4.protocol) {
//             IP_PROTOCOLS_UDP : parse_no_vxlan_udp;
//             default : accept;
//         }
//     }
...
parser Tablep1EParser(
    ...
    state parse_pkt_not_from_nic {
        ...
        transition select(local_md.tunnel.terminate) {
...
parser Tablep1IParser(
    ...
    state parse_flow_trace {
        ...
        local_md.vrf = hdr.bridged_md.base.vrf;
        local_md.drop_reason = hdr.bridged_md.table_result.drop_reason;
        local_md.tunnel.gw_pkt_type = hdr.bridged_md.table_result.gw_pkt_type;
        transition select(hdr.flow_trace.next_hdr) {
            0 : parse_ipv4;
            1 : parse_ipv6;
...
# 149 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/port.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
...
# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/mirror_rewrite.p4" 1
 ...
 *  License.
 ******************************************************************************/
# 25 "/data/bf-p4c-compilers/build/p4c-5164/shared/mirror_rewrite.p4" 2
...
# 138 "/data/bf-p4c-compilers/build/p4c-5164/shared/mirror_rewrite.p4"
    //
    // ---------------- ERSPAN Type II ---------------- 
    //
...
# 388 "/data/bf-p4c-compilers/build/p4c-5164/shared/mirror_rewrite.p4"
    @ways(2)
...
# 421 "/data/bf-p4c-compilers/build/p4c-5164/shared/mirror_rewrite.p4"
        }
...
# 459 "/data/bf-p4c-compilers/build/p4c-5164/shared/mirror_rewrite.p4"
    table pkt_length {
...
# 489 "/data/bf-p4c-compilers/build/p4c-5164/shared/mirror_rewrite.p4"
...
# 529 "/data/bf-p4c-compilers/build/p4c-5164/shared/mirror_rewrite.p4"
            /* len(telemetry report v0.5 header)
...
# 548 "/data/bf-p4c-compilers/build/p4c-5164/shared/mirror_rewrite.p4"
    }
    ...
    apply {
        ...
        rewrite.apply();
# 585 "/data/bf-p4c-compilers/build/p4c-5164/shared/mirror_rewrite.p4"
    }
}
# 21 "/data/bf-p4c-compilers/build/p4c-5164/shared/port.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/rmac.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
...
# 22 "/data/bf-p4c-compilers/build/p4c-5164/shared/port.p4" 2
...
# 270 "/data/bf-p4c-compilers/build/p4c-5164/shared/port.p4"
...
# 379 "/data/bf-p4c-compilers/build/p4c-5164/shared/port.p4"
...
# 410 "/data/bf-p4c-compilers/build/p4c-5164/shared/port.p4"
/* programming notes:
...
// ---------------------------------------------------------------------------------------------------------
# 554 "/data/bf-p4c-compilers/build/p4c-5164/shared/port.p4"
// ----------------------------------------------------------------------------
...
control EgressPortMapping(
    ...
    action set_port_normal(switch_port_lag_index_t port_lag_index,
        ...
        local_md.qos.group = qos_group;
# 664 "/data/bf-p4c-compilers/build/p4c-5164/shared/port.p4"
    }
...
# 700 "/data/bf-p4c-compilers/build/p4c-5164/shared/port.p4"
    apply {
        port_mapping.apply();
...
# 773 "/data/bf-p4c-compilers/build/p4c-5164/shared/port.p4"
//-----------------------------------------------------------------------------
...
# 150 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
 ...
 *  License.
 ******************************************************************************/
# 152 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/multicast.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
 ...
 *  License.
 ******************************************************************************/
# 452 "/data/bf-p4c-compilers/build/p4c-5164/shared/multicast.p4"
//-----------------------------------------------------------------------------
// Multicast flooding
//-----------------------------------------------------------------------------
...
control MulticastReplication(in switch_rid_t replication_id,
    ...
    apply {
# 520 "/data/bf-p4c-compilers/build/p4c-5164/shared/multicast.p4"
    }
}
# 153 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/qos.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
 ...
 *  License.
 ******************************************************************************/
# 24 "/data/bf-p4c-compilers/build/p4c-5164/shared/qos.p4" 2
...
# 154 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/meter.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
 ...
 *  License.
 ******************************************************************************/
# 24 "/data/bf-p4c-compilers/build/p4c-5164/shared/meter.p4" 2
...
# 155 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/wred.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
...
# 156 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/acl.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 ...
 *  License.
 ******************************************************************************/
# 157 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
//#include "dtel.p4"
# 1 "/data/bf-p4c-compilers/build/p4c-5164/shared/sflow.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
...
# 159 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_acl.p4" 1
...
# 160 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_validation.p4" 1
// ============================================================================
// Packet validaion
...
# 50 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_validation.p4"
...
# 171 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_validation.p4"
    @name(".validate_ip")
    table validate_ip {
        key = {
...
# 161 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2

# 1 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/gw_l3.p4" 1
//-----------------------------------------------------------------------------
// GW FIB lookup
//
// @param dst_addr : Destination IPv4 address.
...
# 185 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/gw_l3.p4"
    Alpm(number_partitions = 1024, subtrees_per_partition = 2) algo_lpm128;
...
# 255 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/gw_l3.p4"
    apply {
        ...
        if (!host.apply().hit) {
            ...
            {
# 273 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/gw_l3.p4"
            }
        }

    }
}
# 163 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/gw_nexthop.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
...
control GwNexthop(inout switch_local_metadata_t local_md)(
    ...
    @name(".nexthop_ecmp_action_profile")
    ActionProfile(ecmp_selection_table_size) ecmp_action_profile;
# 46 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/gw_nexthop.p4"
    @name(".nexthop_ecmp_selector")
    ActionSelector(ecmp_action_profile,
                   selector_hash,
                   SelectorMode_t.FAIR,
    ...
    apply {
# 184 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/gw_nexthop.p4"
        switch(nexthop.apply().action_run) {
            NoAction : { ecmp.apply(); }
            default : {}
            }
...
# 164 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/gw_port.p4" 1
/*******************************************************************************
 *  INTEL CONFIDENTIAL
 *
 *  Copyright (c) 2021 Intel Corporation
...
# 165 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
//#include "largetable/pipe1_parde.p4"
# 1 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_tunnel.p4" 1
...
control GwIngressTunnel(inout switch_header_t hdr,
                      ...
                      inout ingress_intrinsic_metadata_for_deparser_t ig_intr_md_for_dprsr)(
                      switch_uint32_t classify_table_size=1024) {
    ...
    action set_vni_properties() {
     ...
     local_md.ingress_outer_bd = local_md.bd;
        local_md.bd = SWITCH_VXLAN_DEFAULT_BD;
        ...
        local_md.tunnel.gw_pkt_type = 1;
        set_route();
        set_flow_trace();
    }

    action vxlan_local_vtep_hit() {
        local_md.flags.services = true;
    }

    action local_region_hit() {//set routed flag and bypass l3
        local_md.tunnel.encap = true;
        local_md.tunnel.gw_pkt_type = 0;
        local_md.flags.services = true;
        set_route();
        set_flow_trace();
    }

    table dst_classifyv4 {
        key = {
        ...
        const default_action = NoAction;
        size = classify_table_size;
    }

    table dst_classifyv6 {
        key = {
            lkp.ip_dst_addr : lpm @name("eip");
        }
    ...
    table local_vtep_classifyv4 {
        key = {
            lkp.ip_dst_addr[95:64] : lpm @name("gw_vtep");
        }

        actions = {
            NoAction;
            vxlan_local_vtep_hit;
        }
    ...
    table local_vtep_classifyv6 {
        key = {
            lkp.ip_dst_addr : lpm @name("gw_vtep");
        }
    ...
    apply {
        ...
        if (local_md.flags.rmac_hit) {
            // vxlan check decap infomation, maybe encap again later
            if (local_md.tunnel.type == SWITCH_INGRESS_TUNNEL_TYPE_VXLAN) {
                if (lkp.ip_type == SWITCH_IP_TYPE_IPV4) { // lkp.ip_type is outer ip type
                    switch(local_vtep_classifyv4.apply().action_run) {//set service flag according to dst ip
                        vxlan_local_vtep_hit : {
                            // need decap ipv4 header
                            set_vni_properties();
                            //pkt_validation.apply(hdr, local_md); // lkp.ip_type is inner ip type
                            //set lkp value accroding to Inner header information
                        }
                        NoAction : {}
                    }
                } else if (lkp.ip_type == SWITCH_IP_TYPE_IPV6) {
                    switch(local_vtep_classifyv6.apply().action_run) {
                        vxlan_local_vtep_hit : {
                            // need decap ipv6 header
                            set_vni_properties();
                ...
                if (lkp.ip_type == SWITCH_IP_TYPE_IPV4) {
                    dst_classifyv4.apply();//check lkp dst ip to identify gw vtep ip and vxlan region ip (set tunnel encap)
                } else if (lkp.ip_type == SWITCH_IP_TYPE_IPV6) {
                    dst_classifyv6.apply();
                }
            }
            // drop vxlan inner broadcast packets and multicast packets
...
control TableMatch(inout switch_header_t hdr,
    ...
    DirectCounter<bit<32>>(CounterType_t.PACKETS) stats_in;
    DirectCounter<bit<32>>(CounterType_t.PACKETS) stats_out;
    bit<2> packet_color;
    ...
    table eip_to_eid {
        key = {
            ...
            local_md.lkp.ip_dst_addr : exact @name("eip");
        }
    ...
    table private_ip_to_eid {
        key = {
            ...
            local_md.lkp.ip_dst_addr : exact @name("private_ip");
        }
    ...
    action set_eip_info(bit<128> eip, bit<128> private_ip, bit<24> vni, bit<128> vtep) {
        local_md.tunnel.eip = eip;
        local_md.tunnel.private_ip = private_ip;
        local_md.tunnel.vni = vni;
        local_md.tunnel.vtep = vtep;
    }

    action eip_info_miss() {
        ig_intr_md_for_dprsr.drop_ctl = 0x1;
        hdr.bridged_md.table_result.drop_reason = GW_DROP_REASON_EIP_INFO_MISS;
    }
    ...
    action rewrite_inner_type_v4() {
        hdr.inner_bridged_md.fpga_result.inner_ip_type = SWITCH_IP_TYPE_IPV4;
    }

    action rewrite_inner_type_v6() {
        hdr.inner_bridged_md.fpga_result.inner_ip_type = SWITCH_IP_TYPE_IPV6;
    }

    action encap_tunnel() {
        hdr.inner_bridged_md.setValid();
        hdr.inner_bridged_md.fpga_result.outer_ip = local_md.tunnel.vtep;
    ...
    action decap_tunnel() {
        hdr.inner_bridged_md.setValid();
        hdr.inner_bridged_md.fpga_result.outer_ip =local_md.tunnel.eip;
    }

    action encap_tunnel4in4() {
        hdr.inner_bridged_md.fpga_result.ip_type = SWITCH_IP_TYPE_IPV4;
        encap_tunnel();
        rewrite_inner_type_v4();
    }

    action encap_tunnel4in6() {
        hdr.inner_bridged_md.fpga_result.ip_type = SWITCH_IP_TYPE_IPV6;
        encap_tunnel();
        rewrite_inner_type_v4();
    }

    action encap_tunnel6in6() {
        hdr.inner_bridged_md.fpga_result.ip_type = SWITCH_IP_TYPE_IPV6;
        encap_tunnel();
        rewrite_inner_type_v6();
    }

    action encap_tunnel6in4() {
        hdr.inner_bridged_md.fpga_result.ip_type = SWITCH_IP_TYPE_IPV4;
        encap_tunnel();
        rewrite_inner_type_v6();
    }

    action decap_tunnel_v4() {
        decap_tunnel();
        rewrite_inner_type_v4();
    }

    action decap_tunnel_v6() {
        decap_tunnel();
        rewrite_inner_type_v6();
    }
    ...
    table eid_add_bridge {
        key = {
            local_md.tunnel.eid : exact @name("eid");
            local_md.tunnel.gw_pkt_type : exact @name("gw_pkt_type");
        }
        actions = {
            encap_tunnel4in4;
            encap_tunnel4in6;
    ...
    action encap_fpga_key2() {
        ...
        hdr.table_2_key.vm_ip = local_md.lkp.ip_dst_addr;
    ...
    apply {
        if (local_md.tunnel.gw_pkt_type == 0) {
        ...
        else if (local_md.tunnel.gw_pkt_type == 1) {
...
*/
    ...
    action copy_inner_non_ip() {
        payload_len = local_md.pkt_length - 16w14;//fix ?
    }
...
control FPGABridgeMdConstruct(inout switch_header_t hdr, inout switch_local_metadata_t local_md)() {
    ...
    action set_table_2_result() {
        ...
        hdr.inner_bridged_md.setValid();
        hdr.inner_bridged_md.fpga_result.outer_ip = hdr.table_2_result.outer_ip;
    ...
    apply {
            ...
            set_outer_type.apply();
            bridged_metadata_rewrite.apply();
...
# 167 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
# 1 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/service_pipe1.p4" 1
...
control TableServiceEgress(
    ...
    GwEgressSystemAcl(drop_stats_table_size=DROP_STATS_TABLE_SIZE) system_acl;
    TunnelDecap() tunnel_decap;
    TunnelEncap() tunnel_encap;
    TunnelRewrite() tunnel_rewrite;

    // action set_encap_local_metadata() {
    //     local_md.flags.routed = hdr.bridged_md.base.routed;
    //     local_md.hash = hdr.bridged_md.table_result.hash;
    //     local_md.tunnel.encap = hdr.bridged_md.table_result.encap;
    //     local_md.tunnel.terminate = hdr.bridged_md.table_result.terminate;
    //     local_md.tunnel.ip_type = hdr.bridged_md.table_result.ip_type;
    //     local_md.tunnel.inner_ip_type = hdr.bridged_md.table_result.inner_ip_type;
    //     local_md.tunnel.gw_pkt_type = hdr.bridged_md.table_result.gw_pkt_type;
    //     local_md.tunnel.vni = hdr.bridged_md.table_result.vni;
    //     local_md.tunnel.private_ip = hdr.bridged_md.table_result.inner_ip;
    //     local_md.tunnel.vtep = hdr.bridged_md.table_result.outer_ip;
    //     local_md.nic.tofino_to_nic = hdr.bridged_md.nic.tofino_to_nic;
    // }
    // action set_decap_local_metadata() {
    //     local_md.flags.routed = hdr.bridged_md.base.routed;
    //     local_md.hash = hdr.bridged_md.table_result.hash;
    //     local_md.tunnel.encap = hdr.bridged_md.table_result.encap;
    //     local_md.tunnel.terminate = hdr.bridged_md.table_result.terminate;
    ...
    //     local_md.tunnel.inner_ip_type = hdr.bridged_md.table_result.inner_ip_type;
    //     local_md.tunnel.gw_pkt_type = hdr.bridged_md.table_result.gw_pkt_type;
    //     local_md.tunnel.eip = hdr.bridged_md.table_result.outer_ip;
    //     local_md.nic.tofino_to_nic = hdr.bridged_md.nic.tofino_to_nic;
    // }

    action set_encap_local_metadata() {
        local_md.tunnel.ip_type = hdr.inner_bridged_md.fpga_result.ip_type;
        local_md.tunnel.inner_ip_type = hdr.inner_bridged_md.fpga_result.inner_ip_type;
        ...
        local_md.tunnel.vtep = hdr.inner_bridged_md.fpga_result.outer_ip;
        hdr.inner_bridged_md.setInvalid();
    }

    action set_decap_local_metadata() {
        local_md.tunnel.ip_type = hdr.inner_bridged_md.fpga_result.ip_type;
        local_md.tunnel.inner_ip_type = hdr.inner_bridged_md.fpga_result.inner_ip_type;
        local_md.tunnel.eip = hdr.inner_bridged_md.fpga_result.outer_ip;
        hdr.inner_bridged_md.setInvalid();
    }

    table set_local_metadata {
        key = {
            local_md.tunnel.gw_pkt_type : exact;
        }
        actions = {
            set_encap_local_metadata();
            set_decap_local_metadata();
        }
        const entries = {
          (1) : set_decap_local_metadata;
          (0) : set_encap_local_metadata;
        }
        size = MIN_TABLE_SIZE;
    }
    ...
    apply {
        if(local_md.nic.tofino_to_nic == 1) {
            ...
            if(!local_md.flags.bypass_service2){
                //service2 function
            }
            if (hdr.ipv4.isValid()) {
            tos = hdr.ipv4.diffserv;
            } else {
                tos = hdr.ipv6.traffic_class;
            }
...
# 168 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2

# 1 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/largetable/table_pipe23.p4" 1
// // To avoid the compiler puts these two fields in a same phv
// @pa_container_size("ingress", "hdr.table_1_key.vni[15:0]", 16)
@pa_solitary("ingress", "hdr.table_1_result.vni")
...
control TableIngress(
    ...
    apply {
        if (local_md.ingress_port==320) {
            ...
            hdr.bridged_md.setValid();
            fpga_hash_construct_bridged_md(hdr.bridged_md,hdr.hash_bridged_md);
            hash_construct_bridged_md(hdr.bridged_md,hdr.nic_bridged_md);
            //hash1_construct_bridged_md(hdr.bridged_md,hdr.nic_bridged_md);
            construct_bridged_md(hdr.bridged_md,hdr.nic_bridged_md);
            set_default_value_bridged_md(hdr.bridged_md);
            hdr.hash_bridged_md.setInvalid();
            hdr.nic_bridged_md.setInvalid();
            if (local_md.nic.tofino_to_nic == 1) {
                nic_to_pipe1.apply();
                from_nic.apply(hdr, local_md, ig_intr_md_for_tm);
            }
            ...
            if (!fpga_port_map.apply().hit) {
                if (local_md.tunnel.gw_pkt_type == 0) {
                    if (hdr.ipv4.isValid()) {
                        local_md.lkp.ip_dst_addr[31:0] = hdr.ipv4.dst_addr;
                        local_md.lkp.ip_type = SWITCH_IP_TYPE_IPV4;
                    }
                    else if (hdr.ipv6.isValid()){
                        local_md.lkp.ip_dst_addr = hdr.ipv6.dst_addr;
                    ...
                    if (hdr.inner_ipv4.isValid()) {
                        local_md.lkp.ip_dst_addr[31:0] = hdr.inner_ipv4.src_addr;//to fix
                        local_md.lkp.ip_type = SWITCH_IP_TYPE_IPV4;
                    }
                    else if (hdr.inner_ipv6.isValid()){
                        local_md.lkp.ip_dst_addr = hdr.inner_ipv6.src_addr;
                        local_md.lkp.ip_type = SWITCH_IP_TYPE_IPV6;
                    }
                }
                if (local_md.flags.services == true) {
                    tunnel_match.apply(hdr, local_md, ig_intr_md_for_tm, ig_intr_md_for_dprsr);
                }
            }
            else {
...
control TableEgress(
    ...
    //     key = {
    //         hdr.fpga_mh.isValid() : exact;
    //         hdr.table_1_key.isValid() : exact;
    //         hdr.ipv4.dst_addr : exact;
    //         hdr.table_1_key.eip[95:64] : exact;
    //     }
    //     actions = {
    //         test_chage_dscp;
    //         NoAction;
    ...
    apply {
        if (local_md.egress_port==320) {
            ...
            hdr.nic_bridged_md.setValid();
            hdr.hash_bridged_md.setValid();
            fpga_hash_copy_bridged_md(hdr.hash_bridged_md,hdr.bridged_md);
            hash_copy_bridged_md(hdr.nic_bridged_md,hdr.bridged_md);
            //hash1_copy_bridged_md(hdr.nic_bridged_md,hdr.bridged_md);
            copy_bridged_md(hdr.nic_bridged_md,hdr.bridged_md);
            ...
            if (fpga_port_map.apply().hit) {
                ...
                if (!local_md.flags.bypass_service1){
                    //service1 pipeline                   
                    //test_change.apply();
                }
                if (local_md.flags.to_fpga) {
                    hdr.bridged_md.flags.to_fpga = false;
                }
                //hdr.bridged_md.flags.bypass_service1= false;
            }
        }

    }
}
# 170 "/data/bf-p4c-compilers/build/p4c-5164/switch-tofino/switch_tofino_xlt.p4" 2
...
control SwitchIngress(
    ...
    apply {
        if (hdr.loop_flag.isValid() && hdr.loop_flag.flags == 1 && local_md.ingress_port==64){
            hdr.loop_flag.setInvalid();
            ig_intr_md_for_tm.ucast_egress_port = 320;
        }
        else{
            if (hdr.loop_flag.isValid() && hdr.loop_flag.flags == 2 && local_md.ingress_port==64){
                hdr.loop_flag.setInvalid();
            }
            pkt_validation.apply(hdr, local_md);
            ...
            if (!local_md.flags.services) {
                nexthop.apply(local_md); // bypass
            }
            else if (local_md.nic.tofino_to_nic == 1){
                redirect_to_service_cpu.apply();
                //bypass
            }
            else {
            ...
            } else if (!local_md.flags.services) {
                lag.apply(local_md, local_md.lag_hash, ig_intr_md_for_tm.ucast_egress_port);
            }
...
control SwitchEgress(
    ...
    table rewrite_ether_type {
        ...
        const entries = {
            (true, false) : rewrite_flow_trace_v4;
            (false, true) : rewrite_flow_trace_v6;
        }
    }
...
Switch(pipe, servicepipe1, tablepipe23) main;
