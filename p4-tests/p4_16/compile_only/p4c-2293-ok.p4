...
parser SwitchIngressParser(
    ...
    state parse_hdr0 {
        ...
        transition decide_hdr1;
    }

    state decide_hdr1 {
        transition select(hdr.hdr0.data) {
            0       : parse_hdr1_1;
            default : parse_hdr1_2;
        }
    }
    ...
    state loopback_hdr1 {
        transition select(hdr.hdr0.data) {
            0       : decide_hdr1; // This is OK because it is possible
                                   // to once extract hdr3, once hdr1
            default : parse_hdr2;
        }
    }
