# 1 "/root/tna_resubmit/tna_resubmit.p4"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/root/tna_resubmit/tna_resubmit.p4"
/*******************************************************************************
...
# 24 "/root/tna_resubmit/tna_resubmit.p4" 2



# 1 "/bfn/bf-p4c-compilers/build/p4c/p4include/tna.p4" 1




# 1 "/bfn/bf-p4c-compilers/build/p4c/p4include/tofino1_specs.p4" 1
...
/* This is the P4-16 core library, which declares some built-in P4 constructs using P4 */
# 17 "/bfn/bf-p4c-compilers/build/p4c/p4include/tofino1_specs.p4" 2
...
# 6 "/bfn/bf-p4c-compilers/build/p4c/p4include/tna.p4" 2
# 14 "/bfn/bf-p4c-compilers/build/p4c/p4include/tna.p4"
# 1 "/bfn/bf-p4c-compilers/build/p4c/p4include/tofino1_arch.p4" 1
...
# 1 "/bfn/bf-p4c-compilers/build/p4c/p4include/tofino1_base.p4" 1
...
/* This is the P4-16 core library, which declares some built-in P4 constructs using P4 */
# 26 "/bfn/bf-p4c-compilers/build/p4c/p4include/tofino1_base.p4" 2
...
# 17 "/bfn/bf-p4c-compilers/build/p4c/p4include/tofino1_arch.p4" 2
...
# 15 "/bfn/bf-p4c-compilers/build/p4c/p4include/tna.p4" 2
# 28 "/root/tna_resubmit/tna_resubmit.p4" 2


// error: resubmit_h digest limited to 64 bits
// header resubmit_h {
//     bit<9> port_id;
//     bit<55> _pad;
// }
...
struct metadata_t {
    bool resubmit_add_hdr;
    resubmit_h resubmit_data;
}

# 1 "/root/tna_resubmit/common/util.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
...
# 91 "/root/tna_resubmit/tna_resubmit.p4" 2
# 1 "/root/tna_resubmit/common/headers.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2018-2019 Barefoot Networks, Inc.
...
const ether_type_t ETHERTYPE_EXP = 16w0x88b5;
...
# 92 "/root/tna_resubmit/tna_resubmit.p4" 2
...
control SwitchIngressDeparser(packet_out pkt,
    ...
    apply {
        if (ig_intr_dprsr_md.resubmit_type == 3) {
            resubmit.emit(ig_md.resubmit_data);
        } else if (ig_intr_dprsr_md.resubmit_type == 3) {
            resubmit.emit();
        }
...
control SwitchIngress(
    ...
    action resubmit_no_hdr() {
        ...
        ig_md.resubmit_add_hdr = false;
    }

    action resubmit_add_hdr(PortId_t add_hdr_port_id) {
        ig_dprsr_md.resubmit_type = 3;
        ig_md.resubmit_add_hdr = true;
    ...
    apply {
        ...
        if (ig_dprsr_md.resubmit_type == 0) {
            ig_tm_md.ucast_egress_port = (bit<9>) ig_md.resubmit_data.port_id;
