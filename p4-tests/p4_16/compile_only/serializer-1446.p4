...
parser SwitchIngressParser(
    ...
    state start {
        ...
        // P4C-1446
        // There is a bug in ResolveComputed pass that pushes the following assignment into the
        // following parse state, which results in the generation of negative offsets for the
        // extract, once the copy propagation is done.
