...
// eth,		e, vn, vl[0], vl[1], ipv4
			...
			// case 2 (e/vn to vlan)
			(true,         false, false): hdr_add_0__from_e_tag___to_vlan_tag0(); // empty

			// case 3 (e/vn to vlan)
			(true,         true,  false): hdr_add_1__from_e_tag___to_vlan_tag0(); // one full
			...
			// case 2 (e/vn to vlan)
			(       true,  false, false): hdr_add_0__from_vn_tag__to_vlan_tag0(); // empty

			// case 3 (e/vn to vlan)
			(       true,  true,  false): hdr_add_1__from_vn_tag__to_vlan_tag0(); // one full
