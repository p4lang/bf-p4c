...
#		self.target = gc.Target(self.dev, pipe_id=0xffff)
	...
	def runTest(self):
		...
		npb_npb_sf2_policy_l34_v6_add    (self, self.target, dsap=dsap, l3_proto=17, l3_proto_mask=0xff, drop=1)
...
#		testutils.verify_packets(self, exp_pkt, [eg_port])
		...
		npb_npb_sf2_policy_l34_v6_del(self, self.target, dsap=dsap, l3_proto=17, l3_proto_mask=0xff)
