...
#		base_pkt = testutils.simple_tcp_packet(eth_dst=dmac)
		...
		npb_nsh_chain_start_end_del(self, self.target,
			#ingress
			[ig_port_1], spi+1, si,                                                 sf_bitmask_0, rmac, nexthop_ptr+1, eg_lag_ptr+1, 0+1, 0+1, 1, [eg_port_0]
			#egress
		)
...
#		npb_nsh_chain_start_end_del(self, self.target,
#			#ingress
#			[ig_port_2], spi+2, si,                                                 sf_bitmask_1, rmac, nexthop_ptr+2, eg_lag_ptr+2, 0+2, 0+2, 1, [eg_port_3]
#			#egress
#		)
#
#		npb_nsh_chain_start_end_del(self, self.target,
#			#ingress
#			[ig_port_3], spi+3, si,                                                 sf_bitmask_1, rmac, nexthop_ptr+3, eg_lag_ptr+3, 0+3, 0+3, 1, [eg_port_2]
#			#egress
#		)
