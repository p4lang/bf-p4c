...
#		self.target = gc.Target(self.dev, pipe_id=0xffff)
	...
	def runTest(self):
		...
		npb_npb_sf0_policy_l34_v4_add(self, self.target, sap=sap, l3_proto=17, l3_proto_mask=0xff, flow_class=flow_class_acl, sfc_enable=1, sfc=sfc)
...
#		time.sleep(1)
		...
		npb_npb_sf0_policy_l34_v4_del(self, self.target, sap=sap, l3_proto=17, l3_proto_mask=0xff)
