...
#		exp_pkt = testutils.simple_tcp_packet(eth_dst=dmac)
		...
		npb_nsh_chain_start_del(self, self.target,
			#ingress
			[ig_port_0], spi+0, si,                                                   sf_bitmask_0, rmac, nexthop_ptr+0, eg_lag_ptr+0, 0+0, 0+0, 1, [eg_port_1],
			#tunnel
		...
		npb_nsh_chain_end_del(self, self.target,
			#ingress
			[ig_port_1], spi+1, si-(popcount(sf_bitmask_2)),                          sf_bitmask_0, rmac, nexthop_ptr+1, eg_lag_ptr+1, 0+1, 0+1, 1, [eg_port_0]
			#egress
		)
...
#		npb_nsh_chain_end_del(self, self.target,
#			#ingress
#			[ig_port_2], spi+0, si-(popcount(sf_bitmask_0)),                          sf_bitmask_2, rmac, nexthop_ptr+2, eg_lag_ptr+2, 0+2, 0+2, 1, [eg_port_3]
#			#egress
#		)

#		npb_nsh_chain_start_del(self, self.target,
#			#ingress
#			[ig_port_3], spi+1, si,                                                   sf_bitmask_2, rmac, nexthop_ptr+3, eg_lag_ptr+3, 0+3, 0+3, 1, [eg_port_2],
#			#tunnel
