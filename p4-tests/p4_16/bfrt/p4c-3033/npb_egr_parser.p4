...
//          (_, SWITCH_PKT_SRC_CLONED_EGRESS,  SWITCH_MIRROR_TYPE_CPU ) : parse_cpu_mirrored_metadata;
            ...
            (_, SWITCH_PKT_SRC_BRIDGED,        _                      ) : parse_bridged_pkt;
            (_, SWITCH_PKT_SRC_CLONED_INGRESS, SWITCH_MIRROR_TYPE_PORT) : parse_ig_port_mirrored_metadata;
            (_, SWITCH_PKT_SRC_CLONED_EGRESS,  SWITCH_MIRROR_TYPE_PORT) : parse_eg_port_mirrored_metadata;
            (_, SWITCH_PKT_SRC_CLONED_EGRESS,  SWITCH_MIRROR_TYPE_CPU ) : parse_cpu_mirrored_metadata;
        }
#else
...
//		eg_md.lkp_1.ipv4_src_addr  = hdr.bridged_md.base.ipv4_src_addr;
//		eg_md.lkp_1.ipv4_dst_addr  = hdr.bridged_md.base.ipv4_dst_addr;
//		eg_md.lkp_1.ip_proto       = hdr.bridged_md.base.ip_proto;
#endif
