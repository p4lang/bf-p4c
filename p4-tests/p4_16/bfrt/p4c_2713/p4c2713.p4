...
#define IPV4_PROTO_INDEX_WIDTH 8
#define IPV4_PROTO_SIZE        1<<IPV4_PROTO_INDEX_WIDTH
#define HASH_WIDTH 16
typedef bit<HASH_WIDTH> selector_hash_t;
typedef bit<IPV4_PROTO_INDEX_WIDTH> ipv4_proto_index_t;
    ...
    inout ingress_intrinsic_metadata_for_tm_t        ig_tm_md)
{
    ...
    @pa_container_size("ingress", "hash_0", 16)
#endif
