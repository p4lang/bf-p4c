...
#		exp_pkt = src_pkt
		...
		src_pkt =           Ether('\x5c\x45\x27\x9b\x31\x24\x3c\x94\xd5\x24\xb8\xcf\x89\x3f\x00\x00\x00\x01\x00\x00\x08\x00')
		src_pkt = src_pkt / IP   ('\x45\x00\x00\x28\xe0\xf5\x00\x00\x40\x06\x41\xef\xac\x10\xff\x01\xac\x10\x00\xc9')
		src_pkt = src_pkt / TCP  ('\x17\x7b\x88\x2b\x20\x3d\x89\x3c\x05\xc0\x92\xb7\x50\x10\xff\xff\x76\x51\x00\x00')

		exp_pkt = src_pkt

#		exp_pkt =           Ether('\x5c\x45\x27\x9b\x31\x24\x3c\x94\xd5\x24\xb8\xcf\x08\x00')
#		exp_pkt = src_pkt / IP   ('\x45\x00\x00\x28\xe0\xf5\x00\x00\x40\x06\x41\xef\xac\x10\xff\x01\xac\x10\x00\xc9')
#		exp_pkt = src_pkt / TCP  ('\x17\x7b\x88\x2b\x20\x3d\x89\x3c\x05\xc0\x92\xb7\x50\x10\xff\xff\x76\x51\x00\x00')
