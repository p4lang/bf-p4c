...
#		src_pkt =           Ether('\xd8\x84\x66\xf9\x3c\x00\x00\x00\x00\x00\x11\x22\x08\x00') # ethernet
...
#			tunnel_encap_ptr, tunnel_encap_nexthop_ptr, tunnel_encap_bd, tunnel_encap_smac_ptr
		...
		npb_nsh_chain_start_end_del(self, self.target,
			#ingress
			[ig_port+8], spi_new, si_new, sf_bitmask, rmac, nexthop_ptr, eg_lag_ptr, 0, 0, 1, [eg_port+8]
			#tunnel
#			tunnel_encap_ptr, tunnel_encap_nexthop_ptr, tunnel_encap_bd, tunnel_encap_smac_ptr
			#egress
		)
