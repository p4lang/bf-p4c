...
//  - 32b fields
//
// parse_h2 should be split over two states because:
//  - 4 x 32b extracts
//  - 1 x 16b extract
//  - 3 x 8b extracts
//  - 1 x 8b vld set
//  - 1 x 16b csum validation
//  - 1 x 32b constant gen
//
// The 32b extract that spills to parse_h2.$split does not need to be narrow-to-wide
...
@pa_container_size("ingress", "h2.f5", 8)
@pa_container_size("ingress", "h2.f6", 8)
@pa_container_size("ingress", "h2.f7", 8)
