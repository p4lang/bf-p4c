...
parser SwitchIngressParser(
    ...
    state parse_header_a1 {
        pkt.extract(hdr.header_a);
        pkt.extract(hdr.header_a1);
        transition select(hdr.header_a.f1) {
            0xb1: parse_header_d;
            0xb2: parse_header_e;
            default: accept;
        }
    ...
    state parse_header_c {
        ...
        transition select(hdr.header_c.f0, hdr.header_c.f1, hdr.header_c.f2, hdr.header_c.f3) {
            ...
            (0xc0, 0xc1, 0xc2, 0xc3) : parse_header_f;
            default: accept;
        }
    }
    ...
    state parse_header_d {
        ...
        transition select(hdr.header_d.f0, hdr.header_d.f1, hdr.header_d.f2, hdr.header_d.f3) {
            (0xd0, 0x01, 0x02, 0x03) : parse_header_h;
            (0xd0, 0xd1, 0xd2, 0xd3) : parse_header_f;
            default: accept;
        }
    }
