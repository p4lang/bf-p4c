...
# ##### wire <port> -> <port>
#
# All packets output on the first port will be sent back as input on the second
# port. Packets output on the first port will not be flagged as errors if there
# are no expect commands queued for the port.
#
# ##### write_raw_tcam <stage>:<unit>:<address> <data>
#
# Writes data into a specific tcam.
#
# ##### write_raw_sram <stage>:<unit>:<address> <data>
#
