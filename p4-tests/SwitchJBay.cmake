...
p4c_add_ptf_test_with_ptfdir ("jbay" "smoketest_switch_msdc" ${SWITCH_P4}
    "${testExtraArgs} -DMSDC_PROFILE -DP4_WRED_DEBUG -pd -to 12000" "${SWITCH_PTF_DIR}")
bfn_set_ptf_test_spec("jbay" "smoketest_switch_msdc"
        "switch_hostif.HostIfRxTxTest")
p4c_add_ptf_test_with_ptfdir ("jbay" "smoketest_switch_msdc_set_1" ${SWITCH_P4}
    "${testExtraArgs} -DMSDC_PROFILE -DP4_WRED_DEBUG -pd -to 12000" "${SWITCH_PTF_DIR}")
bfn_set_ptf_test_spec("jbay" "smoketest_switch_msdc_set_1"
...
p4c_add_ptf_test_with_ptfdir ("jbay" "smoketest_switch_msdc_set_2" ${SWITCH_P4}
    "${testExtraArgs} -DMSDC_PROFILE -DP4_WRED_DEBUG -pd -to 12000" "${SWITCH_PTF_DIR}")
bfn_set_ptf_test_spec("jbay" "smoketest_switch_msdc_set_2"
...
p4c_add_ptf_test_with_ptfdir ("jbay" "smoketest_switch_msdc_set_3" ${SWITCH_P4}
    "${testExtraArgs} -DMSDC_PROFILE -DP4_WRED_DEBUG -pd -to 12000" "${SWITCH_PTF_DIR}")
bfn_set_ptf_test_spec("jbay" "smoketest_switch_msdc_set_3"
...
p4c_add_ptf_test_with_ptfdir ("jbay" "smoketest_switch_msdc_set_4" ${SWITCH_P4}
    "${testExtraArgs} -DMSDC_PROFILE -DP4_WRED_DEBUG -pd -to 12000" "${SWITCH_PTF_DIR}")
bfn_set_ptf_test_spec("jbay" "smoketest_switch_msdc_set_4"
...
p4c_add_ptf_test_with_ptfdir ("jbay" "smoketest_switch_msdc_set_5" ${SWITCH_P4}
    "${testExtraArgs} -DMSDC_PROFILE -DP4_WRED_DEBUG -pd -to 12000" "${SWITCH_PTF_DIR}")
bfn_set_ptf_test_spec("jbay" "smoketest_switch_msdc_set_5"
...
p4c_add_ptf_test_with_ptfdir ("jbay" "smoketest_switch_msdc_set_6" ${SWITCH_P4}
        "${testExtraArgs} -DMSDC_PROFILE -DP4_WRED_DEBUG -pd -to 12000" "${SWITCH_PTF_DIR_MIRROR}")
bfn_set_ptf_test_spec("jbay" "smoketest_switch_msdc_set_6"
        "mirror_acl_slice_tests.IPv6MirrorAclSliceTest_i2e
        mirror_acl_slice_tests.MirrorAclSliceTest_i2e")
p4c_add_ptf_test_with_ptfdir ("jbay" "smoketest_switch_msdc_set_7" ${SWITCH_P4}
        "${testExtraArgs} -DMSDC_PROFILE -DP4_WRED_DEBUG -pd -to 12000" "${SWITCH_PTF_DIR}")
bfn_set_ptf_test_spec("jbay" "smoketest_switch_msdc_set_7"
...
set_tests_properties("jbay/smoketest_switch_msdc_set_2" PROPERTIES TIMEOUT 12000)
set_tests_properties("jbay/smoketest_switch_msdc_set_3" PROPERTIES TIMEOUT 12000)
set_tests_properties("jbay/smoketest_switch_msdc_set_4" PROPERTIES TIMEOUT 12000)
set_tests_properties("jbay/smoketest_switch_msdc_set_5" PROPERTIES TIMEOUT 12000)
set_tests_properties("jbay/smoketest_switch_msdc_set_6" PROPERTIES TIMEOUT 12000)
set_tests_properties("jbay/smoketest_switch_msdc_set_7" PROPERTIES TIMEOUT 12000)
