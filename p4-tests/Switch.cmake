...
# FIXME: remove disabling of parser min/max depth limits (P4C-4170)
p4c_add_test_with_args ("tofino" ${P4C_RUNTEST} FALSE
    "switch_generic_int_leaf" ${switchtest} "" "-arch ${TOFINO_P414_TEST_ARCH} --disable-pragmas=pa_solitary -DGENERIC_INT_LEAF_PROFILE -to 3600 -Xp4c=\"--disable-power-check --disable-parse-max-depth-limit\"")
...
set_tests_properties("tofino/switch_generic_int_leaf" PROPERTIES TIMEOUT 3600)
