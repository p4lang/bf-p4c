...
# FIXME: remove disabling of parser min/max depth limits (P4C-4170)
p4c_add_test_with_args ("tofino" ${P4C_RUNTEST} FALSE
    "switch_ent_dc_general" ${switchtest} "${testExtraArgs}" "-arch ${TOFINO_P414_TEST_ARCH} -DENT_DC_GENERAL_PROFILE -Xp4c=\"--disable-parse-max-depth-limit\"")
...
set_tests_properties("tofino/switch_l3_heavy_int_leaf" PROPERTIES TIMEOUT ${extended_timeout_2times})
set_tests_properties("tofino/switch_ent_dc_general" PROPERTIES TIMEOUT ${extended_timeout_2times})
set_tests_properties("tofino/switch_generic_int_leaf" PROPERTIES TIMEOUT ${extended_timeout_6times})
...
# FIXME: remove disabling of parser min/max depth limits (P4C-4170)
  p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_16_Tests_x2" ${SWITCH_P4_16_X2}
    "${testExtraArgs} -arch tna -bfrt -profile x2_tofino -Xp4c=\"--set-max-power 50 --disable-parse-depth-limit\"" ${SWITCH_P4_16_PTF})
...
set_tests_properties("tofino/smoketest_switch_16_compile_x1_profile" PROPERTIES TIMEOUT ${extended_timeout_2times})
set_tests_properties("tofino/smoketest_switch_16_compile_x2_profile" PROPERTIES TIMEOUT ${extended_timeout_2times})
set_tests_properties("tofino/smoketest_switch_16_compile_x3_profile" PROPERTIES TIMEOUT ${extended_timeout_2times})
set_tests_properties("tofino/smoketest_switch_16_Tests_x1" PROPERTIES TIMEOUT ${extended_timeout_12times})
set_tests_properties("tofino/smoketest_switch_16_Tests_x2" PROPERTIES TIMEOUT ${extended_timeout_12times})

# Switch master MSDC_PROFILE tests
# FIXME: remove disabling of parser min/max depth limits (P4C-4170)
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_msdc" ${SWITCH_P4}
    "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DMSDC_PROFILE -DP4_WRED_DEBUG -pd -Xp4c=\"--disable-parse-depth-limit\"" "${SWITCH_PTF_DIR}")
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_msdc_set_1" ${SWITCH_P4}
    "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DMSDC_PROFILE -DP4_WRED_DEBUG -pd" "${SWITCH_PTF_DIR}")
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_msdc_mirror" ${SWITCH_P4}
        "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DMSDC_PROFILE -DP4_WRED_DEBUG -pd -Xp4c=\"--disable-parse-depth-limit\"" "${SWITCH_PTF_DIR_MIRROR}")
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_msdc_wred" ${SWITCH_P4}
        "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DMSDC_PROFILE -DP4_WRED_DEBUG -pd -Xp4c=\"--disable-parse-depth-limit\"" "${SWITCH_PTF_DIR_WRED}")
...
# 500s timeout is too little for compiling and testing the entire switch, bumping it up
set_tests_properties("tofino/smoketest_switch_msdc" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_msdc_set_1" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_msdc_mirror" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_msdc_wred" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_msdc_MalformedPacketsTest" PROPERTIES TIMEOUT ${extended_timeout_6times})
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_dc_basic" ${SWITCH_P4}
        "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DDC_BASIC_PROFILE -pd -Xp4c=\"--disable-parse-depth-limit\"" "${SWITCH_PTF_DIR}")
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_dc_basic_set_1" ${SWITCH_P4}
    "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DDC_BASIC_PROFILE -pd" "${SWITCH_PTF_DIR}")
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_dc_basic_sai_l2" ${SWITCH_P4}
        "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DDC_BASIC_PROFILE -pd" "${SWITCH_PTF_DIR_SAI}")
...
# 500s timeout is too little for compiling and testing the entire switch, bumping it up
set_tests_properties("tofino/smoketest_switch_dc_basic" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_set_1" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_sai_l2" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_sai_l3" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_sai_acl" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_sai_hostif_ARPTest" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_sai_hostif_DHCPTest" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_sai_hostif_LLDPTest" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_sai_hostif_LACPTest" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_sai_hostif_SNMPTest" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_sai_hostif_SSHTest" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_sai_hostif_IP2METest" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_sai_hostif_TTLErrorTest" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_sai_hostif_BGPTest" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_MalformedPacketsTest" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_MalformedPacketsTest_ipv6" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_MalformedPacketsTest_tunnel" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dc_basic_L2VlanScaleTest" PROPERTIES TIMEOUT ${extended_timeout_6times})
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_ent_dc_general" ${SWITCH_P4}
        "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DENT_DC_GENERAL_PROFILE -pd -Xp4c=\"--disable-parse-max-depth-limit\"" "${SWITCH_PTF_DIR}")
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_ent_dc_general_set_1" ${SWITCH_P4}
    "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DENT_DC_GENERAL_PROFILE -pd" "${SWITCH_PTF_DIR}")
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_ent_dc_general_egress_acl" ${SWITCH_P4}
        "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DENT_DC_GENERAL_PROFILE -pd -Xp4c=\"--disable-parse-max-depth-limit\"" "${SWITCH_PTF_DIR_EGRESS_ACL}")
p4c_add_test_label("tofino" "p414_nightly" "smoketest_switch_ent_dc_general_egress_acl")

# 500s timeout is too little for compiling and testing the entire switch, bumping it up
set_tests_properties("tofino/smoketest_switch_ent_dc_general" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_ent_dc_general_set_1" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_ent_dc_general_egress_acl" PROPERTIES TIMEOUT ${extended_timeout_6times})
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_ipv4" ${SWITCH_P4}
    "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DMSDC_IPV4_PROFILE -DP4_WRED_DEBUG -pd" "${SWITCH_PTF_DIR}")
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_ipv4_mirror" ${SWITCH_P4}
    "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DMSDC_IPV4_PROFILE -DP4_WRED_DEBUG -pd" "${SWITCH_PTF_DIR_MIRROR}")
...
# 500s timeout is too little for compiling and testing the entire switch, bumping it up
set_tests_properties("tofino/smoketest_switch_ipv4" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_ipv4_mirror" PROPERTIES TIMEOUT ${extended_timeout_6times})
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_dtel_int_spine" ${SWITCH_P4}
    "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DMSDC_SPINE_DTEL_INT_PROFILE -pd" "${SWITCH_PTF_DIR}")
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_dtel_int_spine_mirror" ${SWITCH_P4}
    "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DMSDC_SPINE_DTEL_INT_PROFILE -pd" "${SWITCH_PTF_DIR_MIRROR}")
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_dtel_int_spine_dtel" ${SWITCH_P4}
    "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DMSDC_SPINE_DTEL_INT_PROFILE -pd" "${SWITCH_PTF_DIR_DTEL}")
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_dtel_int_spine_dtel_sai" ${SWITCH_P4}
    "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DMSDC_SPINE_DTEL_INT_PROFILE -pd" "${SWITCH_PTF_DIR_SAI_DTEL}")
...
p4c_add_ptf_test_with_ptfdir ("tofino" "smoketest_switch_dtel_int_spine_sai" ${SWITCH_P4}
    "${testExtraArgs} -arch ${TOFINO_P414_TEST_ARCH} -DMSDC_SPINE_DTEL_INT_PROFILE -pd" "${SWITCH_PTF_DIR_SAI}")
...
# 500s timeout is too little for compiling and testing the entire switch, bumping it up
set_tests_properties("tofino/smoketest_switch_dtel_int_spine" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dtel_int_spine_mirror" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dtel_int_spine_dtel" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dtel_int_spine_dtel_part_2" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dtel_int_spine_dtel_INTL45" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dtel_int_spine_dtel_QueueReport" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dtel_int_spine_dtel_MirrorOnDrop" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dtel_int_spine_dtel_INTL45_Transit_DoDTest" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dtel_int_spine_dtel_QueueReport_DoD_Test" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dtel_int_spine_dtel_MirrorOnDropDoDTest" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dtel_int_spine_dtel_sai" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dtel_int_spine_sai" PROPERTIES TIMEOUT ${extended_timeout_6times})
set_tests_properties("tofino/smoketest_switch_dtel_int_spine_sai_hostif" PROPERTIES TIMEOUT ${extended_timeout_6times})
