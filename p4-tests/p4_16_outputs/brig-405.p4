...
control egress_impl(inout headers_t hdr, inout local_metadata_t local_metadata, inout standard_metadata_t standard_metadata) {
    apply {
        local_metadata.f16 = (bit<16>)(standard_metadata.packet_length - 14);
        local_metadata.m16 = (bit<16>)(standard_metadata.packet_length * 2);
        local_metadata.d16 = (bit<16>)(standard_metadata.packet_length / 2);
    }
}
