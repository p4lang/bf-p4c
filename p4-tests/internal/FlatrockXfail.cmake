...
#  "Invalid slice of 7 bit field immediate"
  ...
  extensions/p4_tests/p4_16/internal/flatrock/tf5_template.p4
  )

p4c_add_xfail_reason("tofino5"
  "Compiler Bug.* not an always hit hash_action table"
  extensions/p4_tests/p4_16/internal/flatrock/t5na_bridged_md.p4
  )

p4c_add_xfail_reason("tofino5"
  "Conditions in an action must be simple comparisons of an action data parameter"
  extensions/p4_tests/p4_16/internal/flatrock/exact2.p4
  )
...
p4c_add_xfail_reason("tofino5"
  ...
  extensions/p4_tests/p4_16/internal/flatrock/counter1.p4
  )

#p4c_add_xfail_reason("tofino5"
#  ""  -- need a real test case here.
#  extensions/p4_tests/p4_16/internal/flatrock/pac_single_hdr.p4
#  )

#p4c_add_xfail_reason("tofino5"
#  "mismatch from expected"
#  extensions/p4_tests/p4_16/internal/flatrock/pac_wide_branch_egress_const.p4
#  )
...
#  extensions/p4_tests/p4_16/internal/flatrock/mirror_simple.p4  # see 2023-01-12 dev-env update
  )
...
p4c_add_xfail_reason("tofino5"
  ...
  extensions/p4_tests/p4_16/internal/flatrock/dconfig1.p4
  )
...
p4c_add_xfail_reason("tofino5"
  ...
  extensions/p4_tests/p4_16/internal/flatrock/ealu0.p4
  )
...
p4c_add_xfail_reason("tofino5"
  ...
  extensions/p4_tests/p4_16/internal/flatrock/cuckoo-lamb-default1.p4
  extensions/p4_tests/p4_16/internal/flatrock/direct0.p4
  extensions/p4_tests/p4_16/internal/flatrock/direct1.p4
  extensions/p4_tests/p4_16/internal/flatrock/direct_actiondata1.p4
  extensions/p4_tests/p4_16/internal/flatrock/exact0.p4
  extensions/p4_tests/p4_16/internal/flatrock/exact1.p4
  extensions/p4_tests/p4_16/internal/flatrock/exact3.p4
  extensions/p4_tests/p4_16/internal/flatrock/gateway1.p4
  extensions/p4_tests/p4_16/internal/flatrock/gateway1i.p4
  extensions/p4_tests/p4_16/internal/flatrock/gateway2.p4
  extensions/p4_tests/p4_16/internal/flatrock/gateway2i.p4
  extensions/p4_tests/p4_16/internal/flatrock/gateway3.p4
  extensions/p4_tests/p4_16/internal/flatrock/gateway4.p4
  extensions/p4_tests/p4_16/internal/flatrock/mcast_simple.p4
  extensions/p4_tests/p4_16/internal/flatrock/mirror_simple.p4
  extensions/p4_tests/p4_16/internal/flatrock/pac_shallow_branch_egress_const.p4
  extensions/p4_tests/p4_16/internal/flatrock/pac_shallow_branch_egress_hdrs.p4
  extensions/p4_tests/p4_16/internal/flatrock/pac_shallow_branch_parser_const.p4
  extensions/p4_tests/p4_16/internal/flatrock/pac_shallow_branch_swap_hdrs.p4
  extensions/p4_tests/p4_16/internal/flatrock/pac_unbal_reconverge_egress_const.p4
  extensions/p4_tests/p4_16/internal/flatrock/pac_unbal_reconverge_egress_hdrs.p4
  extensions/p4_tests/p4_16/internal/flatrock/pac_unbal_reconverge_swap_hdrs.p4
  extensions/p4_tests/p4_16/internal/flatrock/pac_wide_branch_egress_const.p4
  extensions/p4_tests/p4_16/internal/flatrock/pac_wide_branch_swap_hdrs.p4
  extensions/p4_tests/p4_16/internal/flatrock/pac_single_hdr.p4
  extensions/p4_tests/p4_16/internal/flatrock/pac_trivial.p4
  extensions/p4_tests/p4_16/internal/flatrock/parser_constant_1.p4
  extensions/p4_tests/p4_16/internal/flatrock/parser_swap_headers.p4
  extensions/p4_tests/p4_16/internal/flatrock/parser_many_small_headers.p4
  extensions/p4_tests/p4_16/internal/flatrock/passthrough.p4
  extensions/p4_tests/p4_16/internal/flatrock/ternary1.p4
  extensions/p4_tests/p4_16/internal/flatrock/ternary2.p4
  extensions/p4_tests/p4_16/internal/flatrock/ternary3.p4
)
p4c_add_xfail_reason("tofino5"
  "Dropping packet=0x[0-9a-f]* at iTM. [(]does NOT output anywhere[)]"
  extensions/p4_tests/p4_16/internal/flatrock/exact4.p4
)
