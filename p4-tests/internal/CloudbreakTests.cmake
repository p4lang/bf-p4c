...
p4c_add_ptf_test_with_ptfdir (
    "tofino3" "p4c_2601" "${CMAKE_CURRENT_SOURCE_DIR}/p4_16/internal/ptf/p4c_2601.p4"
...
set (CLOUDBREAK_JNA_TEST_SUITES
  ...
  ${CMAKE_CURRENT_SOURCE_DIR}/p4_16/internal/jbay/*.p4
...
p4c_add_bf_backend_tests("tofino3" "cb" "t3na" "base" "${CMAKE_CURRENT_SOURCE_DIR}/p4_16/internal/p4c-2740.p4")
set_tests_properties("tofino3/extensions/p4_tests/p4_16/internal/p4c-2740.p4" PROPERTIES TIMEOUT ${extended_timeout_4times})

# P4C-4079
# New HeaderMutex pass increases compilation time.
p4c_add_bf_backend_tests("tofino3" "cb" "t3na" "base" "${CMAKE_CURRENT_SOURCE_DIR}/p4_16/internal/customer/keysight/keysight-eagle-tf2.p4" "-to 1200")
set_tests_properties("tofino3/extensions/p4_tests/p4_16/internal/customer/keysight/keysight-eagle-tf2.p4" PROPERTIES TIMEOUT 1200)
p4c_add_bf_backend_tests("tofino3" "cb" "t3na" "base" "${CMAKE_CURRENT_SOURCE_DIR}/p4_16/internal/stf/p4c-4055.p4" "-to 1200")
set_tests_properties("tofino3/extensions/p4_tests/p4_16/internal/stf/p4c-4055.p4" PROPERTIES TIMEOUT 1200)

p4c_add_bf_backend_tests("tofino3" "jbay" "t3na" "base" "${CMAKE_CURRENT_SOURCE_DIR}/p4_16/internal/stf/p4c-4535.p4" "-to ${extended_timeout_3times} -I${CMAKE_CURRENT_SOURCE_DIR}/p4_16/includes")
set_tests_properties("tofino3/extensions/p4_tests/p4_16/internal/stf/p4c-4535.p4" PROPERTIES TIMEOUT ${extended_timeout_4times})
...
bfn_add_test_with_args ("tofino3" "cb" "p4_16_programs_tna_32q_multiprogram_a"
    ${p4_16_programs_path}/tna_32q_multiprogram/program_a/tna_32q_multiprogram_a.p4 "${testExtraArgs} -arch t3na -I${CMAKE_CURRENT_SOURCE_DIR}/internal/p4-programs/p4_16_programs/tna_32q_multiprogram" "")

bfn_add_test_with_args ("tofino3" "cb" "p4_16_programs_tna_32q_multiprogram_b"
    ${p4_16_programs_path}/tna_32q_multiprogram/program_b/tna_32q_multiprogram_b.p4 "${testExtraArgs} -arch t3na -I${CMAKE_CURRENT_SOURCE_DIR}/internal/p4-programs/p4_16_programs/tna_32q_multiprogram" "")

bfn_add_test_with_args ("tofino3" "cb" "p4_16_programs_tna_resubmit"
    ${p4_16_programs_path}/tna_resubmit/tna_resubmit.p4 "${testExtraArgs} -arch t3na -I${CMAKE_CURRENT_SOURCE_DIR}/internal/p4-programs/p4_16_programs/tna_resubmit" "")

bfn_add_test_with_args ("tofino3" "cb" "p4_16_programs_tna_pktgen"
    ${p4_16_programs_path}/tna_pktgen/tna_pktgen.p4 "${testExtraArgs} -arch t3na -I${CMAKE_CURRENT_SOURCE_DIR}/internal/p4-programs/p4_16_programs/tna_pktgen" "")
...
bfn_add_test_with_args ("tofino3" "cb" "p4_16_internal_p4_16_ipv4_checksum"
    ${p4_16_internal_p4_16_path}/ipv4_checksum/ipv4_checksum.p4 "${testExtraArgs} -arch t3na -I${CMAKE_CURRENT_SOURCE_DIR}/internal/p4-programs/internal_p4_16" "")
bfn_add_test_with_args ("tofino3" "cb" "p4_16_internal_p4_16_mirror"
    ${p4_16_internal_p4_16_path}/mirror/mirror.p4 "${testExtraArgs} -arch t3na -I${CMAKE_CURRENT_SOURCE_DIR}/internal/p4-programs/internal_p4_16" "")


# P4-16 Programs with PTF tests
foreach(t IN LISTS P4FACTORY_P4_16_PROGRAMS)
  p4c_add_ptf_test_with_ptfdir ("tofino3" "p4_16_programs_${t}" "${CMAKE_CURRENT_SOURCE_DIR}/internal/p4-programs/p4_16_programs/${t}/${t}.p4"
    "${testExtraArgs} -target tofino3 -arch t3na -bfrt" "${CMAKE_CURRENT_SOURCE_DIR}/internal/p4-programs/p4_16_programs/${t}")
  bfn_set_p4_build_flag("tofino3" "p4_16_programs_${t}" "-I${CMAKE_CURRENT_SOURCE_DIR}/internal/p4-programs/p4_16_programs")
  set (ports_json ${CMAKE_CURRENT_SOURCE_DIR}/internal/p4-programs/p4_16_programs/${t}/ports_tof3.json)
...
bfn_set_ptf_ports_json_file("tofino3" "p4_16_programs_tna_dkm" "${CMAKE_CURRENT_SOURCE_DIR}/internal/p4-programs/p4_16_programs/tna_dkm/ports.json")
bfn_set_ptf_ports_json_file("tofino3" "p4_16_programs_tna_idletimeout" "${CMAKE_CURRENT_SOURCE_DIR}/internal/p4-programs/p4_16_programs/tna_idletimeout/ports.json")
...
set(TOFINO3_DETERMINISM_TESTS_14
    ${CMAKE_CURRENT_SOURCE_DIR}/p4_14/internal/pd/decaf_10/decaf_10.p4
