# 1 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4"
/*******************************************************************************
 ...
 *
 ******************************************************************************/
# 31 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4"
...
# 32 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
...
# 34 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2




# 1 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/features.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
# 35 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/features.p4"
...
// #define VXLAN_ENABLE
// #define WRED_ENABLE
# 39 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
...
# 40 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
...
# 657 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/types.p4"
}
...
# 41 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
...
# 1 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/../switch-tofino2/util.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
 ...
 *
 ******************************************************************************/
# 24 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/../switch-tofino2/util.p4" 2
...
# 72 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/../switch-tofino2/util.p4"
}
...
# 140 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
...
# 962 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/acl.p4"
...
control EgressAcl(in switch_header_t hdr,
    ...
    apply {
        eg_md.flags.acl_deny = false;
# 1176 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/acl.p4"
    }
}
...
control IngressSTP(in switch_ingress_metadata_t ig_md,
    ...
    apply {
        ...
        if (!(ig_md.bypass & SWITCH_INGRESS_BYPASS_STP != 0)) {
            if (multiple_stp_enable) {
                ...
                if (ig_md.bd[15:12] == 0) {
                    stp_md.state_[0:0] = stp_check.execute(
                        hash.get({ig_md.bd[11:0], ig_md.port[6:0]}));
                }
            }
        }
...
control EgressSTP(in switch_egress_metadata_t eg_md, in switch_port_t port, out bool stp_state) {
    ...
    apply {
        ...
        if (!(eg_md.bypass & SWITCH_EGRESS_BYPASS_STP != 0)) {
            // First 4K BDs which are reserved for VLANs
            if (eg_md.bd[15:12] == 0) {
                bit<32> stp_hash_ = hash.get({eg_md.bd[11:0], port[6:0]});
...
# 143 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
...
# 144 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
...
# 375 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/parde.p4"
        transition parse_ethernet;
    }

    state parse_deflected_pkt {
# 400 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/parde.p4"
    }
...
# 463 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/parde.p4"
        transition reject;

    }

    state parse_dtel_switch_local_metadata {
# 491 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/parde.p4"
        transition reject;
...
# 692 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/parde.p4"
        }
...
# 747 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/parde.p4"
        }
...
# 145 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
...
control MirrorRewrite(inout switch_header_t hdr,
    ...
    action rewrite_dtel_report(
            ...
            ipv4_addr_t sip, ipv4_addr_t dip, bit<8> tos, bit<8> ttl,
            bit<16> udp_dst_port) {
# 303 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/rewrite.p4"
    }
...
# 146 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
...
# 147 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
# 1 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/rewrite.p4" 1
 ...
 *
 ******************************************************************************/
# 148 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
...
control IngressTunnel(in switch_header_t hdr,
    ...
    apply {
# 217 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/tunnel.p4"
    }
}
...
control TunnelDecap(inout switch_header_t hdr,
    ...
    apply {
# 384 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/tunnel.p4"
    }
}
...
control TunnelRewrite(inout switch_header_t hdr,
    ...
    apply {
# 503 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/tunnel.p4"
    }
}
...
# 602 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/tunnel.p4"
    }

    action rewrite_inner_ipv6_tcp() {
# 613 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/tunnel.p4"
    }
...
# 683 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/tunnel.p4"
    }
...
# 775 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/tunnel.p4"
    }
    ...
    apply {
# 816 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/tunnel.p4"
    }
}
# 149 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
...
# 150 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
...
# 151 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
# 1 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/meter.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 ...
 *
 ******************************************************************************/
# 152 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
...
control WRED(inout switch_header_t hdr,
    ...
    apply {
# 140 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/wred.p4"
    }
}
# 153 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
...
control FlowReport(inout switch_egress_metadata_t eg_md, out bit<2> flag) {
    ...
    apply {
# 428 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/dtel.p4"
    }
}
...
control IngressDtel(in switch_header_t hdr,
    ...
    apply {
# 486 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/dtel.p4"
    }
}
...
control EgressDtel(inout switch_header_t hdr,
    ...
    apply {
# 649 "/mnt/p4-tests/p4_16/switch_16/p4src/shared/dtel.p4"
    }
}
# 154 "/mnt/p4-tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2

/* CODE_HACK Avoid corruption of bits above qid in DTEL reports */
