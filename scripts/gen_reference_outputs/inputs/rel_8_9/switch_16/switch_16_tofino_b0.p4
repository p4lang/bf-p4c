...
# 1 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 * Copyright (c) 2015-2019 Barefoot Networks, Inc.
...
# 24 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
...
# 25 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
...
# 42 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4"
//#define MLAG_ENABLE
...
// IP Hosts/Routes
const bit<32> IPV4_HOST_TABLE_SIZE = 65536; // 131072;
const bit<32> IPV4_LPM_TABLE_SIZE = 16384;
const bit<32> IPV6_HOST_TABLE_SIZE = 4096;
const bit<32> IPV6_LPM_TABLE_SIZE = 4096; // 8192;
...
// Tunnel
const bit<32> NUM_TUNNELS = 131072;
...
# 92 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
...
typedef bit<17> switch_nexthop_t;
...
typedef bit<17> switch_tunnel_index_t;
...
# 93 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
...
# 59 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/util.p4"
...
# 94 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
...
# 713 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/acl.p4"
...
control EgressAcl(in switch_header_t hdr,
    ...
    apply {
# 956 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/acl.p4"
    }
}
...
# 96 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
...
# 97 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
...
# 361 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/parde.p4"
...
# 470 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/parde.p4"
    ...
    state parse_ipv4 {
        ...
        transition select(hdr.ipv4.protocol, hdr.ipv4.ihl, hdr.ipv4.flags, hdr.ipv4.frag_offset) {
            ...
            (4, 5, 0, 0) : parse_inner_ipv4;
            (41, 5, 0, 0) : parse_inner_ipv6;
...
# 98 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
...
# 99 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
...
# 100 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
# 1 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/rewrite.p4" 1
 ...
 *
 ******************************************************************************/
# 101 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
...
# 102 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
...
# 103 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
# 1 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/meter.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 ...
 *
 ******************************************************************************/
# 104 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
...
# 105 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
...
# 106 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
# 1 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/acl.p4" 1
/*******************************************************************************
 * BAREFOOT NETWORKS CONFIDENTIAL & PROPRIETARY
 *
 ...
 *
 ******************************************************************************/
# 107 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch_profile_b0.p4" 2
...
control SwitchIngress(
    ...
    OuterNexthop(
        OUTER_NEXTHOP_TABLE_SIZE, OUTER_ECMP_GROUP_TABLE_SIZE, 4096) outer_nexthop;
    LAG() lag;
    ...
    apply {
        ...
        if (ig_md.egress_ifindex == SWITCH_IFINDEX_FLOOD) {
            ...
            lag.apply(ig_md, ig_md.hash[15:0], ig_intr_md_for_tm.ucast_egress_port);
        }
...
control SwitchEgress(
    ...
    TunnelRewrite(131072, 8192, 1034) tunnel_rewrite;
...
Switch(pipe) main;
# 28 "/mnt/p4c/extensions/p4_tests/p4_16/switch_16/p4src/switch-tofino/switch.p4" 2
