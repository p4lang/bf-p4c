...
parser parse_fabric_header_cpu {
    ...
    return select(latest.reasonCode) {
        ...
        0x8: parse_fabric_timestamp_header;


        default : parse_fabric_payload_header;
    }
}
# 1834 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/includes/parser.p4"
...
header_type l3_metadata_t {
    fields {
        ...
        urpf_bd_group : 14; /* urpf bd group */
...
# 296 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/ipv4.p4"
table ipv4_urpf {
    reads {
        l3_metadata.vrf : exact; ipv4_metadata.lkp_ipv4_sa : exact;
    }
    actions {
        on_miss;
        ipv4_urpf_hit;
 ...
 */
# 199 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/ipv6.p4"
table ipv6_fib_lpm {
    reads {
...
# 534 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
...
/*****************************************************************************/
# 580 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
...
control process_tunnel {
    ...
    if ((tunnel_metadata.tunnel_lookup == 1)
...
# 2153 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
...
# 910 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
    }
    actions {
        nop;
        acl_deny;
...
# 1005 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
    }
    actions {
        nop;
        acl_deny;
...
table ipv4_racl {
    reads {
        acl_metadata.port_lag_label : ternary; acl_metadata.bd_label : ternary; ipv4_metadata.lkp_ipv4_sa : ternary; ipv4_metadata.lkp_ipv4_da : ternary; l3_metadata.lkp_ip_proto : ternary; l3_metadata.lkp_ip_ttl : ternary; l3_metadata.lkp_tcp_flags : ternary; acl_metadata.ingress_src_port_range_id : ternary; acl_metadata.ingress_dst_port_range_id : ternary;
# 1272 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
    }
    actions {
        nop;
        racl_deny;
...
table ipv6_racl {
    reads {
        acl_metadata.port_lag_label : ternary; acl_metadata.bd_label : ternary; ipv6_metadata.lkp_ipv6_sa : ternary; ipv6_metadata.lkp_ipv6_da : ternary; l3_metadata.lkp_ip_proto : ternary; l3_metadata.lkp_ip_ttl : ternary; l3_metadata.lkp_tcp_flags : ternary; acl_metadata.ingress_src_port_range_id : ternary; acl_metadata.ingress_dst_port_range_id : ternary;
# 1309 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
    }
    actions {
        nop;
        racl_deny;
...
# 1878 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
counter racl_stats {
    type : packets_and_bytes;
    instance_count : 1024;
    min_width : 16;
...
# 2008 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
/*****************************************************************************/
/* System ACL                                                                */
/*****************************************************************************/
counter drop_stats {
...
# 2622 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
    }
}
...
# 87 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/nexthop.p4"
}
...
# 150 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/qos.p4"
    }
}
...
/* Queuing                                                                   */
/*****************************************************************************/
# 193 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/qos.p4"
...
//----------------------------------------------------------------------
    ...
    process_bfd_packet();
# 1515 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/switch.p4"
...
# 1688 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/switch.p4"
    /* Ingress vlan membership check */
...
# 1744 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/switch.p4"
    /* ecmp/nexthop lookup */
    process_nexthop();
# 1770 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/switch.p4"
    /* meter action/stats */
...
# 1800 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/switch.p4"
...
# 2790 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/switch.p4"
            ...
            apply(egress_port_mapping) {
                egress_port_type_normal {
# 2806 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/switch.p4"
...
# 2836 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/switch.p4"
...
# 2927 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/switch.p4"
