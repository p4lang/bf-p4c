 ...
 * isValid() with references to the new field.
 *
 * XXX(seth): This pass was designed for BMV2; we're using it temporary in the
 * Tofino backend as a hack until we can improve how we handle POV bits in the
 * midend IR. *DON'T USE THIS FOR ANYTHING BUT P4RUNTIME*!!!!
 *
