...
template<> struct CounterlikeTraits<::BFN::CounterExtern<BFN::Arch::TNA> > {
...
template<> struct CounterlikeTraits<::BFN::MeterExtern<BFN::Arch::TNA> > {
...
struct ActionProfile {
    ...
    p4rt_id_t getId(const P4RuntimeSymbolTableIface& symbols,
        ...
        return symbols.getId(SymbolType::ACTION_PROFILE(), symName);
    }
};
...
class BFRuntimeArchHandlerTofino final : public BFN::BFRuntimeArchHandlerCommon<Arch::TNA> {
 public:
    ...
    void collectExtra(P4RuntimeSymbolTableIface* symbols) override {
        ...
        forAllPortMetadataBlocks(evaluatedProgram, [&](cstring portMetadataFullName, const IR::ParserBlock* parserBlock) {
            symbols->add(SymbolType::PORT_METADATA(), portMetadataFullName);
        });
    }
