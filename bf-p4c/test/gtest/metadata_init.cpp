...
class MetadataInitTest : public TofinoBackendTest {};

namespace {

boost::optional<TofinoPipeTestCase>
createMetadataInitTestCase(const std::string& parserSource) {
...
TEST_F(MetadataInitTest, InitAction) {
    auto test = createMetadataInitTestCase(
...
apply {
    ...
    EXPECT_EQ(defuse.hasUninitializedRead(phv.field("ingress::meta.f2")->id), false);
}
