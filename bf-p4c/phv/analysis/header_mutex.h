#ifndef EXTENSIONS_BF_P4C_PHV_ANALYSIS_HEADER_MUTEX_H_
#define EXTENSIONS_BF_P4C_PHV_ANALYSIS_HEADER_MUTEX_H_
...
struct HeaderInfo {
    ...
    ordered_map<const IR::MAU::Table*,
                ordered_map<cstring,
                            std::vector<std::pair<cstring,
                                                  HeaderState>>>> headers_live_during_action;
...
class AddParserHeadersToHeaderMutexMatrix : public BuildMutex {
 ...
 public:
    AddParserHeadersToHeaderMutexMatrix(PhvInfo& phv,
...
class FindPovAndParserErrorInMau : public HeaderNameMauInspector {
 ...
 public:
    FindPovAndParserErrorInMau(PhvInfo& phv, HeaderInfo& headers,
                               bool& mau_contains_pov_read_write,
                               bool& mau_handles_parser_error)
        : HeaderNameMauInspector(phv), header_info(headers),
...
class AddMauHeadersToHeaderMutexMatrix : public Inspector {
 ...
 public:
    explicit AddMauHeadersToHeaderMutexMatrix(HeaderInfo& header_info)
...
class FindParserHeaderEncounterInfo : public PardeInspector {
 ...
 private:
    ...
    ordered_map<gress_t,
                ordered_map<cstring,
                            std::set<const IR::BFN::ParserState*>>> header_to_states;
...
class ExcludeMAUNotMutexHeaders : public MauInspector,
    ...
    ordered_map<std::pair<int, int>,
                ordered_set<const IR::MAU::Table*>>& modified_where;
 ...
 public:
    ExcludeMAUNotMutexHeaders(PhvInfo& phv,
                              HeaderInfo& header_info,
                              bool& mau_handles_parser_error,
                              const PragmaMutuallyExclusive& pa_mutex,
                              ordered_map<std::pair<int, int>,
...
class HeaderMutex : public PassManager {
 ...
 public:
    ...
    : field_level_optimisation(phv) {
        addPasses({
            new AddParserHeadersToHeaderMutexMatrix(phv,
                                                    never_overlay,
                                                    pragmas.pa_no_overlay(),
                                                    header_info),
            ...
            new PassIf(
                ...
                },
                {
                    ...
                    new FindConstEntryTables(phv, header_info),
                    &field_level_optimisation,
                    new ExcludeMAUNotMutexHeaders(phv,
                                                  header_info,
                                                  mau_handles_parser_error,
...
#endif  /* EXTENSIONS_BF_P4C_PHV_ANALYSIS_HEADER_MUTEX_H_  */
