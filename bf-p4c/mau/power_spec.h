...
class TofinoMauPowerSpec : public MauPowerSpec {
 public:
  ...
  double get_ram_write_power() const override {
    return 0.023419 * get_ram_scaling_factor(); }
  ...
  double get_map_ram_read_power() const override {
    return 0.0025861 * get_ram_scaling_factor(); }
  double get_map_ram_write_power() const override {
    return 0.0030107 * get_ram_scaling_factor(); }
...
class JBayMauPowerSpec : public MauPowerSpec {
 public:
  ...
  double get_ram_write_power() const override {
    return 0.0176 * get_ram_scaling_factor(); }
  double get_tcam_search_power() const override {
    return 0.0185 * get_tcam_scaling_factor(); }
  double get_map_ram_read_power() const override {
    return 0.0027 * get_ram_scaling_factor(); }
  double get_map_ram_write_power() const override {
    return 0.0030 * get_ram_scaling_factor(); }
  double get_deferred_ram_read_power() const override {
