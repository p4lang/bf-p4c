/*
Copyright (c) 2020 Barefoot Networks, Inc.
...
/********************************************************************************
 *                Intrinsic Metadata Definition for Cloudbreak                  *
 * This file is only meant to be used for hardware emulation bring-up, it is    *
 * not intended to be used to support Cloudbreak in P4-14. Cloudbreak is only   *
 * supported in P4-16.                                                          *
 *******************************************************************************/

#ifndef CLOUDBREAK_LIB_INTRINSIC_METADATA
#define CLOUDBREAK_LIB_INTRINSIC_METADATA 1
...
header_type ingress_intrinsic_metadata_t {
    fields {
        ...
        ingress_port : 11;              // ingress physical port id.
...
header_type ingress_intrinsic_metadata_for_tm_t {
    fields {
        ...
        _pad1 : 5;
        ucast_egress_port : 11;         // egress port for unicast packets. must
...
header_type ingress_intrinsic_metadata_for_mirror_buffer_t {
    fields {
        ...
        _pad5 : 5;
        mirror_egress_port : 11;        // Mirror packet egress port.
        _pad6 : 1;
