 ...
 *****************************************************************************/
# 549 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/includes/p4_table_sizes.h"
// 4K QinQ RIFs
...
// Tunnels -
# 593 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/includes/p4_table_sizes.h"
/******************************************************************************
...
# 633 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/includes/headers.p4"
...
# 364 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/includes/parser.p4"
...
# 376 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/includes/parser.p4"
...
parser parse_ethernet {
    ...
    return select(latest.etherType) {
        ...
        0x9000 : parse_fabric_header_cpu;
...
# 774 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/includes/parser.p4"
...
# 1514 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/includes/parser.p4"
header genv_t genv;
...
# 1755 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/includes/parser.p4"
...
# 639 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/port.p4"
...
action set_egress_if_params_double_tagged(vlan_id0, vlan_id1) {
    ...
    modify_field(ethernet.etherType, 0x88a8);
}
...
header_type l2_metadata_t {
    fields {
        ...
        l2_nexthop : 17; /* next hop from l2 */
...
# 72 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/l2.p4"
...
# 228 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/l2.p4"
action dmac_drop() {
    drop();
}
...
# 406 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/l2.p4"
...
/* CODE_SENSITIVE For fitting of GENERIC_INT_LEAF, avoid use of hash bits */
@pragma ternary 1
...
header_type l3_metadata_t {
    fields {
        ...
        vrf : 14; /* VRF */
        rmac_group : 8; /* Rmac group, for rmac indirection */
...
# 139 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/l3.p4"
/** CODE_PROTECTED_IP To ensure the action data packing of ipv4_fib
    can be efficiently packed, keep the parameters written in the
    actions in minimum sized containers. */
@pragma pa_solitary ingress l3_metadata.fib_nexthop_type
@pragma pa_solitary ingress l3_metadata.fib_nexthop


/** CODE_SENSITIVE To ensure the action data packing of ipv4_fib
    can be efficiently packed, keep the parameters written in the
    actions in minimum sized containers. */
...
/*****************************************************************************/
# 251 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/l3.p4"
...
action fib_hit_ecmp(ecmp_index, acl_label) {
    ...
    modify_field(nexthop_metadata.nexthop_type, 1);
    modify_field(l3_metadata.routed, 1);



}
# 311 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/l3.p4"
...
/*****************************************************************************/
# 157 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/ipv4.p4"
/*****************************************************************************/
/* IPv4 FIB lookup                                                           */
/*****************************************************************************/
table ipv4_fib {
...
# 245 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/ipv4.p4"
            apply(ipv4_fib) {
                on_miss {
                    apply(ipv4_fib_lpm);
                }
...
# 74 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/ipv6.p4"
...
header_type tunnel_metadata_t {
    fields {
        ...
        tunnel_dst_index : 17; /* index to tunnel dst ip */
        tunnel_src_index : 8; /* index to tunnel src ip */
        tunnel_smac_index : 8; /* index to tunnel src mac */
        tunnel_dmac_index : 8; /* index to tunnel dst mac */
        vnid : 24; /* tunnel vnid */
...
action terminate_tunnel_inner_ipv4() {
    modify_field(tunnel_metadata.tunnel_terminate, 1);
    modify_field(tunnel_metadata.l3_tunnel_terminate, 1);

    modify_field(l2_metadata.lkp_mac_type, 0x0800);
...
action terminate_tunnel_inner_ipv6() {
    ...
    modify_field(l2_metadata.lkp_mac_type, 0x86dd);
    modify_field(l2_metadata.lkp_mac_sa, inner_ethernet.srcAddr); // not-valid
    modify_field(l2_metadata.lkp_mac_da, inner_ethernet.dstAddr); // not-valid
...
# 346 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
    /* VNI -> BD Translation */
...
# 408 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
}
...
# 425 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
}
...
# 474 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
                } else {
                    if (valid(ipv6)) {
...
# 490 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
                    }
...
# 1106 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
/*****************************************************************************/
...
# 1208 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
...
# 1354 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
...
# 1380 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
        ...
        decap_ip_inner_ipv6;
# 1414 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
    }
    size : 512;
}
...
# 1727 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
...
control process_tunnel_encap {
    if (tunnel_metadata.egress_tunnel_type != 0) {
     ...
     if ((tunnel_metadata.egress_tunnel_type == 2) or
            (tunnel_metadata.egress_tunnel_type == 10) or
            (tunnel_metadata.egress_tunnel_type == 12)) {
...
# 477 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
...
/*****************************************************************************/
# 521 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
...
# 902 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
...
/* IPv6 ACL                                                                  */
/*****************************************************************************/
# 968 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
...
# 1000 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
        l3_metadata.rmac_hit : ternary;
...
# 2110 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
...
# 2517 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
...
# 2569 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
...
# 2619 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
   apply(copp_drop);
...
# 2778 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
}
...
table egress_ipv4_mirror_acl {
    reads {
        acl_metadata.egress_port_lag_label : ternary;
/* CODE_PROTECTED_IP BD Label is not include here becuase it allows us 
   to place mirrro_acl independent of egress_bd_map. */
        ipv4.srcAddr : ternary;
        ipv4.dstAddr : ternary;
...
/* Egress ACL stats                                                          */
/*****************************************************************************/
# 2884 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
...
/* Egress System ACL                                                         */
/*****************************************************************************/
# 2950 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
...
# 2979 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
...
# 3072 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
    }
    actions {
        nop;
        drop_packet;
...
header_type nat_metadata_t {
    fields {
        ...
        nat_nexthop : 17; /* next hop from nat */
...
/** CODE_SENSITIVE Keeps ecmp_group__action__ from expanding to 16 instead
    of 8 SRAMS, so that ecmp_group and nexthop can fit in the same stage */
...
/*****************************************************************************/
# 343 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/nexthop.p4"
/*****************************************************************************/
/* ECMP lookup                                                               */
/*****************************************************************************/
...
# 619 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/nexthop.p4"
...
# 698 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/nexthop.p4"
...
# 715 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/nexthop.p4"
            apply(ecmp_group);
# 726 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/nexthop.p4"
    } else {
        /* resolve nexthop */
        apply(nexthop);
    }
...
# 190 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/fabric.p4"
    actions {
...
# 435 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/fabric.p4"
...
# 190 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/dtel.p4"
}
...
# 222 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/dtel.p4"
}

control process_dtel_deflect_on_drop {
# 234 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/dtel.p4"
}
...
control process_dtel_local_report1 {
    // run only for not mirrored packets
# 275 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/dtel.p4"
}
...
# 342 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/dtel.p4"
...
# 382 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/dtel.p4"
}
 ...
 ******************************************************************************/
# 423 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/dtel.p4"
/*******************************************************************************
 Record egress port
 ******************************************************************************/
# 468 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/dtel.p4"
/*******************************************************************************
...
/*******************************************************************************
 Mirror on Drop
 ******************************************************************************/
# 726 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/dtel.p4"
/*******************************************************************************
 DTel flow hash
******************************************************************************/
 ...
 ******************************************************************************/
# 1111 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/dtel.p4"
/*******************************************************************************
...
control ingress {
//----------------------------------------------------------------------
# 991 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/switch.p4"
//----------------------------------------------------------------------
    /* Input Port */
    ...
    if (l2_metadata.lkp_pkt_type == 1) {
        if ((l3_metadata.rmac_hit == 1) or (tunnel_metadata.l3_tunnel_terminate == 1)) {
                if (((ingress_metadata.bypass_lookups & 0x0002) == 0)) {
                    if ((l3_metadata.lkp_ip_type == 1) and (ipv4_metadata.ipv4_unicast_enabled == 1)) {
                        process_ipv4_fib();
                    } else if ((l3_metadata.lkp_ip_type == 2) and (ipv6_metadata.ipv6_unicast_enabled == 1)) {
                        process_ipv6_fib();
                    }
                }
        }
...
//----------------------------------------------------------------------
# 1859 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/switch.p4"
//----------------------------------------------------------------------
}
...
//----------------------------------------------------------------------
# 2387 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/switch.p4"
//----------------------------------------------------------------------
    if (egress_metadata.bypass == 0) {
...
//----------------------------------------------------------------------
# 2978 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/switch.p4"
//----------------------------------------------------------------------
}
