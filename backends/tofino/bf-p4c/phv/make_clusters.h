...
class Clustering : public PassManager {
    ...
    assoc::hash_map<const PHV::Field *, assoc::hash_set<const PHV::Field *>>
        inconsistent_extract_no_packs_i;
    ...
    class MakeRotationalClusters : public Inspector {
     ...
     public:
        explicit MakeRotationalClusters(Clustering &self) : self(self), phv_i(self.phv_i) {}
    };
    ...
    class MakeSuperClusters : public Inspector {
        ...
        /// into @p slice_lists.
        void addPaddingForMarshaledFields(ordered_set<const PHV::RotationalCluster *> &cluster_set,
 ...
 public:
    Clustering(PhvInfo &p, PhvUse &u, const PackConflicts &c, const PragmaContainerSize &pa_sz,
        ...
        : phv_i(p),
          uses_i(u),
          conflicts_i(c),
          pa_container_sizes_i(pa_sz),
          pa_byte_pack_i(pa_byte_pack),
          defuse_i(defuse),
          deps_i(deps),
