...
class ReplaceAllAliases : public Transform {
 ...
 public:
    ReplaceAllAliases(const PhvInfo &p, const PragmaAlias &pragmaAlias,
...
class Alias : public Logging::PassManager {
 ...
 public:
    explicit Alias(PhvInfo &phv, const PragmaAlias &pa)
        ...
        addPasses({new FindExpressionsForFields(phv, fieldExpressions),
...
#endif /* BACKENDS_TOFINO_BF_P4C_COMMON_ALIAS_H_ */
