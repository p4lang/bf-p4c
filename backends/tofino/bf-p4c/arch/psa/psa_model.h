...
struct PacketPathType_Model : public ::Model::Enum_Model {
    PacketPathType_Model()
        : ::Model::Enum_Model("PSA_PacketPath_t"_cs),
          normal("NORMAL"_cs),
          normal_unicast("NORMAL_UNICAST"_cs),
          normal_multicast("NORMAL_MULTICAST"_cs),
          clone_i2e("CLONE_I2E"_cs),
          clone_e2e("CLONE_E2E"_cs),
          resubmit("RESUBMIT"_cs),
...
struct MeterType_Model : public ::Model::Enum_Model {
    MeterType_Model()
        : ::Model::Enum_Model("PSA_MeterType_t"_cs), packets("PACKETS"_cs), bytes("PACKETS"_cs) {}
    ::Model::Elem packets;
    ::Model::Elem bytes;
};
...
struct MeterColor_Model : public ::Model::Enum_Model {
    MeterColor_Model()
        : ::Model::Enum_Model("PSA_MeterColor_t"_cs),
          green("GREEN"_cs),
          yellow("YELLOW"_cs),
          red("RED"_cs) {}
    ::Model::Elem green;
...
struct CounterType_Model : public ::Model::Enum_Model {
    CounterType_Model()
        : ::Model::Enum_Model("PSA_CounterType_t"_cs),
          packets("PACKETS"_cs),
          bytes("BYTES"_cs),
...
struct HashAlgorithmType_Model : public ::Model::Enum_Model {
    HashAlgorithmType_Model()
        : ::Model::Enum_Model("PSA_HashAlgorithm_t"_cs),
...
struct IngressInputMetaType_Model : public ::Model::Type_Model {
    IngressInputMetaType_Model()
        : ::Model::Type_Model("psa_ingress_input_metadata_t"_cs),
          ingress_port("ingress_port"_cs),
          packet_path("packet_path"_cs),
          ingress_timestamp("ingress_timestamp"_cs),
...
struct IngressOutputMetaType_Model : public ::Model::Type_Model {
    IngressOutputMetaType_Model()
        : ::Model::Type_Model("psa_ingress_output_metadata_t"_cs),
          ...
          clone("clone"_cs),
          clone_session_id("clone_session_id"_cs),
          drop("drop"_cs),
          resubmit("resubmit"_cs),
          multicast_group("multicast_group"_cs),
          egress_port("egress_port"_cs) {}
...
struct EgressInputMetaType_Model : public ::Model::Type_Model {
    EgressInputMetaType_Model()
        : ::Model::Type_Model("psa_egress_input_metadata_t"_cs),
          ...
          egress_port("egress_port"_cs),
          packet_path("packet_path"_cs),
          instance("instance"_cs),
          egress_timestamp("egress_timestamp"_cs),
          parser_error("parser_error"_cs) {}
    ::Model::Elem class_of_service;
    ::Model::Elem egress_port;
    ::Model::Elem packet_path;
...
struct CompilerGeneratedMetaType_Model : public ::Model::Type_Model {
    explicit CompilerGeneratedMetaType_Model(cstring name)
        : ::Model::Type_Model("compiler_generated_metadata_t"_cs),
          instance_name(name),
          mirror_id("mirror_id"_cs),
          mirror_source("mirror_source"_cs),
          clone_src("clone_src"_cs),
          clone_digest_id("clone_digest_id"_cs) {}
...
struct Checksum_Model : public ::Model::Extern_Model {
    Checksum_Model()
        : Extern_Model("Checksum"_cs), clear("clear"_cs), update("update"_cs), get("get"_cs) {}
...
struct InternetChecksum_Model : public ::Model::Extern_Model {
    InternetChecksum_Model()
        : Extern_Model("InternetChecksum"_cs),
          clear("clear"_cs),
          add("add"_cs),
          subtract("subtract"_cs),
          get("get"_cs),
          get_state("get_state"_cs),
          set_state("set_state"_cs) {}
    HashAlgorithmType_Model algorithm;
    ::Model::Elem clear;
    ::Model::Elem add;
    ::Model::Elem subtract;
...
struct Hash_Model : public ::Model::Extern_Model {
    Hash_Model() : Extern_Model("Hash"_cs), get("get"_cs), get_with_base("get"_cs) {}
    HashAlgorithmType_Model algorithm;
    ::Model::Elem get;
...
struct Random_Model : public ::Model::Extern_Model {
    Random_Model() : Extern_Model("Random"_cs), get("get"_cs) {}
    ::Model::Elem get;
};

struct Counter_Model : public ::Model::Extern_Model {
    Counter_Model() : Extern_Model("Counter"_cs), counterType(), count("count"_cs) {}
    CounterType_Model counterType;
    ::Model::Elem count;
};

struct DirectCounter_Model : public ::Model::Extern_Model {
    DirectCounter_Model() : Extern_Model("DirectCounter"_cs), counterType(), count("count"_cs) {}
    CounterType_Model counterType;
    ::Model::Elem count;
};

struct Meter_Model : public ::Model::Extern_Model {
    Meter_Model() : Extern_Model("Meter"_cs), meterType(), execute("execute"_cs) {}
    MeterType_Model meterType;
    ::Model::Elem execute;
};

struct DirectMeter_Model : public ::Model::Extern_Model {
    DirectMeter_Model() : Extern_Model("DirectMeter"_cs), meterType(), execute("execute"_cs) {}
    MeterType_Model meterType;
    ::Model::Elem execute;
};
...
struct ActionProfile_Model : public ::Model::Extern_Model {
    ActionProfile_Model()
        : Extern_Model("ActionProfile"_cs),
...
struct ActionSelector_Model : public ::Model::Extern_Model {
    ActionSelector_Model()
        : Extern_Model("ActionSelector"_cs),
          hashType(),
          sizeType(IR::Type_Bits::get(32)),
          sizeParam("size"_cs),
...
struct IngressModel : public ::Model::Elem {
    IngressModel(Model::Type_Model headersType, Model::Type_Model userMetaType,
        ...
        : Model::Elem("Ingress"_cs),
          ...
          ostdParam("ostd"_cs, ostdType, 3) { /* empty */ }
    ::Model::Param_Model headersParam;
    ::Model::Param_Model metadataParam;
    ::Model::Param_Model istdParam;
...
struct IngressDeparserModel : public ::Model::Elem {
    IngressDeparserModel(Model::Type_Model cloneType, Model::Type_Model resubmitMetaType,
        ...
        : Model::Elem("IngressDeparser"_cs),
          ...
          istdParam("istd"_cs, istdType, 6) { /* empty */ }
    ::Model::Param_Model packetParam;
...
struct EgressDeparserModel : public ::Model::Elem {
    EgressDeparserModel(Model::Type_Model cloneE2EMetaType, Model::Type_Model recircMetaType,
                        Model::Type_Model headersType, Model::Type_Model userMetaType,
                        Model::Type_Model istdType, Model::Type_Model edstdType)
        : Model::Elem("EgressDeparser"_cs),
          ...
          edstdParam("edstd"_cs, edstdType, 6) { /* empty */ }
    ::Model::Param_Model packetParam;
    ::Model::Param_Model cloneE2EMetaParam;
 ...
 protected:
    PsaModel()
        : Model::Model(),
          ...
          resubmitMetaType("resubmit_meta"_cs),
          recircMetaType("recirc_meta"_cs),
          cloneI2EMetaType("clone_i2e_meta"_cs),
          cloneE2EMetaType("clone_e2e_meta"_cs),
          bridgeMetaType("bridge_meta"_cs),
          ...
          ingress_deparser(cloneI2EMetaType, resubmitMetaType, bridgeMetaType, headersType,
                           metadataType, igOutputMetaType),
          egress_parser(headersType, metadataType, egParserInputMetaType, bridgeMetaType,
                        cloneI2EMetaType, cloneE2EMetaType),
