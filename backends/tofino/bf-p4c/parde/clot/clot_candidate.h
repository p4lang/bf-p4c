...
#ifndef BACKENDS_TOFINO_BF_P4C_PARDE_CLOT_CLOT_CANDIDATE_H_
#define BACKENDS_TOFINO_BF_P4C_PARDE_CLOT_CLOT_CANDIDATE_H_
...
class ClotCandidate : public LiftLess<ClotCandidate> {
 ...
 public:
    ...
    ClotCandidate(const ClotInfo &clotInfo, const Pseudoheader *pseudoheader,
                  const std::vector<const FieldSliceExtractInfo *> &extract_infos,
                  bool afterAllocatedClot = false, bool beforeAllocatedClot = false);
...
#endif /* BACKENDS_TOFINO_BF_P4C_PARDE_CLOT_CLOT_CANDIDATE_H_ */
