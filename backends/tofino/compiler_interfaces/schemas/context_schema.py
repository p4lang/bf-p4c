...
user_annotations_var = jsl.ArrayField(
    required=False,
    items=jsl.ArrayField(
        min_items=1, items=jsl.StringField(), description="Annotation values as strings."
    ),
...
class ActionDataEntryFormat(jsl.Document):
    ...
    entry_number = jsl.IntField(
        required=True, description="Entry number uniquely identifying this entry."
    )
    fields = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                "field_name": jsl.StringField(required=True, description="Name of this field."),
                "field_width": jsl.IntField(
                    required=True, description="Width of this field, in bits."
                ),
                "lsb_mem_word_idx": jsl.IntField(
                    required=True,
                    description="Index of the wide word containing the least significant bit of this field.",
                ),
                "lsb_mem_word_offset": jsl.IntField(
                    required=True,
                    description="Offset of the least significant bit of the field within this memory word.",
                ),
                "const_tuples": jsl.ArrayField(
                    items=jsl.DictField(
                        properties={
                            "dest_start": jsl.IntField(
                                required=True,
                                description="Index of the least significant bit of this segment of the constant.",
                            ),
                            "value": jsl.IntField(
                                required=True, description="Value of this segment of the constant."
                            ),
                            "dest_width": jsl.IntField(
                                required=True, description="Width of this segment of the constant."
                            ),
                        }
                    ),
                ...
                "source": jsl.StringField(
                    ...
                    enum=['zero', 'constant', 'spec'],
                ),
                "start_bit": jsl.IntField(
                    required=True,
                ...
                "is_mod_field_conditionally_mask": jsl.BooleanField(
...
class TernEntryFormat(jsl.Document):
    ...
    fields = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                "field_name": jsl.StringField(required=True, description="Name of this field."),
                "global_name": jsl.StringField(
                    required=True, description="Global name of this field."
                ),
                "field_width": jsl.IntField(
                    required=True, description="Width of this field, in bits."
                ),
                ...
                "source": jsl.StringField(
                    ...
                    enum=['version', 'zero', 'parity', 'payload', 'range', 'spec'],
                ),
                "range": jsl.DictField(
                    properties={
                        "type": jsl.IntField(
    ...
    fields = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                ...
                "field_width": jsl.IntField(
                    required=True, description="Width of a field, in bits."
                ),
                "source": jsl.StringField(
                    required=True,
                    description="Type of source that originated this entry.",
                ...
                "match_mode": jsl.StringField(
                    enum=["exact", "s0q1", "s1q0", "unused"],
...
class StageTable(jsl.Document):
    class ActionHandleFormat(jsl.Document):
        ...
        next_table_exec = jsl.IntField(
            description="(Tofino2 only: 31 bit local/global exec map for next tables in the same and next stages"
        )
        next_table_global_exec = jsl.IntField(
            description="(Experimental: 24 bit global exec map for next tables in following stages"
        )
        next_table_local_exec = jsl.IntField(
            description="(Experimental: 15 bit local exec map for next tables in the same stages"
        )
        next_table_long_brch = jsl.IntField(description="(Tofino2+ only: 8 bit long branch mask")
        next_tables = jsl.ArrayField(
            items=jsl.DictField(
                properties={
                    "next_table_name": jsl.StringField(
                        required=True, description="P4 next table name for the next table"
                    ),
                    "next_table_logical_id": jsl.IntField(
                        required=True, description="P4 next table logical id within the stage"
                    ),
                    "next_table_stage_no": jsl.IntField(
                        required=True, description="P4 next table stage no"
                    ),
                }
            ),
            required=False,
            description="List of all next tables for the given action",
        )
        action_name = jsl.StringField(description="The name of the action.")
        action_handle = jsl.IntField(
            required=True, description="The handle of this particular action."
        )
        table_name = jsl.StringField(description="The name of the match table.")

        immediate_fields = jsl.ArrayField(
            items=jsl.AnyOfField(
                [
                    jsl.DictField(
                        properties={
                            "param_shift": jsl.IntField(
                                required=True,
                            ...
                            "param_name": jsl.StringField(
                                required=True, description="The name of the parameter."
                            ),
                            "param_type": jsl.StringField(
                                required=True,
                                enum=["parameter", "constant"],
    ...
    class ATCAMMemoryResourceAllocation(jsl.Document):
        ...
        column_priority = jsl.IntField(
            required=True,
            description="Priority for this column. A lower value means higher priority.",
        )
        memory_units_and_vpns = jsl.ArrayField(
            items=jsl.DictField(
                properties={
                    "memory_units": jsl.ArrayField(
                        items=jsl.IntField(),
                        required=True,
    ...
    class MemoryResourceAllocation(jsl.Document):
        ...
        spare_bank_memory_unit = jsl.AnyOfField(
            [jsl.IntField(), jsl.ArrayField(items=jsl.IntField())],
    ...
    class HashMatchMemoryResourceAllocation(jsl.Document):
        ...
        memory_type = jsl.StringField(
            required=True, enum=['sram', 'stm', 'lamb'], description="Type of memory allocated."
        )
        memory_units_and_vpns = jsl.ArrayField(
            items=jsl.DictField(
                properties={
        ...
        hash_function_id = jsl.IntField(
            required=True,
            description="Hash function ID that is used to compute the RAM enable select bits and the RAM word entry bits.",
        )
        hash_select_bit_lo = jsl.IntField(
            required=True,
            description="Position of the least significant bit boundary in the hash value to use to activate a RAM unit.",
        )
        hash_select_bit_hi = jsl.IntField(
            required=True,
            description="Position of the most significant bit boundary in the hash value to use to activate a RAM unit.",
        )
        hash_entry_bit_lo = jsl.IntField(
            required=True,
            description="Position of the least significant bit boundary in the hash value to use to determine a RAM unit row.",
        )
        hash_entry_bit_hi = jsl.IntField(
            required=True,
            description="Position of the most significant bit boundary in the hash value to use to determine a RAM unit row.",
        )
        number_select_bits = jsl.IntField(
            required=True,
            description="Number of hash bits used for selecting the RAM. Values allowed: 0-12 (inclusive).",
        )
        number_entry_bits = jsl.IntField(
            required=True,
            enum=list(range(6, 11)),
            description="Number of hash bits used for selecting the word in a RAM.",
        )
        number_subword_bits = jsl.IntField(
            required=True, description="Number of hash bits used for subword selection"
        )
    ...
    class StashAllocation(jsl.Document):
        ...
        pack_format = jsl.ArrayField(
            items=jsl.DictField(
                properties={
                    "table_word_width": jsl.IntField(
                        required=True,
                        description="Bit width of the stash word.  Note that this can be less than the corresponding exact match table's word width.",
                    ),
                    "memory_word_width": jsl.IntField(
                        required=True, description="Bit width of a single physical stash word."
                    ),
                    "entries_per_table_word": jsl.IntField(
                        required=True,
                        description="Number of entries that are packed into a given table word.  For stashes, this can only be 1.",
                    ),
                    "number_memory_units_per_table_word": jsl.IntField(
                        required=True,
                    ...
                    "entries": jsl.ArrayField(
                        items=jsl.DocumentField("ExactEntryFormat"),
                        required=True,
        ...
        num_stash_entries = jsl.IntField(
            required=True, description="The number of wide-word stash entries available."
        )
        stash_entries = jsl.ArrayField(
            items=jsl.ArrayField(
                jsl.DictField(
                    properties={
                        "stash_entry_id": jsl.IntField(
                            required=True,
    ...
    stage_table_type = jsl.StringField(
        required=True,
        enum=[
            'hash_way',
            'ternary_match',
    ...
    stage_number = jsl.IntField(
        required=True, description="Number identifying the stage containing this stage table."
    )
    logical_table_id = jsl.IntField(
        required=True, description="Unique identifier for this logical table within this stage."
    )
    physical_table_id = jsl.IntField(
        required=False, description="Physical table number for this match table (Experimental)"
    )
    ...
    pack_format = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                "table_word_width": jsl.IntField(
                    required=True, description="Bit width of the table's word."
                ),
                "memory_word_width": jsl.IntField(
                    required=True, description="Bit width of a single physical memory word."
                ),
                "entries_per_table_word": jsl.IntField(
                    required=True,
    ...
    memory_resource_allocation = jsl.OneOfField(
        [jsl.NullField(), jsl.DocumentField("MemoryResourceAllocation", as_ref=True)],
        required=True,
        description="Representation of the Memory resource allocation for this stage table.",
    )
    always_run = jsl.BooleanField(
        required=False,
...
class HashWayStageTable(StageTable):
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['hash_way'], description="Type of stage table."
    )
    ...
    memory_resource_allocation = jsl.OneOfField(
        [
            jsl.DocumentField(
                ...
                description="Representation of the memory resource allocation for this stage table. This structure is particular to a HashWayStageTable.",
            ),
            jsl.NullField(),
        ],
        required=True,
...
class HashFunction(jsl.Document):
    ...
    hash_function_number = jsl.IntField(
        required=True,
    ...
    hash_bits = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                "hash_bit": jsl.IntField(
                    required=True, description="Identifier for this particular hash bit."
                ),
                "seed": jsl.IntField(
                    required=True,
                    enum=[0, 1],
                ...
                "bits_to_xor": jsl.ArrayField(
                    items=jsl.DictField(
                        properties={
                            ...
                            "global_name": jsl.StringField(
                                required=True,
                                description="Global Identifier for this particular hash bit.",
                            ),
                            "field_bit": jsl.IntField(
                                required=True,
                                description="Bit within the byte of the field corresponding to this hash.",
                            ),
                            "hash_match_group_bit": jsl.IntField(
                                required=True,
                                description="Bit within the hash match group corresponding to this bit.",
                            ),
                            "hash_match_group": jsl.IntField(
                                required=True,
    ...
    ghost_bit_info = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                "field_name": jsl.StringField(required=True, description="Name of the field."),
                "global_name": jsl.StringField(
                    required=True, description="Global name of the field."
                ),
                "bit_in_match_spec": jsl.IntField(
                    required=True, description="Bit within the field where this ghost bit lives."
                ),
            },
            required=False,
    ...
    ghost_bit_to_hash_bit = jsl.ArrayField(
        items=jsl.ArrayField(
            items=jsl.IntField(
                required=False,
...
class ExactMatchStageTable(StageTable):
    ...
    hash_functions = jsl.ArrayField(
        items=jsl.DocumentField("HashFunction", as_ref=True),
        required=True,
        description="Array of hash functions for this match table.",
    )

    result_physical_buses = jsl.ArrayField(
        items=jsl.IntField(),
        required=True,
    ...
    has_attached_gateway = jsl.BooleanField(
        required=True,
        description="A Boolean indicating if this stage table has an attached gateway.",
    )

    ways = jsl.ArrayField(
        items=jsl.DocumentField("HashWayStageTable", as_ref=True),
        required=True,
        description="Context information for each particular way in this exact match stage table.",
    )

    action_format = jsl.ArrayField(
        items=jsl.DocumentField("ActionHandleFormat", as_ref=True),
        required=True,
    ...
    memory_resource_allocation = jsl.OneOfField(
        [
            jsl.DocumentField(
                "HashMatchMemoryResourceAllocation",
                as_ref=True,
                description="Representation of the memory resource allocation for this stage table. This structure is particular to ExactMatchStageTables, except for ATCAM.",
            ),
            jsl.NullField(),
        ],
        required=True,
    ...
    stash_allocation = jsl.OneOfField(
        [
            jsl.DocumentField(
                "StashAllocation",
                as_ref=True,
                description="Representation of the stash resource allocation for this stage table. This structure is particular to ExactMatchStageTables, except for ATCAM.",
            ),
            jsl.NullField(),
        ],
        required=True,
    ...
    default_next_table = jsl.OneOfField(
        [jsl.IntField(), jsl.NullField()],
        required=True,
        description="Full address of the default next table, if any.",
    )
    idletime_stage_table = jsl.DocumentField(
        "IdletimeStageTable",
        as_ref=True,
        description="Idletime stage table associated to this stage table.",
    )
...
class HashMatchStageTable(ExactMatchStageTable):
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['hash_match'], description="Type of exact match stage table."
    )
...
class HashActionStageTable(StageTable):
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['hash_action'], description="Type of exact match stage table."
    )
...
class DirectMatchStageTable(ExactMatchStageTable):
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['direct_match'], description="Type of exact match stage table."
    )
...
class ProxyHashMatchStageTable(ExactMatchStageTable):
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['proxy_hash_match'], description="Type of exact match stage table."
    )

    proxy_hash_bit_width = jsl.IntField(
        required=True,
        description="An integer indicating the bit width of proxy value stored in place of the normal exact match key.",
    )
    proxy_hash_algorithm = jsl.StringField(
    ...
    proxy_hash_function = jsl.DocumentField(
        "HashFunction",
        as_ref=True,
        required=True,
        description="Match spec bit properties to include in the calculation for the proxy hash function.",
    )
...
class MatchWithNoKeyStageTable(StageTable):
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['match_with_no_key'], description="Type of exact match stage table."
    )
...
class ATCAMMatchStageTable(StageTable):
    ...
    memory_resource_allocation = jsl.ArrayField(
        jsl.DocumentField("ATCAMMemoryResourceAllocation", as_ref=True),
        required=True,
...
class Phase0MatchStageTable(StageTable):
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['phase_0_match'], description="Type of exact match stage table."
    )
    parser_handle = jsl.IntField(
        required=False,
        description="Handle of the parser associated with this Phase0 Table. This value is optional for a single parser scenario.",
    )
...
class TernMatchStageTable(StageTable):
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['ternary_match'], description="Type of match stage table."
    )
    ...
    pack_format = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                ...
                "entries": jsl.ArrayField(
                    items=jsl.DocumentField("TernEntryFormat"),
                    required=True,
                    description="Entries packed in this stage table's memory.",
                ),
            },
    ...
    ternary_indirection_stage_table = jsl.DocumentField(
        "TindStageTable",
        as_ref=True,
        description="Ternary indirection stage table associated to this stage table.",
    )
    idletime_stage_table = jsl.DocumentField(
        "IdletimeStageTable",
        as_ref=True,
...
class StatisticsStageTable(StageTable):
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['statistics'], description="Type of stage table."
    )
    stats_alu_index = jsl.AnyOfField(
        ...
        required=True,
        description="An integer or an integer vector that indicates the statistics ALU(s) used.  0 is on row 0, 1 on row 2, 2 on row 4 and 3 on row 6.",
    )
...
class MeterStageTable(StageTable):
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['meter'], description="Type of stage table."
    )

    default_lower_huffman_bits_included = jsl.IntField(
        required=True,
        enum=[7],
    ...
    meter_alu_index = jsl.AnyOfField(
        ...
        required=True,
        description="An integer or an integer vector that indicates the meter ALU(s) used.  0 is on row 1, 1 on row 3, 2 on row 5 and 3 on row 7.",
    )
...
class SelectionStageTable(StageTable):
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['selection'], description="Type of stage table."
    )
    meter_alu_index = jsl.IntField(
        required=True,
        enum=list(range(0, 4)),
        description="An integer that indicates the meter ALU used.  0 is on row 1, 1 on row 3, 2 on row 5 and 3 on row 7.",
    )
    sps_scramble_enable = jsl.BooleanField(
        required=True, description="Boolean indicating if the selector ALU SPS scramble is enabled."
    )
...
class StatefulStageTable(StageTable):
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['stateful'], description="Type of stage table."
    )
    meter_alu_index = jsl.IntField(
        required=True,
        enum=list(range(0, 4)),
...
class GatewayStageTable(StageTable):
    ...
    next_table_names = jsl.DictField(
        properties={
            "true": jsl.AnyOfField(
                [
                    jsl.ArrayField(
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['gateway'], description="Type of stage table."
    )
...
class IdletimeStageTable(StageTable):
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['idletime'], description="Type of stage table."
    )
...
class TindStageTable(StageTable):
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['ternary_indirection'], description="Type of stage table."
    )
    ...
    pack_format = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                ...
                "entries": jsl.ArrayField(
                    items=jsl.DocumentField("TindEntryFormat"),
                    required=True,
                    description="Entries packed in this stage table's memory.",
                ),
            },
    ...
    action_format = jsl.ArrayField(
        items=jsl.DocumentField("ActionHandleFormat", required=True, as_ref=True),
        required=True,
...
class ActionDataStageTable(StageTable):
    ...
    stage_table_type = jsl.StringField(
        required=True, enum=['action_data'], description="Type of stage table."
    )
    ...
    pack_format = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                ...
                "entries": jsl.ArrayField(
                    items=jsl.DocumentField("ActionDataEntryFormat"),
                    required=True,
                    description="Entries packed in this stage table's memory.",
                ),
            },
...
class MatchWithNoKeyTableAttr(jsl.Document):
    ...
    match_type = jsl.StringField(
        required=True, enum=['match_with_no_key'], description="Type of match table."
    )

    stage_tables = jsl.ArrayField(
        jsl.DocumentField("MatchWithNoKeyStageTable", as_ref=True),
        required=True,
...
class HashActionTableAttr(jsl.Document):
    ...
    match_type = jsl.StringField(
        required=True, enum=['hash_action'], description="Type of match table."
    )
...
class Phase0MatchTableAttr(jsl.Document):
    ...
    match_type = jsl.StringField(
        required=True, enum=['phase_0_match'], description="Type of match table."
    )

    stage_tables = jsl.ArrayField(
        jsl.DocumentField("Phase0MatchStageTable", as_ref=True),
        required=True,
...
class TernMatchTableAttr(jsl.Document):
    ...
    match_type = jsl.StringField(
        required=True, enum=['ternary'], description="Type of match table."
    )
    ...
    stage_tables = jsl.ArrayField(
        items=jsl.DocumentField("TernMatchStageTable", as_ref=True),
        required=True,
        description="An array of stage-specific resource objects for this match table.",
    )
...
class ALPMMatchTableAttr(jsl.Document):
    ...
    match_type = jsl.StringField(
        required=True, enum=['algorithmic_lpm'], description="Type of match table."
    )

    pre_classifier = jsl.DocumentField(
        "MatchTable",
        required=True,
        description="Match table that serves as the ternary pre-classifier table for this ALPM table.",
    )
    atcam_table = jsl.DocumentField(
        "MatchTable", required=True, description="ATCAM match table within this ALPM table."
    )

    bins_per_partition = jsl.IntField(
        required=True, description="Number of entries per partition in the ALPM table."
    )
    max_subtrees_per_partition = jsl.IntField(
        required=True, description="Maximum number of subtrees in a given ALPM partition."
    )
    partition_field_name = jsl.StringField(
        required=True,
        description="The name of the partition index field. Usually, this is defaulted by the compiler to some known value.",
    )
    lpm_field_name = jsl.StringField(
        required=True, description="Name of the field that is being matched against."
    )
    set_partition_action_handle = jsl.AnyOfField(
        [jsl.IntField(), jsl.ArrayField(items=jsl.IntField())],
        required=True,
        description="set partition action handle(s) for this ALPM table.",
    )
    excluded_field_msb_bits = jsl.ArrayField(
        required=False,
        items=jsl.DictField(
            properties={
                "field_name": jsl.StringField(
                    required=True,
                    description="The name of match key field that has been optimized for generating ATCAM partitions.",
                ),
                "msb_bits_excluded": jsl.IntField(
                    required=True,
                    description="The number of most significant bits of this field that will be excluded from the ATCAM packing.",
                ),
            },
            additional_properties=False,
        ),
        description="A list of the excluded most significant bits from particular fields.  Note that only one field is allowed to exclude a subset of the field.",
    )

    # Added for ALPM optimization
    atcam_subset_width = jsl.IntField(
        required=False,
        description="The width of the slice of lpm match key used in the atcam stage.",
    )
    shift_granularity = jsl.IntField(
        required=False, description="The granularity of right shifts in the set partition action."
    )
...
class ATCAMMatchTableAttr(jsl.Document):
    ...
    match_type = jsl.StringField(
        required=True, enum=['algorithmic_tcam'], description="Type of match table."
    )

    units = jsl.ArrayField(
        required=True,
        items=jsl.DocumentField("MatchTable", as_ref=True),
        description="List of ATCAM algorithmic units related to this ATCAM table.",
    )
    number_partitions = jsl.IntField(
        required=True, description="Number of partitions in this ATCAM table."
    )
    partition_field_name = jsl.StringField(
        required=True, description="Name of the field used to partition entries."
    )
...
class ATCAMMatchUnitAttr(jsl.Document):
    ...
    match_type = jsl.StringField(
        required=True, enum=['algorithmic_tcam_unit'], description="Type of match table."
    )
...
class CLPMMatchTableAttr(jsl.Document):
    ...
    match_type = jsl.StringField(
        required=True, enum=['chained_lpm'], description="Type of match table."
    )
...
class Table(jsl.Document):
    ...
    size = jsl.IntField(
        required=True, description="Minimum size of this table, as specified in P4."
    )
    direction = jsl.StringField(
        required=True,
        description="Whether this table is used for ingress, egress, or ghost.",
        enum=['ingress', 'egress', 'ghost'],
    )

    p4_hidden = jsl.BooleanField(
        required=False,
...
class MatchTable(Table):
    class ReferencedTable(jsl.Document):
        ...
        how_referenced = jsl.StringField(
            required=True,
            enum=['direct', 'indirect'],
            description="Whether the table is directly or indirectly referenced.",
        )
        color_mapram_addr_type = jsl.StringField(
            required=False,
            enum=['idle', 'stats'],
            description="The address for the color mapram for default meter addresses",
        )
    ...
    class StatefulAluExpressionDetails(jsl.Document):
        ...
        operand_1_type = jsl.StringField(
            required=False,
            enum=[
                "phv",
                "immediate",
        ...
        operand_1_value = jsl.OneOfField(
            [jsl.DocumentField("StatefulAluExpressionDetails", as_ref=True), jsl.StringField()],
            required=False,
            description="A field name, reference name, immediate value, register parameter name, binary expression, or unary expression.",
        )
        operand_2_type = jsl.StringField(
            required=False,
            enum=[
                "phv",
                "immediate",
        ...
        operand_2_value = jsl.OneOfField(
            [jsl.DocumentField("StatefulAluExpressionDetails", as_ref=True), jsl.StringField()],
            required=False,
            description="A field name, reference name, immediate value, register parameter name, binary expression, or unary expression.",
        )
    ...
    class StatefulAluDetails(jsl.Document):
        ...
        single_bit_mode = jsl.BooleanField(
            required=True,
            description="A Boolean indicating if this expression is operating in single-bit mode.",
        )

        condition_hi = jsl.DocumentField(
            "StatefulAluExpressionDetails",
            as_ref=True,
            required=False,
            description="Expression details about condition_hi.",
        )
        condition_lo = jsl.DocumentField(
            "StatefulAluExpressionDetails",
            as_ref=True,
            required=False,
            description="Expression details about condition_lo.",
        )

        update_lo_1_predicate = jsl.DocumentField(
            "StatefulAluExpressionDetails",
            as_ref=True,
            required=False,
            description="Expression details about update_lo_1_predicate.",
        )
        update_lo_1_value = jsl.DocumentField(
            "StatefulAluExpressionDetails",
            as_ref=True,
            required=False,
            description="Expression details about update_lo_1_value.",
        )
        update_lo_2_predicate = jsl.DocumentField(
            "StatefulAluExpressionDetails",
            as_ref=True,
            required=False,
            description="Expression details about update_lo_2_predicate.",
        )
        update_lo_2_value = jsl.DocumentField(
            "StatefulAluExpressionDetails",
            as_ref=True,
            required=False,
            description="Expression details about update_lo_2_value.",
        )

        update_hi_1_predicate = jsl.DocumentField(
            "StatefulAluExpressionDetails",
            as_ref=True,
            required=False,
            description="Expression details about update_hi_1_predicate.",
        )
        update_hi_1_value = jsl.DocumentField(
            "StatefulAluExpressionDetails",
            as_ref=True,
            required=False,
            description="Expression details about update_hi_1_value.",
        )
        update_hi_2_predicate = jsl.DocumentField(
            "StatefulAluExpressionDetails",
            as_ref=True,
            required=False,
            description="Expression details about update_hi_2_predicate.",
        )
        update_hi_2_value = jsl.DocumentField(
            "StatefulAluExpressionDetails",
            as_ref=True,
            required=False,
            description="Expression details about update_hi_2_value.",
        )

        output_predicate = jsl.DocumentField(
            "StatefulAluExpressionDetails",
            as_ref=True,
            required=False,
            description="Expression details about output_predicate.",
        )
        output_value = jsl.DocumentField(
            "StatefulAluExpressionDetails",
            as_ref=True,
            required=False,
            description="Expression details about output_value.",
        )
        output_dst = jsl.StringField(
            required=False, description="The name of the field to write the output result to."
        )

        initial_value_hi = jsl.IntField(
            required=False,
            description="Initial value to use for memory hi in all table entries (only applicable in dual-width mode).",
        )
        initial_value_lo = jsl.IntField(
            required=False, description="Initial value to use for memory lo in all table entries."
        )
    ...
    class P4Primitive(jsl.Document):
        ...
        operation = jsl.StringField(
            required=False, description="A more specific indication of the operation performed."
        )
        dst = jsl.DictField(
            properties={
        ...
        dst_mask = jsl.DictField(
            properties={
                "name": jsl.StringField(
                    required=True, description="The value of the destination mask."
                ),
                "type": jsl.StringField(
                    required=True,
                    enum=["immediate"],
        ...
        src1 = jsl.DictField(
            properties={
                "name": jsl.StringField(
                    required=True, description="The name or value of source 1."
                ),
                "type": jsl.StringField(
                    required=True,
                    enum=["phv", "action_param", "immediate", "header", "hash"],
                    description="The type of source 1.",
                ),
                "algorithm": jsl.StringField(
                    required=False, description="The name of the hash algorithm being used."
                ),
                "format_type": jsl.StringField(
                    required=False,
                    description="A user-supplied type for this field, which can be used for string formatting during display.",
        ...
        src2 = jsl.DictField(
            properties={
                "name": jsl.StringField(
                    required=True, description="The name or value of source 2."
                ),
                "type": jsl.StringField(
                    required=True,
                    enum=["phv", "action_param", "immediate", "header", "hash"],
        ...
        src3 = jsl.DictField(
            properties={
                "name": jsl.StringField(
                    required=True, description="The name or value of source 3."
                ),
                "type": jsl.StringField(
                    required=True, enum=["immediate"], description="The type of source 3."
                ),
                "algorithm": jsl.StringField(
                    required=False, description="The name of the hash algorithm being used."
                ),
        ...
        hash_inputs = jsl.ArrayField(
            items=jsl.StringField(),
            required=False,
            description="An array of the field names that participate in a hash computation used in this primitive.",
        )
        idx = jsl.DictField(
            properties={
                "name": jsl.StringField(
                    required=True, description="The name or value of the source."
                ),
                "algorithm": jsl.StringField(
                    required=False, description="The name of the hash algorithm being used."
                ),
        ...
        cond = jsl.DictField(
            properties={
                "name": jsl.StringField(
                    required=True, description="The name or value of the condition parameter."
                ),
                "type": jsl.StringField(
                    required=True,
                    enum=["phv", "action_param", "immediate", "header", "hash"],
        ...
        stateful_alu_details = jsl.DocumentField(
            "StatefulAluDetails",
            as_ref=True,
            required=False,
            description="The properties associated with the stateful ALU instruction being run.",
        )
    ...
    uses_range = jsl.BooleanField(
        required=True, description="Whether this table uses range fields or not."
    )
    range_entries = jsl.IntField(
        required=False, description="The number of P4-level range entries available."
    )
    disable_atomic_modify = jsl.BooleanField(
        required=False,
        description="Boolean indicating whether atomic table modifications should be disabled.",
    )

    action_data_table_refs = jsl.ArrayField(
        jsl.DocumentField("ReferencedTable", as_ref=True),
        required=True,
        description="Action Data Tables referenced from this table.",
    )
    selection_table_refs = jsl.ArrayField(
        jsl.DocumentField("ReferencedTable", as_ref=True),
        required=True,
        description="Selection Tables referenced from this table.",
    )
    statistics_table_refs = jsl.ArrayField(
        jsl.DocumentField("ReferencedTable", as_ref=True),
        required=True,
        description="Statistics Tables referenced from this table.",
    )
    meter_table_refs = jsl.ArrayField(
        jsl.DocumentField("ReferencedTable", as_ref=True),
        required=True,
        description="Meter Tables referenced from this table.",
    )
    stateful_table_refs = jsl.ArrayField(
        jsl.DocumentField("ReferencedTable", as_ref=True),
        required=True,
    ...
    default_next_table_mask = jsl.IntField(
        required=True,
        description="Mask used to not overwrite the next_table field in the match spec. FIXME",
    )
    default_next_table_default = jsl.IntField(
        description="Default to use when updating the next_table_format_data"
    )

    match_key_fields = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                "name": jsl.StringField(
                    required=True, description="The fully qualified name of the field."
                ),
                "instance_name": jsl.StringField(
                    required=True, description="The header or metadata instance name for the field."
                ),
                "field_name": jsl.StringField(required=True, description="The name of the field."),
                "match_type": jsl.StringField(
                    required=True,
                    enum=["exact", "lpm", "range", "ternary", "valid"],
                ...
                "mask": jsl.StringField(
                    required=False,
                    description="A mask (as hex string to accommodate >64 bits values) of the bits that make up the key. If absent, the full bit width makes up the key. This is not a ternary mask.",
                ),
                "position": jsl.IntField(
                    required=False,
                    description="The position in p4_param_order. Repeated fields (for disjointed bit ranges) get the same position.",
                ),
                "is_valid": jsl.BooleanField(
                    required=True,
                    description="Whether this match key field is on the valid bit of the specified field.",
                ),
                "global_name": jsl.StringField(
                    required=False,
                    description="The optional name of the field used in a global context. This is the name assigned to the snapshot name for the field",
                ),
                "user_annotations": user_annotations_var,
            }
        ),
    ...
    actions = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                "name": jsl.StringField(required=True, description="The P4 name of the action."),
                "handle": jsl.IntField(
                    required=True, description="A unique identifier for this action."
                ),
                "constant_default_action": jsl.BooleanField(
                    required=True,
                ...
                "is_compiler_added_action": jsl.BooleanField(
                    required=True,
                ...
                "p4_parameters": jsl.ArrayField(
                    items=jsl.DictField(
                        properties={
                            ...
                            "bit_width": jsl.IntField(
                                required=True, description="The bit width of the parameter."
                            ),
                            "default_value": jsl.StringField(
                                description="Default value of this parameter (as hex string to accommodate >64 bit values), in case this action is the default one."
                            ),
                            "format_type": jsl.StringField(
                                required=False,
                                description="A user-supplied type for this field, which can be used for string formatting during display.",
                ...
                "direct_resources": jsl.ArrayField(
                    items=jsl.DictField(
                        properties={
                            "handle": jsl.IntField(
                                required=True,
                                description="Unique identifier of the direct resource.",
                            ),
                            "resource_name": jsl.StringField(
                                required=True, description="The name of the direct resource."
                            ),
                        }
                    ),
                    required=True,
                    description="A list of the direct resources used by this action.",
                ),
                "indirect_resources": jsl.ArrayField(
                    items=jsl.AnyOfField(
                        [
                            jsl.DictField(
                                properties={
                                    "access_mode": jsl.StringField(
                                        required=True,
                                        enum=['index'],
                                    ...
                                    "parameter_name": jsl.StringField(
                                    ...
                                    "parameter_index": jsl.IntField(
                                        description="The index of the parameter in the action parameter list."
                                    ),
                                    "handle": jsl.IntField(
                                        required=True,
                                        description="Unique identifier of the indirect resource.",
                                    ),
                                    "resource_name": jsl.StringField(
                                        required=True,
                ...
                "override_stat_addr_pfe": jsl.BooleanField(
                    required=True,
                ...
                "override_meter_addr_pfe": jsl.BooleanField(
                    required=True,
                ...
                "override_stateful_addr_pfe": jsl.BooleanField(
                    required=True,
                ...
                "override_stat_addr": jsl.BooleanField(
                    required=True,
                ...
                "override_meter_addr": jsl.BooleanField(
                    required=True,
                ...
                "override_stateful_addr": jsl.BooleanField(
                    required=True,
    ...
    static_entries = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                "action_handle": jsl.IntField(
                    required=True, description="The unique handle for the action to run."
                ),
                "priority": jsl.IntField(
                    required=False,
                    description="An integer indicating the entry priority.  Priority 0 is the highest priority.  This field is required if a ternary, lpm, or range match type is used.",
                ),
                "is_default_entry": jsl.BooleanField(
                    required=True,
                    description="A Boolean indicating if this is the default table entry.",
                ),
                "action_parameters_values": jsl.ArrayField(
                    items=jsl.DictField(
                        properties={
                            "parameter_name": jsl.StringField(
                                required=True, description="The name of the action parameter."
                            ),
                            "value": jsl.StringField(
                                required=True,
                                description="An integer indicating the value (as hex string to accommodate >64 bit values) to program for this parameter.",
                            ),
                        }
                    ),
                    required=True,
                ...
                "match_key_fields_values": jsl.ArrayField(
                    items=jsl.DictField(
                        properties={
                            "field_name": jsl.StringField(
                            ...
                            "value": jsl.StringField(
                                required=False,
                                description="An integer indicating the value (as hex string to accommodate >64 bit values) to program for this field.  This field is required for all but range fields.",
                            ),
                            "mask": jsl.StringField(
                                required=False,
                                description="For the ternary match type, the mask value (as hex string to accommodate >64 bits values) to use with the field value.",
                            ),
                            "prefix_length": jsl.IntField(
                                required=False,
                                description="For the lpm match type, the prefix length to use with the value.",
                            ),
                            "range_start": jsl.StringField(
                                required=False,
                                description="An integer (as hex string to accommodate >64 bit values) indicating the start value of a range.  A range match occurs if the field value is within [start_range:end_range].",
                            ),
                            "range_end": jsl.StringField(
                                required=False,
                                description="An integer (as hex string to accommodate >64 bit values) indicating the end value of a range.  A range match occurs if the field value is within [start_range:end_range].",
                            ),
                            "user_annotations": user_annotations_var,
                        }
                    ),
    ...
    default_action_handle = jsl.IntField(
    ...
    is_resource_controllable = jsl.BooleanField(
...
class ActionDataTable(Table):
                ...
                "p4_parameters": jsl.ArrayField(
                    items=jsl.DictField(
                        properties={
                            ...
                            "default_value": jsl.IntField(
                                description="Default value of this parameter, in case this action is the default one."
                            ),
                            "user_annotations": user_annotations_var,
                        }
                    ),
    ...
    static_entries = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                ...
                "default_entry": jsl.BooleanField(
                    required=True,
                    description="A Boolean indicating if this is the default table entry.",
                ),
                "action_entry": jsl.DictField(
                    properties={
                        "name": jsl.StringField(
                            required=True, description="The name of the action to run."
                        ),
                        # FIXME: Better name
                        "action_id": jsl.IntField(
                            required=True, description="The unique handle for the action to run."
                        ),
                        "action_data": jsl.ArrayField(
                            items=jsl.DictField(
                                properties={
                                    "name": jsl.StringField(
                                        required=True,
    ...
    stage_tables = jsl.ArrayField(
        items=jsl.DocumentField("ActionDataStageTable", as_ref=True),
        required=True,
...
class SelectionTable(Table):
    ...
    selector_name = jsl.StringField(
        required=True, description="The name given to the action selector in P4."
    )
    selection_type = jsl.StringField(
        required=True,
        enum=['resilient', 'fair'],
        description="Whether the selection is [resilient] or [fair].",
    )
    selection_key_name = jsl.StringField(
        required=True, description="The name given to the selector calculation object in P4."
    )
    dynamic_selection_calculation = jsl.StringField(
        description="If this selector uses dynamic hashing, the name given to the P4 calculation object."
    )
    bound_to_action_data_table_handle = jsl.IntField(
        description="An integer indicating the action data table handle this is bound to, if any. FIXME: Update description."
    )
    bound_to_stateful_table_handle = jsl.IntField(
...
class StatisticsTable(Table):
    ...
    statistics_type = jsl.StringField(
        required=True,
        enum=['packets', 'bytes', 'packets_and_bytes'],
    ...
    stage_tables = jsl.ArrayField(
        items=jsl.DocumentField("StatisticsStageTable", as_ref=True),
        required=True,
...
class MeterTable(Table):
    ...
    meter_type = jsl.StringField(
        required=True, enum=['standard', 'lpf', 'red'], description="Type of meter in use."
    )
    meter_profile = jsl.IntField(
        required=False,
        enum=list(range(0, 16)),
        description="For color-based meters, a profile specifies what minimum and maximum burst rates are supported.  The default value is 0.",
    )
    meter_granularity = jsl.StringField(
        required=True, enum=['bytes', 'packets'], description="Granularity of meter in use."
    )
    how_referenced = jsl.StringField(
        required=True,
        enum=['direct', 'indirect'],
    ...
    enable_color_aware_pfe = jsl.BooleanField(
        required=True,
    ...
    color_aware_pfe_address_type_bit_position = jsl.IntField(
        required=True,
    ...
    stage_tables = jsl.ArrayField(
        items=jsl.DocumentField("MeterStageTable", as_ref=True),
        required=True,
...
class StatefulTable(Table):
    ...
    dual_width_mode = jsl.BooleanField(
        required=True,
    ...
    alu_width = jsl.IntField(
        required=True,
        enum=[1, 8, 16, 32, 64, 128],
    ...
    set_instr_adjust_total = jsl.IntField(
        enum=[0, 1, 2, 3],
    ...
    clr_instr_adjust_total = jsl.IntField(
        enum=[0, 1, 2, 3],
    ...
    initial_value_lo = jsl.NumberField(
        required=True,
    ...
    initial_value_hi = jsl.NumberField(
    ...
    bound_to_selection_table_handle = jsl.IntField(
    ...
    stateful_table_type = jsl.StringField(
        required=False,
        enum=['normal', 'log', 'fifo', 'stack', 'bloom_clear'],
        description="Type of stateful table.",
    )
    stateful_direction = jsl.StringField(
        required=False,
        enum=['in', 'out', 'inout'],
        description="Direction of dataplane accesses to a fifo or stack",
    )
    stateful_counter_index = jsl.IntField(
        required=False,
        enum=list(range(0, 4)),
        description="An integer that indicates the counter set used for this stateful log, fifo, or stack",
    )

    action_to_stateful_instruction_slot = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                "action_handle": jsl.IntField(
                    required=True, description="Unique identifier for an action."
                ),
                "instruction_slot": jsl.IntField(
                    required=True, description="Stateful ALU instruction slot used by the action."
                ),
            },
    ...
    register_params = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                "register_file_index": jsl.IntField(
                    required=True,
                    description="Index of the SALU register file row the register parameter is stored in.",
                ),
                "initial_value": jsl.IntField(
                    required=True, description="Initial value of the register parameter."
                ),
                "name": jsl.StringField(
                    required=True, description="Name of the register parameter."
                ),
                "handle": jsl.IntField(
                    required=True, description="Unique identifier of the register parameter."
                ),
            }
        ),
        required=False,
        description="List of register parameters stored in the SALU register file.",
    )

    stage_tables = jsl.ArrayField(
        items=jsl.DocumentField("StatefulStageTable", as_ref=True),
        required=True,
...
class ConditionTable(Table):
    ...
    condition = jsl.StringField(
        required=True, description="String representation of condition from P4."
    )
    attached_to = jsl.OneOfField(
        [jsl.NullField(), jsl.StringField()],
        required=True,
        description="The name of a match table this condition table is attached to, or null if unattached.",
    )
    stage_tables = jsl.ArrayField(
        items=jsl.DocumentField("GatewayStageTable", as_ref=True),
        required=True,
        description="An array of stage-specific resource objects for this condition table.",
    )
    condition_fields = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                "name": jsl.StringField(
                    required=True, description="The fully qualified name of the field."
...
class Parser(jsl.Document):
    ...
    ingress = jsl.ArrayField(
        jsl.DocumentField("PVS", as_ref=True),
        required=True,
        description="Parser value set information for Ingress.",
    )
    egress = jsl.ArrayField(
        jsl.DocumentField("PVS", as_ref=True),
        required=True,
...
class Parsers(jsl.Document):
    class ParserInstance(jsl.Document):
        ...
        handle = jsl.IntField(
            required=True, description="Unique handle to identify a parser program instance."
        )
        states = jsl.ArrayField(
            jsl.DocumentField("PVS", as_ref=True),
            required=True,
            description="Parser state information.",
        )
        default_parser_id = jsl.ArrayField(
            jsl.IntField(required=True, description="Default parser id information.")
        )

    title = "Parsers"
    description = "Multiple parsers context information."
    ingress = jsl.ArrayField(
        jsl.DocumentField("ParserInstance", as_ref=True),
        required=True,
        description="Parser instances information for Ingress.",
    )
    egress = jsl.ArrayField(
        jsl.DocumentField("ParserInstance", as_ref=True),
        required=True,
        description="Parser instances information for Egress.",
    )
...
class PHVStageAllocation(jsl.Document):
    class PHV(jsl.Document):
        ...
        phv_number = jsl.IntField(
            required=True, description="Unique address of this PHV container."
        )
        container_type = jsl.StringField(
            required=True,
            enum=["normal", "tagalong", "mocha", "dark"],
            description="A string describing the type of this PHV container.",
        )
        word_bit_width = jsl.IntField(
            required=True, enum=[8, 16, 32], description="The PHV container bit width."
        )
        records = jsl.ArrayField(
            items=jsl.DictField(
                properties={
                    "is_pov": jsl.BooleanField(
                        required=True,
                    ...
                    "is_compiler_generated": jsl.BooleanField(
                        required=True,
                        description="Indicates whether this field was generated by the compiler.",
                    ),
                    "pov_headers": jsl.ArrayField(
                        items=jsl.DictField(
                            properties={
                                "header_name": jsl.StringField(
                                    required=True, description="Name of the POV header."
                                ),
                                "bit_index": jsl.IntField(
                                    required=True,
                                    description="The index of this POV bit in the PHV record.",
                                ),
                                "position_offset": jsl.IntField(
                                    required=True,
                    ...
                    "live_start": jsl.OneOfField(
                        [jsl.IntField(), jsl.StringField(enum=["parser", "deparser"])],
                        required=False,
                        description="The location this field is first live.",
                    ),
                    "live_end": jsl.OneOfField(
                        [jsl.IntField(), jsl.StringField(enum=["parser", "deparser"])],
                        required=False,
                        description="The location this field is last live.",
                    ),
                    "mutually_exclusive_with": jsl.ArrayField(
                        items=jsl.StringField(
                            required=True,
                    ...
                    "tcam_rows": jsl.ArrayField(
                        items=jsl.IntField(required=True),
                        required=False,
                        description="A list of parser TCAM rows this field is extracted on.",
                    ),
                },
    ...
    stage_number = jsl.IntField(
        required=True, description="Number of the stage attached to this PHV."
    )
...
class LearnQuanta(jsl.Document):
    ...
    fields = jsl.ArrayField(
        jsl.DictField(
            properties={
                "field_name": jsl.StringField(required=True, description="Name of this field."),
                "phv_offset": jsl.IntField(
                    required=False, description="p4 field offset of this phv slice"
                ),
                "field_width": jsl.IntField(
                    required=True, description="Bit width of this phv slice"
                ),
                "start_bit": jsl.IntField(
                    required=True,
                    description="FIXME The start bit of the field from which the learner will take information from.",
                ),
                "start_byte": jsl.IntField(
                    required=True,
...
class MauStageCharacteristics(jsl.Document):
    ...
    gress = jsl.StringField(
        required=True,
        enum=["ingress", "egress", "ghost"],
        description="The gress this stage belongs to.",
    )
    match_dependent = jsl.BooleanField(
        required=True,
        description="Boolean indicating if this stage is match dependent on the previous stage.",
    )
...
class DynamicHashCalculation(jsl.Document):
    ...
    class HashConfiguration(jsl.Document):
        ...
        hash = jsl.DictField(
            properties={
                ...
                "num_hash_bits": jsl.IntField(
                    required=True,
                    enum=list(range(0, 52)),
                    description="The number of hash bits in use.",
                ),
                "hash_bits": jsl.ArrayField(
                    items=jsl.DictField(
                        properties={
                            "gfm_hash_bit": jsl.IntField(
                                required=True,
                                enum=list(range(0, 52)),
                                description="Integer that indicates the specific hash bit being configured (GFM column).",
                            ),
                            # Note: We only support up to two hardware hash functions, so the maximum number of P4 hash function bits is 104.
                            "p4_hash_bit": jsl.IntField(
                                required=True,
                                enum=list(range(0, 104)),
                                description="Integer that indicates the specific hash bit in the user hash function.",
                            ),
                        }
                    ),
                    required=True,
                    description="A list of the hardware hash bits in use in the hash function, with their mapping to the original user hash function bit.",
                ),
            },
            required=True,
            description="Hardware hash function properties for this stage.",
        )
    ...
    class CrossbarConfiguration(jsl.Document):
        ...
        crossbar = jsl.ArrayField(
            ...
            required=True,
            description="Crossbar bit-in-byte mapping to field bit.",
        )
    ...
    field_lists = jsl.ArrayField(
        jsl.DictField(
            properties={
                ...
                "handle": jsl.IntField(
                    required=True, description="Unique identifier for this field list."
                ),
                "is_default": jsl.BooleanField(
                    required=True,
                    description="Boolean indicating if this field list is the default field list.",
                ),
                "can_permute": jsl.BooleanField(
                    required=False,
                    description="Boolean indicating if the fields in this field list are allowed to be permuted.",
                ),
                "can_rotate": jsl.BooleanField(
                    required=False,
                    description="Boolean indicating if the fields in this field list are allowed to be rotated.",
                ),
                "fields": jsl.ArrayField(
                    items=jsl.DictField(
                        properties={
                            ...
                            "start_bit": jsl.IntField(
                                required=True,
                                description="The start bit of the field, from the least significant bit position.",
                            ),
                            "bit_width": jsl.IntField(
                                required=True,
                                description="The bit width of this field.  Field slices are represented as name[start_bit + bit_width - 1: start_bit].",
                            ),
                            "optional": jsl.BooleanField(
                                required=True,
                                description="A Boolean indicating if this field (or field slice) is optional.",
                            ),
                            "is_constant": jsl.BooleanField(
                                required=True,
                                description="A Boolean indicating if this field represents a constant value.",
                            ),
                            "value": jsl.IntField(
                                required=False,
                                description="An integer representing the value of this 'field,' if is_constant is true.",
                            ),
                        }
                    ),
                    required=True,
                    description="Ordered list of fields, as specified by the P4 source.  Fields that will become the more significant section of the hash key will appear in lower indices (index 0 is the most significant field).",
                ),
                "crossbar_configuration": jsl.ArrayField(
                    items=jsl.DocumentField(
                        "CrossbarConfiguration",
                        as_ref=True,
                        description="Configuration information for the input crossbar hardware mapping for this field list.",
                    ),
                    required=True,
                    description="Per-stage array of crossbar configuration information.",
                ),
            }
        ),
        required=True,
        description="Available field lists for dynamic hash calculation.",
    )

    any_hash_algorithm_allowed = jsl.BooleanField(
        required=False,
        description="A Boolean indicating if any hash algorithm (of the appropriate size) is supported.",
    )
    hash_bit_width = jsl.IntField(
        required=True,
        description="The bit width of the hash being computed.  Note that this need not match the width what the hash algorithm can uniquely produce.",
    )

    algorithms = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                "name": jsl.StringField(
                    required=True, description="The name of the hash algorithm."
                ),
                "type": jsl.StringField(
                    required=True,
                    enum=["crc", "identity", "random", "xor"],
                    description="The type of the hash algorithm.",
                ),
                "handle": jsl.IntField(
                    required=True, description="Unique identifier for this hash algorithm."
                ),
                "is_default": jsl.BooleanField(
                    required=True,
                    description="Boolean indicating if this hash algorithm is the default hash algorithm.",
                ),
                "msb": jsl.BooleanField(
                    required=True,
                    description="Boolean indicating if the most significant bits of the computed hash should be used.",
                ),
                "extend": jsl.BooleanField(
                    required=True,
                    description="Boolean indicating if the computed hash should be repeated until the output width is filled.",
                ),
                "poly": jsl.StringField(
                    required=False,
                    description="For CRC-based hash algorithms, the polynomial it uses.",
                ),
                "init": jsl.StringField(
                    required=False,
                    description="For CRC-based hash algorithms, the initial value used to start the CRC calculation. This initial value should be the initial shift register value, reversed if it uses a reversed algorithm, and then XORed with the final XOR value.",
                ),
                "reverse": jsl.BooleanField(
                    required=False,
                    description="For CRC-based hash algorithms, a Boolean indicating if a bit-reversed algorithm is used.",
                ),
                "final_xor": jsl.StringField(
                    required=False,
                    description="For CRC-based hash algorithms, the final value to XOR with the calculated CRC value.",
                ),
            }
        ),
        required=True,
    ...
    hash_configuration = jsl.ArrayField(
        items=jsl.DocumentField(
            "HashConfiguration",
            as_ref=True,
            description="Configuration information for the hashing hardware mapping.",
        ),
        required=True,
        description="Per-stage array of hash configuration information.",
    )
...
class ConfigurationValue(jsl.Document):
    ...
    name = jsl.StringField(
        required=True, description="Unique name given, preferably device agnostic."
    )
    fully_qualified_name = jsl.StringField(
        description="Fully qualified name in the register hierarchy."
    )
    value = jsl.StringField(
        required=True, description="A hexadecimal string representation of the configuration value."
    )
...
class EgressPacketLengthAdjust(jsl.Document):
    ...
    field_name = jsl.StringField(
        required=True, description="The metadata field name to be adjusted."
    )
    default_adjustment_value = jsl.IntField(
        required=True,
    ...
    adjustment_values = jsl.ArrayField(
        items=jsl.DictField(
            properties={
                "adjustment_value": jsl.IntField(
                    required=True,
...
class HeaderType(jsl.Document):
    ...
    fields = jsl.ArrayField(
        ...
        items=jsl.DocumentField("FieldInfo", as_ref=True),
        min_items=1,
    )
...
class MauStageExtension(jsl.Document):
    ...
    registers = jsl.ArrayField(
        required=True,
        description="registers to set in each stage",
        items=jsl.DictField(
            required=True,
            properties={
                ...
                "value": jsl.ArrayField(
                    items=jsl.IntField(), required=True, description="register value(s)"
                ),
                "mask": jsl.ArrayField(
                    items=jsl.IntField(),
                    min_items=3,
...
class ContextJSONSchema(jsl.Document):
    ...
    compile_command = jsl.StringField(
        required=False, description="The command line arguments used to compile the program."
    )
    ...
    target = jsl.StringField(
        required=True, enum=TARGETS, description="The target device this program was compiled for."
    )
    ...
    phv_allocation = jsl.ArrayField(
        items=jsl.DocumentField("PHVStageAllocation", as_ref=True),
        required=True,
    ...
    parsers = jsl.DocumentField(
        "Parsers", required=False, as_ref=True, description="Multiple parsers context information."
    )
    learn_quanta = jsl.ArrayField(
        items=jsl.DocumentField("LearnQuanta", as_ref=True),
        required=True,
        description="LearnQuanta context information.",
    )
    dynamic_hash_calculations = jsl.ArrayField(
        items=jsl.DocumentField("DynamicHashCalculation", as_ref=True),
        required=True,
        description="Dynamic hash calculation context information.",
    )
    configuration_cache = jsl.ArrayField(
        items=jsl.DocumentField("ConfigurationValue", as_ref=True),
        required=True,
        description="Cached configuration values.",
    )
    egress_packet_length_adjust = jsl.DocumentField(
        "EgressPacketLengthAdjust",
        as_ref=True,
        description="Information needed to manually adjust the egress intrinsic metadata packet length.",
    )
    driver_options = jsl.DictField(
        properties={
            "hash_parity_enabled": jsl.BooleanField(
                required=True,
                description="Boolean indicating if hash parity errors will generate interrupts.",
            ),
            "high_availability_enabled": jsl.BooleanField(
                required=False,
                description="Boolean indicating if the compiler allocated resources to support high availability.",
            ),
            "tof1_egr_parse_depth_checks_disabled": jsl.BooleanField(
                required=False,
                description="Boolean indicating that Tofino 1 egress parse depth checks were disabled during compilation.",
            ),
        },
    ...
    mau_stage_characteristics = jsl.ArrayField(
        items=jsl.DocumentField("MauStageCharacteristics", as_ref=True),
        required=True,
        description="Characteristics information about how a MAU stage has been configured.",
    )
    flexible_headers = jsl.ArrayField(
        items=jsl.DocumentField("HeaderType", as_ref=True),
        required=False,
        description="compiler defined layouts for flexible headers",
    )
    mau_stage_extension = jsl.DocumentField(
        "MauStageExtension",
        as_ref=True,
        required=False,
...
def gen_docs(klass):
    ...
    def get_item_docs(item, docs):
        ...
        if isinstance(item, jsl.ArrayField):
            ...
            info = {"type": item.document_cls.title, "required": item.required}
        elif isinstance(item, jsl.StringField):
            info = {"type": "string", "description": item.description, "required": item.required}
        elif isinstance(item, jsl.IntField):
            info = {"type": "integer", "description": item.description, "required": item.required}
        elif isinstance(item, jsl.BooleanField):
            info = {"type": "boolean", "description": item.description, "required": item.required}
    ...
    def handle_doc(doc, docs):
        ...
        docs[title] = {"type": "object", "description": doc.description, "properties": {}}
