 ...
 *****************************************************************************/
# 283 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/includes/p4_table_sizes.h"
//#undef INGRESS_IP_RACL_TABLE_SIZE
//#undef INGRESS_IPV6_RACL_TABLE_SIZE

//#undef RACL_STATS_TABLE_SIZE
# 308 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/includes/p4_table_sizes.h"
   // 32K MACs
...
//#define EGRESS_ACL_TABLE_SIZE                  256
   ...
   // ECMP/Nexthop
# 388 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/includes/p4_table_sizes.h"
/******************************************************************************
...
# 290 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/port.p4"
}
...
control process_ingress_stp {
    ...
    if (((ingress_metadata.bd & 0x3000) == 0) and (ingress_metadata.port_type == 0)) {
        apply(ingress_stp);
    }
...
control process_egress_stp {
    ...
    if (((egress_metadata.bd & 0x3000) == 0) and (egress_metadata.port_type == 0)) {
        apply(egress_stp);
    }
...
# 65 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
...
# 255 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
...
# 492 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
                }
            }
        }
    } else {
...
# 1749 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
...
# 2222 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
//#ifdef SRV6_ENABLE
///*****************************************************************************/
///* Tunnel MAC rewrite                                                        */
///*****************************************************************************/
...
# 2315 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/tunnel.p4"
...
action acl_deny(acl_stats_index, acl_meter_index, acl_copy_reason,
    ...
    modify_field(ingress_metadata.drop_reason, 80);
...
/*****************************************************************************/
# 1362 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
...
table system_acl {
    reads {
        ...
        ipv6_metadata.lkp_ipv6_da : ternary; ipv4_metadata.lkp_ipv4_da : ternary; ipv4_metadata.lkp_ipv4_sa : ternary; vlan_tag_[0].vid : ternary; l2_metadata.lkp_mac_da : ternary; l2_metadata.lkp_mac_type : ternary; l3_metadata.lkp_ip_proto : ternary; l3_metadata.lkp_ip_ttl : ternary; l3_metadata.lkp_dscp : ternary; l3_metadata.lkp_l4_sport : ternary; l3_metadata.lkp_l4_dport : ternary; fabric_metadata.reason_code : ternary;
...
# 2596 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
        apply(system_acl);
# 2606 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
...
table egress_mac_acl {
    reads {
        acl_metadata.egress_port_lag_label : ternary; acl_metadata.egress_bd_label : ternary; ethernet.srcAddr : ternary; ethernet.dstAddr : ternary; ethernet.etherType : ternary;
    }
    actions {
        nop;
        egress_acl_deny;
...
# 2706 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
    }
    actions {
        nop;
        egress_acl_deny;
...
table egress_ipv6_acl {
    reads {
        ...
        l3_metadata.lkp_l4_sport : ternary;
        l3_metadata.lkp_l4_dport : ternary;
# 2742 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
    }
    actions {
        nop;
        egress_acl_deny;
...
# 2910 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
...
# 3056 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/acl.p4"
...
table ipv4_multicast_bridge {
    reads {
# 469 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/multicast.p4"
        ingress_metadata.bd : exact;
...
# 169 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/nexthop.p4"
...
# 317 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/nexthop.p4"
 ...
 * WRED processing
 */
# 68 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/wred.p4"
control process_ecn_acl {



}
# 198 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/wred.p4"
...
control ingress {
//----------------------------------------------------------------------
# 1331 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/switch.p4"
//----------------------------------------------------------------------
...
//----------------------------------------------------------------------
# 2544 "/mnt/p4c/extensions/p4_tests/p4_14/switch/p4src/switch.p4"
//----------------------------------------------------------------------
