...
void MinMax::write_regs(Target::Cloudbreak::mau_regs &regs, Table *tbl_, Table::Actions::Action *act) {
...
template<>
void AluOP::write_regs(Target::Cloudbreak::mau_regs &regs, Table *tbl_, Table::Actions::Action *act) {
    LOG2(this);
    auto tbl = dynamic_cast<StatefulTable *>(tbl_);
    int logical_home_row = tbl->layout[0].row;
    auto &meter_group = regs.rams.map_alu.meter_group[logical_home_row/4U];
...
void AluOP::write_regs(Target::Cloudbreak::mau_regs &regs, Table *tbl, Table::Actions::Action *act) {
    write_regs<Target::Cloudbreak::mau_regs>(regs, tbl, act); }

template<>
void BitOP::write_regs(Target::Cloudbreak::mau_regs &regs, Table *tbl, Table::Actions::Action *act) {
    LOG2(this);
    int logical_home_row = tbl->layout[0].row;
    auto &meter_group = regs.rams.map_alu.meter_group[logical_home_row/4U];
    auto &salu = meter_group.stateful.salu_instr_state_alu[act->code][slot-ALU2LO];
...
template<>
void CmpOP::write_regs(Target::Cloudbreak::mau_regs &regs, Table *tbl_, Table::Actions::Action *act) {
    LOG2(this);
    auto tbl = dynamic_cast<StatefulTable *>(tbl_);
    int logical_home_row = tbl->layout[0].row;
    auto &meter_group = regs.rams.map_alu.meter_group[logical_home_row/4U];
...
void CmpOP::write_regs(Target::Cloudbreak::mau_regs &regs, Table *tbl, Table::Actions::Action *act) {
    write_regs<Target::Cloudbreak::mau_regs>(regs, tbl, act); }

template<>
void TMatchOP::write_regs(Target::Cloudbreak::mau_regs &regs, Table *tbl_, Table::Actions::Action *act) {
    LOG2(this);
    auto tbl = dynamic_cast<StatefulTable *>(tbl_);
    int logical_home_row = tbl->layout[0].row;
    auto &meter_group = regs.rams.map_alu.meter_group[logical_home_row/4U];
...
void TMatchOP::write_regs(Target::Cloudbreak::mau_regs &regs, Table *tbl, Table::Actions::Action *act) {
    write_regs<Target::Cloudbreak::mau_regs>(regs, tbl, act); }
...
template<>
void OutOP::write_regs(Target::Cloudbreak::mau_regs &regs, Table *tbl_, Table::Actions::Action *act) {
    LOG2(this);
    auto tbl = dynamic_cast<StatefulTable *>(tbl_);
    int logical_home_row = tbl->layout[0].row;
    auto &meter_group = regs.rams.map_alu.meter_group[logical_home_row/4U];
...
void OutOP::write_regs(Target::Cloudbreak::mau_regs &regs, Table *tbl, Table::Actions::Action *act) {
    write_regs<Target::Cloudbreak::mau_regs>(regs, tbl, act); }
