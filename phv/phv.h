...
constexpr int kNumMauGroups = kNumPhvMauGroups + kNumMauUnusedGroups + kNumTPhvMauGroups;
...
std::array<std::vector<int>, kNumDeparserGroups> kDeparserGroups =
    {{{32}, {36}, {40}, {44}, {48}, {52}, {56}, {60},
      {61}, {62}, {63}, {64}, {96}, {104}, {112}, {120},
      {121}, {122}, {123}, {124}, {125}, {126}, {127}, {128},
      {160}, {168}, {176}, {184}, {192}, {200}, {208}, {216},
      {217}, {218}, {219}, {220}, {221}, {222}, {223}, {256},
      {260, 288, 292, 320, 326},
      {264, 288, 296, 320, 332},
      {268, 288, 300, 320, 338},
      {272, 288, 304, 320, 344},
...
class Bit : public std::pair<cstring, int> {
 public:
    ...
    std::string name() const { return first + "[" + std::to_string(second) + "]"; }
...
inline std::ostream &operator<<(std::ostream &out, const PHV::Bits &b) {
    if (b.size() > 0) {
        ...
        out << b.front().first << "[" << b.front().second << ":" << b.back().second << "]"; }
    return out;
}
