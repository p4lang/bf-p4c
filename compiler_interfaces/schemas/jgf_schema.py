...
class JsonGraphFormatSchema(jsl.Document):
    ...
    metadata = jsl.OneOfField([
      jsl.DictField(),
      jsl.NullField()
    ], required=False, description="Graph collection metadata object.")
    graphs = jsl.ArrayField(required=True, items=jsl.DocumentField("Graph", as_ref=True, required=True), description="An array of JSON graphs.")
...
class GraphNode(jsl.Document):
    ...
    metadata = jsl.OneOfField([
      jsl.DictField(),
      jsl.NullField()
    ], required=False, description="Graph node metadata object")
...
class GraphEdge(jsl.Document):
    ...
    relation = jsl.StringField(required=False, description="The interaction between the source and target node.")
    directed = jsl.OneOfField([
      jsl.BooleanField(default=True),
      jsl.NullField(),
    ], required=False, description="Directed or undirected edge mode. Determined by graph if omitted.")
    metadata = jsl.OneOfField([
      jsl.DictField(),
      jsl.NullField()
    ], required=False, description="Graph edge metadata object.")
