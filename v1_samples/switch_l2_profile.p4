...
# 1 "switch.p4" 2
# 34 "switch.p4"
# 1 "./includes/tofino.p4" 1
# 28 "./includes/tofino.p4"
...
# 39 "./switch_config.p4"
    modify_field(i2e_metadata.ingress_tstamp, ig_intr_md.ingress_global_tstamp);
...
control process_int_egress {
    ...
    if (int_metadata_i2e.sink == 1 and not ((standard_metadata.instance_type != 0) and (standard_metadata.instance_type != 5))) {
# 1802 "./int_plt.p4"
    }
    else {
        ...
        if (tunnel_metadata.egress_tunnel_type == 7 or
            tunnel_metadata.egress_tunnel_type == 20) {
...
control process_int_outer_encap {
    ...
    if ((int_metadata.insert_cnt != 0)
            or (int_metadata_i2e.sink == 1 and (standard_metadata.instance_type == 2)))
    {
...
header_type flowlet_metadata_t {
    fields {
        ...
        timestamp : 32;
        map_index : 13;
        inter_packet_gap : 32 (saturating);
    }
}
