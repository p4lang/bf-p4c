...
# 377 "../../p4c-tofino/p4c_tofino/target/tofino/p4_lib/tofino/intrinsic_metadata.p4"
...
# 420 "../../p4c-tofino/p4c_tofino/target/tofino/p4_lib/tofino/intrinsic_metadata.p4"
        force_tx_error : 1;
...
parser parse_mpls {
# 275 "./includes/parser.p4"
    return ingress;

}

parser parse_mpls_bos {
# 294 "./includes/parser.p4"
...
header udp_t udp;
# 607 "./includes/parser.p4"
parser parse_udp {
    extract(udp);
    set_metadata(l3_metadata.lkp_outer_l4_sport, latest.srcPort);
    set_metadata(l3_metadata.lkp_outer_l4_dport, latest.dstPort);
    return select(latest.dstPort) {
# 624 "./includes/parser.p4"
        67 : parse_set_prio_med;
        68 : parse_set_prio_med;
        546 : parse_set_prio_med;
        547 : parse_set_prio_med;
...
# 45 "switch.p4" 2
# 1 "./includes/negative_mirroring.h" 1
# 46 "switch.p4" 2
...
action set_wcmp() {
    modify_field(nexthop_metadata.nexthop_type, 2);
}
...
# 246 "../../p4c-tofino/p4c_tofino/target/tofino/p4_lib/tofino/stateful_alu_blackbox.p4"
    method execute_stateful_alu(optional in bit<1> index){
