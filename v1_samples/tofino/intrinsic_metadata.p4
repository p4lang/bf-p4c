...
@pragma not_deparsed ingress
@pragma not_deparsed egress
metadata generator_metadata_t ig_pg_md;


/* Produced by Ingress Parser-Auxiliary */ 
// TODO: convert to struct post P4 revision
...
metadata ingress_intrinsic_metadata_from_parser_aux_t ig_intr_md_from_parser_aux;
...
@pragma not_deparsed ingress
@pragma not_deparsed egress
metadata ingress_intrinsic_metadata_for_mirror_buffer_t ig_intr_md_for_mb;
...
@pragma not_deparsed ingress
@pragma not_deparsed egress
metadata egress_intrinsic_metadata_for_deparser_t eg_intr_md_for_deparser;
*/
...
@pragma not_deparsed ingress
@pragma not_deparsed egress
metadata egress_intrinsic_metadata_for_mirror_buffer_t eg_intr_md_for_mb;
...
metadata egress_intrinsic_metadata_for_output_port_t eg_intr_md_for_oport;
