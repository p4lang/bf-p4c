...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
    @name("meter_0") direct_meter<bit<8>>(CounterType.bytes) meter_2;
    @name("meter_1") meter(32w500, CounterType.bytes) meter_3;
    ...
    @pa_solitare("meter_result.color_0", "meter_result.color_1") @name("table_0") table table_2() {
        actions = {
            action_0_1();
            NoAction();
        }
    ...
    @idletime_two_way_notification(1) @name("table_1") table table_3() {
        actions = {
            do_nothing_0();
            action_0();
            NoAction();
